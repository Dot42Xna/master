...
//
// Original filename: DexImportAttribute.cs
//
...
{
    /// <summary>
    /// Indicates that a type/member is imported from Android.
    /// </summary>
    [AttributeUsage(AttributeTargets.All)]
    [Ignore]
    public sealed class DexImportAttribute : Attribute
    {
		public DexImportAttribute(string javaClassName) { }
		public DexImportAttribute(string memberName, string typeName) { }
        public DexImportAttribute(string javaClassName, string memberName, string typeName) { }
