        ...
        private void UpdateDeterminant(int xmIdx)
        {
            ...
            for (int i = 0; num3 != 0; i++)
            {
                ...
                for (int j = 0; j < i; j++)
                {
                    ...
                    num13 = (this.edgeLengthSq[num5][num10] < this.edgeLengthSq[xmIdx][num10]) ? num5 : xmIdx;
                    ...
                    num13 = (this.edgeLengthSq[num10][num5] < this.edgeLengthSq[xmIdx][num5]) ? num10 : xmIdx;
                    this.det[num12][num5] = (this.det[num11 | index][num10] * Dot(ref this.edges[num13][num5], ref this.y[num10])) + (this.det[num11 | index][xmIdx] * Dot(ref this.edges[num13][num5], ref this.y[xmIdx]));
                    num13 = (this.edgeLengthSq[num5][xmIdx] < this.edgeLengthSq[num10][xmIdx]) ? num5 : num10;
                    this.det[num12][xmIdx] = (this.det[num6 | num11][num10] * Dot(ref this.edges[num13][xmIdx], ref this.y[num10])) + (this.det[num6 | num11][num5] * Dot(ref this.edges[num13][xmIdx], ref this.y[num5]));
                    num8 = num8 >> 3;
                }
                num3 = num3 >> 3;
            }
            ...
            {
                num13 = (this.edgeLengthSq[1][0] < this.edgeLengthSq[2][0]) ? ((this.edgeLengthSq[1][0] < this.edgeLengthSq[3][0]) ? 1 : 3) : ((this.edgeLengthSq[2][0] < this.edgeLengthSq[3][0]) ? 2 : 3);
                this.det[15][0] = ((this.det[14][1] * Dot(ref this.edges[num13][0], ref this.y[1])) + (this.det[14][2] * Dot(ref this.edges[num13][0], ref this.y[2]))) + (this.det[14][3] * Dot(ref this.edges[num13][0], ref this.y[3]));
                ...
                this.det[15][1] = ((this.det[13][0] * Dot(ref this.edges[num13][1], ref this.y[0])) + (this.det[13][2] * Dot(ref this.edges[num13][1], ref this.y[2]))) + (this.det[13][3] * Dot(ref this.edges[num13][1], ref this.y[3]));
                ...
                this.det[15][2] = ((this.det[11][0] * Dot(ref this.edges[num13][2], ref this.y[0])) + (this.det[11][1] * Dot(ref this.edges[num13][2], ref this.y[1]))) + (this.det[11][3] * Dot(ref this.edges[num13][2], ref this.y[3]));
                ...
                this.det[15][3] = ((this.det[7][0] * Dot(ref this.edges[num13][3], ref this.y[0])) + (this.det[7][1] * Dot(ref this.edges[num13][3], ref this.y[1]))) + (this.det[7][2] * Dot(ref this.edges[num13][3], ref this.y[2]));
            }
        }
