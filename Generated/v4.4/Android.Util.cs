...
//
// Original filename: Android.Util.cs
//
...
namespace Android.Util
{
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para>SparseArray mapping longs to Objects. Unlike a normal array of Objects, there can be gaps in the indices. It is intended to be more efficient than using a HashMap to map Longs to Objects. </para>    
		/// </summary>
		/// <java-name>
		/// android/util/LongSparseArray
		/// </java-name>
		[Dot42.DexImport("android/util/LongSparseArray", AccessFlags = 33, Signature = "<E:Ljava/lang/Object;>Ljava/lang/Object;Ljava/lang/Cloneable;")]
		public partial class LongSparseArray<E> : global::Java.Lang.ICloneable
 /* scope: __dot42__ */ 
		{
				/// <summary>
				/// <para>Creates a new LongSparseArray containing no mappings. </para>        
				/// </summary>
				[Dot42.DexImport("<init>", "()V", AccessFlags = 1)]
				public LongSparseArray() /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Creates a new LongSparseArray containing no mappings that will not require any additional memory allocation to store the specified number of mappings. </para>        
				/// </summary>
				[Dot42.DexImport("<init>", "(I)V", AccessFlags = 1)]
				public LongSparseArray(int initialCapacity) /* MethodBuilder.Create */ 
				{
				}
				...
				/// clone
				/// </java-name>
				[Dot42.DexImport("clone", "()Landroid/util/LongSparseArray;", AccessFlags = 1, Signature = "()Landroid/util/LongSparseArray<TE;>;")]
				public virtual global::Android.Util.LongSparseArray<E> Clone() /* MethodBuilder.Create */ 
				{
						return default(global::Android.Util.LongSparseArray<E>);
				}
				...
				/// get
				/// </java-name>
				[Dot42.DexImport("get", "(J)Ljava/lang/Object;", AccessFlags = 1, Signature = "(J)TE;")]
				public virtual E Get(long key) /* MethodBuilder.Create */ 
				{
						return default(E);
				}
				...
				/// get
				/// </java-name>
				[Dot42.DexImport("get", "(JLjava/lang/Object;)Ljava/lang/Object;", AccessFlags = 1, Signature = "(JTE;)TE;")]
				public virtual E Get(long key, E valueIfKeyNotFound) /* MethodBuilder.Create */ 
				{
						return default(E);
				}
				...
				/// delete
				/// </java-name>
				[Dot42.DexImport("delete", "(J)V", AccessFlags = 1)]
				public virtual void Delete(long key) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Alias for delete(long). </para>        
				/// </summary>
				/// <java-name>
				/// remove
				/// </java-name>
				[Dot42.DexImport("remove", "(J)V", AccessFlags = 1)]
				public virtual void Remove(long key) /* MethodBuilder.Create */ 
				{
				}
				...
				/// put
				/// </java-name>
				[Dot42.DexImport("put", "(JLjava/lang/Object;)V", AccessFlags = 1, Signature = "(JTE;)V")]
				public virtual void Put(long key, E value) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Returns the number of key-value mappings that this LongSparseArray currently stores. </para>        
				/// </summary>
				/// <java-name>
				/// size
				/// </java-name>
				...
				/// <summary>
				/// <para>Given an index in the range <code>0...size()-1</code>, returns the key from the <code>index</code>th key-value mapping that this LongSparseArray stores. </para>        
				/// </summary>
				/// <java-name>
				/// keyAt
				/// </java-name>
				[Dot42.DexImport("keyAt", "(I)J", AccessFlags = 1)]
				public virtual long KeyAt(int index) /* MethodBuilder.Create */ 
				{
						return default(long);
				}

				/// <summary>
				/// <para>Given an index in the range <code>0...size()-1</code>, returns the value from the <code>index</code>th key-value mapping that this LongSparseArray stores. </para>        
				/// </summary>
				/// <java-name>
				/// valueAt
				/// </java-name>
				...
				/// <summary>
				/// <para>Given an index in the range <code>0...size()-1</code>, sets a new value for the <code>index</code>th key-value mapping that this LongSparseArray stores. </para>        
				/// </summary>
				/// <java-name>
				/// setValueAt
				/// </java-name>
				...
				/// indexOfKey
				/// </java-name>
				[Dot42.DexImport("indexOfKey", "(J)I", AccessFlags = 1)]
				public virtual int IndexOfKey(long key) /* MethodBuilder.Create */ 
				{
						return default(int);
				}
				...
				/// <summary>
				/// <para>Removes all key-value mappings from this LongSparseArray. </para>        
				/// </summary>
				/// <java-name>
				/// clear
				/// </java-name>
				...
				/// append
				/// </java-name>
				[Dot42.DexImport("append", "(JLjava/lang/Object;)V", AccessFlags = 1, Signature = "(JTE;)V")]
				public virtual void Append(long key, E value) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Configure this parser to be be liberal in what it accepts. By default, this parser is strict and only accepts JSON as specified by . Setting the parser to lenient causes it to ignore the following syntax errors:</para><para><ul><li><para>End of line comments starting with <c> // </c> or <c> # </c> and ending with a newline character. </para></li><li><para>C-style comments starting with <c> /* </c> and ending with <c> * </c> <c> / </c> . Such comments may not be nested. </para></li><li><para>Names that are unquoted or <c> 'single quoted' </c> . </para></li><li><para>Strings that are unquoted or <c> 'single quoted' </c> . </para></li><li><para>Array elements separated by <c> ; </c> instead of <c> , </c> . </para></li><li><para>Unnecessary array separators. These are interpreted as if null was the omitted value. </para></li><li><para>Names and values separated by <c> = </c> or <c> =&gt; </c> instead of <c> : </c> . </para></li><li><para>Name/value pairs separated by <c> ; </c> instead of <c> , </c> . </para></li></ul></para>        
				/// </summary>
				/// <java-name>
				/// setLenient
				/// </java-name>
				[Dot42.DexImport("setLenient", "(Z)V", AccessFlags = 1)]
				public void SetLenient(bool lenient) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para>SparseArrays map integers to Objects. Unlike a normal array of Objects, there can be gaps in the indices. It is intended to be more efficient than using a HashMap to map Integers to Objects. </para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Creates a new SparseArray containing no mappings that will not require any additional memory allocation to store the specified number of mappings. </para>        
				/// </summary>
				[Dot42.DexImport("<init>", "(I)V", AccessFlags = 1)]
				...
				/// removeAtRange
				/// </java-name>
				[Dot42.DexImport("removeAtRange", "(II)V", AccessFlags = 1)]
				public virtual void RemoveAtRange(int int32, int int321) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Given an index in the range <code>0...size()-1</code>, returns the key from the <code>index</code>th key-value mapping that this SparseArray stores. </para>        
				/// </summary>
				/// <java-name>
				/// keyAt
				/// </java-name>
				...
				/// <summary>
				/// <para>Given an index in the range <code>0...size()-1</code>, returns the value from the <code>index</code>th key-value mapping that this SparseArray stores. </para>        
				/// </summary>
				/// <java-name>
				/// valueAt
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Remove the eldest entries until the total of remaining entries is at or below the requested size.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// trimToSize
				/// </java-name>
				[Dot42.DexImport("trimToSize", "(I)V", AccessFlags = 1)]
				public virtual void TrimToSize(int maxSize) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Configure this writer to relax its syntax rules. By default, this writer only emits well-formed JSON as specified by . Setting the writer to lenient permits the following: <ul><li><para>Top-level values of any type. With strict writing, the top-level value must be an object or an array. </para></li><li><para>Numbers may be NaNs or infinities. </para></li></ul></para>        
				/// </summary>
				/// <java-name>
				/// setLenient
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// DENSITY_400
				/// </java-name>
				[Dot42.DexImport("DENSITY_400", "I", AccessFlags = 25)]
				public const int DENSITY_400 = 400;
				/// <summary>
				/// <para>Standard quantized DPI for extra-extra-high-density screens. Applications should not generally worry about this density; relying on XHIGH graphics being scaled up to it should be sufficient for almost all cases. </para>        
				/// </summary>
				/// <java-name>
				/// DENSITY_XXHIGH
				/// </java-name>
				[Dot42.DexImport("DENSITY_XXHIGH", "I", AccessFlags = 25)]
				public const int DENSITY_XXHIGH = 480;
				/// <summary>
				/// <para>Standard quantized DPI for extra-extra-extra-high-density screens. Applications should not generally worry about this density; relying on XHIGH graphics being scaled up to it should be sufficient for almost all cases. A typical use of this density would be 4K television screens  3840x2160, which is 2x a traditional HD 1920x1080 screen which runs at DENSITY_XHIGH. </para>        
				/// </summary>
				/// <java-name>
				/// DENSITY_XXXHIGH
				/// </java-name>
				[Dot42.DexImport("DENSITY_XXXHIGH", "I", AccessFlags = 25)]
				...
				/// <summary>
				/// <para>Returns true if these display metrics equal the other display metrics.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>True if the display metrics are equal. </para>
				/// </returns>
				/// <java-name>
				/// equals
				/// </java-name>
				...
				/// equals
				/// </java-name>
				[Dot42.DexImport("equals", "(Landroid/util/DisplayMetrics;)Z", AccessFlags = 1)]
				public virtual bool Equals(global::Android.Util.DisplayMetrics other) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Encoder/decoder flag bit to indicate using the "URL and       filename safe" variant of Base64 (see RFC 3548 section 4) where <c> - </c> and <c> _ </c> are used in place of <c> + </c> and <c> / </c> . </para>        
				/// </summary>
				/// <java-name>
				/// URL_SAFE
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Returns the closest float approximation of the raising "e" to the power of the argument.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>the exponential of value </para>
				/// </returns>
				/// <java-name>
				/// exp
				/// </java-name>
				[Dot42.DexImport("exp", "(F)F", AccessFlags = 265)]
				public static float Exp(float value) /* MethodBuilder.Create */ 
				{
						return default(float);
				}

				/// <summary>
				/// <para>Returns the closest float approximation of the result of raising <c>       x </c> to the power of <c> y </c> .</para><para></para>        
				/// </summary>
				/// <returns>
				...
				/// pow
				/// </java-name>
				[Dot42.DexImport("pow", "(FF)F", AccessFlags = 265)]
				public static float Pow(float x, float y) /* MethodBuilder.Create */ 
				{
						return default(float);
				}

				/// <summary>
				/// <para>Returns <c> sqrt( </c> <b><c> x </c> </b><span><c> 2 </c> </span><c> + </c> <b> <c> y </c> </b><span><c> 2 </c> </span><c> ) </c> .</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>the hypotenuse </para>
				/// </returns>
				/// <java-name>
				/// hypot
				/// </java-name>
				[Dot42.DexImport("hypot", "(FF)F", AccessFlags = 265)]
				public static float Hypot(float x, float y) /* MethodBuilder.Create */ 
				{
						return default(float);
				}
		...
		/// </java-name>
		[Dot42.DexImport("android/util/ArrayMap", AccessFlags = 49, Signature = "<K:Ljava/lang/Object;V:Ljava/lang/Object;>Ljava/lang/Object;Ljava/util/Map<TK;TV;" +
    ">;")]
		public sealed partial class ArrayMap<K, V> : global::Java.Util.IMap<K, V>
 /* scope: __dot42__ */ 
		{
				[Dot42.DexImport("<init>", "()V", AccessFlags = 1)]
				public ArrayMap() /* MethodBuilder.Create */ 
				{
				}

				[Dot42.DexImport("<init>", "(I)V", AccessFlags = 1)]
				public ArrayMap(int int32) /* MethodBuilder.Create */ 
				{
				}

				[Dot42.DexImport("<init>", "(Landroid/util/ArrayMap;)V", AccessFlags = 1)]
				public ArrayMap(global::Android.Util.ArrayMap<object, object> arrayMap) /* MethodBuilder.Create */ 
				{
				}
				...
				public bool ContainsKey(object @object) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				public bool ContainsValue(object @object) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				public V Get(object @object) /* MethodBuilder.Create */ 
				{
						return default(V);
				}
				...
				/// keyAt
				/// </java-name>
				[Dot42.DexImport("keyAt", "(I)Ljava/lang/Object;", AccessFlags = 1, Signature = "(I)TK;")]
				public K KeyAt(int int32) /* MethodBuilder.Create */ 
				{
						return default(K);
				}
				...
				/// valueAt
				/// </java-name>
				[Dot42.DexImport("valueAt", "(I)Ljava/lang/Object;", AccessFlags = 1, Signature = "(I)TV;")]
				public V ValueAt(int int32) /* MethodBuilder.Create */ 
				{
						return default(V);
				}
				...
				/// setValueAt
				/// </java-name>
				[Dot42.DexImport("setValueAt", "(ILjava/lang/Object;)Ljava/lang/Object;", AccessFlags = 1, Signature = "(ITV;)TV;")]
				public V SetValueAt(int int32, V v) /* MethodBuilder.Create */ 
				{
						return default(V);
				}
				...
				/// putAll
				/// </java-name>
				[Dot42.DexImport("putAll", "(Landroid/util/ArrayMap;)V", AccessFlags = 1, Signature = "(Landroid/util/ArrayMap<+TK;+TV;>;)V")]
				public void PutAll(global::Android.Util.ArrayMap<K, V> arrayMap) /* MethodBuilder.Create */ 
				{
				}
				...
				public V Remove(object @object) /* MethodBuilder.Create */ 
				{
						return default(V);
				}
				...
				/// removeAt
				/// </java-name>
				[Dot42.DexImport("removeAt", "(I)Ljava/lang/Object;", AccessFlags = 1, Signature = "(I)TV;")]
				public V RemoveAt(int int32) /* MethodBuilder.Create */ 
				{
						return default(V);
				}
				...
				public bool ContainsAll(global::Java.Util.ICollection<object> collection) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				public void PutAll(global::Java.Util.IMap<K, V> map) /* MethodBuilder.Create */ 
				{
				}
				...
				public bool RemoveAll(global::Java.Util.ICollection<object> collection) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				public bool RetainAll(global::Java.Util.ICollection<object> collection) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				public global::Java.Util.ISet<global::Java.Util.IMap_IEntry<K, V>> EntrySet() /* MethodBuilder.Create */ 
				{
				...
				public global::Java.Util.ISet<K> KeySet() /* MethodBuilder.Create */ 
				{
				...
				public global::Java.Util.ICollection<V> Values() /* MethodBuilder.Create */ 
				{
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para>SparseLongArrays map integers to longs. Unlike a normal array of longs, there can be gaps in the indices. It is intended to be more efficient than using a HashMap to map Integers to Longs. </para>    
		/// </summary>
		/// <java-name>
		/// android/util/SparseLongArray
		/// </java-name>
		[Dot42.DexImport("android/util/SparseLongArray", AccessFlags = 33)]
		public partial class SparseLongArray : global::Java.Lang.ICloneable
 /* scope: __dot42__ */ 
		{
				/// <summary>
				/// <para>Creates a new SparseLongArray containing no mappings. </para>        
				/// </summary>
				[Dot42.DexImport("<init>", "()V", AccessFlags = 1)]
				public SparseLongArray() /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Creates a new SparseLongArray containing no mappings that will not require any additional memory allocation to store the specified number of mappings. </para>        
				/// </summary>
				[Dot42.DexImport("<init>", "(I)V", AccessFlags = 1)]
				public SparseLongArray(int initialCapacity) /* MethodBuilder.Create */ 
				{
				}
				...
				/// clone
				/// </java-name>
				[Dot42.DexImport("clone", "()Landroid/util/SparseLongArray;", AccessFlags = 1)]
				public virtual global::Android.Util.SparseLongArray Clone() /* MethodBuilder.Create */ 
				{
						return default(global::Android.Util.SparseLongArray);
				}

				/// <summary>
				/// <para>Gets the long mapped from the specified key, or <code>0</code> if no such mapping has been made. </para>        
				/// </summary>
				/// <java-name>
				/// get
				/// </java-name>
				[Dot42.DexImport("get", "(I)J", AccessFlags = 1)]
				public virtual long Get(int key) /* MethodBuilder.Create */ 
				{
						return default(long);
				}

				/// <summary>
				/// <para>Gets the long mapped from the specified key, or the specified value if no such mapping has been made. </para>        
				/// </summary>
				/// <java-name>
				/// get
				/// </java-name>
				[Dot42.DexImport("get", "(IJ)J", AccessFlags = 1)]
				public virtual long Get(int key, long valueIfKeyNotFound) /* MethodBuilder.Create */ 
				{
						return default(long);
				}
				...
				/// put
				/// </java-name>
				[Dot42.DexImport("put", "(IJ)V", AccessFlags = 1)]
				public virtual void Put(int key, long value) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Given an index in the range <code>0...size()-1</code>, returns the key from the <code>index</code>th key-value mapping that this SparseLongArray stores. </para>        
				/// </summary>
				/// <java-name>
				/// keyAt
				/// </java-name>
				...
				/// <summary>
				/// <para>Given an index in the range <code>0...size()-1</code>, returns the value from the <code>index</code>th key-value mapping that this SparseLongArray stores. </para>        
				/// </summary>
				/// <java-name>
				/// valueAt
				/// </java-name>
				[Dot42.DexImport("valueAt", "(I)J", AccessFlags = 1)]
				public virtual long ValueAt(int index) /* MethodBuilder.Create */ 
				{
						return default(long);
				}
				...
				/// indexOfValue
				/// </java-name>
				[Dot42.DexImport("indexOfValue", "(J)I", AccessFlags = 1)]
				public virtual int IndexOfValue(long value) /* MethodBuilder.Create */ 
				{
						return default(int);
				}
				...
				/// append
				/// </java-name>
				[Dot42.DexImport("append", "(IJ)V", AccessFlags = 1)]
				public virtual void Append(int key, long value) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para>SparseBooleanArrays map integers to booleans. Unlike a normal array of booleans there can be gaps in the indices. It is intended to be more efficient than using a HashMap to map Integers to Booleans. </para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Creates a new SparseBooleanArray containing no mappings that will not require any additional memory allocation to store the specified number of mappings. </para>        
				/// </summary>
				[Dot42.DexImport("<init>", "(I)V", AccessFlags = 1)]
				...
				/// <summary>
				/// <para>Given an index in the range <code>0...size()-1</code>, returns the key from the <code>index</code>th key-value mapping that this SparseBooleanArray stores. </para>        
				/// </summary>
				/// <java-name>
				/// keyAt
				/// </java-name>
				...
				/// <summary>
				/// <para>Given an index in the range <code>0...size()-1</code>, returns the value from the <code>index</code>th key-value mapping that this SparseBooleanArray stores. </para>        
				/// </summary>
				/// <java-name>
				/// valueAt
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		...
		/// </java-name>
		[Dot42.DexImport("android/util/LayoutDirection", AccessFlags = 49)]
		public sealed partial class LayoutDirection
 /* scope: __dot42__ */ 
		{
				/// <java-name>
				/// LTR
				/// </java-name>
				[Dot42.DexImport("LTR", "I", AccessFlags = 25)]
				public const int LTR = 0;
				/// <java-name>
				/// RTL
				/// </java-name>
				[Dot42.DexImport("RTL", "I", AccessFlags = 25)]
				public const int RTL = 1;
				/// <java-name>
				/// INHERIT
				/// </java-name>
				[Dot42.DexImport("INHERIT", "I", AccessFlags = 25)]
				public const int INHERIT = 2;
				/// <java-name>
				/// LOCALE
				/// </java-name>
				[Dot42.DexImport("LOCALE", "I", AccessFlags = 25)]
				public const int LOCALE = 3;
				[Dot42.DexImport("<init>", "()V", AccessFlags = 0)]
				internal LayoutDirection() /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para>Helper class for performing atomic operations on a file by creating a backup file until a write has successfully completed. If you need this on older versions of the platform you can use android.support.v4.util.AtomicFile in the v4 support library. </para><para>Atomic file guarantees file integrity by ensuring that a file has been completely written and sync'd to disk before removing its backup. As long as the backup file exists, the original file is considered to be invalid (left over from a previous attempt to write the file). </para><para>Atomic file does not confer any file locking semantics. Do not use this class when the file may be accessed or modified concurrently by multiple threads or processes. The caller is responsible for ensuring appropriate mutual exclusion invariants whenever it accesses the file. </para>    
		/// </summary>
		/// <java-name>
		/// android/util/AtomicFile
		/// </java-name>
		[Dot42.DexImport("android/util/AtomicFile", AccessFlags = 33)]
		public partial class AtomicFile
 /* scope: __dot42__ */ 
		{
				/// <summary>
				/// <para>Create a new AtomicFile for a file located at the given File path. The secondary backup file will be the same file path with ".bak" appended. </para>        
				/// </summary>
				[Dot42.DexImport("<init>", "(Ljava/io/File;)V", AccessFlags = 1)]
				public AtomicFile(global::Java.Io.File baseName) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Return the path to the base file. You should not generally use this, as the data at that path may not be valid. </para>        
				/// </summary>
				/// <java-name>
				/// getBaseFile
				/// </java-name>
				[Dot42.DexImport("getBaseFile", "()Ljava/io/File;", AccessFlags = 1)]
				public virtual global::Java.Io.File GetBaseFile() /* MethodBuilder.Create */ 
				{
						return default(global::Java.Io.File);
				}

				/// <summary>
				/// <para>Delete the atomic file. This deletes both the base and backup files. </para>        
				/// </summary>
				/// <java-name>
				/// delete
				/// </java-name>
				[Dot42.DexImport("delete", "()V", AccessFlags = 1)]
				public virtual void Delete() /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Start a new write operation on the file. This returns a FileOutputStream to which you can write the new file data. The existing file is replaced with the new data. You <b>must not</b> directly close the given FileOutputStream; instead call either finishWrite(FileOutputStream) or failWrite(FileOutputStream).</para><para>Note that if another thread is currently performing a write, this will simply replace whatever that thread is writing with the new file being written by this thread, and when the other thread finishes the write the new write operation will no longer be safe (or will be lost). You must do your own threading protection for access to AtomicFile. </para>        
				/// </summary>
				/// <java-name>
				/// startWrite
				/// </java-name>
				[Dot42.DexImport("startWrite", "()Ljava/io/FileOutputStream;", AccessFlags = 1)]
				public virtual global::Java.Io.FileOutputStream StartWrite() /* MethodBuilder.Create */ 
				{
						return default(global::Java.Io.FileOutputStream);
				}

				/// <summary>
				/// <para>Call when you have successfully finished writing to the stream returned by startWrite(). This will close, sync, and commit the new data. The next attempt to read the atomic file will return the new file stream. </para>        
				/// </summary>
				/// <java-name>
				/// finishWrite
				/// </java-name>
				[Dot42.DexImport("finishWrite", "(Ljava/io/FileOutputStream;)V", AccessFlags = 1)]
				public virtual void FinishWrite(global::Java.Io.FileOutputStream str) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Call when you have failed for some reason at writing to the stream returned by startWrite(). This will close the current write stream, and roll back to the previous state of the file. </para>        
				/// </summary>
				/// <java-name>
				/// failWrite
				/// </java-name>
				[Dot42.DexImport("failWrite", "(Ljava/io/FileOutputStream;)V", AccessFlags = 1)]
				public virtual void FailWrite(global::Java.Io.FileOutputStream str) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Open the atomic file for reading. If there previously was an incomplete write, this will roll back to the last good data before opening for read. You should call close() on the FileInputStream when you are done reading from it.</para><para>Note that if another thread is currently performing a write, this will incorrectly consider it to be in the state of a bad write and roll back, causing the new data currently being written to be dropped. You must do your own threading protection for access to AtomicFile. </para>        
				/// </summary>
				/// <java-name>
				/// openRead
				/// </java-name>
				[Dot42.DexImport("openRead", "()Ljava/io/FileInputStream;", AccessFlags = 1)]
				public virtual global::Java.Io.FileInputStream OpenRead() /* MethodBuilder.Create */ 
				{
						return default(global::Java.Io.FileInputStream);
				}

				/// <summary>
				/// <para>A convenience for openRead() that also reads all of the file contents into a byte array which is returned. </para>        
				/// </summary>
				/// <java-name>
				/// readFully
				/// </java-name>
				[Dot42.DexImport("readFully", "()[B", AccessFlags = 1)]
				public virtual sbyte[] JavaReadFully() /* MethodBuilder.Create */ 
				{
						return default(sbyte[]);
				}
				...
				/// readFully
				/// </java-name>
				[Dot42.DexImport("readFully", "()[B", AccessFlags = 1, IgnoreFromJava = true)]
				public virtual byte[] ReadFully() /* MethodBuilder.Create */ 
				{
						return default(byte[]);
				}

				[global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
				internal AtomicFile() /* TypeBuilder.AddDefaultConstructor */ 
				{
				}
				...
				/// getBaseFile
				/// </java-name>
				public global::Java.Io.File BaseFile
				{
				[Dot42.DexImport("getBaseFile", "()Ljava/io/File;", AccessFlags = 1)]
		...
		/// <summary>
		/// <para>SparseIntArrays map integers to integers. Unlike a normal array of integers, there can be gaps in the indices. It is intended to be more efficient than using a HashMap to map Integers to Integers. </para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Creates a new SparseIntArray containing no mappings that will not require any additional memory allocation to store the specified number of mappings. </para>        
				/// </summary>
				[Dot42.DexImport("<init>", "(I)V", AccessFlags = 1)]
				...
				/// <summary>
				/// <para>Given an index in the range <code>0...size()-1</code>, returns the key from the <code>index</code>th key-value mapping that this SparseIntArray stores. </para>        
				/// </summary>
				/// <java-name>
				/// keyAt
				/// </java-name>
				...
				/// <summary>
				/// <para>Given an index in the range <code>0...size()-1</code>, returns the value from the <code>index</code>th key-value mapping that this SparseIntArray stores. </para>        
				/// </summary>
				/// <java-name>
				/// valueAt
				/// </java-name>
