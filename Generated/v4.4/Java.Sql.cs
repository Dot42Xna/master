...
namespace Java.Sql
{
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>This method is deprecated and must not be used. An SQL </para></xrefdescription></xrefsect><c> Time </c> object does not have a <c> Date </c> component. </para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				/// <para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>This method is deprecated and must not be used. An SQL </para></xrefdescription></xrefsect><c> Time </c> object does not have a <b>Day</b> component. </para>        
				/// </summary>
				/// <returns>
				/// <para>does not return anything. </para>
				/// </returns>
				...
				/// <summary>
				/// <para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>This method is deprecated and must not be used. An SQL </para></xrefdescription></xrefsect><c> Time </c> object does not have a <b>Month</b> component. </para>        
				/// </summary>
				/// <returns>
				/// <para>does not return anything. </para>
				/// </returns>
				...
				/// <summary>
				/// <para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>This method is deprecated and must not be used. An SQL </para></xrefdescription></xrefsect><c> Time </c> object does not have a <b>Year</b> component. </para>        
				/// </summary>
				/// <returns>
				/// <para>does not return anything. </para>
				/// </returns>
				...
				public override void SetMonth(int i) /* MethodBuilder.Create */ 
				{
				}
				...
				public override void SetYear(int i) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Sets the time for this <c> Time </c> object to the supplied milliseconds value.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setTime
				/// </java-name>
				[Dot42.DexImport("setTime", "(J)V", AccessFlags = 1)]
				public override void SetTime(long time) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Sets the login timeout when connecting to a database in seconds.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setLoginTimeout
				/// </java-name>
				[Dot42.DexImport("setLoginTimeout", "(I)V", AccessFlags = 9)]
				public static void SetLoginTimeout(int seconds) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Sets the print stream to use for logging data from the <c>       DriverManager </c> and the JDBC drivers.</para><para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>Use setLogWriter instead. </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <java-name>
				/// setLogStream
				/// </java-name>
				[Dot42.DexImport("setLogStream", "(Ljava/io/PrintStream;)V", AccessFlags = 9)]
				public static void SetLogStream(global::Java.Io.PrintStream @out) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Sets the <c> PrintWriter </c> that is used by all loaded drivers, and also the <c> DriverManager </c> .</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setLogWriter
				/// </java-name>
				[Dot42.DexImport("setLogWriter", "(Ljava/io/PrintWriter;)V", AccessFlags = 9)]
				public static void SetLogWriter(global::Java.Io.PrintWriter @out) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Obsolete. Appends <c> ex </c> to the end of this chain. </para>        
				/// </summary>
				/// <java-name>
				/// setNextException
				/// </java-name>
				[Dot42.DexImport("setNextException", "(Ljava/sql/SQLException;)V", AccessFlags = 1)]
				public virtual void SetNextException(global::Java.Sql.SQLException ex) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		...
		public partial interface IConnection : global::Java.Sql.IWrapper, global::Java.Lang.IAutoCloseable
 /* scope: __dot42__ */ 
		{
				/// <summary>
				...
				/// <summary>
				/// <para>Returns the transaction isolation level for this connection.</para><para><para>TRANSACTION_NONE </para><simplesectsep></simplesectsep><para>TRANSACTION_READ_COMMITTED </para><simplesectsep></simplesectsep><para>TRANSACTION_READ_UNCOMMITTED </para><simplesectsep></simplesectsep><para>TRANSACTION_REPEATABLE_READ </para><simplesectsep></simplesectsep><para>TRANSACTION_SERIALIZABLE </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				/// <para>Sets this connection's auto-commit mode <c> on </c> or <c> off </c> . </para><para>Putting a Connection into auto-commit mode means that all associated SQL statements are run and committed as separate transactions. By contrast, setting auto-commit to <c> off </c> means that associated SQL statements get grouped into transactions that need to be completed by explicit calls to either the commit() or rollback() methods. </para><para>Auto-commit is the default mode for new connection instances. </para><para>When in this mode, commits will automatically occur upon successful SQL statement completion or upon successful completion of an execute. Statements are not considered successfully completed until all associated <c> ResultSet </c> s and output parameters have been obtained or closed. </para><para>Calling this operation during an uncommitted transaction will result in it being committed.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setAutoCommit
				/// </java-name>
				[Dot42.DexImport("setAutoCommit", "(Z)V", AccessFlags = 1025)]
				void SetAutoCommit(bool autoCommit) /* MethodBuilder.Create */ ;

				/// <summary>
				/// <para>Sets the catalog name for this connection. This is used to select a subspace of the database for future work. If the driver does not support catalog names, this method is ignored.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setCatalog
				/// </java-name>
				[Dot42.DexImport("setCatalog", "(Ljava/lang/String;)V", AccessFlags = 1025)]
				void SetCatalog(string catalog) /* MethodBuilder.Create */ ;

				/// <summary>
				/// <para>Sets the holdability of the <c> ResultSet </c> s created by this Connection.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setHoldability
				/// </java-name>
				[Dot42.DexImport("setHoldability", "(I)V", AccessFlags = 1025)]
				void SetHoldability(int holdability) /* MethodBuilder.Create */ ;

				/// <summary>
				/// <para>Sets this connection to read-only mode. </para><para>This serves as a hint to the driver, which can enable database optimizations.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setReadOnly
				/// </java-name>
				...
				/// <summary>
				/// <para>Sets the transaction isolation level for this Connection. </para><para>If this method is called during a transaction, the results are implementation defined.</para><para></para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				/// <para>Sets the <c> TypeMap </c> for this connection. The input <c> map </c> should contain mappings between complex Java and SQL types.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setTypeMap
				/// </java-name>
				...
				/// <summary>
				/// <para>Replaces all client info properties with the name/value pairs from <c> properties </c> . All existing properties are removed. If an exception is thrown, the resulting state of this connection's client info properties is undefined. </para>        
				/// </summary>
				/// <java-name>
				/// setClientInfo
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		...
		public partial interface IResultSet : global::Java.Sql.IWrapper, global::Java.Lang.IAutoCloseable
 /* scope: __dot42__ */ 
		{
				/// <java-name>
				/// absolute
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Chains a supplied <c> SQLWarning </c> to this <c> SQLWarning </c> .</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setNextWarning
				/// </java-name>
				[Dot42.DexImport("setNextWarning", "(Ljava/sql/SQLWarning;)V", AccessFlags = 1)]
				public virtual void SetNextWarning(global::Java.Sql.SQLWarning w) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		...
		public partial interface IStatement : global::Java.Sql.IWrapper, global::Java.Lang.IAutoCloseable
 /* scope: __dot42__ */ 
		{
				/// <summary>
				...
				/// <summary>
				/// <para>Sets the fetch direction - a hint to the JDBC driver about the direction of processing of rows in <c> ResultSet </c> s created by this statement. The default fetch direction is <c> FETCH_FORWARD </c> .</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setFetchDirection
				/// </java-name>
				[Dot42.DexImport("setFetchDirection", "(I)V", AccessFlags = 1025)]
				void SetFetchDirection(int direction) /* MethodBuilder.Create */ ;

				/// <summary>
				/// <para>Sets the fetch size. This is a hint to the JDBC driver about how many rows should be fetched from the database when more are required by application processing.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setFetchSize
				/// </java-name>
				[Dot42.DexImport("setFetchSize", "(I)V", AccessFlags = 1025)]
				void SetFetchSize(int rows) /* MethodBuilder.Create */ ;

				/// <summary>
				/// <para>Sets the maximum number of bytes for <c> ResultSet </c> columns that contain character or binary values. This applies to <c> BINARY </c> , <c> VARBINARY </c> , <c> LONGVARBINARY </c> , <c> CHAR </c> , <c> VARCHAR </c> , and <c> LONGVARCHAR </c> fields. Any data exceeding the maximum size is abandoned without announcement.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setMaxFieldSize
				/// </java-name>
				...
				/// <summary>
				/// <para>Sets the maximum number of rows that any <c> ResultSet </c> can contain. If the number of rows exceeds this value, the additional rows are silently discarded.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setMaxRows
				/// </java-name>
				...
				/// <summary>
				/// <para>Sets the timeout, in seconds, for queries - how long the driver will allow for completion of a statement execution. If the timeout is exceeded, the query will throw an <c> SQLException </c> .</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setQueryTimeout
				/// </java-name>
				...
				/// <summary>
				/// <para>Hints whether this statement should be pooled. Defaults to false for <c> Statement </c> , but true for <c> CallableStatement </c> and <c> PreparedStatement </c> . Pool manager implementations may or may not honor this hint. </para>        
				/// </summary>
				/// <java-name>
				/// setPoolable
				/// </java-name>
				[Dot42.DexImport("setPoolable", "(Z)V", AccessFlags = 1025)]
				void SetPoolable(bool poolable) /* MethodBuilder.Create */ ;
 ...
 /* scope: __dot42__ */ 
		{
				/// <summary>
				/// <para>Constructs a <c> Date </c> object corresponding to the supplied year, month and day.</para><para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>Use the constructor Date(long). </para></xrefdescription></xrefsect></para>        
				/// </summary>
				[Dot42.DexImport("<init>", "(III)V", AccessFlags = 1)]
				...
				/// <summary>
				/// <para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>This method is deprecated and must not be used. SQL</para></xrefdescription></xrefsect><c>                   Date </c> values do not have an hours component. </para>        
				/// </summary>
				/// <returns>
				/// <para>does not return anything. </para>
				/// </returns>
				...
				/// <summary>
				/// <para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>This method is deprecated and must not be used. SQL</para></xrefdescription></xrefsect><c>                   Date </c> values do not have a minutes component. </para>        
				/// </summary>
				/// <returns>
				/// <para>does not return anything. </para>
				/// </returns>
				...
				/// <summary>
				/// <para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>This method is deprecated and must not be used. SQL</para></xrefdescription></xrefsect><c>                   Date </c> values do not have a seconds component. </para>        
				/// </summary>
				/// <returns>
				/// <para>does not return anything. </para>
				/// </returns>
				...
				public override void SetHours(int theHours) /* MethodBuilder.Create */ 
				{
				}
				...
				public override void SetMinutes(int theMinutes) /* MethodBuilder.Create */ 
				{
				}
				...
				public override void SetSeconds(int theSeconds) /* MethodBuilder.Create */ 
				{
				}
				...
				/// </java-name>
				[Dot42.DexImport("setTime", "(J)V", AccessFlags = 1)]
				public override void SetTime(long theTime) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
    ...
    "lang/Object;")]
				...
				/// <summary>
				/// <para>Gets the value of a specified JDBC <c> TIME </c> parameter as a <c>       java.sql.Time </c> , using the supplied <c> Calendar </c> to construct the time. The JDBC driver uses the calendar to handle specific timezones and locales in order to determine <c> Time </c> .</para><para><para>Time </para><simplesectsep></simplesectsep><para>java.util.Calendar </para></para>        
				/// </summary>
				/// <returns>
				/// <para>the parameter's value as a <c> java.sql.Time </c> . <c> null </c> is returned if the value is SQL <c> NULL </c> . </para>
				/// </returns>
				...
				/// <summary>
				/// <para>Sets the value of a specified parameter to a supplied <c>       java.sql.Timestamp </c> value, using the supplied calendar.</para><para>The driver uses the supplied calendar to create the SQL <c> TIMESTAMP </c> value, which allows it to use a custom timezone - otherwise the driver uses the VM defaults. See "&lt;a href="../util/Locale.html::default_locale"&gt;Be wary of the default locale&lt;/a&gt;".</para><para><para>Timestamp </para><simplesectsep></simplesectsep><para>java.util.Calendar </para></para>        
				/// </summary>
				/// <java-name>
				/// setTimestamp
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
    ...
    "sql/ResultSet;", AccessFlags = 1025)]
				...
				/// <summary>
				/// <para>Determines whether the database supports using a column name in a <c> GROUP       BY </c> clause not included in the <c> SELECT </c> statement as long as all of the columns in the <c> SELECT </c> statement are used in the <c> GROUP       BY </c> clause.</para><para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				/// <para>Determines whether the database supports using a column name in a <c> GROUP       BY </c> clause that is not in the <c> SELECT </c> statement.</para><para></para>        
				/// </summary>
				/// <returns>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Sets the value of a specified parameter to a supplied <c>       java.sql.Date </c> value, using a supplied <c> Calendar </c> to map the Date. The <c> Calendar </c> allows the application to control the timezone used to compute the SQL <c> DATE </c> in the database - without the supplied <c> Calendar </c> , the driver uses the VM defaults. See "&lt;a href="../util/Locale.html::default_locale"&gt;Be wary of the default locale&lt;/a&gt;".</para><para><para>Date </para><simplesectsep></simplesectsep><para>java.util.Calendar </para></para>        
				/// </summary>
				/// <java-name>
				/// setDate
				/// </java-name>
				...
				/// <summary>
				/// <para>Sets the value of a specified parameter to a supplied <c>       java.sql.Time </c> value, using a supplied <c> Calendar </c> . </para><para>The driver uses the supplied <c> Calendar </c> to create the SQL <c>       TIME </c> value, which allows it to use a custom timezone - otherwise the driver uses the VM defaults. See "&lt;a href="../util/Locale.html::default_locale"&gt;Be wary of the default locale&lt;/a&gt;".</para><para><para>Time </para><simplesectsep></simplesectsep><para>java.util.Calendar </para></para>        
				/// </summary>
				/// <java-name>
				/// setTime
				/// </java-name>
				...
				/// <summary>
				/// <para>Sets the value of a specified parameter to a supplied <c>       java.sql.Timestamp </c> value, using the supplied <c> Calendar </c> . </para><para>The driver uses the supplied <c> Calendar </c> to create the SQL <c>       TIMESTAMP </c> value, which allows it to use a custom timezone - otherwise the driver uses the VM defaults. See "&lt;a href="../util/Locale.html::default_locale"&gt;Be wary of the default locale&lt;/a&gt;".</para><para><para>Timestamp </para><simplesectsep></simplesectsep><para>java.util.Calendar </para></para>        
				/// </summary>
				/// <java-name>
				/// setTimestamp
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
    ...
    "lientInfoStatus;>;Ljava/lang/Throwable;)V")]
		...
		/// <summary>
		/// <para>A Java representation of the SQL <c> TIMESTAMP </c> type. It provides the capability of representing the SQL <c> TIMESTAMP </c> nanosecond value, in addition to the regular date/time value which has millisecond resolution. </para><para>The <c> Timestamp </c> class consists of a regular date/time value, where only the integral seconds value is stored, plus a nanoseconds value where the fractional seconds are stored. </para><para>The addition of the nanosecond value field to the <c> Timestamp </c> object makes it significantly different from the <c> java.util.Date </c> object which it extends. Users should be aware that <c> Timestamp </c> objects are not interchangable with <c> java.util.Date </c> objects when used outside the confines of the <c> java.sql </c> package.</para><para><para>Date </para><simplesectsep></simplesectsep><para>Time </para><simplesectsep></simplesectsep><para>java.util.Date </para></para>    
		/// </summary>
		/// <java-name>
		/// java/sql/Timestamp
		/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Sets the nanosecond value for this <c> Timestamp </c> .</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setNanos
				/// </java-name>
				[Dot42.DexImport("setNanos", "(I)V", AccessFlags = 1)]
				public virtual void SetNanos(int n) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Sets the time represented by this <c> Timestamp </c> object to the supplied time, defined as the number of milliseconds since the Epoch (January 1 1970, 00:00:00.000 GMT).</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setTime
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Sets the value of the structured type that this <c> Ref </c> references to a supplied object.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setObject
				/// </java-name>
				[Dot42.DexImport("setObject", "(Ljava/lang/Object;)V", AccessFlags = 1025)]
				void SetObject(object value) /* MethodBuilder.Create */ ;
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Sets this object's data to the given XML string. </para>        
				/// </summary>
				/// <java-name>
				/// setString
				/// </java-name>
				[Dot42.DexImport("setString", "(Ljava/lang/String;)V", AccessFlags = 1025)]
				void SetString(string value) /* MethodBuilder.Create */ ;
