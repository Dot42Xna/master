 ...
 /* scope: __dot42__ */ 
		{
				...
				/// getKeyType
				/// </java-name>
				[Dot42.DexImport("getKeyType", "()Ljava/lang/String;", AccessFlags = 1)]
				public string GetKeyType() /* MethodBuilder.Create */ 
				{
						return default(string);
				}
				...
				public int GetKeySize() /* MethodBuilder.Create */ 
				{
						return default(int);
				}
				...
				/// </java-name>
				[Dot42.DexImport("getAlgorithmParameterSpec", "()Ljava/security/spec/AlgorithmParameterSpec;", AccessFlags = 1)]
				public global::Java.Security.Spec.IAlgorithmParameterSpec GetAlgorithmParameterSpec() /* MethodBuilder.Create */ 
				{
				...
				/// getAlgorithmParameterSpec
				/// </java-name>
				public global::Java.Security.Spec.IAlgorithmParameterSpec AlgorithmParameterSpec
				{
				[Dot42.DexImport("getAlgorithmParameterSpec", "()Ljava/security/spec/AlgorithmParameterSpec;", AccessFlags = 1)]
						get{ return GetAlgorithmParameterSpec(); }
				}
 ...
 /* scope: __dot42__ */ 
				{
						...
						/// setKeyType
						/// </java-name>
						[Dot42.DexImport("setKeyType", "(Ljava/lang/String;)Landroid/security/KeyPairGeneratorSpec$Builder;", AccessFlags = 1)]
						public Builder SetKeyType(string @string) /* MethodBuilder.Create */ 
						{
								return default(Builder);
						}
						...
						/// setKeySize
						/// </java-name>
						[Dot42.DexImport("setKeySize", "(I)Landroid/security/KeyPairGeneratorSpec$Builder;", AccessFlags = 1)]
						public Builder SetKeySize(int int32) /* MethodBuilder.Create */ 
						{
								return default(Builder);
						}
						...
						/// </java-name>
						[Dot42.DexImport("setAlgorithmParameterSpec", "(Ljava/security/spec/AlgorithmParameterSpec;)Landroid/security/KeyPairGeneratorSp" +
    "ec$Builder;", AccessFlags = 1)]
						public Builder SetAlgorithmParameterSpec(global::Java.Security.Spec.IAlgorithmParameterSpec algorithmParameterSpec) /* MethodBuilder.Create */ 
						{
								return default(Builder);
						}
