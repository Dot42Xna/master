...
//
// Original filename: Android.Content.cs
//
...
namespace Android.Content
{
 ...
 /* scope: __dot42__ */ 
		{
				/// <summary>
				/// <para>File creation mode: the default mode, where the created file can only be accessed by the calling application (or all applications sharing the same user ID). <para>MODE_WORLD_READABLE </para><simplesectsep></simplesectsep><para>MODE_WORLD_WRITEABLE </para></para>        
				/// </summary>
				/// <java-name>
				/// MODE_PRIVATE
				/// </java-name>
				...
				/// <summary>
				/// <para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>Creating world-writable files is very dangerous, and likely to cause security holes in applications. It is strongly discouraged; instead, applications should use more formal mechanism for interactions such as ContentProvider, BroadcastReceiver, and android.app.Service. There are no guarantees that this access mode will remain on a file, such as when it goes through a backup and restore. File creation mode: allow all other applications to have write access to the created file. </para></xrefdescription></xrefsect><para>MODE_PRIVATE </para><simplesectsep></simplesectsep><para>MODE_WORLD_READABLE </para></para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				/// <para>Database open flag: when set, the database is opened with write-ahead logging enabled by default.</para><para><para>openOrCreateDatabase(String, int, CursorFactory) </para><simplesectsep></simplesectsep><para>openOrCreateDatabase(String, int, CursorFactory, DatabaseErrorHandler) </para><simplesectsep></simplesectsep><para>SQLiteDatabase::enableWriteAheadLogging </para></para>        
				/// </summary>
				/// <java-name>
				/// MODE_ENABLE_WRITE_AHEAD_LOGGING
				/// </java-name>
				[Dot42.DexImport("MODE_ENABLE_WRITE_AHEAD_LOGGING", "I", AccessFlags = 25)]
				public const int MODE_ENABLE_WRITE_AHEAD_LOGGING = 8;
				/// <summary>
				...
				/// <summary>
				/// <para>Flag for bindService: indicates that the client application binding to this service considers the service to be more important than the app itself. When set, the platform will try to have the out of memory killer kill the app before it kills the service it is bound to, though this is not guaranteed to be the case. </para>        
				/// </summary>
				/// <java-name>
				/// BIND_ABOVE_CLIENT
				/// </java-name>
				...
				/// <summary>
				/// <para>Flag for bindService: allow the process hosting the bound service to go through its normal memory management. It will be treated more like a running service, allowing the system to (temporarily) expunge the process if low on memory or for some other whim it may have, and being more aggressive about making it a candidate to be killed (and restarted) if running for a long time. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				/// <para>Flag for bindService: don't impact the scheduling or memory management priority of the target service's hosting process. Allows the service's process to be managed on the background LRU list just like a regular application process in the background. </para>        
				/// </summary>
				/// <java-name>
				/// BIND_WAIVE_PRIORITY
				/// </java-name>
				...
				/// <summary>
				/// <para>Flag for bindService: this service is very important to the client, so should be brought to the foreground process level when the client is. Normally a process can only be raised to the visibility level by a client, even if that client is in the foreground. </para>        
				/// </summary>
				/// <java-name>
				/// BIND_IMPORTANT
				/// </java-name>
				...
				/// <summary>
				/// <para>Flag for bindService: If binding from an activity, allow the target service's process importance to be raised based on whether the activity is visible to the user, regardless whether another flag is used to reduce the amount that the client process's overall importance is used to impact it. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				/// <para>Use with getSystemService to retrieve a android.view.WindowManager for accessing the system's window manager.</para><para><para>getSystemService </para><simplesectsep></simplesectsep><para>android.view.WindowManager </para></para>        
				/// </summary>
				/// <java-name>
				/// WINDOW_SERVICE
				/// </java-name>
				...
				/// <summary>
				/// <para>Use with getSystemService to retrieve a android.view.LayoutInflater for inflating layout resources in this context.</para><para><para>getSystemService </para><simplesectsep></simplesectsep><para>android.view.LayoutInflater </para></para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				/// <para>Use with getSystemService to retrieve a android.accounts.AccountManager for receiving intents at a time of your choosing.</para><para><para>getSystemService </para><simplesectsep></simplesectsep><para>android.accounts.AccountManager </para></para>        
				/// </summary>
				/// <java-name>
				/// ACCOUNT_SERVICE
				/// </java-name>
				...
				/// <summary>
				/// <para>Use with getSystemService to retrieve a android.app.ActivityManager for interacting with the global system state.</para><para><para>getSystemService </para><simplesectsep></simplesectsep><para>android.app.ActivityManager </para></para>        
				/// </summary>
				/// <java-name>
				/// ACTIVITY_SERVICE
				/// </java-name>
				...
				/// <summary>
				/// <para>Use with getSystemService to retrieve a android.app.AlarmManager for receiving intents at a time of your choosing.</para><para><para>getSystemService </para><simplesectsep></simplesectsep><para>android.app.AlarmManager </para></para>        
				/// </summary>
				/// <java-name>
				/// ALARM_SERVICE
				/// </java-name>
				...
				/// <summary>
				/// <para>Use with getSystemService to retrieve a android.app.NotificationManager for informing the user of background events.</para><para><para>getSystemService </para><simplesectsep></simplesectsep><para>android.app.NotificationManager </para></para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				/// <para>Use with getSystemService to retrieve a android.view.accessibility.AccessibilityManager for giving the user feedback for UI events through the registered event listeners.</para><para><para>getSystemService </para><simplesectsep></simplesectsep><para>android.view.accessibility.AccessibilityManager </para></para>        
				/// </summary>
				/// <java-name>
				...
				/// CAPTIONING_SERVICE
				/// </java-name>
				[Dot42.DexImport("CAPTIONING_SERVICE", "Ljava/lang/String;", AccessFlags = 25)]
				public const string CAPTIONING_SERVICE = "captioning";
				/// <summary>
				/// <para>Use with getSystemService to retrieve a android.app.NotificationManager for controlling keyguard.</para><para><para>getSystemService </para><simplesectsep></simplesectsep><para>android.app.KeyguardManager </para></para>        
				/// </summary>
				/// <java-name>
				/// KEYGUARD_SERVICE
				/// </java-name>
				...
				/// <summary>
				/// <para>Use with getSystemService to retrieve a android.location.LocationManager for controlling location updates.</para><para><para>getSystemService </para><simplesectsep></simplesectsep><para>android.location.LocationManager </para></para>        
				/// </summary>
				/// <java-name>
				/// LOCATION_SERVICE
				/// </java-name>
				...
				/// <summary>
				/// <para>Use with getSystemService to retrieve a android.app.SearchManager for handling searches.</para><para><para>getSystemService </para><simplesectsep></simplesectsep><para>android.app.SearchManager </para></para>        
				/// </summary>
				/// <java-name>
				/// SEARCH_SERVICE
				/// </java-name>
				...
				/// <summary>
				/// <para>Use with getSystemService to retrieve a android.hardware.SensorManager for accessing sensors.</para><para><para>getSystemService </para><simplesectsep></simplesectsep><para>android.hardware.SensorManager </para></para>        
				/// </summary>
				/// <java-name>
				/// SENSOR_SERVICE
				/// </java-name>
				...
				/// <summary>
				/// <para>Use with getSystemService to retrieve a android.os.storage.StorageManager for accessing system storage functions.</para><para><para>getSystemService </para><simplesectsep></simplesectsep><para>android.os.storage.StorageManager </para></para>        
				/// </summary>
				/// <java-name>
				/// STORAGE_SERVICE
				/// </java-name>
				...
				/// <summary>
				/// <para>Use with getSystemService to retrieve a android.os.Vibrator for interacting with the vibration hardware.</para><para><para>getSystemService </para><simplesectsep></simplesectsep><para>android.os.Vibrator </para></para>        
				/// </summary>
				/// <java-name>
				/// VIBRATOR_SERVICE
				/// </java-name>
				...
				/// <summary>
				/// <para>Use with getSystemService to retrieve a android.net.ConnectivityManager for handling management of network connections.</para><para><para>getSystemService </para><simplesectsep></simplesectsep><para>android.net.ConnectivityManager </para></para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				/// <para>Use with getSystemService to retrieve a android.net.wifi.WifiManager for handling management of Wi-Fi access.</para><para><para>getSystemService </para><simplesectsep></simplesectsep><para>android.net.wifi.WifiManager </para></para>        
				/// </summary>
				/// <java-name>
				/// WIFI_SERVICE
				/// </java-name>
				...
				/// <summary>
				/// <para>Use with getSystemService to retrieve a android.net.wifi.p2p.WifiP2pManager for handling management of Wi-Fi peer-to-peer connections.</para><para><para>getSystemService </para><simplesectsep></simplesectsep><para>android.net.wifi.p2p.WifiP2pManager </para></para>        
				/// </summary>
				/// <java-name>
				/// WIFI_P2P_SERVICE
				/// </java-name>
				...
				/// <summary>
				/// <para>Use with getSystemService to retrieve a android.net.nsd.NsdManager for handling management of network service discovery</para><para><para>getSystemService </para><simplesectsep></simplesectsep><para>android.net.nsd.NsdManager </para></para>        
				/// </summary>
				/// <java-name>
				/// NSD_SERVICE
				/// </java-name>
				[Dot42.DexImport("NSD_SERVICE", "Ljava/lang/String;", AccessFlags = 25)]
				public const string NSD_SERVICE = "servicediscovery";
				/// <summary>
				/// <para>Use with getSystemService to retrieve a android.media.AudioManager for handling management of volume, ringer modes and audio routing.</para><para><para>getSystemService </para><simplesectsep></simplesectsep><para>android.media.AudioManager </para></para>        
				/// </summary>
				/// <java-name>
				/// AUDIO_SERVICE
				/// </java-name>
				...
				/// <summary>
				/// <para>Use with getSystemService to retrieve a android.media.MediaRouter for controlling and managing routing of media.</para><para><para>getSystemService </para><simplesectsep></simplesectsep><para>android.media.MediaRouter </para></para>        
				/// </summary>
				/// <java-name>
				/// MEDIA_ROUTER_SERVICE
				/// </java-name>
				[Dot42.DexImport("MEDIA_ROUTER_SERVICE", "Ljava/lang/String;", AccessFlags = 25)]
				public const string MEDIA_ROUTER_SERVICE = "media_router";
				/// <summary>
				/// <para>Use with getSystemService to retrieve a android.telephony.TelephonyManager for handling management the telephony features of the device.</para><para><para>getSystemService </para><simplesectsep></simplesectsep><para>android.telephony.TelephonyManager </para></para>        
				/// </summary>
				/// <java-name>
				/// TELEPHONY_SERVICE
				/// </java-name>
				...
				/// <summary>
				/// <para>Use with getSystemService to retrieve a android.text.ClipboardManager for accessing and modifying the contents of the global clipboard.</para><para><para>getSystemService </para><simplesectsep></simplesectsep><para>android.text.ClipboardManager </para></para>        
				/// </summary>
				/// <java-name>
				/// CLIPBOARD_SERVICE
				/// </java-name>
				...
				/// <summary>
				/// <para>Use with getSystemService to retrieve a android.view.textservice.TextServicesManager for accessing text services.</para><para><para>getSystemService </para></para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				/// <para>Use with getSystemService to retrieve a android.bluetooth.BluetoothAdapter for using Bluetooth.</para><para><para>getSystemService </para></para>        
				/// </summary>
				/// <java-name>
				/// BLUETOOTH_SERVICE
				/// </java-name>
				[Dot42.DexImport("BLUETOOTH_SERVICE", "Ljava/lang/String;", AccessFlags = 25)]
				public const string BLUETOOTH_SERVICE = "bluetooth";
				/// <summary>
				/// <para>Use with getSystemService to retrieve a android.hardware.usb.UsbManager for access to USB devices (as a USB host) and for controlling this device's behavior as a USB device.</para><para><para>getSystemService </para><simplesectsep></simplesectsep><para>android.harware.usb.UsbManager </para></para>        
				/// </summary>
				/// <java-name>
				/// USB_SERVICE
				/// </java-name>
				...
				/// <summary>
				/// <para>Use with getSystemService to retrieve a android.hardware.input.InputManager for interacting with input devices.</para><para><para>getSystemService </para><simplesectsep></simplesectsep><para>android.hardware.input.InputManager </para></para>        
				/// </summary>
				/// <java-name>
				/// INPUT_SERVICE
				/// </java-name>
				[Dot42.DexImport("INPUT_SERVICE", "Ljava/lang/String;", AccessFlags = 25)]
				public const string INPUT_SERVICE = "input";
				/// <summary>
				/// <para>Use with getSystemService to retrieve a android.hardware.display.DisplayManager for interacting with display devices.</para><para><para>getSystemService </para><simplesectsep></simplesectsep><para>android.hardware.display.DisplayManager </para></para>        
				/// </summary>
				/// <java-name>
				/// DISPLAY_SERVICE
				/// </java-name>
				[Dot42.DexImport("DISPLAY_SERVICE", "Ljava/lang/String;", AccessFlags = 25)]
				public const string DISPLAY_SERVICE = "display";
				/// <summary>
				/// <para>Use with getSystemService to retrieve a android.os.UserManager for managing users on devices that support multiple users.</para><para><para>getSystemService </para><simplesectsep></simplesectsep><para>android.os.UserManager </para></para>        
				/// </summary>
				/// <java-name>
				/// USER_SERVICE
				/// </java-name>
				[Dot42.DexImport("USER_SERVICE", "Ljava/lang/String;", AccessFlags = 25)]
				public const string USER_SERVICE = "user";
				/// <summary>
				/// <para>Use with getSystemService to retrieve a android.app.AppOpsManager for tracking application operations on the device.</para><para><para>getSystemService </para><simplesectsep></simplesectsep><para>android.app.AppOpsManager</para></para>        
				/// </summary>
				/// <java-name>
				/// APP_OPS_SERVICE
				/// </java-name>
				[Dot42.DexImport("APP_OPS_SERVICE", "Ljava/lang/String;", AccessFlags = 25)]
				public const string APP_OPS_SERVICE = "appops";
				/// <java-name>
				/// PRINT_SERVICE
				/// </java-name>
				[Dot42.DexImport("PRINT_SERVICE", "Ljava/lang/String;", AccessFlags = 25)]
				public const string PRINT_SERVICE = "print";
				/// <java-name>
				/// CONSUMER_IR_SERVICE
				/// </java-name>
				[Dot42.DexImport("CONSUMER_IR_SERVICE", "Ljava/lang/String;", AccessFlags = 25)]
				public const string CONSUMER_IR_SERVICE = "consumer_ir";
				/// <summary>
				...
				/// <summary>
				/// <para>Add a new ComponentCallbacks to the base application of the Context, which will be called at the same times as the ComponentCallbacks methods of activities and other components are called. Note that you <b>must</b> be sure to use unregisterComponentCallbacks when appropriate in the future; this will not be removed for you.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// registerComponentCallbacks
				/// </java-name>
				[Dot42.DexImport("registerComponentCallbacks", "(Landroid/content/ComponentCallbacks;)V", AccessFlags = 1)]
				public virtual void RegisterComponentCallbacks(global::Android.Content.IComponentCallbacks callback) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Remove a ComponentCallbacks objec that was previously registered with registerComponentCallbacks(ComponentCallbacks). </para>        
				/// </summary>
				/// <java-name>
				/// unregisterComponentCallbacks
				/// </java-name>
				[Dot42.DexImport("unregisterComponentCallbacks", "(Landroid/content/ComponentCallbacks;)V", AccessFlags = 1)]
				public virtual void UnregisterComponentCallbacks(global::Android.Content.IComponentCallbacks callback) /* MethodBuilder.Create */ 
				{
				}
				...
				/// </java-name>
				[Dot42.DexImport("getExternalFilesDirs", "(Ljava/lang/String;)[Ljava/io/File;", AccessFlags = 1025)]
				public abstract global::Java.Io.File[] GetExternalFilesDirs(string @string) /* MethodBuilder.Create */ ;
				...
				/// getObbDirs
				/// </java-name>
				[Dot42.DexImport("getObbDirs", "()[Ljava/io/File;", AccessFlags = 1025)]
				public abstract global::Java.Io.File[] GetObbDirs() /* MethodBuilder.Create */ ;
				...
				/// </java-name>
				[Dot42.DexImport("getExternalCacheDirs", "()[Ljava/io/File;", AccessFlags = 1025)]
				public abstract global::Java.Io.File[] GetExternalCacheDirs() /* MethodBuilder.Create */ ;
    ...
    "d/database/DatabaseErrorHandler;)Landroid/database/sqlite/SQLiteDatabase;", AccessFlags = 1025)]
				...
				/// <summary>
				/// <para>Launch multiple new activities. This is generally the same as calling startActivity(Intent) for the first Intent in the array, that activity during its creation calling startActivity(Intent) for the second entry, etc. Note that unlike that approach, generally none of the activities except the last in the array will be created at this point, but rather will be created when the user first visits them (due to pressing back from the activity on top).</para><para>This method throws ActivityNotFoundException if there was no Activity found for <b>any</b> given Intent. In this case the state of the activity stack is undefined (some Intents in the list may be on it, some not), so you probably want to avoid such situations.</para><para><para>startActivities(Intent[]) </para><simplesectsep></simplesectsep><para>PackageManager::resolveActivity </para></para>        
				/// </summary>
				/// <java-name>
				/// startActivities
				/// </java-name>
				[Dot42.DexImport("startActivities", "([Landroid/content/Intent;Landroid/os/Bundle;)V", AccessFlags = 1025)]
				public abstract void StartActivities(global::Android.Content.Intent[] intents, global::Android.Os.Bundle options) /* MethodBuilder.Create */ ;
				...
				/// <summary>
				/// <para>Like startActivity(Intent, Bundle), but taking a IntentSender to start. If the IntentSender is for an activity, that activity will be started as if you had called the regular startActivity(Intent) here; otherwise, its associated action will be executed (such as sending a broadcast) as if you had called IntentSender.sendIntent on it.</para><para><para>startActivity(Intent, Bundle) </para><simplesectsep></simplesectsep><para>startIntentSender(IntentSender, Intent, int, int, int) </para></para>        
				/// </summary>
				/// <java-name>
				/// startIntentSender
				/// </java-name>
				[Dot42.DexImport("startIntentSender", "(Landroid/content/IntentSender;Landroid/content/Intent;IIILandroid/os/Bundle;)V", AccessFlags = 1025)]
				public abstract void StartIntentSender(global::Android.Content.IntentSender intent, global::Android.Content.Intent fillInIntent, int flagsMask, int flagsValues, int extraFlags, global::Android.Os.Bundle options) /* MethodBuilder.Create */ ;
    ...
    "droid/os/Handler;ILjava/lang/String;Landroid/os/Bundle;)V", AccessFlags = 1025)]
				...
				/// <summary>
				/// <para>Version of sendBroadcast(Intent) that allows you to specify the user the broadcast will be sent to. This is not available to applications that are not pre-installed on the system image. Using it requires holding the INTERACT_ACROSS_USERS permission. <para>sendBroadcast(Intent) </para></para>        
				/// </summary>
				/// <java-name>
				/// sendBroadcastAsUser
				/// </java-name>
				[Dot42.DexImport("sendBroadcastAsUser", "(Landroid/content/Intent;Landroid/os/UserHandle;)V", AccessFlags = 1025)]
				public abstract void SendBroadcastAsUser(global::Android.Content.Intent intent, global::Android.Os.UserHandle user) /* MethodBuilder.Create */ ;

				/// <summary>
				/// <para>Version of sendBroadcast(Intent, String) that allows you to specify the user the broadcast will be sent to. This is not available to applications that are not pre-installed on the system image. Using it requires holding the INTERACT_ACROSS_USERS permission.</para><para><para>sendBroadcast(Intent, String) </para></para>        
				/// </summary>
				/// <java-name>
				/// sendBroadcastAsUser
				/// </java-name>
				[Dot42.DexImport("sendBroadcastAsUser", "(Landroid/content/Intent;Landroid/os/UserHandle;Ljava/lang/String;)V", AccessFlags = 1025)]
				public abstract void SendBroadcastAsUser(global::Android.Content.Intent intent, global::Android.Os.UserHandle user, string receiverPermission) /* MethodBuilder.Create */ ;

				/// <summary>
				/// <para>Version of sendOrderedBroadcast(Intent, String, BroadcastReceiver, Handler, int, String, Bundle) that allows you to specify the user the broadcast will be sent to. This is not available to applications that are not pre-installed on the system image. Using it requires holding the INTERACT_ACROSS_USERS permission.</para><para>See BroadcastReceiver for more information on Intent broadcasts.</para><para><para>sendOrderedBroadcast(Intent, String, BroadcastReceiver, Handler, int, String, Bundle) </para></para>        
				/// </summary>
				/// <java-name>
				/// sendOrderedBroadcastAsUser
				/// </java-name>
				[Dot42.DexImport("sendOrderedBroadcastAsUser", "(Landroid/content/Intent;Landroid/os/UserHandle;Ljava/lang/String;Landroid/conten" +
    "t/BroadcastReceiver;Landroid/os/Handler;ILjava/lang/String;Landroid/os/Bundle;)V" +
    "", AccessFlags = 1025)]
				public abstract void SendOrderedBroadcastAsUser(global::Android.Content.Intent intent, global::Android.Os.UserHandle user, string receiverPermission, global::Android.Content.BroadcastReceiver resultReceiver, global::Android.Os.Handler scheduler, int initialCode, string initialData, global::Android.Os.Bundle initialExtras) /* MethodBuilder.Create */ ;
    ...
    "Ljava/lang/String;Landroid/os/Bundle;)V", AccessFlags = 1025)]
				...
				/// <summary>
				/// <para>Version of sendStickyBroadcast(Intent) that allows you to specify the user the broadcast will be sent to. This is not available to applications that are not pre-installed on the system image. Using it requires holding the INTERACT_ACROSS_USERS permission.</para><para><para>sendBroadcast(Intent) </para></para>        
				/// </summary>
				/// <java-name>
				/// sendStickyBroadcastAsUser
				/// </java-name>
				[Dot42.DexImport("sendStickyBroadcastAsUser", "(Landroid/content/Intent;Landroid/os/UserHandle;)V", AccessFlags = 1025)]
				public abstract void SendStickyBroadcastAsUser(global::Android.Content.Intent intent, global::Android.Os.UserHandle user) /* MethodBuilder.Create */ ;

				/// <summary>
				/// <para>Version of sendStickyOrderedBroadcast(Intent, BroadcastReceiver, Handler, int, String, Bundle) that allows you to specify the user the broadcast will be sent to. This is not available to applications that are not pre-installed on the system image. Using it requires holding the INTERACT_ACROSS_USERS permission.</para><para>See BroadcastReceiver for more information on Intent broadcasts.</para><para><para>sendStickyOrderedBroadcast(Intent, BroadcastReceiver, Handler, int, String, Bundle) </para></para>        
				/// </summary>
				/// <java-name>
				/// sendStickyOrderedBroadcastAsUser
				/// </java-name>
				[Dot42.DexImport("sendStickyOrderedBroadcastAsUser", "(Landroid/content/Intent;Landroid/os/UserHandle;Landroid/content/BroadcastReceive" +
    "r;Landroid/os/Handler;ILjava/lang/String;Landroid/os/Bundle;)V", AccessFlags = 1025)]
				public abstract void SendStickyOrderedBroadcastAsUser(global::Android.Content.Intent intent, global::Android.Os.UserHandle user, global::Android.Content.BroadcastReceiver resultReceiver, global::Android.Os.Handler scheduler, int initialCode, string initialData, global::Android.Os.Bundle initialExtras) /* MethodBuilder.Create */ ;

				/// <summary>
				/// <para>Version of removeStickyBroadcast(Intent) that allows you to specify the user the broadcast will be sent to. This is not available to applications that are not pre-installed on the system image. Using it requires holding the INTERACT_ACROSS_USERS permission.</para><para>You must hold the android.Manifest.permission#BROADCAST_STICKY permission in order to use this API. If you do not hold that permission, SecurityException will be thrown.</para><para><para>sendStickyBroadcastAsUser </para></para>        
				/// </summary>
				/// <java-name>
				/// removeStickyBroadcastAsUser
				/// </java-name>
				[Dot42.DexImport("removeStickyBroadcastAsUser", "(Landroid/content/Intent;Landroid/os/UserHandle;)V", AccessFlags = 1025)]
				public abstract void RemoveStickyBroadcastAsUser(global::Android.Content.Intent intent, global::Android.Os.UserHandle user) /* MethodBuilder.Create */ ;
    ...
    "ng;Landroid/os/Handler;)Landroid/content/Intent;", AccessFlags = 1025)]
				...
				/// <summary>
				/// <para>Return a new Context object for the current Context but whose resources are adjusted to match the given Configuration. Each call to this method returns a new instance of a Context object; Context objects are not shared, however common state (ClassLoader, other Resources for the same configuration) may be so the Context itself can be fairly lightweight.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>A Context with the given configuration override. </para>
				/// </returns>
				/// <java-name>
				/// createConfigurationContext
				/// </java-name>
				[Dot42.DexImport("createConfigurationContext", "(Landroid/content/res/Configuration;)Landroid/content/Context;", AccessFlags = 1025)]
				public abstract global::Android.Content.Context CreateConfigurationContext(global::Android.Content.Res.Configuration overrideConfiguration) /* MethodBuilder.Create */ ;

				/// <summary>
				/// <para>Return a new Context object for the current Context but whose resources are adjusted to match the metrics of the given Display. Each call to this method returns a new instance of a Context object; Context objects are not shared, however common state (ClassLoader, other Resources for the same configuration) may be so the Context itself can be fairly lightweight.</para><para>The returned display Context provides a WindowManager (see getSystemService(String)) that is configured to show windows on the given display. The WindowManager's WindowManager#getDefaultDisplay method can be used to retrieve the Display from the returned Context.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>A Context for the display. </para>
				/// </returns>
				/// <java-name>
				/// createDisplayContext
				/// </java-name>
				[Dot42.DexImport("createDisplayContext", "(Landroid/view/Display;)Landroid/content/Context;", AccessFlags = 1025)]
				public abstract global::Android.Content.Context CreateDisplayContext(global::Android.View.Display display) /* MethodBuilder.Create */ ;
				...
				/// getObbDirs
				/// </java-name>
				public global::Java.Io.File[] ObbDirs
				{
				[Dot42.DexImport("getObbDirs", "()[Ljava/io/File;", AccessFlags = 1025)]
						get{ return GetObbDirs(); }
				}
				...
				/// getExternalCacheDirs
				/// </java-name>
				public global::Java.Io.File[] ExternalCacheDirs
				{
				[Dot42.DexImport("getExternalCacheDirs", "()[Ljava/io/File;", AccessFlags = 1025)]
						get{ return GetExternalCacheDirs(); }
				}
 ...
 /* scope: __dot42__ */ 
    ...
    "ring;)I", AccessFlags = 1)]
		...
		/// <summary>
		/// <para>Value type that contains information about a periodic sync. Is parcelable, making it suitable for passing in an IPC. </para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				/// <summary>
				/// <para>The account to be synced </para>        
				/// </summary>
				/// <java-name>
				/// account
				/// </java-name>
				...
				/// <summary>
				/// <para>The authority of the sync </para>        
				/// </summary>
				/// <java-name>
				/// authority
				/// </java-name>
				...
				/// <summary>
				/// <para>How frequently the sync should be scheduled, in seconds. </para>        
				/// </summary>
				/// <java-name>
				/// period
				/// </java-name>
				...
				/// <summary>
				/// <para>Creates a new PeriodicSync, copying the Bundle </para>        
				/// </summary>
				[Dot42.DexImport("<init>", "(Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;J)V", AccessFlags = 1)]
				public PeriodicSync(global::Android.Accounts.Account account, string authority, global::Android.Os.Bundle extras, long period) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
    ...
    "OnFinished;Landroid/os/Handler;Ljava/lang/String;)V", AccessFlags = 1)]
				public virtual void SendIntent(global::Android.Content.Context context, int code, global::Android.Content.Intent intent, global::Android.Content.IntentSender.IOnFinished onFinished, global::Android.Os.Handler handler, string requiredPermission) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Return the package name of the application that created this IntentSender, that is the identity under which you will actually be sending the Intent. The returned string is supplied by the system, so that an application can not spoof its package.</para><para></para>        
				/// </summary>
				/// <returns>
				...
				public virtual string GetCreatorPackage() /* MethodBuilder.Create */ 
				{
						return default(string);
				}

				/// <summary>
				/// <para>Return the uid of the application that created this PendingIntent, that is the identity under which you will actually be sending the Intent. The returned integer is supplied by the system, so that an application can not spoof its uid.</para><para></para>        
				/// </summary>
				/// <returns>
				...
				public virtual global::Android.Os.UserHandle GetCreatorUserHandle() /* MethodBuilder.Create */ 
				{
						return default(global::Android.Os.UserHandle);
				}
				...
				{
				[Dot42.DexImport("getCreatorUserHandle", "()Landroid/os/UserHandle;", AccessFlags = 1)]
						get{ return GetCreatorUserHandle(); }
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>The MIME type for a clip holding HTML text. </para>        
				/// </summary>
				/// <java-name>
				/// MIMETYPE_TEXT_HTML
				/// </java-name>
				[Dot42.DexImport("MIMETYPE_TEXT_HTML", "Ljava/lang/String;", AccessFlags = 25)]
				public const string MIMETYPE_TEXT_HTML = "text/html";
				/// <summary>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>The name of the extra used to define the icon, as a ShortcutIconResource, of a shortcut.</para><para><para>ACTION_CREATE_SHORTCUT </para><simplesectsep></simplesectsep><para>android.content.Intent.ShortcutIconResource </para></para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				/// <para>Activity Action: Perform assist action. </para><para>Input: EXTRA_ASSIST_PACKAGE and EXTRA_ASSIST_CONTEXT can provide additional optional contextual information about where the user was when they requested the assist. Output: nothing. </para>        
				/// </summary>
				/// <java-name>
				/// ACTION_ASSIST
				/// </java-name>
				[Dot42.DexImport("ACTION_ASSIST", "Ljava/lang/String;", AccessFlags = 25)]
				public const string ACTION_ASSIST = "android.intent.action.ASSIST";
				/// <summary>
				/// <para>An optional field on ACTION_ASSIST containing the name of the current foreground application package at the time the assist was invoked. </para>        
				/// </summary>
				/// <java-name>
				/// EXTRA_ASSIST_PACKAGE
				/// </java-name>
				[Dot42.DexImport("EXTRA_ASSIST_PACKAGE", "Ljava/lang/String;", AccessFlags = 25)]
				public const string EXTRA_ASSIST_PACKAGE = "android.intent.extra.ASSIST_PACKAGE";
				/// <summary>
				/// <para>An optional field on ACTION_ASSIST containing additional contextual information supplied by the current foreground app at the time of the assist request. This is a Bundle of additional data. </para>        
				/// </summary>
				/// <java-name>
				/// EXTRA_ASSIST_CONTEXT
				/// </java-name>
				[Dot42.DexImport("EXTRA_ASSIST_CONTEXT", "Ljava/lang/String;", AccessFlags = 25)]
				...
				/// <summary>
				/// <para>Activity Action: The user pressed the "Report" button in the crash/ANR dialog. This intent is delivered to the package which installed the application, usually Google Play. </para><para>Input: No data is specified. The bug report is passed in using an EXTRA_BUG_REPORT field. </para><para>Output: Nothing.</para><para><para>EXTRA_BUG_REPORT </para></para>        
				/// </summary>
				/// <java-name>
				/// ACTION_APP_ERROR
				/// </java-name>
				...
				/// <summary>
				/// <para>Activity Action: Show settings for managing network data usage of a specific application. Applications should define an activity that offers options to control data usage. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				/// <para>Activity Action: Launch application installer. </para><para>Input: The data must be a content: or file: URI at which the application can be retrieved. As of android.os.Build.VERSION_CODES#JELLY_BEAN_MR1, you can also use "package:&lt;package-name&gt;" to install an application for the current user that is already installed for another user. You can optionally supply EXTRA_INSTALLER_PACKAGE_NAME, EXTRA_NOT_UNKNOWN_SOURCE, EXTRA_ALLOW_REPLACE, and EXTRA_RETURN_RESULT. </para><para>Output: If EXTRA_RETURN_RESULT, returns whether the install succeeded.</para><para><para>EXTRA_INSTALLER_PACKAGE_NAME </para><simplesectsep></simplesectsep><para>EXTRA_NOT_UNKNOWN_SOURCE </para><simplesectsep></simplesectsep><para>EXTRA_RETURN_RESULT </para></para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				/// <para>Used as a string extra field with ACTION_INSTALL_PACKAGE to install a package. Specifies the installer package name; this package will receive the ACTION_APP_ERROR intent. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				/// <para>Used as a boolean extra field with ACTION_INSTALL_PACKAGE to install a package. Specifies that the application being installed should not be treated as coming from an unknown source, but as coming from the app invoking the Intent. For this to work you must start the installer with startActivityForResult(). </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				/// <para>Used as a URI extra field with ACTION_INSTALL_PACKAGE and ACTION_VIEW to indicate the URI from which the local APK in the Intent data field originated from. </para>        
				/// </summary>
				/// <java-name>
				/// EXTRA_ORIGINATING_URI
				/// </java-name>
				[Dot42.DexImport("EXTRA_ORIGINATING_URI", "Ljava/lang/String;", AccessFlags = 25)]
				public const string EXTRA_ORIGINATING_URI = "android.intent.extra.ORIGINATING_URI";
				/// <summary>
				/// <para>Used as a URI extra field with ACTION_INSTALL_PACKAGE and ACTION_VIEW to indicate the HTTP referrer URI associated with the Intent data field or EXTRA_ORIGINATING_URI. </para>        
				/// </summary>
				/// <java-name>
				/// EXTRA_REFERRER
				/// </java-name>
				[Dot42.DexImport("EXTRA_REFERRER", "Ljava/lang/String;", AccessFlags = 25)]
				public const string EXTRA_REFERRER = "android.intent.extra.REFERRER";
				/// <summary>
				/// <para>Used as a boolean extra field with ACTION_INSTALL_PACKAGE to install a package. Tells the installer UI to skip the confirmation with the user if the .apk is replacing an existing one. <xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>As of android.os.Build.VERSION_CODES#JELLY_BEAN, Android will no longer show an interstitial message about updating existing applications so this is no longer needed. </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <java-name>
				/// EXTRA_ALLOW_REPLACE
				/// </java-name>
				...
				/// <summary>
				/// <para>Used as a boolean extra field with ACTION_INSTALL_PACKAGE or ACTION_UNINSTALL_PACKAGE. Specifies that the installer UI should return to the application the result code of the install/uninstall. The returned result code will be android.app.Activity#RESULT_OK on success or android.app.Activity#RESULT_FIRST_USER on failure. </para>        
				/// </summary>
				/// <java-name>
				/// EXTRA_RETURN_RESULT
				/// </java-name>
				...
				/// <summary>
				/// <para>Activity Action: Launch application uninstaller. </para><para>Input: The data must be a package: URI whose scheme specific part is the package name of the current installed package to be uninstalled. You can optionally supply EXTRA_RETURN_RESULT. </para><para>Output: If EXTRA_RETURN_RESULT, returns whether the install succeeded. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				/// <para>Broadcast Action: Sent after the system stops dreaming.</para><para>This is a protected intent that can only be sent by the system. It is only sent to registered receivers.</para>        
				/// </summary>
				/// <java-name>
				/// ACTION_DREAMING_STOPPED
				/// </java-name>
				[Dot42.DexImport("ACTION_DREAMING_STOPPED", "Ljava/lang/String;", AccessFlags = 25)]
				public const string ACTION_DREAMING_STOPPED = "android.intent.action.DREAMING_STOPPED";
				/// <summary>
				/// <para>Broadcast Action: Sent after the system starts dreaming.</para><para>This is a protected intent that can only be sent by the system. It is only sent to registered receivers.</para>        
				/// </summary>
				/// <java-name>
				/// ACTION_DREAMING_STARTED
				/// </java-name>
				[Dot42.DexImport("ACTION_DREAMING_STARTED", "Ljava/lang/String;", AccessFlags = 25)]
				...
				/// <summary>
				/// <para>Broadcast Action: The current time has changed. Sent every minute. You can <b>not</b> receive this through components declared in manifests, only by exlicitly registering for it with Context.registerReceiver().</para><para>This is a protected intent that can only be sent by the system. </para>        
				/// </summary>
				/// <java-name>
				/// ACTION_TIME_TICK
				/// </java-name>
				...
				/// <summary>
				/// <para>Broadcast Action: An existing application package has been completely removed from the device. The data contains the name of the package. This is like ACTION_PACKAGE_REMOVED, but only set when EXTRA_DATA_REMOVED is true and EXTRA_REPLACING is false of that broadcast.</para><para><ul><li><para>EXTRA_UID containing the integer uid previously assigned to the package. </para></li></ul></para><para>This is a protected intent that can only be sent by the system. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				/// <para>Broadcast Action: Sent to the system package verifier when a package needs to be verified. The data contains the package URI. </para><para>This is a protected intent that can only be sent by the system. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				/// <para>Broadcast Action: Sent to the system package verifier when a package is verified. The data contains the package URI. </para><para>This is a protected intent that can only be sent by the system. </para>        
				/// </summary>
				/// <java-name>
				/// ACTION_PACKAGE_VERIFIED
				/// </java-name>
				[Dot42.DexImport("ACTION_PACKAGE_VERIFIED", "Ljava/lang/String;", AccessFlags = 25)]
				...
				/// <summary>
				/// <para>Broadcast Action: Device is shutting down. This is broadcast when the device is being shut down (completely turned off, not sleeping). Once the broadcast is complete, the final shutdown will proceed and all unsaved data lost. Apps will not normally need to handle this, since the foreground activity will be paused as well.</para><para>This is a protected intent that can only be sent by the system. </para>        
				/// </summary>
				/// <java-name>
				/// ACTION_SHUTDOWN
				/// </java-name>
				...
				/// <summary>
				/// <para>Broadcast to a specific application to query any supported restrictions to impose on restricted users. The broadcast intent contains an extra EXTRA_RESTRICTIONS_BUNDLE with the currently persisted restrictions as a Bundle of key/value pairs. The value types can be Boolean, String or String[] depending on the restriction type.</para><para>The response should contain an extra EXTRA_RESTRICTIONS_LIST, which is of type <code>ArrayList&lt;RestrictionEntry&gt;</code>. It can also contain an extra EXTRA_RESTRICTIONS_INTENT, which is of type <code>Intent</code>. The activity specified by that intent will be launched for a result which must contain one of the extras EXTRA_RESTRICTIONS_LIST or EXTRA_RESTRICTIONS_BUNDLE. The keys and values of the returned restrictions will be persisted. <para>RestrictionEntry </para></para>        
				/// </summary>
				/// <java-name>
				/// ACTION_GET_RESTRICTION_ENTRIES
				/// </java-name>
				[Dot42.DexImport("ACTION_GET_RESTRICTION_ENTRIES", "Ljava/lang/String;", AccessFlags = 25)]
				public const string ACTION_GET_RESTRICTION_ENTRIES = "android.intent.action.GET_RESTRICTION_ENTRIES";
				/// <summary>
				/// <para>Sent the first time a user is starting, to allow system apps to perform one time initialization. (This will not be seen by third party applications because a newly initialized user does not have any third party applications installed for it.) This is sent early in starting the user, around the time the home app is started, before ACTION_BOOT_COMPLETED is sent. This is sent as a foreground broadcast, since it is part of a visible user interaction; be as quick as possible when handling it. </para>        
				/// </summary>
				/// <java-name>
				/// ACTION_USER_INITIALIZE
				/// </java-name>
				[Dot42.DexImport("ACTION_USER_INITIALIZE", "Ljava/lang/String;", AccessFlags = 25)]
				public const string ACTION_USER_INITIALIZE = "android.intent.action.USER_INITIALIZE";
				/// <summary>
				/// <para>Sent when a user switch is happening, causing the process's user to be brought to the foreground. This is only sent to receivers registered through Context.registerReceiver. It is sent to the user that is going to the foreground. This is sent as a foreground broadcast, since it is part of a visible user interaction; be as quick as possible when handling it. </para>        
				/// </summary>
				/// <java-name>
				/// ACTION_USER_FOREGROUND
				/// </java-name>
				[Dot42.DexImport("ACTION_USER_FOREGROUND", "Ljava/lang/String;", AccessFlags = 25)]
				public const string ACTION_USER_FOREGROUND = "android.intent.action.USER_FOREGROUND";
				/// <summary>
				/// <para>Sent when a user switch is happening, causing the process's user to be sent to the background. This is only sent to receivers registered through Context.registerReceiver. It is sent to the user that is going to the background. This is sent as a foreground broadcast, since it is part of a visible user interaction; be as quick as possible when handling it. </para>        
				/// </summary>
				/// <java-name>
				/// ACTION_USER_BACKGROUND
				/// </java-name>
				[Dot42.DexImport("ACTION_USER_BACKGROUND", "Ljava/lang/String;", AccessFlags = 25)]
				public const string ACTION_USER_BACKGROUND = "android.intent.action.USER_BACKGROUND";
				/// <summary>
				/// <para>Sent when the user taps on the clock widget in the system's "quick settings" area. </para>        
				/// </summary>
				/// <java-name>
				/// ACTION_QUICK_CLOCK
				/// </java-name>
				[Dot42.DexImport("ACTION_QUICK_CLOCK", "Ljava/lang/String;", AccessFlags = 25)]
				public const string ACTION_QUICK_CLOCK = "android.intent.action.QUICK_CLOCK";
				/// <java-name>
				/// ACTION_OPEN_DOCUMENT
				/// </java-name>
				[Dot42.DexImport("ACTION_OPEN_DOCUMENT", "Ljava/lang/String;", AccessFlags = 25)]
				public const string ACTION_OPEN_DOCUMENT = "android.intent.action.OPEN_DOCUMENT";
				/// <java-name>
				/// ACTION_CREATE_DOCUMENT
				/// </java-name>
				[Dot42.DexImport("ACTION_CREATE_DOCUMENT", "Ljava/lang/String;", AccessFlags = 25)]
				public const string ACTION_CREATE_DOCUMENT = "android.intent.action.CREATE_DOCUMENT";
				/// <summary>
				/// <para>Set if the activity should be an option for the default action (center press) to perform on a piece of data. Setting this will hide from the user any activities without it set when performing an action on some data. Note that this is normal -not- set in the Intent when initiating an action  it is for use in intent filters specified in packages. </para>        
				/// </summary>
				/// <java-name>
				/// CATEGORY_DEFAULT
				/// </java-name>
				...
				/// <summary>
				/// <para>Used to indicate that a GET_CONTENT intent only wants URIs that can be opened with ContentResolver.openInputStream. Openable URIs must support the columns in android.provider.OpenableColumns when queried, though it is allowable for those columns to be blank. </para>        
				/// </summary>
				/// <java-name>
				/// CATEGORY_OPENABLE
				/// </java-name>
				...
				/// <summary>
				/// <para>Used with ACTION_MAIN to launch the browser application. The activity should be able to browse the Internet. </para><para>NOTE: This should not be used as the primary key of an Intent, since it will not result in the app launching with the correct action and category. Instead, use this with makeMainSelectorActivity(String, String) to generate a main Intent with this category in the selector.</para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				/// <para>Used with ACTION_MAIN to launch the calculator application. The activity should be able to perform standard arithmetic operations. </para><para>NOTE: This should not be used as the primary key of an Intent, since it will not result in the app launching with the correct action and category. Instead, use this with makeMainSelectorActivity(String, String) to generate a main Intent with this category in the selector.</para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				/// <para>Used with ACTION_MAIN to launch the calendar application. The activity should be able to view and manipulate calendar entries. </para><para>NOTE: This should not be used as the primary key of an Intent, since it will not result in the app launching with the correct action and category. Instead, use this with makeMainSelectorActivity(String, String) to generate a main Intent with this category in the selector.</para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				/// <para>Used with ACTION_MAIN to launch the contacts application. The activity should be able to view and manipulate address book entries. </para><para>NOTE: This should not be used as the primary key of an Intent, since it will not result in the app launching with the correct action and category. Instead, use this with makeMainSelectorActivity(String, String) to generate a main Intent with this category in the selector.</para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				/// <para>Used with ACTION_MAIN to launch the email application. The activity should be able to send and receive email. </para><para>NOTE: This should not be used as the primary key of an Intent, since it will not result in the app launching with the correct action and category. Instead, use this with makeMainSelectorActivity(String, String) to generate a main Intent with this category in the selector.</para>        
				/// </summary>
				/// <java-name>
				/// CATEGORY_APP_EMAIL
				/// </java-name>
				...
				/// <summary>
				/// <para>Used with ACTION_MAIN to launch the gallery application. The activity should be able to view and manipulate image and video files stored on the device. </para><para>NOTE: This should not be used as the primary key of an Intent, since it will not result in the app launching with the correct action and category. Instead, use this with makeMainSelectorActivity(String, String) to generate a main Intent with this category in the selector.</para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				/// <para>Used with ACTION_MAIN to launch the maps application. The activity should be able to show the user's current location and surroundings. </para><para>NOTE: This should not be used as the primary key of an Intent, since it will not result in the app launching with the correct action and category. Instead, use this with makeMainSelectorActivity(String, String) to generate a main Intent with this category in the selector.</para>        
				/// </summary>
				/// <java-name>
				/// CATEGORY_APP_MAPS
				/// </java-name>
				...
				/// <summary>
				/// <para>Used with ACTION_MAIN to launch the messaging application. The activity should be able to send and receive text messages. </para><para>NOTE: This should not be used as the primary key of an Intent, since it will not result in the app launching with the correct action and category. Instead, use this with makeMainSelectorActivity(String, String) to generate a main Intent with this category in the selector.</para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				/// <para>Used with ACTION_MAIN to launch the music application. The activity should be able to play, browse, or manipulate music files stored on the device. </para><para>NOTE: This should not be used as the primary key of an Intent, since it will not result in the app launching with the correct action and category. Instead, use this with makeMainSelectorActivity(String, String) to generate a main Intent with this category in the selector.</para>        
				/// </summary>
				/// <java-name>
				/// CATEGORY_APP_MUSIC
				/// </java-name>
				...
				/// <summary>
				/// <para>A constant String that is associated with the Intent, used with ACTION_SEND to supply an alternative to EXTRA_TEXT as HTML formatted text. Note that you <b>must</b> also supply EXTRA_TEXT. </para>        
				/// </summary>
				/// <java-name>
				/// EXTRA_HTML_TEXT
				/// </java-name>
				[Dot42.DexImport("EXTRA_HTML_TEXT", "Ljava/lang/String;", AccessFlags = 25)]
				...
				/// <summary>
				/// <para>Used as a parcelable extra field in ACTION_APP_ERROR, containing the bug report. </para>        
				/// </summary>
				/// <java-name>
				/// EXTRA_BUG_REPORT
				/// </java-name>
				...
				/// <summary>
				/// <para>Used to indicate that a ACTION_GET_CONTENT intent should only return data that is on the local device. This is a boolean extra; the default is false. If true, an implementation of ACTION_GET_CONTENT should only allow the user to select media that is already on the device, not requiring it be downloaded from a remote service when opened. Another way to look at it is that such content should generally have a "_data" column to the path of the content on local external storage. </para>        
				/// </summary>
				/// <java-name>
				/// EXTRA_LOCAL_ONLY
				/// </java-name>
				...
				/// <summary>
				/// <para>Used to indicate that a ACTION_GET_CONTENT intent can allow the user to select and return multiple items. This is a boolean extra; the default is false. If true, an implementation of ACTION_GET_CONTENT is allowed to present the user with a UI where they can pick multiple items that are all returned to the caller. When this happens, they should be returned as the getClipData() part of the result Intent. </para>        
				/// </summary>
				/// <java-name>
				/// EXTRA_ALLOW_MULTIPLE
				/// </java-name>
				[Dot42.DexImport("EXTRA_ALLOW_MULTIPLE", "Ljava/lang/String;", AccessFlags = 25)]
				public const string EXTRA_ALLOW_MULTIPLE = "android.intent.extra.ALLOW_MULTIPLE";
				/// <summary>
				/// <para>Extra used in the response from a BroadcastReceiver that handles ACTION_GET_RESTRICTION_ENTRIES. The type of the extra is <code>ArrayList&lt;RestrictionEntry&gt;</code>. </para>        
				/// </summary>
				/// <java-name>
				/// EXTRA_RESTRICTIONS_LIST
				/// </java-name>
				[Dot42.DexImport("EXTRA_RESTRICTIONS_LIST", "Ljava/lang/String;", AccessFlags = 25)]
				public const string EXTRA_RESTRICTIONS_LIST = "android.intent.extra.restrictions_list";
				/// <summary>
				/// <para>Extra sent in the intent to the BroadcastReceiver that handles ACTION_GET_RESTRICTION_ENTRIES. The type of the extra is a Bundle containing the restrictions as key/value pairs. </para>        
				/// </summary>
				/// <java-name>
				/// EXTRA_RESTRICTIONS_BUNDLE
				/// </java-name>
				[Dot42.DexImport("EXTRA_RESTRICTIONS_BUNDLE", "Ljava/lang/String;", AccessFlags = 25)]
				public const string EXTRA_RESTRICTIONS_BUNDLE = "android.intent.extra.restrictions_bundle";
				/// <summary>
				/// <para>Extra used in the response from a BroadcastReceiver that handles ACTION_GET_RESTRICTION_ENTRIES. </para>        
				/// </summary>
				/// <java-name>
				/// EXTRA_RESTRICTIONS_INTENT
				/// </java-name>
				[Dot42.DexImport("EXTRA_RESTRICTIONS_INTENT", "Ljava/lang/String;", AccessFlags = 25)]
				public const string EXTRA_RESTRICTIONS_INTENT = "android.intent.extra.restrictions_intent";
				/// <java-name>
				/// EXTRA_MIME_TYPES
				/// </java-name>
				[Dot42.DexImport("EXTRA_MIME_TYPES", "Ljava/lang/String;", AccessFlags = 25)]
				public const string EXTRA_MIME_TYPES = "android.intent.extra.MIME_TYPES";
				/// <java-name>
				/// EXTRA_SHUTDOWN_USERSPACE_ONLY
				/// </java-name>
				[Dot42.DexImport("EXTRA_SHUTDOWN_USERSPACE_ONLY", "Ljava/lang/String;", AccessFlags = 25)]
				...
				/// </java-name>
				[Dot42.DexImport("FLAG_GRANT_PERSISTABLE_URI_PERMISSION", "I", AccessFlags = 25)]
				...
				/// <summary>
				/// <para>If set, when sending a broadcast the recipient is allowed to run at foreground priority, with a shorter timeout interval. During normal broadcasts the receivers are not automatically hoisted out of the background priority class. </para>        
				/// </summary>
				/// <java-name>
				/// FLAG_RECEIVER_FOREGROUND
				/// </java-name>
				[Dot42.DexImport("FLAG_RECEIVER_FOREGROUND", "I", AccessFlags = 25)]
				public const int FLAG_RECEIVER_FOREGROUND = 268435456;
				/// <java-name>
				/// FLAG_RECEIVER_NO_ABORT
				/// </java-name>
				[Dot42.DexImport("FLAG_RECEIVER_NO_ABORT", "I", AccessFlags = 25)]
				...
				/// <summary>
				/// <para>Use with fillIn to allow the current selector to be overwritten, even if it is already set. </para>        
				/// </summary>
				/// <java-name>
				/// FILL_IN_SELECTOR
				/// </java-name>
				...
				/// <summary>
				/// <para>Use with fillIn to allow the current ClipData to be overwritten, even if it is already set. </para>        
				/// </summary>
				/// <java-name>
				/// FILL_IN_CLIP_DATA
				/// </java-name>
				[Dot42.DexImport("FILL_IN_CLIP_DATA", "I", AccessFlags = 25)]
    ...
    ")V")]
				...
				/// <summary>
				/// <para>Make an Intent for the main activity of an application, without specifying a specific activity to run but giving a selector to find the activity. This results in a final Intent that is structured the same as when the application is launched from Home. For anything else that wants to launch an application in the same way, it is important that they use an Intent structured the same way, and can use this function to ensure this is the case.</para><para>The returned Intent has ACTION_MAIN as its action, and includes the category CATEGORY_LAUNCHER. This does <b>not</b> have FLAG_ACTIVITY_NEW_TASK set, though typically you will want to do that through addFlags(int) on the returned Intent.</para><para><para>setSelector(Intent) </para></para>        
				/// </summary>
				/// <returns>
				/// <para>Returns a newly created Intent that can be used to launch the activity as a main application entry.</para>
				/// </returns>
				...
				public static global::Android.Content.Intent MakeMainSelectorActivity(string selectorAction, string selectorCategory) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Content.Intent);
				}
				...
				/// <summary>
				/// <para>Retrieve data this intent is operating on. This URI specifies the name of the data; often it uses the content: scheme, specifying data in a content provider. Other schemes may be handled by specific activities, such as http: by the web browser.</para><para><para>getScheme </para><simplesectsep></simplesectsep><para>setData </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				/// <para>Retrieve any explicit MIME type included in the intent. This is usually null, as the type is determined by the intent data.</para><para><para>resolveType(ContentResolver) </para><simplesectsep></simplesectsep><para>setType </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				/// <para>Return the MIME data type of this intent. If the type field is explicitly set, that is simply returned. Otherwise, if the data is set, the type of that data is returned. If neither fields are set, a null is returned.</para><para><para>getType </para><simplesectsep></simplesectsep><para>resolveType(ContentResolver) </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				/// <para>Check if a category exists in the intent.</para><para><para>getCategories </para><simplesectsep></simplesectsep><para>addCategory </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				/// <para>Return the set of all categories in the intent. If there are no categories, returns NULL.</para><para><para>hasCategory </para><simplesectsep></simplesectsep><para>addCategory </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				/// <para>Return the specific selector associated with this Intent. If there is none, returns null. See setSelector for more information.</para><para><para>setSelector </para></para>        
				/// </summary>
				/// <java-name>
				/// getSelector
				/// </java-name>
				...
				/// <summary>
				/// <para>Return the ClipData associated with this Intent. If there is none, returns null. See setClipData for more information.</para><para><para>setClipData; </para></para>        
				/// </summary>
				/// <java-name>
				/// getClipData
				/// </java-name>
				[Dot42.DexImport("getClipData", "()Landroid/content/ClipData;", AccessFlags = 1)]
				public virtual global::Android.Content.ClipData GetClipData() /* MethodBuilder.Create */ 
				{
				...
				/// <summary>
				/// <para>Retrieve the application package name this Intent is limited to. When resolving an Intent, if non-null this limits the resolution to only components in the given application package.</para><para><para>resolveActivity </para><simplesectsep></simplesectsep><para>setPackage </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				/// <para>Normalize and set the data this intent is operating on.</para><para>This method automatically clears any type that was previously set (for example, by setType).</para><para>The data Uri is normalized using android.net.Uri#normalizeScheme before it is set, so really this is just a convenience method for <pre>
				///        setData(data.normalize())
				///        </pre></para><para><para>getData </para><simplesectsep></simplesectsep><para>setType </para><simplesectsep></simplesectsep><para>android.net.Uri::normalizeScheme </para></para>        
				/// </summary>
				/// <returns>
				/// <para>Returns the same Intent object, for chaining multiple calls into a single statement.</para>
				/// </returns>
				...
				/// <summary>
				/// <para>Normalize and set an explicit MIME data type.</para><para>This is used to create intents that only specify a type and not data, for example to indicate the type of data to return.</para><para>This method automatically clears any data that was previously set (for example by setData).</para><para>The MIME type is normalized using normalizeMimeType before it is set, so really this is just a convenience method for <pre>
				///        setType(Intent.normalizeMimeType(type))
				///        </pre></para><para><para>getType </para><simplesectsep></simplesectsep><para>setData </para><simplesectsep></simplesectsep><para>normalizeMimeType </para></para>        
				/// </summary>
				/// <returns>
				/// <para>Returns the same Intent object, for chaining multiple calls into a single statement.</para>
				/// </returns>
				...
				/// <summary>
				/// <para>(Usually optional) Normalize and set both the data Uri and an explicit MIME data type. This method should very rarely be used  it allows you to override the MIME type that would ordinarily be inferred from the data with your own type given here.</para><para>The data Uri and the MIME type are normalize using android.net.Uri#normalizeScheme and normalizeMimeType before they are set, so really this is just a convenience method for <pre>
				///        setDataAndType(data.normalize(), Intent.normalizeMimeType(type))
				///        </pre></para><para><para>setType </para><simplesectsep></simplesectsep><para>setData </para><simplesectsep></simplesectsep><para>setDataAndType </para><simplesectsep></simplesectsep><para>normalizeMimeType </para><simplesectsep></simplesectsep><para>android.net.Uri::normalizeScheme </para></para>        
				/// </summary>
				/// <returns>
				/// <para>Returns the same Intent object, for chaining multiple calls into a single statement.</para>
				/// </returns>
				...
				/// </java-name>
				[Dot42.DexImport("setDataAndTypeAndNormalize", "(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Intent;", AccessFlags = 1)]
				public virtual global::Android.Content.Intent SetDataAndTypeAndNormalize(global::Android.Net.Uri data, string type) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Content.Intent);
				}

				/// <summary>
				/// <para>Add a new category to the intent. Categories provide additional detail about the action the intent performs. When resolving an intent, only activities that provide <b>all</b> of the requested categories will be used.</para><para><para>hasCategory </para><simplesectsep></simplesectsep><para>removeCategory </para></para>        
				/// </summary>
				/// <returns>
				/// <para>Returns the same Intent object, for chaining multiple calls into a single statement.</para>
				/// </returns>
				...
				/// <summary>
				/// <para>Set a selector for this Intent. This is a modification to the kinds of things the Intent will match. If the selector is set, it will be used when trying to find entities that can handle the Intent, instead of the main contents of the Intent. This allows you build an Intent containing a generic protocol while targeting it more specifically.</para><para>An example of where this may be used is with things like CATEGORY_APP_BROWSER. This category allows you to build an Intent that will launch the Browser application. However, the correct main entry point of an application is actually ACTION_MAIN CATEGORY_LAUNCHER with setComponent(ComponentName) used to specify the actual Activity to launch. If you launch the browser with something different, undesired behavior may happen if the user has previously or later launches it the normal way, since they do not match. Instead, you can build an Intent with the MAIN action (but no ComponentName yet specified) and set a selector with ACTION_MAIN and CATEGORY_APP_BROWSER to point it specifically to the browser activity.</para><para>Setting a selector does not impact the behavior of filterEquals(Intent) and filterHashCode(). This is part of the desired behavior of a selector  it does not impact the base meaning of the Intent, just what kinds of things will be matched against it when determining who can handle it.</para><para>You can not use both a selector and setPackage(String) on the same base Intent.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setSelector
				/// </java-name>
				[Dot42.DexImport("setSelector", "(Landroid/content/Intent;)V", AccessFlags = 1)]
				public virtual void SetSelector(global::Android.Content.Intent selector) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Set a ClipData associated with this Intent. This replaces any previously set ClipData.</para><para>The ClipData in an intent is not used for Intent matching or other such operations. Semantically it is like extras, used to transmit additional data with the Intent. The main feature of using this over the extras for data is that FLAG_GRANT_READ_URI_PERMISSION and FLAG_GRANT_WRITE_URI_PERMISSION will operate on any URI items included in the clip data. This is useful, in particular, if you want to transmit an Intent containing multiple <code>content:</code> URIs for which the recipient may not have global permission to access the content provider.</para><para>If the ClipData contains items that are themselves Intents, any grant flags in those Intents will be ignored. Only the top-level flags of the main Intent are respected, and will be applied to all Uri or Intent items in the clip (or sub-items of the clip).</para><para>The MIME type, label, and icon in the ClipData object are not directly used by Intent. Applications should generally rely on the MIME type of the Intent itself, not what it may find in the ClipData. A common practice is to construct a ClipData for use with an Intent with a MIME type of "*\/*".</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setClipData
				/// </java-name>
				[Dot42.DexImport("setClipData", "(Landroid/content/ClipData;)V", AccessFlags = 1)]
				public virtual void SetClipData(global::Android.Content.ClipData clip) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Add extended data to the intent. The name must include a package prefix, for example the app com.android.contacts would use names like "com.android.contacts.ShowAll".</para><para><para>putExtras </para><simplesectsep></simplesectsep><para>removeExtra </para><simplesectsep></simplesectsep><para>#getParcelableArrayListExtra(String) </para></para>        
				/// </summary>
				/// <returns>
				/// <para>Returns the same Intent object, for chaining multiple calls into a single statement.</para>
				/// </returns>
    ...
    "nt/Intent;")]
				...
				/// <summary>
				/// <para>Add extended data to the intent. The name must include a package prefix, for example the app com.android.contacts would use names like "com.android.contacts.ShowAll".</para><para><para>putExtras </para><simplesectsep></simplesectsep><para>removeExtra </para><simplesectsep></simplesectsep><para>getIntegerArrayListExtra(String) </para></para>        
				/// </summary>
				/// <returns>
				/// <para>Returns the same Intent object, for chaining multiple calls into a single statement.</para>
				/// </returns>
    ...
    "tent;")]
				...
				/// <summary>
				/// <para>Add extended data to the intent. The name must include a package prefix, for example the app com.android.contacts would use names like "com.android.contacts.ShowAll".</para><para><para>putExtras </para><simplesectsep></simplesectsep><para>removeExtra </para><simplesectsep></simplesectsep><para>getStringArrayListExtra(String) </para></para>        
				/// </summary>
				/// <returns>
				/// <para>Returns the same Intent object, for chaining multiple calls into a single statement.</para>
				/// </returns>
    ...
    "ent;")]
				...
				/// <summary>
				/// <para>Add extended data to the intent. The name must include a package prefix, for example the app com.android.contacts would use names like "com.android.contacts.ShowAll".</para><para><para>putExtras </para><simplesectsep></simplesectsep><para>removeExtra </para><simplesectsep></simplesectsep><para>getCharSequenceArrayListExtra(String) </para></para>        
				/// </summary>
				/// <returns>
				/// <para>Returns the same Intent object, for chaining multiple calls into a single statement.</para>
				/// </returns>
    ...
    "nt/Intent;")]
				...
				/// <summary>
				/// <para>Set special flags controlling how this intent is handled. Most values here depend on the type of component being executed by the Intent, specifically the FLAG_ACTIVITY_* flags are all for use with Context.startActivity() and the FLAG_RECEIVER_* flags are all for use with Context.sendBroadcast().</para><para>See the  documentation for important information on how some of these options impact the behavior of your application.</para><para><para>getFlags </para><simplesectsep></simplesectsep><para>addFlags</para><simplesectsep></simplesectsep><para>FLAG_GRANT_READ_URI_PERMISSION </para><simplesectsep></simplesectsep><para>FLAG_GRANT_WRITE_URI_PERMISSION </para><simplesectsep></simplesectsep><para>FLAG_DEBUG_LOG_RESOLUTION </para><simplesectsep></simplesectsep><para>FLAG_FROM_BACKGROUND </para><simplesectsep></simplesectsep><para>FLAG_ACTIVITY_BROUGHT_TO_FRONT </para><simplesectsep></simplesectsep><para>FLAG_ACTIVITY_CLEAR_TASK </para><simplesectsep></simplesectsep><para>FLAG_ACTIVITY_CLEAR_TOP </para><simplesectsep></simplesectsep><para>FLAG_ACTIVITY_CLEAR_WHEN_TASK_RESET </para><simplesectsep></simplesectsep><para>FLAG_ACTIVITY_EXCLUDE_FROM_RECENTS </para><simplesectsep></simplesectsep><para>FLAG_ACTIVITY_FORWARD_RESULT </para><simplesectsep></simplesectsep><para>FLAG_ACTIVITY_LAUNCHED_FROM_HISTORY </para><simplesectsep></simplesectsep><para>FLAG_ACTIVITY_MULTIPLE_TASK </para><simplesectsep></simplesectsep><para>FLAG_ACTIVITY_NEW_TASK </para><simplesectsep></simplesectsep><para>FLAG_ACTIVITY_NO_ANIMATION </para><simplesectsep></simplesectsep><para>FLAG_ACTIVITY_NO_HISTORY </para><simplesectsep></simplesectsep><para>FLAG_ACTIVITY_NO_USER_ACTION </para><simplesectsep></simplesectsep><para>FLAG_ACTIVITY_PREVIOUS_IS_TOP </para><simplesectsep></simplesectsep><para>FLAG_ACTIVITY_RESET_TASK_IF_NEEDED </para><simplesectsep></simplesectsep><para>FLAG_ACTIVITY_REORDER_TO_FRONT </para><simplesectsep></simplesectsep><para>FLAG_ACTIVITY_SINGLE_TOP </para><simplesectsep></simplesectsep><para>FLAG_ACTIVITY_TASK_ON_HOME </para><simplesectsep></simplesectsep><para>FLAG_RECEIVER_REGISTERED_ONLY </para></para>        
				/// </summary>
				/// <returns>
				/// <para>Returns the same Intent object, for chaining multiple calls into a single statement.</para>
				/// </returns>
				...
				/// <summary>
				/// <para>(Usually optional) Explicitly set the component to handle the intent. If left with the default value of null, the system will determine the appropriate class to use based on the other fields (action, data, type, categories) in the Intent. If this class is defined, the specified class will always be used regardless of the other fields. You should only set this value when you know you absolutely want a specific class to be used; otherwise it is better to let the system find the appropriate class so that you will respect the installed applications and user preferences.</para><para><para>setClass </para><simplesectsep></simplesectsep><para>setClassName(Context, String) </para><simplesectsep></simplesectsep><para>setClassName(String, String) </para><simplesectsep></simplesectsep><para>getComponent </para><simplesectsep></simplesectsep><para>resolveActivity </para></para>        
				/// </summary>
				/// <returns>
				/// <para>Returns the same Intent object, for chaining multiple calls into a single statement.</para>
				/// </returns>
				...
				/// <summary>
				/// <para>Set the bounds of the sender of this intent, in screen coordinates. This can be used as a hint to the receiver for animations and the like. Null means that there is no source bounds. </para>        
				/// </summary>
				/// <java-name>
				/// setSourceBounds
				/// </java-name>
				[Dot42.DexImport("setSourceBounds", "(Landroid/graphics/Rect;)V", AccessFlags = 1)]
				public virtual void SetSourceBounds(global::Android.Graphics.Rect r) /* MethodBuilder.Create */ 
				{
				}
    ...
    "buteSet;)Landroid/content/Intent;", AccessFlags = 9)]
				...
				/// <summary>
				/// <para>Normalize a MIME data type.</para><para>A normalized MIME type has white-space trimmed, content-type parameters removed, and is lower-case. This aligns the type with Android best practices for intent filtering.</para><para>For example, "text/plain; charset=utf-8" becomes "text/plain". "text/x-vCard" becomes "text/x-vcard".</para><para>All MIME types received from outside Android (such as user input, or external sources like Bluetooth, NFC, or the Internet) should be normalized before they are used to create an Intent.</para><para><para>setType </para><simplesectsep></simplesectsep><para>setTypeAndNormalize </para></para>        
				/// </summary>
				/// <returns>
				/// <para>normalized MIME data type, or null if the input was null </para>
				/// </returns>
				/// <java-name>
				/// normalizeMimeType
				/// </java-name>
				[Dot42.DexImport("normalizeMimeType", "(Ljava/lang/String;)Ljava/lang/String;", AccessFlags = 9)]
				public static string NormalizeMimeType(string type) /* MethodBuilder.Create */ 
				{
						return default(string);
				}
				...
				/// getClipData
				/// </java-name>
				public global::Android.Content.ClipData ClipData
				{
				[Dot42.DexImport("getClipData", "()Landroid/content/ClipData;", AccessFlags = 1)]
						get{ return GetClipData(); }
				[Dot42.DexImport("setClipData", "(Landroid/content/ClipData;)V", AccessFlags = 1)]
						set{ SetClipData(value); }
				}
 ...
 /* scope: __dot42__ */ 
				...
				/// <summary>
				/// <para>Represents a shortcut/live folder icon resource.</para><para><para>Intent::ACTION_CREATE_SHORTCUT </para><simplesectsep></simplesectsep><para>Intent::EXTRA_SHORTCUT_ICON_RESOURCE </para><simplesectsep></simplesectsep><para>android.provider.LiveFolders::ACTION_CREATE_LIVE_FOLDER </para><simplesectsep></simplesectsep><para>android.provider.LiveFolders::EXTRA_LIVE_FOLDER_ICON </para></para>    
				/// </summary>
				/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Sets the current primary clip on the clipboard. This is the clip that is involved in normal cut and paste operations.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setPrimaryClip
				/// </java-name>
				[Dot42.DexImport("setPrimaryClip", "(Landroid/content/ClipData;)V", AccessFlags = 1)]
				public virtual void SetPrimaryClip(global::Android.Content.ClipData clip) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>Use setPrimaryClip(ClipData) instead. This creates a ClippedItem holding the given text and sets it as the primary clip. It has no label or icon. </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <java-name>
				/// setText
				/// </java-name>
				[Dot42.DexImport("setText", "(Ljava/lang/CharSequence;)V", AccessFlags = 1)]
				public override void SetText(global::Java.Lang.ICharSequence text) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		...
		/// </java-name>
		[Dot42.DexImport("android/content/UriPermission", AccessFlags = 49)]
		public sealed partial class UriPermission : global::Android.Os.IParcelable
 /* scope: __dot42__ */ 
		{
				/// <java-name>
				/// INVALID_TIME
				/// </java-name>
				[Dot42.DexImport("INVALID_TIME", "J", AccessFlags = 25)]
				public const long INVALID_TIME = -9223372036854775808;
				/// <java-name>
				/// CREATOR
				/// </java-name>
				[Dot42.DexImport("CREATOR", "Landroid/os/Parcelable$Creator;", AccessFlags = 25)]
				public static readonly global::Android.Os.IParcelable_ICreator<global::Android.Content.UriPermission> CREATOR;
				[Dot42.DexImport("<init>", "()V", AccessFlags = 0)]
				internal UriPermission() /* MethodBuilder.Create */ 
				{
				}
				...
				/// </java-name>
				[Dot42.DexImport("getUri", "()Landroid/net/Uri;", AccessFlags = 1)]
				public global::Android.Net.Uri GetUri() /* MethodBuilder.Create */ 
				{
						return default(global::Android.Net.Uri);
				}
				...
				/// isReadPermission
				/// </java-name>
				[Dot42.DexImport("isReadPermission", "()Z", AccessFlags = 1)]
				public bool IsReadPermission() /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				/// isWritePermission
				/// </java-name>
				[Dot42.DexImport("isWritePermission", "()Z", AccessFlags = 1)]
				public bool IsWritePermission() /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				/// getPersistedTime
				/// </java-name>
				[Dot42.DexImport("getPersistedTime", "()J", AccessFlags = 1)]
				public long GetPersistedTime() /* MethodBuilder.Create */ 
				{
						return default(long);
				}
				...
				{
				[Dot42.DexImport("getPersistedTime", "()J", AccessFlags = 1)]
						get{ return GetPersistedTime(); }
				}

		}

		/// <summary>
		/// <para>The set of callback APIs that are common to all application components (android.app.Activity, android.app.Service, ContentProvider, and android.app.Application). </para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>This is called when the overall system is running low on memory, and would like actively running process to try to tighten their belt. While the exact point at which this will be called is not defined, generally it will happen around the time all background process have been killed, that is before reaching the point of killing processes hosting service and foreground UI that we would like to avoid killing.</para><para>Applications that want to be nice can implement this method to release any caches or other unnecessary resources they may be holding on to. The system will perform a gc for you after returning from this method. </para>        
				/// </summary>
				/// <java-name>
				/// onLowMemory
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// </summary>
				/// <returns>
				/// <para>The activity to use to invoke this SyncAdapter's settings activity. May be null. </para>
				/// </returns>
				/// <java-name>
				/// getSettingsActivity
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Change the current result code of this broadcast; only works with broadcasts sent through Context.sendOrderedBroadcast. Often uses the Activity android.app.Activity#RESULT_CANCELED and android.app.Activity#RESULT_OK constants, though the actual meaning of this value is ultimately up to the broadcaster.</para><para>This method does not work with non-ordered broadcasts such as those sent with Context.sendBroadcast</para><para><para>setResult(int, String, Bundle) </para></para>        
				/// </summary>
				/// <java-name>
				/// setResultCode
				/// </java-name>
				[Dot42.DexImport("setResultCode", "(I)V", AccessFlags = 17)]
				public void SetResultCode(int code) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Change the current result data of this broadcast; only works with broadcasts sent through Context.sendOrderedBroadcast. This is an arbitrary string whose interpretation is up to the broadcaster.</para><para><b>This method does not work with non-ordered broadcasts such as those sent with Context.sendBroadcast</b></para><para><para>setResult(int, String, Bundle) </para></para>        
				/// </summary>
				/// <java-name>
				/// setResultData
				/// </java-name>
				[Dot42.DexImport("setResultData", "(Ljava/lang/String;)V", AccessFlags = 17)]
				public void SetResultData(string data) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
				{
						...
						/// <summary>
						/// <para>Version of BroadcastReceiver.setResultCode(int) for asynchronous broadcast handling. </para>        
						/// </summary>
						/// <java-name>
						/// setResultCode
						/// </java-name>
						...
						/// <summary>
						/// <para>Version of BroadcastReceiver.setResultData(String) for asynchronous broadcast handling. </para>        
						/// </summary>
						/// <java-name>
						/// setResultData
						/// </java-name>
 ...
 /* scope: __dot42__ */ 
    ...
    "Ljava/lang/String;Ljava/lang/String;)V", AccessFlags = 1)]
				...
				/// </java-name>
				[Dot42.DexImport("cancelLoadInBackground", "()V", AccessFlags = 1)]
				public override void CancelLoadInBackground() /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual void SetProjection(string[] projection) /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual void SetSelection(string selection) /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual void SetSelectionArgs(string[] selectionArgs) /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual void SetSortOrder(string sortOrder) /* MethodBuilder.Create */ 
				{
				}
    ...
    "g;)V", AccessFlags = 1)]
		...
		/// <summary>
		/// <para>Extended ComponentCallbacks interface with a new callback for finer-grained memory management. </para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				/// <summary>
				/// <para>Level for onTrimMemory(int): the process is nearing the end of the background LRU list, and if more memory isn't found soon it will be killed. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				/// <para>Level for onTrimMemory(int): the process is around the middle of the background LRU list; freeing memory can help the system keep other processes running later in the list for better overall performance. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				/// <para>Level for onTrimMemory(int): the process has gone on to the LRU list. This is a good opportunity to clean up resources that can efficiently and quickly be re-built if the user returns to the app. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				/// <para>Level for onTrimMemory(int): the process had been showing a user interface, and is no longer doing so. Large allocations with the UI should be released at this point to allow memory to be better managed. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				/// <para>Level for onTrimMemory(int): the process is not an expendable background process, but the device is running extremely low on memory and is about to not be able to keep any background processes running. Your running process should free up as many non-critical resources as it can to allow that memory to be used elsewhere. The next thing that will happen after this is onLowMemory() called to report that nothing at all can be kept in the background, a situation that can start to notably impact the user. </para>        
				/// </summary>
				/// <java-name>
				/// TRIM_MEMORY_RUNNING_CRITICAL
				/// </java-name>
				[Dot42.DexImport("TRIM_MEMORY_RUNNING_CRITICAL", "I", AccessFlags = 25)]
				public const int TRIM_MEMORY_RUNNING_CRITICAL = 15;
				/// <summary>
				/// <para>Level for onTrimMemory(int): the process is not an expendable background process, but the device is running low on memory. Your running process should free up unneeded resources to allow that memory to be used elsewhere. </para>        
				/// </summary>
				/// <java-name>
				/// TRIM_MEMORY_RUNNING_LOW
				/// </java-name>
				[Dot42.DexImport("TRIM_MEMORY_RUNNING_LOW", "I", AccessFlags = 25)]
				public const int TRIM_MEMORY_RUNNING_LOW = 10;
				/// <summary>
				/// <para>Level for onTrimMemory(int): the process is not an expendable background process, but the device is running moderately low on memory. Your running process may want to release some unneeded resources for use elsewhere. </para>        
				/// </summary>
				/// <java-name>
				/// TRIM_MEMORY_RUNNING_MODERATE
				/// </java-name>
				[Dot42.DexImport("TRIM_MEMORY_RUNNING_MODERATE", "I", AccessFlags = 25)]
				public const int TRIM_MEMORY_RUNNING_MODERATE = 5;
		}
 ...
 /* scope: __dot42__ */ 
		{
				...
				void OnTrimMemory(int level) /* MethodBuilder.Create */ ;
 ...
 /* scope: __dot42__ */ 
    ...
    "ang/String;)Landroid/database/Cursor;", AccessFlags = 1)]
				...
				/// </java-name>
				[Dot42.DexImport("query", "(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/l" +
    "ang/String;Landroid/os/CancellationSignal;)Landroid/database/Cursor;", AccessFlags = 1)]
				public virtual global::Android.Database.ICursor Query(global::Android.Net.Uri url, string[] projection, string selection, string[] selectionArgs, string sortOrder, global::Android.Os.CancellationSignal cancellationSignal) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Database.ICursor);
				}
				...
				/// canonicalize
				/// </java-name>
				[Dot42.DexImport("canonicalize", "(Landroid/net/Uri;)Landroid/net/Uri;", AccessFlags = 17)]
				public global::Android.Net.Uri Canonicalize(global::Android.Net.Uri uri) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Net.Uri);
				}
				...
				/// uncanonicalize
				/// </java-name>
				[Dot42.DexImport("uncanonicalize", "(Landroid/net/Uri;)Landroid/net/Uri;", AccessFlags = 17)]
				public global::Android.Net.Uri Uncanonicalize(global::Android.Net.Uri uri) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Net.Uri);
				}
    ...
    "arcelFileDescriptor;", AccessFlags = 1)]
				public virtual global::Android.Os.ParcelFileDescriptor OpenFile(global::Android.Net.Uri uri, string @string, global::Android.Os.CancellationSignal cancellationSignal) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Os.ParcelFileDescriptor);
				}
				...
				/// openAssetFile
				/// </java-name>
				[Dot42.DexImport("openAssetFile", "(Landroid/net/Uri;Ljava/lang/String;Landroid/os/CancellationSignal;)Landroid/cont" +
    "ent/res/AssetFileDescriptor;", AccessFlags = 1)]
				public virtual global::Android.Content.Res.AssetFileDescriptor OpenAssetFile(global::Android.Net.Uri uri, string @string, global::Android.Os.CancellationSignal cancellationSignal) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Content.Res.AssetFileDescriptor);
				}
    ...
    "tFileDescriptor;", AccessFlags = 17)]
				...
				/// openTypedAssetFileDescriptor
				/// </java-name>
				[Dot42.DexImport("openTypedAssetFileDescriptor", "(Landroid/net/Uri;Ljava/lang/String;Landroid/os/Bundle;Landroid/os/CancellationSi" +
    "gnal;)Landroid/content/res/AssetFileDescriptor;", AccessFlags = 17)]
				public global::Android.Content.Res.AssetFileDescriptor OpenTypedAssetFileDescriptor(global::Android.Net.Uri uri, string @string, global::Android.Os.Bundle bundle, global::Android.Os.CancellationSignal cancellationSignal) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Content.Res.AssetFileDescriptor);
				}
    ...
    "ent/ContentProviderResult;")]
				...
				/// <summary>
				/// <para>See ContentProvider#call(String, String, Bundle) </para>        
				/// </summary>
				/// <java-name>
				/// call
				/// </java-name>
				...
				/// </java-name>
				[Dot42.DexImport("finalize", "()V", AccessFlags = 4)]
				extern ~ContentProviderClient() /* MethodBuilder.Create */ ;
		...
		/// </java-name>
		[Dot42.DexImport("android/content/SyncRequest", AccessFlags = 33)]
		public partial class SyncRequest : global::Android.Os.IParcelable
 /* scope: __dot42__ */ 
		{
				/// <java-name>
				/// CREATOR
				/// </java-name>
				[Dot42.DexImport("CREATOR", "Landroid/os/Parcelable$Creator;", AccessFlags = 25)]
				public static readonly global::Android.Os.IParcelable_ICreator<global::Android.Content.SyncRequest> CREATOR;
				[Dot42.DexImport("<init>", "()V", AccessFlags = 0)]
				internal SyncRequest() /* MethodBuilder.Create */ 
				{
				}
				...
				/// </java-name>
				[Dot42.DexImport("android/content/SyncRequest$Builder", AccessFlags = 9)]
				public partial class Builder
 /* scope: __dot42__ */ 
				{
						[Dot42.DexImport("<init>", "()V", AccessFlags = 1)]
						...
						/// syncOnce
						/// </java-name>
						[Dot42.DexImport("syncOnce", "()Landroid/content/SyncRequest$Builder;", AccessFlags = 1)]
						public virtual Builder SyncOnce() /* MethodBuilder.Create */ 
						{
								return default(Builder);
						}
						...
						/// syncPeriodic
						/// </java-name>
						[Dot42.DexImport("syncPeriodic", "(JJ)Landroid/content/SyncRequest$Builder;", AccessFlags = 1)]
						public virtual Builder SyncPeriodic(long int64, long int641) /* MethodBuilder.Create */ 
						{
								return default(Builder);
						}
						...
						/// setDisallowMetered
						/// </java-name>
						[Dot42.DexImport("setDisallowMetered", "(Z)Landroid/content/SyncRequest$Builder;", AccessFlags = 1)]
						public virtual Builder SetDisallowMetered(bool boolean) /* MethodBuilder.Create */ 
						{
								return default(Builder);
						}
						...
						/// setSyncAdapter
						/// </java-name>
						[Dot42.DexImport("setSyncAdapter", "(Landroid/accounts/Account;Ljava/lang/String;)Landroid/content/SyncRequest$Builde" +
    "r;", AccessFlags = 1)]
						public virtual Builder SetSyncAdapter(global::Android.Accounts.Account account, string @string) /* MethodBuilder.Create */ 
						{
								return default(Builder);
						}
						...
						/// setExtras
						/// </java-name>
						[Dot42.DexImport("setExtras", "(Landroid/os/Bundle;)Landroid/content/SyncRequest$Builder;", AccessFlags = 1)]
						public virtual Builder SetExtras(global::Android.Os.Bundle bundle) /* MethodBuilder.Create */ 
						{
								return default(Builder);
						}
						...
						/// setNoRetry
						/// </java-name>
						[Dot42.DexImport("setNoRetry", "(Z)Landroid/content/SyncRequest$Builder;", AccessFlags = 1)]
						public virtual Builder SetNoRetry(bool boolean) /* MethodBuilder.Create */ 
						{
								return default(Builder);
						}
						...
						/// setIgnoreSettings
						/// </java-name>
						[Dot42.DexImport("setIgnoreSettings", "(Z)Landroid/content/SyncRequest$Builder;", AccessFlags = 1)]
						public virtual Builder SetIgnoreSettings(bool boolean) /* MethodBuilder.Create */ 
						{
								return default(Builder);
						}
						...
						/// setIgnoreBackoff
						/// </java-name>
						[Dot42.DexImport("setIgnoreBackoff", "(Z)Landroid/content/SyncRequest$Builder;", AccessFlags = 1)]
						public virtual Builder SetIgnoreBackoff(bool boolean) /* MethodBuilder.Create */ 
						{
								return default(Builder);
						}
						...
						/// setManual
						/// </java-name>
						[Dot42.DexImport("setManual", "(Z)Landroid/content/SyncRequest$Builder;", AccessFlags = 1)]
						public virtual Builder SetManual(bool boolean) /* MethodBuilder.Create */ 
						{
								return default(Builder);
						}
						...
						/// setExpedited
						/// </java-name>
						[Dot42.DexImport("setExpedited", "(Z)Landroid/content/SyncRequest$Builder;", AccessFlags = 1)]
						public virtual Builder SetExpedited(bool boolean) /* MethodBuilder.Create */ 
						{
								return default(Builder);
						}
						...
						/// build
						/// </java-name>
						[Dot42.DexImport("build", "()Landroid/content/SyncRequest;", AccessFlags = 1)]
						public virtual global::Android.Content.SyncRequest Build() /* MethodBuilder.Create */ 
						{
								return default(global::Android.Content.SyncRequest);
						}
 ...
 /* scope: __dot42__ */ 
    ...
    "ang/String;)Landroid/database/Cursor;", AccessFlags = 17)]
				...
				/// </java-name>
				[Dot42.DexImport("query", "(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/l" +
    "ang/String;Landroid/os/CancellationSignal;)Landroid/database/Cursor;", AccessFlags = 17)]
				public global::Android.Database.ICursor Query(global::Android.Net.Uri uri, string[] projection, string selection, string[] selectionArgs, string sortOrder, global::Android.Os.CancellationSignal cancellationSignal) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Database.ICursor);
				}
				...
				/// openFileDescriptor
				/// </java-name>
				[Dot42.DexImport("openFileDescriptor", "(Landroid/net/Uri;Ljava/lang/String;Landroid/os/CancellationSignal;)Landroid/os/P" +
    "arcelFileDescriptor;", AccessFlags = 17)]
				public global::Android.Os.ParcelFileDescriptor OpenFileDescriptor(global::Android.Net.Uri uri, string @string, global::Android.Os.CancellationSignal cancellationSignal) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Os.ParcelFileDescriptor);
				}
				...
				/// openAssetFileDescriptor
				/// </java-name>
				[Dot42.DexImport("openAssetFileDescriptor", "(Landroid/net/Uri;Ljava/lang/String;Landroid/os/CancellationSignal;)Landroid/cont" +
    "ent/res/AssetFileDescriptor;", AccessFlags = 17)]
				public global::Android.Content.Res.AssetFileDescriptor OpenAssetFileDescriptor(global::Android.Net.Uri uri, string @string, global::Android.Os.CancellationSignal cancellationSignal) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Content.Res.AssetFileDescriptor);
				}
    ...
    "d/os/Bundle;", AccessFlags = 17)]
				...
				/// acquireUnstableContentProviderClient
				/// </java-name>
				[Dot42.DexImport("acquireUnstableContentProviderClient", "(Ljava/lang/String;)Landroid/content/ContentProviderClient;", AccessFlags = 17)]
				public global::Android.Content.ContentProviderClient AcquireUnstableContentProviderClient(string uri) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Content.ContentProviderClient);
				}
				...
				/// </java-name>
				[Dot42.DexImport("takePersistableUriPermission", "(Landroid/net/Uri;I)V", AccessFlags = 1)]
				public virtual void TakePersistableUriPermission(global::Android.Net.Uri uri, int int32) /* MethodBuilder.Create */ 
				{
				}
				...
				/// </java-name>
				[Dot42.DexImport("releasePersistableUriPermission", "(Landroid/net/Uri;I)V", AccessFlags = 1)]
				public virtual void ReleasePersistableUriPermission(global::Android.Net.Uri uri, int int32) /* MethodBuilder.Create */ 
				{
				}
				...
				/// </java-name>
				[Dot42.DexImport("getPersistedUriPermissions", "()Ljava/util/List;", AccessFlags = 1, Signature = "()Ljava/util/List<Landroid/content/UriPermission;>;")]
				public virtual global::Java.Util.IList<global::Android.Content.UriPermission> GetPersistedUriPermissions() /* MethodBuilder.Create */ 
				{
						return default(global::Java.Util.IList<global::Android.Content.UriPermission>);
				}

				/// <java-name>
				/// getOutgoingPersistedUriPermissions
				/// </java-name>
				[Dot42.DexImport("getOutgoingPersistedUriPermissions", "()Ljava/util/List;", AccessFlags = 1, Signature = "()Ljava/util/List<Landroid/content/UriPermission;>;")]
				public virtual global::Java.Util.IList<global::Android.Content.UriPermission> GetOutgoingPersistedUriPermissions() /* MethodBuilder.Create */ 
				{
						return default(global::Java.Util.IList<global::Android.Content.UriPermission>);
				}

				/// <summary>
				/// <para>Start an asynchronous sync operation. If you want to monitor the progress of the sync you may register a SyncObserver. Only values of the following types may be used in the extras bundle: <ul><li><para>Integer </para></li><li><para>Long </para></li><li><para>Boolean </para></li><li><para>Float </para></li><li><para>Double </para></li><li><para>String </para></li></ul></para><para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>instead use requestSync(android.accounts.Account, String, android.os.Bundle) </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <java-name>
				/// startSync
				/// </java-name>
				...
				/// <summary>
				/// <para>Start an asynchronous sync operation. If you want to monitor the progress of the sync you may register a SyncObserver. Only values of the following types may be used in the extras bundle: <ul><li><para>Integer </para></li><li><para>Long </para></li><li><para>Boolean </para></li><li><para>Float </para></li><li><para>Double </para></li><li><para>String </para></li></ul></para><para></para>        
				/// </summary>
				/// <java-name>
				/// requestSync
				/// </java-name>
				...
				/// requestSync
				/// </java-name>
				[Dot42.DexImport("requestSync", "(Landroid/content/SyncRequest;)V", AccessFlags = 9)]
				public static void RequestSync(global::Android.Content.SyncRequest syncRequest) /* MethodBuilder.Create */ 
				{
				}
    ...
    "riodicSync;>;")]
				...
				/// <summary>
				/// <para>Sets the master auto-sync setting that applies to all the providers and accounts. If this is false then the per-provider auto-sync setting is ignored. </para><para>This method requires the caller to hold the permission android.Manifest.permission#WRITE_SYNC_SETTINGS.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setMasterSyncAutomatically
				/// </java-name>
				[Dot42.DexImport("setMasterSyncAutomatically", "(Z)V", AccessFlags = 9)]
				public static void SetMasterSyncAutomatically(bool sync) /* MethodBuilder.Create */ 
				{
				}
				...
				/// getPersistedUriPermissions
				/// </java-name>
				public global::Java.Util.IList<global::Android.Content.UriPermission> PersistedUriPermissions
				{
				[Dot42.DexImport("getPersistedUriPermissions", "()Ljava/util/List;", AccessFlags = 1, Signature = "()Ljava/util/List<Landroid/content/UriPermission;>;")]
						get{ return GetPersistedUriPermissions(); }
				}

				/// <java-name>
				/// getOutgoingPersistedUriPermissions
				/// </java-name>
				public global::Java.Util.IList<global::Android.Content.UriPermission> OutgoingPersistedUriPermissions
				{
				[Dot42.DexImport("getOutgoingPersistedUriPermissions", "()Ljava/util/List;", AccessFlags = 1, Signature = "()Ljava/util/List<Landroid/content/UriPermission;>;")]
						get{ return GetOutgoingPersistedUriPermissions(); }
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// getCallingPackage
				/// </java-name>
				[Dot42.DexImport("getCallingPackage", "()Ljava/lang/String;", AccessFlags = 17)]
				public string GetCallingPackage() /* MethodBuilder.Create */ 
				{
						return default(string);
				}
				...
				/// <summary>
				/// <para><para>This is called when the overall system is running low on memory, and would like actively running process to try to tighten their belt. While the exact point at which this will be called is not defined, generally it will happen around the time all background process have been killed, that is before reaching the point of killing processes hosting service and foreground UI that we would like to avoid killing.</para><para>Applications that want to be nice can implement this method to release any caches or other unnecessary resources they may be holding on to. The system will perform a gc for you after returning from this method.</para> This method is always called on the application main thread, and must not perform lengthy operations.</para><para>The default content provider implementation does nothing. Subclasses may override this method to take appropriate action. </para>        
				/// </summary>
				/// <java-name>
				/// onLowMemory
				/// </java-name>
    ...
    "ang/String;)Landroid/database/Cursor;", AccessFlags = 1025)]
				...
				/// <summary>
				/// <para><span>   Implement this to handle query requests from clients with support for cancellation.   This method can be called from multiple threads, as described in   &lt;a href="{@docRoot}guide/topics/fundamentals/processes-and-threads.html#Threads"&gt;Processes   and Threads&lt;/a&gt;.   &lt;p&gt;   Example client call:&lt;p&gt;   &lt;pre&gt;// Request a specific record.   Cursor managedCursor = managedQuery(            ContentUris.withAppendedId(Contacts.People.CONTENT_URI, 2),            projection,    // Which columns to return.            null,          // WHERE clause.            null,          // WHERE clause value substitution            People.NAME + " ASC");   // Sort order.&lt;/pre&gt;   Example implementation:&lt;p&gt;   &lt;pre&gt;// SQLiteQueryBuilder is a helper class that creates the</span> proper SQL syntax for us. SQLiteQueryBuilder qBuilder = new SQLiteQueryBuilder();</para><para>Set the table we're querying. qBuilder.setTables(DATABASE_TABLE_NAME);</para><para>If the query ends in a specific record number, we're being asked for a specific record, so set the WHERE clause in our query. if((URI_MATCHER.match(uri)) == SPECIFIC_MESSAGE){ qBuilder.appendWhere("_id=" + uri.getPathLeafId()); }</para><para>Make the query. Cursor c = qBuilder.query(mDb, projection, selection, selectionArgs, groupBy, having, sortOrder); c.setNotificationUri(getContext().getContentResolver(), uri); return c; </para><para>If you implement this method then you must also implement the version of query(Uri, String[], String, String[], String) that does not take a cancellation signal to ensure correct operation on older versions of the Android Framework in which the cancellation signal overload was not available.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>a Cursor or <c> null </c> . </para>
				/// </returns>
				...
				[Dot42.DexImport("query", "(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/l" +
    "ang/String;Landroid/os/CancellationSignal;)Landroid/database/Cursor;", AccessFlags = 1)]
				public virtual global::Android.Database.ICursor Query(global::Android.Net.Uri uri, string[] projection, string selection, string[] selectionArgs, string sortOrder, global::Android.Os.CancellationSignal cancellationSignal) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Database.ICursor);
				}
				...
				/// canonicalize
				/// </java-name>
				[Dot42.DexImport("canonicalize", "(Landroid/net/Uri;)Landroid/net/Uri;", AccessFlags = 1)]
				public virtual global::Android.Net.Uri Canonicalize(global::Android.Net.Uri uri) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Net.Uri);
				}
				...
				/// uncanonicalize
				/// </java-name>
				[Dot42.DexImport("uncanonicalize", "(Landroid/net/Uri;)Landroid/net/Uri;", AccessFlags = 1)]
				public virtual global::Android.Net.Uri Uncanonicalize(global::Android.Net.Uri uri) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Net.Uri);
				}
    ...
    "gnal;)Landroid/content/res/AssetFileDescriptor;", AccessFlags = 1)]
				public virtual global::Android.Content.Res.AssetFileDescriptor OpenTypedAssetFile(global::Android.Net.Uri uri, string @string, global::Android.Os.Bundle bundle, global::Android.Os.CancellationSignal cancellationSignal) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Content.Res.AssetFileDescriptor);
				}
    ...
    "ent/ContentProviderResult;")]
				...
				/// <summary>
				/// <para>Print the Provider's state into the given stream. This gets invoked if you run "adb shell dumpsys activity provider &amp;lt;provider_component_name&amp;gt;".</para><para></para>        
				/// </summary>
				/// <java-name>
				/// dump
				/// </java-name>
				[Dot42.DexImport("dump", "(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V", AccessFlags = 1)]
				public virtual void Dump(global::Java.Io.FileDescriptor fd, global::Java.Io.PrintWriter writer, string[] args) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>The part of a match constant that describes the category of match that occurred. May be either MATCH_CATEGORY_EMPTY, MATCH_CATEGORY_SCHEME, MATCH_CATEGORY_HOST, MATCH_CATEGORY_PORT, MATCH_CATEGORY_PATH, or MATCH_CATEGORY_TYPE. Higher values indicate a better match. </para>        
				/// </summary>
				/// <java-name>
				/// MATCH_CATEGORY_MASK
				/// </java-name>
				...
				/// </java-name>
				[Dot42.DexImport("MATCH_CATEGORY_SCHEME_SPECIFIC_PART", "I", AccessFlags = 25)]
				public const int MATCH_CATEGORY_SCHEME_SPECIFIC_PART = 5767168;
				/// <summary>
				...
				/// <summary>
				/// <para>Modify priority of this filter. The default priority is 0. Positive values will be before the default, lower values will be after it. Applications must use a value that is larger than SYSTEM_LOW_PRIORITY and smaller than SYSTEM_HIGH_PRIORITY .</para><para><para>getPriority </para><simplesectsep></simplesectsep><para>SYSTEM_LOW_PRIORITY </para><simplesectsep></simplesectsep><para>SYSTEM_HIGH_PRIORITY </para></para>        
				/// </summary>
				/// <java-name>
				/// setPriority
				/// </java-name>
				...
				/// </java-name>
				[Dot42.DexImport("addDataSchemeSpecificPart", "(Ljava/lang/String;I)V", AccessFlags = 17)]
				public void AddDataSchemeSpecificPart(string @string, int int32) /* MethodBuilder.Create */ 
				{
				}
				...
				/// </java-name>
				[Dot42.DexImport("countDataSchemeSpecificParts", "()I", AccessFlags = 17)]
				public int CountDataSchemeSpecificParts() /* MethodBuilder.Create */ 
				{
						return default(int);
				}
				...
				/// </java-name>
				[Dot42.DexImport("getDataSchemeSpecificPart", "(I)Landroid/os/PatternMatcher;", AccessFlags = 17)]
				public global::Android.Os.PatternMatcher GetDataSchemeSpecificPart(int int32) /* MethodBuilder.Create */ 
				{
				...
				/// </java-name>
				[Dot42.DexImport("hasDataSchemeSpecificPart", "(Ljava/lang/String;)Z", AccessFlags = 17)]
				public bool HasDataSchemeSpecificPart(string @string) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				/// </summary>
				/// <returns>
				/// <para>Returns either a valid match constant (a combination of MATCH_CATEGORY_MASK and MATCH_ADJUSTMENT_MASK), or one of the error codes NO_MATCH_TYPE if the type didn't match, NO_MATCH_DATA if the scheme/path didn't match, if the action didn't match, or  #NO_MATCH_CATEGORY if one or more categories didn't match.</para><simplesectsep></simplesectsep><para>How well the filter matches. Negative if it doesn't match, zero or positive positive value if it does with a higher value representing a better match.</para>
				/// </returns>
				/// <java-name>
				/// match
				/// </java-name>
				...
				/// <summary>
				/// <para>Test whether this filter matches the given intent data. A match is only successful if the actions and categories in the Intent match against the filter, as described in IntentFilter; in that case, the match result returned will be as per matchData.</para><para><para>matchData </para><simplesectsep></simplesectsep><para>Intent::getAction </para><simplesectsep></simplesectsep><para>Intent::resolveType </para><simplesectsep></simplesectsep><para>Intent::getScheme </para><simplesectsep></simplesectsep><para>Intent::getData </para><simplesectsep></simplesectsep><para>Intent::getCategories </para></para>        
				/// </summary>
				/// <returns>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Create a new clip that is a copy of another clip. This does a deep-copy of all items in the clip.</para><para></para>        
				/// </summary>
				[Dot42.DexImport("<init>", "(Landroid/content/ClipData;)V", AccessFlags = 1)]
				public ClipData(global::Android.Content.ClipData other) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Create a new ClipData holding data of the type ClipDescription#MIMETYPE_TEXT_HTML.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>Returns a new ClipData containing the specified data. </para>
				/// </returns>
				...
				/// newHtmlText
				/// </java-name>
				[Dot42.DexImport("newHtmlText", "(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/String;)Landroid/cont" +
    "ent/ClipData;", AccessFlags = 9)]
				public static global::Android.Content.ClipData NewHtmlText(global::Java.Lang.ICharSequence label, global::Java.Lang.ICharSequence text, string htmlText) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Content.ClipData);
				}
 ...
 /* scope: __dot42__ */ 
				{
						...
						[Dot42.DexImport("<init>", "(Ljava/lang/CharSequence;Ljava/lang/String;)V", AccessFlags = 1)]
						public Item(global::Java.Lang.ICharSequence charSequence, string @string) /* MethodBuilder.Create */ 
						{
						}
						...
						[Dot42.DexImport("<init>", "(Ljava/lang/CharSequence;Ljava/lang/String;Landroid/content/Intent;Landroid/net/U" +
    "ri;)V", AccessFlags = 1)]
						public Item(global::Java.Lang.ICharSequence charSequence, string @string, global::Android.Content.Intent intent, global::Android.Net.Uri uri) /* MethodBuilder.Create */ 
						{
						}
						...
						/// <summary>
						/// <para>Retrieve the raw HTML text contained in this Item. </para>        
						/// </summary>
						/// <java-name>
						/// getHtmlText
						/// </java-name>
						[Dot42.DexImport("getHtmlText", "()Ljava/lang/String;", AccessFlags = 1)]
						public virtual string GetHtmlText() /* MethodBuilder.Create */ 
						{
								return default(string);
						}
						...
						/// <summary>
						/// <para>Like coerceToHtmlText(Context), but any text that would be returned as HTML formatting will be returned as text with style spans. </para>        
						/// </summary>
						/// <returns>
						/// <para>Returns the item's textual representation. </para>
						/// </returns>
						...
						/// coerceToStyledText
						/// </java-name>
						[Dot42.DexImport("coerceToStyledText", "(Landroid/content/Context;)Ljava/lang/CharSequence;", AccessFlags = 1)]
						public virtual global::Java.Lang.ICharSequence CoerceToStyledText(global::Android.Content.Context context) /* MethodBuilder.Create */ 
						{
								return default(global::Java.Lang.ICharSequence);
						}

						/// <summary>
						/// <para>Turn this item into HTML text, regardless of the type of data it actually contains.</para><para>The algorithm for deciding what text to return is: <ul><li><para>If getHtmlText is non-null, return that. </para></li><li><para>If getText is non-null, return that, converting to valid HTML text. If this text contains style spans, Html.toHtml(Spanned) is used to convert them to HTML formatting. </para></li><li><para>If getUri is non-null, try to retrieve its data as a text stream from its content provider. If the provider can supply text/html data, that will be preferred and returned as-is. Otherwise, any text/* data will be returned and escaped to HTML. If it is not a content: URI or the content provider does not supply a text representation, HTML text containing a link to the URI will be returned. </para></li><li><para>If getIntent is non-null, convert that to an intent: URI and return as an HTML link. </para></li><li><para>Otherwise, return an empty string. </para></li></ul></para><para></para>        
						/// </summary>
						/// <returns>
						/// <para>Returns the item's representation as HTML text. </para>
						/// </returns>
						/// <java-name>
						/// coerceToHtmlText
						/// </java-name>
						[Dot42.DexImport("coerceToHtmlText", "(Landroid/content/Context;)Ljava/lang/String;", AccessFlags = 1)]
						public virtual string CoerceToHtmlText(global::Android.Content.Context context) /* MethodBuilder.Create */ 
						{
								return default(string);
						}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Informs the registered OnLoadCanceledListener that the load has been canceled. Should only be called by subclasses.</para><para>Must be called from the process's main thread. </para>        
				/// </summary>
				/// <java-name>
				/// deliverCancellation
				/// </java-name>
				[Dot42.DexImport("deliverCancellation", "()V", AccessFlags = 1)]
				public virtual void DeliverCancellation() /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Registers a listener that will receive callbacks when a load is canceled. The callback will be called on the process's main thread so it's safe to pass the results to widgets.</para><para>Must be called from the process's main thread.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// registerOnLoadCanceledListener
				/// </java-name>
				[Dot42.DexImport("registerOnLoadCanceledListener", "(Landroid/content/Loader$OnLoadCanceledListener;)V", AccessFlags = 1, Signature = "(Landroid/content/Loader$OnLoadCanceledListener<TD;>;)V")]
				public virtual void RegisterOnLoadCanceledListener(global::Android.Content.Loader<D>.IOnLoadCanceledListener<D> listener) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Unregisters a listener that was previously added with registerOnLoadCanceledListener.</para><para>Must be called from the process's main thread.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// unregisterOnLoadCanceledListener
				/// </java-name>
				[Dot42.DexImport("unregisterOnLoadCanceledListener", "(Landroid/content/Loader$OnLoadCanceledListener;)V", AccessFlags = 1, Signature = "(Landroid/content/Loader$OnLoadCanceledListener<TD;>;)V")]
				public virtual void UnregisterOnLoadCanceledListener(global::Android.Content.Loader<D>.IOnLoadCanceledListener<D> listener) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Attempt to cancel the current load task. Must be called on the main thread of the process.</para><para>Cancellation is not an immediate operation, since the load is performed in a background thread. If there is currently a load in progress, this method requests that the load be canceled, and notes this is the case; once the background thread has completed its work its remaining state will be cleared. If another load request comes in during this time, it will be held until the canceled load is complete.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>Returns <code>false</code> if the task could not be canceled, typically because it has already completed normally, or because startLoading() hasn't been called; returns <code>true</code> otherwise. When <code>true</code> is returned, the task is still running and the OnLoadCanceledListener will be called when the task completes. </para>
				/// </returns>
				/// <java-name>
				/// cancelLoad
				/// </java-name>
				...
				/// <summary>
				/// <para>Subclasses must implement this to take care of requests to cancelLoad(). This will always be called from the process's main thread.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>Returns <code>false</code> if the task could not be canceled, typically because it has already completed normally, or because startLoading() hasn't been called; returns <code>true</code> otherwise. When <code>true</code> is returned, the task is still running and the OnLoadCanceledListener will be called when the task completes. </para>
				/// </returns>
				...
				/// onCancelLoad
				/// </java-name>
				[Dot42.DexImport("onCancelLoad", "()Z", AccessFlags = 4)]
				protected internal virtual bool OnCancelLoad() /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				/// <summary>
				/// <para>Commit that you have actually fully processed a content change that was returned by takeContentChanged. This is for use with rollbackContentChanged() to handle situations where a load is cancelled. Call this when you have completely processed a load without it being cancelled. </para>        
				/// </summary>
				/// <java-name>
				/// commitContentChanged
				/// </java-name>
				[Dot42.DexImport("commitContentChanged", "()V", AccessFlags = 1)]
				public virtual void CommitContentChanged() /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Report that you have abandoned the processing of a content change that was returned by takeContentChanged() and would like to rollback to the state where there is again a pending content change. This is to handle the case where a data load due to a content change has been canceled before its data was delivered back to the loader. </para>        
				/// </summary>
				/// <java-name>
				/// rollbackContentChanged
				/// </java-name>
				[Dot42.DexImport("rollbackContentChanged", "()V", AccessFlags = 1)]
				public virtual void RollbackContentChanged() /* MethodBuilder.Create */ 
				{
				}
    ...
    "g;)V", AccessFlags = 1)]
				...
				/// </java-name>
				[Dot42.DexImport("android/content/Loader$OnLoadCanceledListener", AccessFlags = 1545, Signature = "<D:Ljava/lang/Object;>Ljava/lang/Object;")]
				public partial interface IOnLoadCanceledListener<D>
 /* scope: __dot42__ */ 
				{
						/// <java-name>
						/// onLoadCanceled
						/// </java-name>
						[Dot42.DexImport("onLoadCanceled", "(Landroid/content/Loader;)V", AccessFlags = 1025, Signature = "(Landroid/content/Loader<TD;>;)V")]
						void OnLoadCanceled(global::Android.Content.Loader<D> loader) /* MethodBuilder.Create */ ;
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Used to indicate that the SyncAdapter experienced a hard error due to an error it received from interacting with the storage later. The SyncManager will record that the sync request failed and it will not reschedule the request. </para>        
				/// </summary>
				/// <java-name>
				/// databaseError
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				bool OnKey(global::Android.Content.IDialogInterface dialog, int keyCode, global::Android.View.KeyEvent @event) /* MethodBuilder.Create */ ;
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// </java-name>
				[Dot42.DexImport("onCancelLoad", "()Z", AccessFlags = 4)]
				protected internal override bool OnCancelLoad() /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				/// <summary>
				/// <para>Called on the main thread to abort a load in progress.</para><para>Override this method to abort the current invocation of loadInBackground that is running in the background on a worker thread.</para><para>This method should do nothing if loadInBackground has not started running or if it has already finished.</para><para><para>loadInBackground </para></para>        
				/// </summary>
				/// <java-name>
				/// cancelLoadInBackground
				/// </java-name>
				[Dot42.DexImport("cancelLoadInBackground", "()V", AccessFlags = 1)]
				public virtual void CancelLoadInBackground() /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Returns true if the current invocation of loadInBackground is being canceled.</para><para><para>loadInBackground </para></para>        
				/// </summary>
				/// <returns>
				/// <para>True if the current invocation of loadInBackground is being canceled.</para>
				/// </returns>
				/// <java-name>
				/// isLoadInBackgroundCanceled
				/// </java-name>
				[Dot42.DexImport("isLoadInBackgroundCanceled", "()Z", AccessFlags = 1)]
				public virtual bool IsLoadInBackgroundCanceled() /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// getExternalFilesDirs
				/// </java-name>
				[Dot42.DexImport("getExternalFilesDirs", "(Ljava/lang/String;)[Ljava/io/File;", AccessFlags = 1)]
				public override global::Java.Io.File[] GetExternalFilesDirs(string @string) /* MethodBuilder.Create */ 
				{
						return default(global::Java.Io.File[]);
				}
				...
				/// getObbDirs
				/// </java-name>
				[Dot42.DexImport("getObbDirs", "()[Ljava/io/File;", AccessFlags = 1)]
				public override global::Java.Io.File[] GetObbDirs() /* MethodBuilder.Create */ 
				{
						return default(global::Java.Io.File[]);
				}
				...
				/// getExternalCacheDirs
				/// </java-name>
				[Dot42.DexImport("getExternalCacheDirs", "()[Ljava/io/File;", AccessFlags = 1)]
				public override global::Java.Io.File[] GetExternalCacheDirs() /* MethodBuilder.Create */ 
				{
						return default(global::Java.Io.File[]);
				}
    ...
    "droid/os/Handler;ILjava/lang/String;Landroid/os/Bundle;)V", AccessFlags = 1)]
				...
				/// sendBroadcastAsUser
				/// </java-name>
				[Dot42.DexImport("sendBroadcastAsUser", "(Landroid/content/Intent;Landroid/os/UserHandle;)V", AccessFlags = 1)]
				public override void SendBroadcastAsUser(global::Android.Content.Intent intent, global::Android.Os.UserHandle user) /* MethodBuilder.Create */ 
				{
				}
				...
				/// sendBroadcastAsUser
				/// </java-name>
				[Dot42.DexImport("sendBroadcastAsUser", "(Landroid/content/Intent;Landroid/os/UserHandle;Ljava/lang/String;)V", AccessFlags = 1)]
				public override void SendBroadcastAsUser(global::Android.Content.Intent intent, global::Android.Os.UserHandle user, string receiverPermission) /* MethodBuilder.Create */ 
				{
				}
    ...
    "t/BroadcastReceiver;Landroid/os/Handler;ILjava/lang/String;Landroid/os/Bundle;)V" +
    "", AccessFlags = 1)]
				public override void SendOrderedBroadcastAsUser(global::Android.Content.Intent intent, global::Android.Os.UserHandle user, string receiverPermission, global::Android.Content.BroadcastReceiver resultReceiver, global::Android.Os.Handler scheduler, int initialCode, string initialData, global::Android.Os.Bundle initialExtras) /* MethodBuilder.Create */ 
				{
				}
    ...
    "Ljava/lang/String;Landroid/os/Bundle;)V", AccessFlags = 1)]
				...
				/// sendStickyBroadcastAsUser
				/// </java-name>
				[Dot42.DexImport("sendStickyBroadcastAsUser", "(Landroid/content/Intent;Landroid/os/UserHandle;)V", AccessFlags = 1)]
				public override void SendStickyBroadcastAsUser(global::Android.Content.Intent intent, global::Android.Os.UserHandle user) /* MethodBuilder.Create */ 
				{
				}
				...
				/// </java-name>
				[Dot42.DexImport("sendStickyOrderedBroadcastAsUser", "(Landroid/content/Intent;Landroid/os/UserHandle;Landroid/content/BroadcastReceive" +
    "r;Landroid/os/Handler;ILjava/lang/String;Landroid/os/Bundle;)V", AccessFlags = 1)]
				public override void SendStickyOrderedBroadcastAsUser(global::Android.Content.Intent intent, global::Android.Os.UserHandle user, global::Android.Content.BroadcastReceiver resultReceiver, global::Android.Os.Handler scheduler, int initialCode, string initialData, global::Android.Os.Bundle initialExtras) /* MethodBuilder.Create */ 
				{
				}
				...
				/// removeStickyBroadcastAsUser
				/// </java-name>
				[Dot42.DexImport("removeStickyBroadcastAsUser", "(Landroid/content/Intent;Landroid/os/UserHandle;)V", AccessFlags = 1)]
				public override void RemoveStickyBroadcastAsUser(global::Android.Content.Intent intent, global::Android.Os.UserHandle user) /* MethodBuilder.Create */ 
				{
				}
    ...
    "ng;Landroid/os/Handler;)Landroid/content/Intent;", AccessFlags = 1)]
				...
				/// createConfigurationContext
				/// </java-name>
				[Dot42.DexImport("createConfigurationContext", "(Landroid/content/res/Configuration;)Landroid/content/Context;", AccessFlags = 1)]
				public override global::Android.Content.Context CreateConfigurationContext(global::Android.Content.Res.Configuration overrideConfiguration) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Content.Context);
				}
				...
				/// createDisplayContext
				/// </java-name>
				[Dot42.DexImport("createDisplayContext", "(Landroid/view/Display;)Landroid/content/Context;", AccessFlags = 1)]
				public override global::Android.Content.Context CreateDisplayContext(global::Android.View.Display display) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Content.Context);
				}
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para>Applications can expose restrictions for a restricted user on a multiuser device. The administrator can configure these restrictions that will then be applied to the restricted user. Each RestrictionsEntry is one configurable restriction. </para><para>Any application that chooses to expose such restrictions does so by implementing a receiver that handles the Intent#ACTION_GET_RESTRICTION_ENTRIES action. The receiver then returns a result bundle that contains an entry called "restrictions", whose value is an ArrayList&lt;RestrictionsEntry&gt;. </para>    
		/// </summary>
		/// <java-name>
		/// android/content/RestrictionEntry
		/// </java-name>
		[Dot42.DexImport("android/content/RestrictionEntry", AccessFlags = 33)]
		public partial class RestrictionEntry : global::Android.Os.IParcelable
 /* scope: __dot42__ */ 
		{
				/// <summary>
				/// <para>A type of restriction. Use this type for information that needs to be transferred across but shouldn't be presented to the user in the UI. Stores a single String value. </para>        
				/// </summary>
				/// <java-name>
				/// TYPE_NULL
				/// </java-name>
				...
				/// <summary>
				/// <para>A type of restriction. Use this for storing a boolean value, typically presented as a checkbox in the UI. </para>        
				/// </summary>
				/// <java-name>
				/// TYPE_BOOLEAN
				/// </java-name>
				[Dot42.DexImport("TYPE_BOOLEAN", "I", AccessFlags = 25)]
				public const int TYPE_BOOLEAN = 1;
				/// <summary>
				/// <para>A type of restriction. Use this for storing a string value, typically presented as a single-select list. Call setChoiceEntries(String[]) and setChoiceValues(String[]) to set the localized list entries to present to the user and the corresponding values, respectively. </para>        
				/// </summary>
				/// <java-name>
				/// TYPE_CHOICE
				/// </java-name>
				[Dot42.DexImport("TYPE_CHOICE", "I", AccessFlags = 25)]
				public const int TYPE_CHOICE = 2;
				/// <summary>
				/// <para>A type of restriction. Use this for presenting a multi-select list where more than one entry can be selected, such as for choosing specific titles to white-list. Call setChoiceEntries(String[]) and setChoiceValues(String[]) to set the localized list entries to present to the user and the corresponding values, respectively. Use getAllSelectedStrings() and setAllSelectedStrings(String[]) to manipulate the selections. </para>        
				/// </summary>
				/// <java-name>
				/// TYPE_MULTI_SELECT
				/// </java-name>
				[Dot42.DexImport("TYPE_MULTI_SELECT", "I", AccessFlags = 25)]
				public const int TYPE_MULTI_SELECT = 4;
				/// <java-name>
				/// CREATOR
				/// </java-name>
				[Dot42.DexImport("CREATOR", "Landroid/os/Parcelable$Creator;", AccessFlags = 25)]
				public static readonly global::Android.Os.IParcelable_ICreator<global::Android.Content.RestrictionEntry> CREATOR;
				[Dot42.DexImport("<init>", "(Ljava/lang/String;Ljava/lang/String;)V", AccessFlags = 1)]
				public RestrictionEntry(string @string, string string1) /* MethodBuilder.Create */ 
				{
				}

				[Dot42.DexImport("<init>", "(Ljava/lang/String;Z)V", AccessFlags = 1)]
				public RestrictionEntry(string @string, bool boolean) /* MethodBuilder.Create */ 
				{
				}
				...
				[Dot42.DexImport("<init>", "(Landroid/os/Parcel;)V", AccessFlags = 1)]
				public RestrictionEntry(global::Android.Os.Parcel @in) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Sets the type for this restriction. </para>        
				/// </summary>
				/// <java-name>
				/// setType
				/// </java-name>
				...
				/// <summary>
				/// <para>Returns the type for this restriction. </para>        
				/// </summary>
				/// <returns>
				/// <para>the type for this restriction </para>
				/// </returns>
				/// <java-name>
				/// getType
				/// </java-name>
				...
				/// <summary>
				/// <para>Returns the currently selected string value. </para>        
				/// </summary>
				/// <returns>
				/// <para>the currently selected value, which can be null for types that aren't for holding single string values. </para>
				/// </returns>
				/// <java-name>
				/// getSelectedString
				/// </java-name>
				[Dot42.DexImport("getSelectedString", "()Ljava/lang/String;", AccessFlags = 1)]
				public virtual string GetSelectedString() /* MethodBuilder.Create */ 
				{
						return default(string);
				}

				/// <summary>
				/// <para>Returns the list of currently selected values. </para>        
				/// </summary>
				/// <returns>
				/// <para>the list of current selections, if type is TYPE_MULTI_SELECT, null otherwise. </para>
				/// </returns>
				/// <java-name>
				/// getAllSelectedStrings
				/// </java-name>
				[Dot42.DexImport("getAllSelectedStrings", "()[Ljava/lang/String;", AccessFlags = 1)]
				public virtual string[] GetAllSelectedStrings() /* MethodBuilder.Create */ 
				{
						return default(string[]);
				}

				/// <summary>
				/// <para>Returns the current selected state for an entry of type TYPE_BOOLEAN. </para>        
				/// </summary>
				/// <returns>
				/// <para>the current selected state of the entry. </para>
				/// </returns>
				/// <java-name>
				/// getSelectedState
				/// </java-name>
				[Dot42.DexImport("getSelectedState", "()Z", AccessFlags = 1)]
				public virtual bool GetSelectedState() /* MethodBuilder.Create */ 
				{
						return default(bool);
				}

				/// <summary>
				/// <para>Sets the string value to use as the selected value for this restriction. This value will be persisted by the system for later use by the application. </para>        
				/// </summary>
				/// <java-name>
				/// setSelectedString
				/// </java-name>
				[Dot42.DexImport("setSelectedString", "(Ljava/lang/String;)V", AccessFlags = 1)]
				public virtual void SetSelectedString(string selectedString) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Sets the current selected state for an entry of type TYPE_BOOLEAN. This value will be persisted by the system for later use by the application. </para>        
				/// </summary>
				/// <java-name>
				/// setSelectedState
				/// </java-name>
				[Dot42.DexImport("setSelectedState", "(Z)V", AccessFlags = 1)]
				public virtual void SetSelectedState(bool state) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Sets the current list of selected values for an entry of type TYPE_MULTI_SELECT. These values will be persisted by the system for later use by the application. </para>        
				/// </summary>
				/// <java-name>
				/// setAllSelectedStrings
				/// </java-name>
				[Dot42.DexImport("setAllSelectedStrings", "([Ljava/lang/String;)V", AccessFlags = 1)]
				public virtual void SetAllSelectedStrings(string[] allSelectedStrings) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Sets a list of string values that can be selected by the user. If no user-visible entries are set by a call to setChoiceEntries(String[]), these values will be the ones shown to the user. Values will be chosen from this list as the user's selection and the selected values can be retrieved by a call to getAllSelectedStrings(), or getSelectedString(), depending on whether it is a multi-select type or choice type. This method is not relevant for types other than TYPE_CHOICE, and TYPE_MULTI_SELECT. <para>getChoiceValues() </para><simplesectsep></simplesectsep><para>getAllSelectedStrings() </para></para>        
				/// </summary>
				/// <java-name>
				/// setChoiceValues
				/// </java-name>
				[Dot42.DexImport("setChoiceValues", "([Ljava/lang/String;)V", AccessFlags = 1)]
				public virtual void SetChoiceValues(string[] choiceValues) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Sets a list of string values that can be selected by the user, similar to setChoiceValues(String[]). <para>setChoiceValues(String[]) </para></para>        
				/// </summary>
				/// <java-name>
				/// setChoiceValues
				/// </java-name>
				[Dot42.DexImport("setChoiceValues", "(Landroid/content/Context;I)V", AccessFlags = 1)]
				public virtual void SetChoiceValues(global::Android.Content.Context context, int stringArrayResId) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Returns the list of possible string values set earlier. </para>        
				/// </summary>
				/// <returns>
				/// <para>the list of possible values. </para>
				/// </returns>
				/// <java-name>
				/// getChoiceValues
				/// </java-name>
				[Dot42.DexImport("getChoiceValues", "()[Ljava/lang/String;", AccessFlags = 1)]
				public virtual string[] GetChoiceValues() /* MethodBuilder.Create */ 
				{
						return default(string[]);
				}

				/// <summary>
				/// <para>Sets a list of strings that will be presented as choices to the user. When the user selects one or more of these choices, the corresponding value from the possible values are stored as the selected strings. The size of this array must match the size of the array set in setChoiceValues(String[]). This method is not relevant for types other than TYPE_CHOICE, and TYPE_MULTI_SELECT. <para>setChoiceValues(String[]) </para></para>        
				/// </summary>
				/// <java-name>
				/// setChoiceEntries
				/// </java-name>
				[Dot42.DexImport("setChoiceEntries", "([Ljava/lang/String;)V", AccessFlags = 1)]
				public virtual void SetChoiceEntries(string[] choiceEntries) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Sets a list of strings that will be presented as choices to the user. This is similar to setChoiceEntries(String[]). </para>        
				/// </summary>
				/// <java-name>
				/// setChoiceEntries
				/// </java-name>
				[Dot42.DexImport("setChoiceEntries", "(Landroid/content/Context;I)V", AccessFlags = 1)]
				public virtual void SetChoiceEntries(global::Android.Content.Context context, int stringArrayResId) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Returns the list of strings, set earlier, that will be presented as choices to the user. </para>        
				/// </summary>
				/// <returns>
				/// <para>the list of choices presented to the user. </para>
				/// </returns>
				/// <java-name>
				/// getChoiceEntries
				/// </java-name>
				[Dot42.DexImport("getChoiceEntries", "()[Ljava/lang/String;", AccessFlags = 1)]
				public virtual string[] GetChoiceEntries() /* MethodBuilder.Create */ 
				{
						return default(string[]);
				}

				/// <summary>
				/// <para>Returns the provided user-visible description of the entry, if any. </para>        
				/// </summary>
				/// <returns>
				/// <para>the user-visible description, null if none was set earlier. </para>
				/// </returns>
				/// <java-name>
				/// getDescription
				/// </java-name>
				...
				/// <summary>
				/// <para>Sets the user-visible description of the entry, as a possible sub-text for the title. You can use this to describe the entry in more detail or to display the current state of the restriction. </para>        
				/// </summary>
				/// <java-name>
				/// setDescription
				/// </java-name>
				...
				/// <summary>
				/// <para>This is the unique key for the restriction entry. </para>        
				/// </summary>
				/// <returns>
				/// <para>the key for the restriction. </para>
				/// </returns>
				/// <java-name>
				/// getKey
				/// </java-name>
				...
				/// <summary>
				/// <para>Returns the user-visible title for the entry, if any. </para>        
				/// </summary>
				/// <returns>
				/// <para>the user-visible title for the entry, null if none was set earlier. </para>
				/// </returns>
				/// <java-name>
				/// getTitle
				/// </java-name>
				...
				/// <summary>
				/// <para>Sets the user-visible title for the entry. </para>        
				/// </summary>
				/// <java-name>
				/// setTitle
				/// </java-name>
				[Dot42.DexImport("setTitle", "(Ljava/lang/String;)V", AccessFlags = 1)]
				public virtual void SetTitle(string title) /* MethodBuilder.Create */ 
				{
				}
				...
				[global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
				internal RestrictionEntry() /* TypeBuilder.AddDefaultConstructor */ 
				{
				}
				...
				/// getAllSelectedStrings
				/// </java-name>
				public string[] AllSelectedStrings
				{
				[Dot42.DexImport("getAllSelectedStrings", "()[Ljava/lang/String;", AccessFlags = 1)]
						get{ return GetAllSelectedStrings(); }
				[Dot42.DexImport("setAllSelectedStrings", "([Ljava/lang/String;)V", AccessFlags = 1)]
						set{ SetAllSelectedStrings(value); }
				}
				...
				{
				[Dot42.DexImport("getSelectedState", "()Z", AccessFlags = 1)]
						get{ return GetSelectedState(); }
				[Dot42.DexImport("setSelectedState", "(Z)V", AccessFlags = 1)]
						set{ SetSelectedState(value); }
				}
				...
				{
				[Dot42.DexImport("getChoiceValues", "()[Ljava/lang/String;", AccessFlags = 1)]
						get{ return GetChoiceValues(); }
				[Dot42.DexImport("setChoiceValues", "([Ljava/lang/String;)V", AccessFlags = 1)]
						set{ SetChoiceValues(value); }
				}
				...
				/// getChoiceEntries
				/// </java-name>
				public string[] ChoiceEntries
				{
				[Dot42.DexImport("getChoiceEntries", "()[Ljava/lang/String;", AccessFlags = 1)]
						get{ return GetChoiceEntries(); }
				[Dot42.DexImport("setChoiceEntries", "([Ljava/lang/String;)V", AccessFlags = 1)]
						set{ SetChoiceEntries(value); }
				}
