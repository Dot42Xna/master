...
//
// Original filename: Android.Os.cs
//
...
namespace Android.Os
{
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Power source is wireless. </para>        
				/// </summary>
				/// <java-name>
				/// BATTERY_PLUGGED_WIRELESS
				/// </java-name>
				[Dot42.DexImport("BATTERY_PLUGGED_WIRELESS", "I", AccessFlags = 25)]
				public const int BATTERY_PLUGGED_WIRELESS = 4;
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// myPid
				/// </java-name>
				[Dot42.DexImport("myPid", "()I", AccessFlags = 25)]
				...
				/// myTid
				/// </java-name>
				[Dot42.DexImport("myTid", "()I", AccessFlags = 25)]
				...
				/// myUid
				/// </java-name>
				[Dot42.DexImport("myUid", "()I", AccessFlags = 25)]
				...
				/// <summary>
				/// <para>Returns this process's user handle. This is the user the process is running under. It is distinct from myUid() in that a particular user will have multiple distinct apps running under it each with their own uid. </para>        
				/// </summary>
				/// <java-name>
				/// myUserHandle
				/// </java-name>
				[Dot42.DexImport("myUserHandle", "()Landroid/os/UserHandle;", AccessFlags = 25)]
				public static global::Android.Os.UserHandle MyUserHandle() /* MethodBuilder.Create */ 
				{
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Flatten a List containing String objects into the parcel, at the current dataPosition() and growing dataCapacity() if needed. They can later be retrieved with createStringArrayList or readStringList.</para><para><para>createStringArrayList </para><simplesectsep></simplesectsep><para>readStringList </para></para>        
				/// </summary>
				/// <java-name>
				/// writeStringList
				/// </java-name>
				...
				/// <summary>
				/// <para>Flatten a List containing IBinder objects into the parcel, at the current dataPosition() and growing dataCapacity() if needed. They can later be retrieved with createBinderArrayList or readBinderList.</para><para><para>createBinderArrayList </para><simplesectsep></simplesectsep><para>readBinderList </para></para>        
				/// </summary>
				/// <java-name>
				/// writeBinderList
				/// </java-name>
				...
				/// <summary>
				/// <para>Flatten a heterogeneous array containing a particular object type into the parcel, at the current dataPosition() and growing dataCapacity() if needed. The type of the objects in the array must be one that implements Parcelable. Unlike the writeParcelableArray method, however, only the raw data of the objects is written and not their type, so you must use readTypedArray with the correct corresponding Parcelable.Creator implementation to unmarshall them.</para><para><para>#readTypedArray </para><simplesectsep></simplesectsep><para>writeParcelableArray </para><simplesectsep></simplesectsep><para>Parcelable.Creator </para></para>        
				/// </summary>
				/// <java-name>
				/// writeTypedArray
				/// </java-name>
				...
				/// <summary>
				/// <para>Special function for writing information at the front of the Parcel indicating that no exception occurred.</para><para><para>writeException </para><simplesectsep></simplesectsep><para>readException </para></para>        
				/// </summary>
				/// <java-name>
				/// writeNoException
				/// </java-name>
				...
				/// <summary>
				/// <para>Special function for reading an exception result from the header of a parcel, to be used after receiving the result of a transaction. This will throw the exception for you if it had been written to the Parcel, otherwise return and let you read the normal result data from the Parcel.</para><para><para>writeException </para><simplesectsep></simplesectsep><para>writeNoException </para></para>        
				/// </summary>
				/// <java-name>
				/// readException
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
						{
								...
								/// <summary>
								/// <para>Detect when a <c> file:// </c> android.net.Uri is exposed beyond this app. The receiving app may not have access to the sent path. Instead, when sharing files between apps, <c> content:// </c> should be used with permission grants. </para>        
								/// </summary>
								/// <java-name>
								/// detectFileUriExposure
								/// </java-name>
								[Dot42.DexImport("detectFileUriExposure", "()Landroid/os/StrictMode$VmPolicy$Builder;", AccessFlags = 1)]
								public Builder DetectFileUriExposure() /* MethodBuilder.Create */ 
								{
										return default(Builder);
								}
 ...
 /* scope: __dot42__ */ 
				{
						...
						/// <summary>
						/// <para>Android 4.2: Moar jelly beans!</para><para>Applications targeting this or a later release will get these new changes in behavior:</para><para><ul><li><para>Content Providers: The default value of <c> android:exported </c> is now <c> false </c> . See  in the provider documentation for more details. </para></li><li><para>View.getLayoutDirection() can return different values than android.view.View#LAYOUT_DIRECTION_LTR based on the locale etc. </para></li><li><para>WebView.addJavascriptInterface requires explicit annotations on methods for them to be accessible from Javascript. </para></li></ul></para>        
						/// </summary>
						/// <java-name>
						/// JELLY_BEAN_MR1
						/// </java-name>
						[Dot42.DexImport("JELLY_BEAN_MR1", "I", AccessFlags = 25)]
						public const int JELLY_BEAN_MR1 = 17;
						/// <summary>
						/// <para>Android 4.3: Jelly Bean MR2, the revenge of the beans. </para>        
						/// </summary>
						/// <java-name>
						/// JELLY_BEAN_MR2
						/// </java-name>
						[Dot42.DexImport("JELLY_BEAN_MR2", "I", AccessFlags = 25)]
						public const int JELLY_BEAN_MR2 = 18;
						/// <java-name>
						/// KITKAT
						/// </java-name>
						[Dot42.DexImport("KITKAT", "I", AccessFlags = 25)]
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para>Writes trace events to the system trace buffer. These trace events can be collected and visualized using the Systrace tool.</para><para>This tracing mechanism is independent of the method tracing mechanism offered by Debug#startMethodTracing. In particular, it enables tracing of events that occur across multiple processes. </para>    
		/// </summary>
		/// <java-name>
		/// android/os/Trace
		/// </java-name>
		[Dot42.DexImport("android/os/Trace", AccessFlags = 49)]
		public sealed partial class Trace
 /* scope: __dot42__ */ 
		{
				[Dot42.DexImport("<init>", "()V", AccessFlags = 0)]
				internal Trace() /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Writes a trace message to indicate that a given section of code has begun. This call must be followed by a corresponding call to endSection() on the same thread.</para><para>At this time the vertical bar character '|', newline character '<br></br>', and null character '\0' are used internally by the tracing mechanism. If sectionName contains these characters they will be replaced with a space character in the trace.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// beginSection
				/// </java-name>
				[Dot42.DexImport("beginSection", "(Ljava/lang/String;)V", AccessFlags = 9)]
				public static void BeginSection(string sectionName) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Writes a trace message to indicate that a given section of code has ended. This call must be preceeded by a corresponding call to beginSection(String). Calling this method will mark the end of the most recently begun section of code, so care must be taken to ensure that beginSection / endSection pairs are properly nested and called from the same thread. </para>        
				/// </summary>
				/// <java-name>
				/// endSection
				/// </java-name>
				[Dot42.DexImport("endSection", "()V", AccessFlags = 9)]
				public static void EndSection() /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para><span>   Start method tracing with default log name and buffer size. See &lt;a</span> href="{@docRoot}guide/developing/tools/traceview.html"&gt;Traceview: A Graphical Log Viewer for information about reading these files. Call stopMethodTracing() to stop tracing. </para>        
				/// </summary>
				/// <java-name>
				/// startMethodTracing
				/// </java-name>
				...
				/// <summary>
				/// <para>Clears the global size of objects allocated. <para>#getGlobalAllocCountSize() </para></para>        
				/// </summary>
				/// <java-name>
				...
				///           [... do lots of stuff ...]
				///          if (icount.collect()) {
				///              System.out.println("Total instructions executed: "<ul>
				/// <li><para>icount.globalTotal());
				///              System.out.println("Method invocations: "</para></li><li><para>icount.globalMethodInvocations());
				///          }
				///        
				/// </para></li></ul>
				/// </pre></para>    
 ...
 /* scope: __dot42__ */ 
				{
						/// <summary>
						/// <para>The proportional set size for dalvik. </para>        
						/// </summary>
						/// <java-name>
						/// dalvikPss
						/// </java-name>
						...
						/// <summary>
						/// <para>The private dirty pages used by dalvik. </para>        
						/// </summary>
						/// <java-name>
						/// dalvikPrivateDirty
						/// </java-name>
						...
						/// <summary>
						/// <para>The shared dirty pages used by dalvik. </para>        
						/// </summary>
						/// <java-name>
						/// dalvikSharedDirty
						/// </java-name>
						...
						/// </java-name>
						[Dot42.DexImport("getTotalSwappablePss", "()I", AccessFlags = 1)]
						public virtual int GetTotalSwappablePss() /* MethodBuilder.Create */ 
						{
								return default(int);
						}
						...
						/// </java-name>
						[Dot42.DexImport("getTotalPrivateClean", "()I", AccessFlags = 1)]
						public virtual int GetTotalPrivateClean() /* MethodBuilder.Create */ 
						{
								return default(int);
						}
						...
						/// getTotalSharedClean
						/// </java-name>
						[Dot42.DexImport("getTotalSharedClean", "()I", AccessFlags = 1)]
						public virtual int GetTotalSharedClean() /* MethodBuilder.Create */ 
						{
								return default(int);
						}
						...
						{
						[Dot42.DexImport("getTotalSwappablePss", "()I", AccessFlags = 1)]
								get{ return GetTotalSwappablePss(); }
						}
						...
						{
						[Dot42.DexImport("getTotalPrivateClean", "()I", AccessFlags = 1)]
								get{ return GetTotalPrivateClean(); }
						}
						...
						{
						[Dot42.DexImport("getTotalSharedClean", "()I", AccessFlags = 1)]
								get{ return GetTotalSharedClean(); }
						}
 ...
 /* scope: __dot42__ */ 
		...
		/// <span>public void onTick(long millisUntilFinished) {
 ...
 /* scope: __dot42__ */ 
		...
		/// </java-name>
		[Dot42.DexImport("android/os/PowerManager", AccessFlags = 49)]
		public sealed partial class PowerManager
 /* scope: __dot42__ */ 
		{
				/// <summary>
				...
				public bool IsScreenOn() /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				public void Reboot(string reason) /* MethodBuilder.Create */ 
				{
				}
				...
				/// </java-name>
				[Dot42.DexImport("android/os/PowerManager$WakeLock", AccessFlags = 17)]
				public sealed partial class WakeLock
 /* scope: __dot42__ */ 
				{
						/// <java-name>
						/// this$0
						...
						public void SetReferenceCounted(bool value) /* MethodBuilder.Create */ 
						{
						}
						...
						public void Acquire() /* MethodBuilder.Create */ 
						{
						}
						...
						public void Acquire(long timeout) /* MethodBuilder.Create */ 
						{
						}
						...
						public bool IsHeld() /* MethodBuilder.Create */ 
						{
								return default(bool);
						}
						...
						public void SetWorkSource(global::Android.Os.WorkSource ws) /* MethodBuilder.Create */ 
						{
						}
 ...
 /* scope: __dot42__ */ 
		{
				...
				public abstract bool HasVibrator() /* MethodBuilder.Create */ ;
		...
		/// <summary>
		/// <para>Representation of a user on the device. </para>    
		/// </summary>
		/// <java-name>
		/// android/os/UserHandle
		/// </java-name>
		[Dot42.DexImport("android/os/UserHandle", AccessFlags = 49)]
		public sealed partial class UserHandle : global::Android.Os.IParcelable
 /* scope: __dot42__ */ 
		{
				/// <java-name>
				/// CREATOR
				/// </java-name>
				[Dot42.DexImport("CREATOR", "Landroid/os/Parcelable$Creator;", AccessFlags = 25)]
				public static readonly global::Android.Os.IParcelable_ICreator<global::Android.Os.UserHandle> CREATOR;
				[Dot42.DexImport("<init>", "(Landroid/os/Parcel;)V", AccessFlags = 1)]
				public UserHandle(global::Android.Os.Parcel h) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Write a UserHandle to a Parcel, handling null pointers. Must be read with readFromParcel(Parcel).</para><para><para>readFromParcel(Parcel) </para></para>        
				/// </summary>
				/// <java-name>
				/// writeToParcel
				/// </java-name>
				[Dot42.DexImport("writeToParcel", "(Landroid/os/Parcel;I)V", AccessFlags = 1)]
				public void WriteToParcel(global::Android.Os.Parcel h, int @out) /* MethodBuilder.Create */ 
				{
				}
				...
				/// writeToParcel
				/// </java-name>
				[Dot42.DexImport("writeToParcel", "(Landroid/os/UserHandle;Landroid/os/Parcel;)V", AccessFlags = 9)]
				public static void WriteToParcel(global::Android.Os.UserHandle h, global::Android.Os.Parcel @out) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Read a UserHandle from a Parcel that was previously written with writeToParcel(UserHandle, Parcel), returning either a null or new object as appropriate.</para><para><para>writeToParcel(UserHandle, Parcel) </para></para>        
				/// </summary>
				/// <returns>
				/// <para>Returns a new UserHandle matching the previously written object, or null if a null had been written.</para>
				/// </returns>
				/// <java-name>
				/// readFromParcel
				/// </java-name>
				[Dot42.DexImport("readFromParcel", "(Landroid/os/Parcel;)Landroid/os/UserHandle;", AccessFlags = 9)]
				public static global::Android.Os.UserHandle ReadFromParcel(global::Android.Os.Parcel @in) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Os.UserHandle);
				}

				[global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
				internal UserHandle() /* TypeBuilder.AddDefaultConstructor */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				public void SetTarget(global::Android.Os.Handler target) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Like getData(), but does not lazily create the Bundle. A null is returned if the Bundle does not already exist. See getData for further information on this. <para>getData() </para><simplesectsep></simplesectsep><para>setData(Bundle) </para></para>        
				/// </summary>
				/// <java-name>
				/// peekData
				/// </java-name>
				...
				/// <summary>
				/// <para>Sets a Bundle of arbitrary data values. Use arg1 and arg1 members as a lower cost way to send a few simple integer values, if you can. <para>getData() </para><simplesectsep></simplesectsep><para>peekData() </para></para>        
				/// </summary>
				/// <java-name>
				/// setData
				/// </java-name>
				[Dot42.DexImport("setData", "(Landroid/os/Bundle;)V", AccessFlags = 1)]
				public void SetData(global::Android.Os.Bundle data) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// getBlockSize
				/// </java-name>
				[Dot42.DexImport("getBlockSize", "()I", AccessFlags = 1)]
				...
				/// <summary>
				/// <para>The size, in bytes, of a block on the file system. This corresponds to the Unix <c> statvfs.f_bsize </c> field. </para>        
				/// </summary>
				/// <java-name>
				/// getBlockSizeLong
				/// </java-name>
				[Dot42.DexImport("getBlockSizeLong", "()J", AccessFlags = 1)]
				public virtual long GetBlockSizeLong() /* MethodBuilder.Create */ 
				{
						return default(long);
				}
				...
				/// <summary>
				/// <para>The total number of blocks on the file system. This corresponds to the Unix <c> statvfs.f_blocks </c> field. </para>        
				/// </summary>
				/// <java-name>
				/// getBlockCountLong
				/// </java-name>
				[Dot42.DexImport("getBlockCountLong", "()J", AccessFlags = 1)]
				public virtual long GetBlockCountLong() /* MethodBuilder.Create */ 
				{
						return default(long);
				}
				...
				/// getFreeBlocks
				/// </java-name>
				[Dot42.DexImport("getFreeBlocks", "()I", AccessFlags = 1)]
				...
				/// <summary>
				/// <para>The total number of blocks that are free on the file system, including reserved blocks (that are not available to normal applications). This corresponds to the Unix <c> statvfs.f_bfree </c> field. Most applications will want to use getAvailableBlocks() instead. </para>        
				/// </summary>
				/// <java-name>
				/// getFreeBlocksLong
				/// </java-name>
				[Dot42.DexImport("getFreeBlocksLong", "()J", AccessFlags = 1)]
				public virtual long GetFreeBlocksLong() /* MethodBuilder.Create */ 
				{
						return default(long);
				}

				/// <summary>
				/// <para>The number of bytes that are free on the file system, including reserved blocks (that are not available to normal applications). Most applications will want to use getAvailableBytes() instead. </para>        
				/// </summary>
				/// <java-name>
				/// getFreeBytes
				/// </java-name>
				[Dot42.DexImport("getFreeBytes", "()J", AccessFlags = 1)]
				public virtual long GetFreeBytes() /* MethodBuilder.Create */ 
				{
						return default(long);
				}
				...
				/// getAvailableBlocks
				/// </java-name>
				[Dot42.DexImport("getAvailableBlocks", "()I", AccessFlags = 1)]
				...
				/// <summary>
				/// <para>The number of blocks that are free on the file system and available to applications. This corresponds to the Unix <c> statvfs.f_bavail </c> field. </para>        
				/// </summary>
				/// <java-name>
				/// getAvailableBlocksLong
				/// </java-name>
				[Dot42.DexImport("getAvailableBlocksLong", "()J", AccessFlags = 1)]
				public virtual long GetAvailableBlocksLong() /* MethodBuilder.Create */ 
				{
						return default(long);
				}

				/// <summary>
				/// <para>The number of bytes that are free on the file system and available to applications. </para>        
				/// </summary>
				/// <java-name>
				/// getAvailableBytes
				/// </java-name>
				[Dot42.DexImport("getAvailableBytes", "()J", AccessFlags = 1)]
				public virtual long GetAvailableBytes() /* MethodBuilder.Create */ 
				{
						return default(long);
				}

				/// <summary>
				/// <para>The total number of bytes supported by the file system. </para>        
				/// </summary>
				/// <java-name>
				/// getTotalBytes
				/// </java-name>
				[Dot42.DexImport("getTotalBytes", "()J", AccessFlags = 1)]
				public virtual long GetTotalBytes() /* MethodBuilder.Create */ 
				{
						return default(long);
				}
				...
				{
				[Dot42.DexImport("getAvailableBlocksLong", "()J", AccessFlags = 1)]
						get{ return GetAvailableBlocksLong(); }
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// </summary>
				/// <returns>
				/// <para>Returns true if the <b>recipient</b> is successfully unlinked, assuring you that its DeathRecipient.binderDied() method will not be called. Returns false if the target IBinder has already died, meaning the method has been (or soon will be) called.</para>
				/// </returns>
				/// <java-name>
				/// unlinkToDeath
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		...
		/// </java-name>
		[Dot42.DexImport("android/os/MessageQueue", AccessFlags = 49)]
		public sealed partial class MessageQueue
 /* scope: __dot42__ */ 
		{
				[Dot42.DexImport("<init>", "()V", AccessFlags = 0)]
				...
				/// addIdleHandler
				/// </java-name>
				[Dot42.DexImport("addIdleHandler", "(Landroid/os/MessageQueue$IdleHandler;)V", AccessFlags = 1)]
				...
				/// removeIdleHandler
				/// </java-name>
				[Dot42.DexImport("removeIdleHandler", "(Landroid/os/MessageQueue$IdleHandler;)V", AccessFlags = 1)]
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Returns nanoseconds since boot, including time spent in sleep.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>elapsed nanoseconds since boot. </para>
				/// </returns>
				/// <java-name>
				/// elapsedRealtimeNanos
				/// </java-name>
				[Dot42.DexImport("elapsedRealtimeNanos", "()J", AccessFlags = 265)]
				public static long ElapsedRealtimeNanos() /* MethodBuilder.Create */ 
				{
						return default(long);
				}
		...
		/// android/os/Looper
		/// </java-name>
		[Dot42.DexImport("android/os/Looper", AccessFlags = 49)]
		public sealed partial class Looper
 /* scope: __dot42__ */ 
		{
				[Dot42.DexImport("<init>", "()V", AccessFlags = 0)]
				...
				public void SetMessageLogging(global::Android.Util.IPrinter printer) /* MethodBuilder.Create */ 
				{
				}
				...
				public void Quit() /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Quits the looper safely. </para><para>Causes the loop method to terminate as soon as all remaining messages in the message queue that are already due to be delivered have been handled. However pending delayed messages with due times in the future will not be delivered before the loop terminates. </para><para>Any attempt to post messages to the queue after the looper is asked to quit will fail. For example, the Handler#sendMessage(Message) method will return false. </para>        
				/// </summary>
				/// <java-name>
				/// quitSafely
				/// </java-name>
				[Dot42.DexImport("quitSafely", "()V", AccessFlags = 1)]
				public void QuitSafely() /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Changes the ClassLoader this Bundle uses when instantiating objects.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setClassLoader
				/// </java-name>
				[Dot42.DexImport("setClassLoader", "(Ljava/lang/ClassLoader;)V", AccessFlags = 1)]
				public void SetClassLoader(global::Java.Lang.ClassLoader loader) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Inserts an IBinder value into the mapping of this Bundle, replacing any existing value for the given key. Either key or value may be null.</para><para>You should be very careful when using this function. In many places where Bundles are used (such as inside of Intent objects), the Bundle can live longer inside of another process than the process that had originally created it. In that case, the IBinder you supply here will become invalid when your process goes away, and no longer usable, even if a new process is created for you later on.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// putBinder
				/// </java-name>
				[Dot42.DexImport("putBinder", "(Ljava/lang/String;Landroid/os/IBinder;)V", AccessFlags = 1)]
				public void PutBinder(string key, global::Android.Os.IBinder value) /* MethodBuilder.Create */ 
				{
				}
				...
				/// </summary>
				/// <returns>
				/// <para>an IBinder value, or null </para>
				/// </returns>
				/// <java-name>
				/// getBinder
				/// </java-name>
				[Dot42.DexImport("getBinder", "(Ljava/lang/String;)Landroid/os/IBinder;", AccessFlags = 1)]
				public global::Android.Os.IBinder GetBinder(string key) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Os.IBinder);
				}
		...
		/// <summary>
		/// <para>Manages users and user details on a multi-user system. </para>    
		/// </summary>
		/// <java-name>
		/// android/os/UserManager
		/// </java-name>
		[Dot42.DexImport("android/os/UserManager", AccessFlags = 33)]
		public partial class UserManager
 /* scope: __dot42__ */ 
		{
				/// <summary>
				/// <para>Key for user restrictions. Specifies if a user is disallowed from adding and removing accounts. The default value is <code>false</code>. </para><para>Type: Boolean <para>setUserRestrictions(Bundle) </para><simplesectsep></simplesectsep><para>getUserRestrictions() </para></para>        
				/// </summary>
				/// <java-name>
				/// DISALLOW_MODIFY_ACCOUNTS
				/// </java-name>
				[Dot42.DexImport("DISALLOW_MODIFY_ACCOUNTS", "Ljava/lang/String;", AccessFlags = 25)]
				public const string DISALLOW_MODIFY_ACCOUNTS = "no_modify_accounts";
				/// <summary>
				/// <para>Key for user restrictions. Specifies if a user is disallowed from changing Wi-Fi access points. The default value is <code>false</code>. </para><para>Type: Boolean <para>setUserRestrictions(Bundle) </para><simplesectsep></simplesectsep><para>getUserRestrictions() </para></para>        
				/// </summary>
				/// <java-name>
				/// DISALLOW_CONFIG_WIFI
				/// </java-name>
				[Dot42.DexImport("DISALLOW_CONFIG_WIFI", "Ljava/lang/String;", AccessFlags = 25)]
				public const string DISALLOW_CONFIG_WIFI = "no_config_wifi";
				/// <summary>
				/// <para>Key for user restrictions. Specifies if a user is disallowed from installing applications. The default value is <code>false</code>. </para><para>Type: Boolean <para>setUserRestrictions(Bundle) </para><simplesectsep></simplesectsep><para>getUserRestrictions() </para></para>        
				/// </summary>
				/// <java-name>
				/// DISALLOW_INSTALL_APPS
				/// </java-name>
				[Dot42.DexImport("DISALLOW_INSTALL_APPS", "Ljava/lang/String;", AccessFlags = 25)]
				public const string DISALLOW_INSTALL_APPS = "no_install_apps";
				/// <summary>
				/// <para>Key for user restrictions. Specifies if a user is disallowed from uninstalling applications. The default value is <code>false</code>. </para><para>Type: Boolean <para>setUserRestrictions(Bundle) </para><simplesectsep></simplesectsep><para>getUserRestrictions() </para></para>        
				/// </summary>
				/// <java-name>
				/// DISALLOW_UNINSTALL_APPS
				/// </java-name>
				[Dot42.DexImport("DISALLOW_UNINSTALL_APPS", "Ljava/lang/String;", AccessFlags = 25)]
				public const string DISALLOW_UNINSTALL_APPS = "no_uninstall_apps";
				/// <summary>
				/// <para>Key for user restrictions. Specifies if a user is disallowed from toggling location sharing. The default value is <code>false</code>. </para><para>Type: Boolean <para>setUserRestrictions(Bundle) </para><simplesectsep></simplesectsep><para>getUserRestrictions() </para></para>        
				/// </summary>
				/// <java-name>
				/// DISALLOW_SHARE_LOCATION
				/// </java-name>
				[Dot42.DexImport("DISALLOW_SHARE_LOCATION", "Ljava/lang/String;", AccessFlags = 25)]
				public const string DISALLOW_SHARE_LOCATION = "no_share_location";
				/// <summary>
				/// <para>Key for user restrictions. Specifies if a user is disallowed from enabling the "Unknown Sources" setting, that allows installation of apps from unknown sources. The default value is <code>false</code>. </para><para>Type: Boolean <para>setUserRestrictions(Bundle) </para><simplesectsep></simplesectsep><para>getUserRestrictions() </para></para>        
				/// </summary>
				/// <java-name>
				/// DISALLOW_INSTALL_UNKNOWN_SOURCES
				/// </java-name>
				[Dot42.DexImport("DISALLOW_INSTALL_UNKNOWN_SOURCES", "Ljava/lang/String;", AccessFlags = 25)]
				public const string DISALLOW_INSTALL_UNKNOWN_SOURCES = "no_install_unknown_sources";
				/// <summary>
				/// <para>Key for user restrictions. Specifies if a user is disallowed from configuring bluetooth. The default value is <code>false</code>. </para><para>Type: Boolean <para>setUserRestrictions(Bundle) </para><simplesectsep></simplesectsep><para>getUserRestrictions() </para></para>        
				/// </summary>
				/// <java-name>
				/// DISALLOW_CONFIG_BLUETOOTH
				/// </java-name>
				[Dot42.DexImport("DISALLOW_CONFIG_BLUETOOTH", "Ljava/lang/String;", AccessFlags = 25)]
				public const string DISALLOW_CONFIG_BLUETOOTH = "no_config_bluetooth";
				/// <summary>
				/// <para>Key for user restrictions. Specifies if a user is disallowed from transferring files over USB. The default value is <code>false</code>. </para><para>Type: Boolean <para>setUserRestrictions(Bundle) </para><simplesectsep></simplesectsep><para>getUserRestrictions() </para></para>        
				/// </summary>
				/// <java-name>
				/// DISALLOW_USB_FILE_TRANSFER
				/// </java-name>
				[Dot42.DexImport("DISALLOW_USB_FILE_TRANSFER", "Ljava/lang/String;", AccessFlags = 25)]
				public const string DISALLOW_USB_FILE_TRANSFER = "no_usb_file_transfer";
				/// <summary>
				/// <para>Key for user restrictions. Specifies if a user is disallowed from configuring user credentials. The default value is <code>false</code>. </para><para>Type: Boolean <para>setUserRestrictions(Bundle) </para><simplesectsep></simplesectsep><para>getUserRestrictions() </para></para>        
				/// </summary>
				/// <java-name>
				/// DISALLOW_CONFIG_CREDENTIALS
				/// </java-name>
				[Dot42.DexImport("DISALLOW_CONFIG_CREDENTIALS", "Ljava/lang/String;", AccessFlags = 25)]
				public const string DISALLOW_CONFIG_CREDENTIALS = "no_config_credentials";
				/// <summary>
				/// <para>Key for user restrictions. Specifies if a user is disallowed from removing users. The default value is <code>false</code>. </para><para>Type: Boolean <para>setUserRestrictions(Bundle) </para><simplesectsep></simplesectsep><para>getUserRestrictions() </para></para>        
				/// </summary>
				/// <java-name>
				/// DISALLOW_REMOVE_USER
				/// </java-name>
				[Dot42.DexImport("DISALLOW_REMOVE_USER", "Ljava/lang/String;", AccessFlags = 25)]
				public const string DISALLOW_REMOVE_USER = "no_remove_user";
				[Dot42.DexImport("<init>", "()V", AccessFlags = 0)]
				internal UserManager() /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Returns the user name of the user making this call. This call is only available to applications on the system image; it requires the MANAGE_USERS permission. </para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				/// <para>Used to determine whether the user making this call is subject to teleportations. </para>        
				/// </summary>
				/// <returns>
				/// <para>whether the user making this call is a goat </para>
				/// </returns>
				/// <java-name>
				/// isUserAGoat
				/// </java-name>
				[Dot42.DexImport("isUserAGoat", "()Z", AccessFlags = 1)]
				public virtual bool IsUserAGoat() /* MethodBuilder.Create */ 
				{
						return default(bool);
				}

				/// <summary>
				/// <para>Return whether the given user is actively running. This means that the user is in the "started" state, not "stopped"  it is currently allowed to run code through scheduled alarms, receiving broadcasts, etc. A started user may be either the current foreground user or a background user; the result here does not distinguish between the two. </para>        
				/// </summary>
				/// <java-name>
				/// isUserRunning
				/// </java-name>
				[Dot42.DexImport("isUserRunning", "(Landroid/os/UserHandle;)Z", AccessFlags = 1)]
				public virtual bool IsUserRunning(global::Android.Os.UserHandle user) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}

				/// <summary>
				/// <para>Return whether the given user is actively running <b>or</b> stopping. This is like isUserRunning(UserHandle), but will also return true if the user had been running but is in the process of being stopped (but is not yet fully stopped, and still running some code). </para>        
				/// </summary>
				/// <java-name>
				/// isUserRunningOrStopping
				/// </java-name>
				[Dot42.DexImport("isUserRunningOrStopping", "(Landroid/os/UserHandle;)Z", AccessFlags = 1)]
				public virtual bool IsUserRunningOrStopping(global::Android.Os.UserHandle user) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}

				/// <summary>
				/// <para>Returns the user-wide restrictions imposed on this user. </para>        
				/// </summary>
				/// <returns>
				/// <para>a Bundle containing all the restrictions. </para>
				/// </returns>
				/// <java-name>
				/// getUserRestrictions
				/// </java-name>
				[Dot42.DexImport("getUserRestrictions", "()Landroid/os/Bundle;", AccessFlags = 1)]
				public virtual global::Android.Os.Bundle GetUserRestrictions() /* MethodBuilder.Create */ 
				{
						return default(global::Android.Os.Bundle);
				}

				/// <summary>
				/// <para>Returns the user-wide restrictions imposed on the user specified by <code>userHandle</code>. </para>        
				/// </summary>
				/// <returns>
				/// <para>a Bundle containing all the restrictions. </para>
				/// </returns>
				...
				/// getUserRestrictions
				/// </java-name>
				[Dot42.DexImport("getUserRestrictions", "(Landroid/os/UserHandle;)Landroid/os/Bundle;", AccessFlags = 1)]
				public virtual global::Android.Os.Bundle GetUserRestrictions(global::Android.Os.UserHandle userHandle) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Os.Bundle);
				}

				/// <summary>
				/// <para>Sets all the user-wide restrictions for this user. Requires the MANAGE_USERS permission. </para>        
				/// </summary>
				/// <java-name>
				/// setUserRestrictions
				/// </java-name>
				[Dot42.DexImport("setUserRestrictions", "(Landroid/os/Bundle;)V", AccessFlags = 1)]
				public virtual void SetUserRestrictions(global::Android.Os.Bundle restrictions) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Sets all the user-wide restrictions for the specified user. Requires the MANAGE_USERS permission. </para>        
				/// </summary>
				/// <java-name>
				/// setUserRestrictions
				/// </java-name>
				[Dot42.DexImport("setUserRestrictions", "(Landroid/os/Bundle;Landroid/os/UserHandle;)V", AccessFlags = 1)]
				public virtual void SetUserRestrictions(global::Android.Os.Bundle restrictions, global::Android.Os.UserHandle userHandle) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Sets the value of a specific restriction. Requires the MANAGE_USERS permission. </para>        
				/// </summary>
				/// <java-name>
				/// setUserRestriction
				/// </java-name>
				[Dot42.DexImport("setUserRestriction", "(Ljava/lang/String;Z)V", AccessFlags = 1)]
				public virtual void SetUserRestriction(string key, bool value) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Return the serial number for a user. This is a device-unique number assigned to that user; if the user is deleted and then a new user created, the new users will not be given the same serial number. <para>getUserForSerialNumber(long) </para></para>        
				/// </summary>
				/// <returns>
				/// <para>The serial number of the given user; returns -1 if the given UserHandle does not exist. </para>
				/// </returns>
				/// <java-name>
				/// getSerialNumberForUser
				/// </java-name>
				[Dot42.DexImport("getSerialNumberForUser", "(Landroid/os/UserHandle;)J", AccessFlags = 1)]
				public virtual long GetSerialNumberForUser(global::Android.Os.UserHandle user) /* MethodBuilder.Create */ 
				{
						return default(long);
				}

				/// <summary>
				/// <para>Return the user associated with a serial number previously returned by getSerialNumberForUser(UserHandle). <para>getSerialNumberForUser(UserHandle) </para></para>        
				/// </summary>
				/// <returns>
				/// <para>Return the user associated with the serial number, or null if there is not one. </para>
				/// </returns>
				/// <java-name>
				/// getUserForSerialNumber
				/// </java-name>
				[Dot42.DexImport("getUserForSerialNumber", "(J)Landroid/os/UserHandle;", AccessFlags = 1)]
				public virtual global::Android.Os.UserHandle GetUserForSerialNumber(long serialNumber) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Os.UserHandle);
				}

				/// <summary>
				/// <para>Return the number of users currently created on the device. </para>        
				/// </summary>
				/// <java-name>
				/// getUserCount
				/// </java-name>
				[Dot42.DexImport("getUserCount", "()I", AccessFlags = 1)]
				public virtual int GetUserCount() /* MethodBuilder.Create */ 
				{
						return default(int);
				}

				/// <summary>
				/// <para>Returns a Bundle containing any saved application restrictions for this user, for the given package name. Only an application with this package name can call this method. </para>        
				/// </summary>
				/// <returns>
				/// <para>a Bundle with the restrictions as key/value pairs, or null if there are no saved restrictions. The values can be of type Boolean, String or String[], depending on the restriction type, as defined by the application. </para>
				/// </returns>
				/// <java-name>
				/// getApplicationRestrictions
				/// </java-name>
				[Dot42.DexImport("getApplicationRestrictions", "(Ljava/lang/String;)Landroid/os/Bundle;", AccessFlags = 1)]
				public virtual global::Android.Os.Bundle GetApplicationRestrictions(string packageName) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Os.Bundle);
				}
				...
				/// </java-name>
				[Dot42.DexImport("setRestrictionsChallenge", "(Ljava/lang/String;)Z", AccessFlags = 1)]
				public virtual bool SetRestrictionsChallenge(string @string) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				/// getUserRestrictions
				/// </java-name>
				public global::Android.Os.Bundle UserRestrictions
				{
				[Dot42.DexImport("getUserRestrictions", "()Landroid/os/Bundle;", AccessFlags = 1)]
						get{ return GetUserRestrictions(); }
				[Dot42.DexImport("setUserRestrictions", "(Landroid/os/Bundle;)V", AccessFlags = 1)]
						set{ SetUserRestrictions(value); }
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Add a new callback to the list. This callback will remain in the list until a corresponding call to unregister or its hosting process goes away. If the callback was already registered (determined by checking to see if the callback.asBinder() object is already in the list), then it will be left as-is. Registrations are not counted; a single call to unregister will remove a callback after any number calls to register it.</para><para><para>unregister </para><simplesectsep></simplesectsep><para>kill </para><simplesectsep></simplesectsep><para>onCallbackDied </para></para>        
				/// </summary>
				/// <returns>
				...
				///            }
				///        }
				///        callbacks.finishBroadcast();</pre></para><para><para>getBroadcastItem </para><simplesectsep></simplesectsep><para>finishBroadcast </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				/// <para>Returns the number of registered callbacks. Note that the number of registered callbacks may differ from the value returned by beginBroadcast() since the former returns the number of callbacks registered at the time of the call and the second the number of callback to which the broadcast will be delivered. </para><para>This function is useful to decide whether to schedule a broadcast if this requires doing some work which otherwise would not be performed. </para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>The size. </para>
				/// </returns>
				...
				/// </java-name>
				[Dot42.DexImport("getRegisteredCallbackCount", "()I", AccessFlags = 1)]
				public virtual int GetRegisteredCallbackCount() /* MethodBuilder.Create */ 
				{
						return default(int);
				}
				...
				{
				[Dot42.DexImport("getRegisteredCallbackCount", "()I", AccessFlags = 1)]
						get{ return GetRegisteredCallbackCount(); }
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Return the UserHandle assigned to the process that sent you the current transaction that is being processed. This is the user of the caller. It is distinct from getCallingUid() in that a particular user will have multiple distinct apps running under it each with their own uid. If the current thread is not currently executing an incoming transaction, then its own UserHandle is returned. </para>        
				/// </summary>
				/// <java-name>
				/// getCallingUserHandle
				/// </java-name>
				[Dot42.DexImport("getCallingUserHandle", "()Landroid/os/UserHandle;", AccessFlags = 25)]
				public static global::Android.Os.UserHandle GetCallingUserHandle() /* MethodBuilder.Create */ 
				{
						return default(global::Android.Os.UserHandle);
				}

				/// <summary>
				/// <para>Reset the identity of the incoming IPC on the current thread. This can be useful if, while handling an incoming call, you will be calling on interfaces of other objects that may be local to your process and need to do permission checks on the calls coming into them (so they will check the permission of your own local process, and not whatever process originally called you).</para><para><para>getCallingPid() </para><simplesectsep></simplesectsep><para>getCallingUid() </para><simplesectsep></simplesectsep><para>restoreCallingIdentity(long) </para></para>        
				/// </summary>
				/// <returns>
				...
				/// getCallingUserHandle
				/// </java-name>
				public static global::Android.Os.UserHandle CallingUserHandle
				{
				[Dot42.DexImport("getCallingUserHandle", "()Landroid/os/UserHandle;", AccessFlags = 25)]
						get{ return GetCallingUserHandle(); }
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Callback interface you can use when instantiating a Handler to avoid having to implement your own subclass of Handler. </para>    
				/// </summary>
				/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Override this method to perform a computation on a background thread. The specified parameters are the parameters passed to execute by the caller of this task.</para><para>This method can call publishProgress to publish updates on the UI thread.</para><para><para>onPreExecute() </para><simplesectsep></simplesectsep><para>onPostExecute </para><simplesectsep></simplesectsep><para>publishProgress </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				/// <para>Runs on the UI thread before doInBackground.</para><para><para>onPostExecute </para><simplesectsep></simplesectsep><para>doInBackground </para></para>        
				/// </summary>
				/// <java-name>
				/// onPreExecute
				/// </java-name>
				...
				/// <summary>
				/// <para>Runs on the UI thread after doInBackground. The specified result is the value returned by doInBackground.</para><para>This method won't be invoked if the task was cancelled.</para><para><para>onPreExecute </para><simplesectsep></simplesectsep><para>doInBackground </para><simplesectsep></simplesectsep><para>#onCancelled(Object) </para></para>        
				/// </summary>
				/// <java-name>
				/// onPostExecute
				/// </java-name>
				...
				/// <summary>
				/// <para>Runs on the UI thread after publishProgress is invoked. The specified values are the values passed to publishProgress.</para><para><para>publishProgress </para><simplesectsep></simplesectsep><para>doInBackground </para></para>        
				/// </summary>
				/// <java-name>
				/// onProgressUpdate
				/// </java-name>
				...
				/// <summary>
				/// <para>Runs on the UI thread after cancel(boolean) is invoked and doInBackground(Object[]) has finished.</para><para>The default implementation simply invokes onCancelled() and ignores the result. If you write your own implementation, do not call <code>super.onCancelled(result)</code>.</para><para><para>cancel(boolean) </para><simplesectsep></simplesectsep><para>isCancelled() </para></para>        
				/// </summary>
				/// <java-name>
				/// onCancelled
				/// </java-name>
				...
				/// <summary>
				/// <para>Applications should preferably override onCancelled(Object). This method is invoked by the default implementation of onCancelled(Object).</para><para>Runs on the UI thread after cancel(boolean) is invoked and doInBackground(Object[]) has finished.</para><para><para>#onCancelled(Object) </para><simplesectsep></simplesectsep><para>cancel(boolean) </para><simplesectsep></simplesectsep><para>isCancelled() </para></para>        
				/// </summary>
				/// <java-name>
				/// onCancelled
				/// </java-name>
    ...
    ";TResult;>;")]
				...
				/// <summary>
				/// <para>This method can be invoked from doInBackground to publish updates on the UI thread while the background computation is still running. Each call to this method will trigger the execution of onProgressUpdate on the UI thread.</para><para>onProgressUpdate will note be called if the task has been canceled.</para><para><para>onProgressUpdate </para><simplesectsep></simplesectsep><para>doInBackground </para></para>        
				/// </summary>
				/// <java-name>
				/// publishProgress
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				/// <summary>
				/// <para>For use with open: if MODE_CREATE has been supplied and this file doesn't already exist, then create the file with permissions such that any application can read it. </para>        
				/// </summary>
				/// <java-name>
				/// MODE_WORLD_READABLE
				/// </java-name>
				...
				/// <summary>
				/// <para>For use with open: if MODE_CREATE has been supplied and this file doesn't already exist, then create the file with permissions such that any application can write it. </para>        
				/// </summary>
				/// <java-name>
				...
				public ParcelFileDescriptor(global::Android.Os.ParcelFileDescriptor descriptor) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Create a new ParcelFileDescriptor accessing a given file.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>Returns a new ParcelFileDescriptor pointing to the given file.</para>
				/// </returns>
				/// <java-name>
				/// open
				/// </java-name>
				...
				/// open
				/// </java-name>
				[Dot42.DexImport("open", "(Ljava/io/File;ILandroid/os/Handler;Landroid/os/ParcelFileDescriptor$OnCloseListe" +
    "ner;)Landroid/os/ParcelFileDescriptor;", AccessFlags = 9)]
				public static global::Android.Os.ParcelFileDescriptor Open(global::Java.Io.File file, int int32, global::Android.Os.Handler handler, global::Android.Os.ParcelFileDescriptor.IOnCloseListener onCloseListener) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Os.ParcelFileDescriptor);
				}
				...
				/// createReliablePipe
				/// </java-name>
				[Dot42.DexImport("createReliablePipe", "()[Landroid/os/ParcelFileDescriptor;", AccessFlags = 9)]
				public static global::Android.Os.ParcelFileDescriptor[] CreateReliablePipe() /* MethodBuilder.Create */ 
				{
						return default(global::Android.Os.ParcelFileDescriptor[]);
				}
				...
				/// createSocketPair
				/// </java-name>
				[Dot42.DexImport("createSocketPair", "()[Landroid/os/ParcelFileDescriptor;", AccessFlags = 9)]
				public static global::Android.Os.ParcelFileDescriptor[] CreateSocketPair() /* MethodBuilder.Create */ 
				{
						return default(global::Android.Os.ParcelFileDescriptor[]);
				}
				...
				/// </java-name>
				[Dot42.DexImport("createReliableSocketPair", "()[Landroid/os/ParcelFileDescriptor;", AccessFlags = 9)]
				public static global::Android.Os.ParcelFileDescriptor[] CreateReliableSocketPair() /* MethodBuilder.Create */ 
				{
						return default(global::Android.Os.ParcelFileDescriptor[]);
				}
				...
				/// parseMode
				/// </java-name>
				[Dot42.DexImport("parseMode", "(Ljava/lang/String;)I", AccessFlags = 9)]
				public static int ParseMode(string @string) /* MethodBuilder.Create */ 
				{
						return default(int);
				}
				...
				/// <summary>
				/// <para>Return the total size of the file representing this fd, as determined by stat(). Returns -1 if the fd is not a file. </para>        
				/// </summary>
				/// <java-name>
				/// getStatSize
				/// </java-name>
				[Dot42.DexImport("getStatSize", "()J", AccessFlags = 1)]
				...
				/// <summary>
				/// <para>Return the native fd int for this ParcelFileDescriptor and detach it from the object here. You are now responsible for closing the fd in native code. </para>        
				/// </summary>
				/// <java-name>
				/// detachFd
				/// </java-name>
				...
				/// closeWithError
				/// </java-name>
				[Dot42.DexImport("closeWithError", "(Ljava/lang/String;)V", AccessFlags = 1)]
				public virtual void CloseWithError(string @string) /* MethodBuilder.Create */ 
				{
				}
				...
				/// canDetectErrors
				/// </java-name>
				[Dot42.DexImport("canDetectErrors", "()Z", AccessFlags = 1)]
				public virtual bool CanDetectErrors() /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				/// checkError
				/// </java-name>
				[Dot42.DexImport("checkError", "()V", AccessFlags = 1)]
				public virtual void CheckError() /* MethodBuilder.Create */ 
				{
				}
				...
				/// </java-name>
				[Dot42.DexImport("android/os/ParcelFileDescriptor$FileDescriptorDetachedException", AccessFlags = 9)]
				public partial class FileDescriptorDetachedException : global::System.IO.IOException
 /* scope: __dot42__ */ 
				{
						[Dot42.DexImport("<init>", "()V", AccessFlags = 1)]
						public FileDescriptorDetachedException() /* MethodBuilder.Create */ 
						{
						}
				...
				/// </java-name>
				[Dot42.DexImport("android/os/ParcelFileDescriptor$OnCloseListener", AccessFlags = 1545)]
 ...
 /* scope: __dot42__ */ 
				{
						...
						/// onClose
						/// </java-name>
						[Dot42.DexImport("onClose", "(Ljava/io/IOException;)V", AccessFlags = 1025)]
						void OnClose(global::System.IO.IOException iOException) /* MethodBuilder.Create */ ;
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// DIRECTORY_DOCUMENTS
				/// </java-name>
				[Dot42.DexImport("DIRECTORY_DOCUMENTS", "Ljava/lang/String;", AccessFlags = 9)]
				public static string DIRECTORY_DOCUMENTS;
				/// <java-name>
				/// MEDIA_UNKNOWN
				/// </java-name>
				[Dot42.DexImport("MEDIA_UNKNOWN", "Ljava/lang/String;", AccessFlags = 25)]
				public const string MEDIA_UNKNOWN = "unknown";
				/// <summary>
				/// <para>getExternalStorageState() returns MEDIA_REMOVED if the media is not present. </para>        
				/// </summary>
				/// <java-name>
				/// MEDIA_REMOVED
				/// </java-name>
				...
				/// <summary>
				/// <para>getExternalStorageState() returns MEDIA_UNMOUNTED if the media is present but not mounted. </para>        
				/// </summary>
				/// <java-name>
				/// MEDIA_UNMOUNTED
				/// </java-name>
				...
				/// <summary>
				/// <para>getExternalStorageState() returns MEDIA_CHECKING if the media is present and being disk-checked </para>        
				/// </summary>
				/// <java-name>
				/// MEDIA_CHECKING
				/// </java-name>
				...
				/// <summary>
				/// <para>getExternalStorageState() returns MEDIA_NOFS if the media is present but is blank or is using an unsupported filesystem </para>        
				/// </summary>
				/// <java-name>
				/// MEDIA_NOFS
				/// </java-name>
				...
				/// <summary>
				/// <para>getExternalStorageState() returns MEDIA_MOUNTED if the media is present and mounted at its mount point with read/write access. </para>        
				/// </summary>
				/// <java-name>
				/// MEDIA_MOUNTED
				/// </java-name>
				...
				/// <summary>
				/// <para>getExternalStorageState() returns MEDIA_MOUNTED_READ_ONLY if the media is present and mounted at its mount point with read only access. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				/// <para>getExternalStorageState() returns MEDIA_SHARED if the media is present not mounted, and shared via USB mass storage. </para>        
				/// </summary>
				/// <java-name>
				/// MEDIA_SHARED
				/// </java-name>
				...
				/// <summary>
				/// <para>getExternalStorageState() returns MEDIA_BAD_REMOVAL if the media was removed before it was unmounted. </para>        
				/// </summary>
				/// <java-name>
				/// MEDIA_BAD_REMOVAL
				/// </java-name>
				...
				/// <summary>
				/// <para>getExternalStorageState() returns MEDIA_UNMOUNTABLE if the media is present but cannot be mounted. Typically this happens if the file system on the media is corrupted. </para>        
				/// </summary>
				/// <java-name>
				/// MEDIA_UNMOUNTABLE
				/// </java-name>
				...
				/// <summary>
				/// <para>Gets the Android data directory. </para>        
				/// </summary>
				/// <java-name>
				/// getDataDirectory
				/// </java-name>
				...
				/// <summary>
				/// <para>Gets the Android download/cache content directory. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				/// <para>Gets the current state of the primary "external" storage device.</para><para><para>getExternalStorageDirectory() </para></para>        
				/// </summary>
				/// <java-name>
				...
				/// getStorageState
				/// </java-name>
				[Dot42.DexImport("getStorageState", "(Ljava/io/File;)Ljava/lang/String;", AccessFlags = 9)]
				public static string GetStorageState(global::Java.Io.File file) /* MethodBuilder.Create */ 
				{
						return default(string);
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Quits the handler thread's looper safely. </para><para>Causes the handler thread's looper to terminate as soon as all remaining messages in the message queue that are already due to be delivered have been handled. Pending delayed messages with due times in the future will not be delivered. </para><para>Any attempt to post messages to the queue after the looper is asked to quit will fail. For example, the Handler#sendMessage(Message) method will return false. </para><para>If the thread has not been started or has finished (that is if getLooper returns null), then false is returned. Otherwise the looper is asked to quit and true is returned. </para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>True if the looper looper has been asked to quit or false if the thread had not yet started running. </para>
				/// </returns>
				...
				/// quitSafely
				/// </java-name>
				[Dot42.DexImport("quitSafely", "()Z", AccessFlags = 1)]
				public virtual bool QuitSafely() /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
