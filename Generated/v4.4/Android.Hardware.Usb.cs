 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Performs a control transaction on endpoint zero for this device. The direction of the transfer is determined by the request type. If requestType &amp; UsbConstants#USB_ENDPOINT_DIR_MASK is UsbConstants#USB_DIR_OUT, then the transfer is a write, and if it is UsbConstants#USB_DIR_IN, then the transfer is a read.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>length of data transferred (or zero) for success, or negative value for failure </para>
				/// </returns>
				...
				/// controlTransfer
				/// </java-name>
				[Dot42.DexImport("controlTransfer", "(IIII[BIII)I", AccessFlags = 1)]
				public virtual int ControlTransfer(int requestType, int request, int value, int index, sbyte[] buffer, int offset, int length, int timeout) /* MethodBuilder.Create */ 
				{
						return default(int);
				}
				...
				/// controlTransfer
				/// </java-name>
				[Dot42.DexImport("controlTransfer", "(IIII[BIII)I", AccessFlags = 1, IgnoreFromJava = true)]
				public virtual int ControlTransfer(int requestType, int request, int value, int index, byte[] buffer, int offset, int length, int timeout) /* MethodBuilder.Create */ 
				{
						return default(int);
				}
				...
				/// <summary>
				/// <para>Performs a bulk transaction on the given endpoint. The direction of the transfer is determined by the direction of the endpoint.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>length of data transferred (or zero) for success, or negative value for failure </para>
				/// </returns>
				...
				/// bulkTransfer
				/// </java-name>
				[Dot42.DexImport("bulkTransfer", "(Landroid/hardware/usb/UsbEndpoint;[BIII)I", AccessFlags = 1)]
				public virtual int BulkTransfer(global::Android.Hardware.Usb.UsbEndpoint endpoint, sbyte[] buffer, int offset, int length, int timeout) /* MethodBuilder.Create */ 
				{
						return default(int);
				}
				...
				/// bulkTransfer
				/// </java-name>
				[Dot42.DexImport("bulkTransfer", "(Landroid/hardware/usb/UsbEndpoint;[BIII)I", AccessFlags = 1, IgnoreFromJava = true)]
				public virtual int BulkTransfer(global::Android.Hardware.Usb.UsbEndpoint endpoint, byte[] buffer, int offset, int length, int timeout) /* MethodBuilder.Create */ 
				{
						return default(int);
				}
