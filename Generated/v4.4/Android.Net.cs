 ...
 /* scope: __dot42__ */ 
		{
				...
				/// SOCKET_DGRAM
				/// </java-name>
				[Dot42.DexImport("SOCKET_DGRAM", "I", AccessFlags = 25)]
				public const int SOCKET_DGRAM = 1;
				/// <java-name>
				/// SOCKET_STREAM
				/// </java-name>
				[Dot42.DexImport("SOCKET_STREAM", "I", AccessFlags = 25)]
				public const int SOCKET_STREAM = 2;
				/// <java-name>
				/// SOCKET_SEQPACKET
				/// </java-name>
				[Dot42.DexImport("SOCKET_SEQPACKET", "I", AccessFlags = 25)]
				public const int SOCKET_SEQPACKET = 3;
				/// <summary>
				...
				/// <summary>
				/// <para>Creates a AF_LOCAL/UNIX domain stream socket with FileDescriptor.  </para>        
				/// </summary>
				[Dot42.DexImport("<init>", "(I)V", AccessFlags = 1)]
				public LocalSocket(int fd) /* MethodBuilder.Create */ 
				{
				}
