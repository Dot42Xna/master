...
namespace Android.Nfc
{
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para>Wraps information associated with any NFC event.</para><para>Immutable object, with direct access to the (final) fields.</para><para>An NfcEvent object is usually included in callbacks from NfcAdapter. Check the documentation of the callback to see which fields may be set.</para><para>This wrapper object is used (instead of parameters in the callback) because it allows new fields to be added without breaking API compatibility.</para><para><para>NfcAdapter.OnNdefPushCompleteCallback::onNdefPushComplete </para><simplesectsep></simplesectsep><para>NfcAdapter.CreateNdefMessageCallback::createNdefMessage </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				public int GetByteArrayLength() /* MethodBuilder.Create */ 
				{
						return default(int);
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Broadcast Action: The state of the local NFC adapter has been changed. </para><para>For example, NFC has been turned on or off. </para><para>Always contains the extra field EXTRA_ADAPTER_STATE </para>        
				/// </summary>
				/// <java-name>
				/// ACTION_ADAPTER_STATE_CHANGED
				/// </java-name>
				[Dot42.DexImport("ACTION_ADAPTER_STATE_CHANGED", "Ljava/lang/String;", AccessFlags = 25)]
				public const string ACTION_ADAPTER_STATE_CHANGED = "android.nfc.action.ADAPTER_STATE_CHANGED";
				/// <summary>
				/// <para>Used as an int extra field in ACTION_ADAPTER_STATE_CHANGED intents to request the current power state. Possible values are: STATE_OFF, STATE_TURNING_ON, STATE_ON, STATE_TURNING_OFF, </para>        
				/// </summary>
				/// <java-name>
				/// EXTRA_ADAPTER_STATE
				/// </java-name>
				[Dot42.DexImport("EXTRA_ADAPTER_STATE", "Ljava/lang/String;", AccessFlags = 25)]
				public const string EXTRA_ADAPTER_STATE = "android.nfc.extra.ADAPTER_STATE";
				/// <java-name>
				/// STATE_OFF
				/// </java-name>
				...
				public const int STATE_TURNING_ON = 2;
				/// <java-name>
				/// STATE_ON
				/// </java-name>
				...
				public const int STATE_TURNING_OFF = 4;
				/// <java-name>
				/// FLAG_READER_NFC_A
				/// </java-name>
				[Dot42.DexImport("FLAG_READER_NFC_A", "I", AccessFlags = 25)]
				public const int FLAG_READER_NFC_A = 1;
				/// <java-name>
				/// FLAG_READER_NFC_B
				/// </java-name>
				[Dot42.DexImport("FLAG_READER_NFC_B", "I", AccessFlags = 25)]
				public const int FLAG_READER_NFC_B = 2;
				/// <java-name>
				/// FLAG_READER_NFC_F
				/// </java-name>
				[Dot42.DexImport("FLAG_READER_NFC_F", "I", AccessFlags = 25)]
				public const int FLAG_READER_NFC_F = 4;
				/// <java-name>
				/// FLAG_READER_NFC_V
				/// </java-name>
				[Dot42.DexImport("FLAG_READER_NFC_V", "I", AccessFlags = 25)]
				public const int FLAG_READER_NFC_V = 8;
				/// <java-name>
				/// FLAG_READER_NFC_BARCODE
				/// </java-name>
				[Dot42.DexImport("FLAG_READER_NFC_BARCODE", "I", AccessFlags = 25)]
				public const int FLAG_READER_NFC_BARCODE = 16;
				/// <java-name>
				/// FLAG_READER_SKIP_NDEF_CHECK
				/// </java-name>
				[Dot42.DexImport("FLAG_READER_SKIP_NDEF_CHECK", "I", AccessFlags = 25)]
				public const int FLAG_READER_SKIP_NDEF_CHECK = 128;
				/// <java-name>
				/// FLAG_READER_NO_PLATFORM_SOUNDS
				/// </java-name>
				[Dot42.DexImport("FLAG_READER_NO_PLATFORM_SOUNDS", "I", AccessFlags = 25)]
				public const int FLAG_READER_NO_PLATFORM_SOUNDS = 256;
				/// <java-name>
				/// EXTRA_READER_PRESENCE_CHECK_DELAY
				/// </java-name>
				[Dot42.DexImport("EXTRA_READER_PRESENCE_CHECK_DELAY", "Ljava/lang/String;", AccessFlags = 25)]
    ...
    "[[Ljava/lang/String;)V", AccessFlags = 1)]
				...
				/// enableReaderMode
				/// </java-name>
				[Dot42.DexImport("enableReaderMode", "(Landroid/app/Activity;Landroid/nfc/NfcAdapter$ReaderCallback;ILandroid/os/Bundle" +
    ";)V", AccessFlags = 1)]
				public void EnableReaderMode(global::Android.App.Activity activity, global::Android.Nfc.NfcAdapter.IReaderCallback readerCallback, int int32, global::Android.Os.Bundle bundle) /* MethodBuilder.Create */ 
				{
				}
				...
				/// disableReaderMode
				/// </java-name>
				[Dot42.DexImport("disableReaderMode", "(Landroid/app/Activity;)V", AccessFlags = 1)]
				public void DisableReaderMode(global::Android.App.Activity activity) /* MethodBuilder.Create */ 
				{
				}
				...
				public bool IsNdefPushEnabled() /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
 ...
 /* scope: __dot42__ */ 
				...
				/// </java-name>
				[Dot42.DexImport("android/nfc/NfcAdapter$ReaderCallback", AccessFlags = 1545)]
				public partial interface IReaderCallback
 /* scope: __dot42__ */ 
				{
						/// <java-name>
						/// onTagDiscovered
						/// </java-name>
						[Dot42.DexImport("onTagDiscovered", "(Landroid/nfc/Tag;)V", AccessFlags = 1025)]
						void OnTagDiscovered(global::Android.Nfc.Tag tag) /* MethodBuilder.Create */ ;
