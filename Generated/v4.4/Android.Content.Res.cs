...
//
// Original filename: Android.Content.Res.cs
//
...
namespace Android.Content.Res
{
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Open an asset using ACCESS_STREAMING mode. This provides access to files that have been bundled with an application as assets  that is, files placed in to the "assets" directory.</para><para><para>open(String, int) </para><simplesectsep></simplesectsep><para>list </para></para>        
				/// </summary>
				/// <java-name>
				/// open
				/// </java-name>
				...
				/// <summary>
				/// <para>Open an asset using an explicit access mode, returning an InputStream to read its contents. This provides access to files that have been bundled with an application as assets  that is, files placed in to the "assets" directory.</para><para><para>ACCESS_UNKNOWN </para><simplesectsep></simplesectsep><para>ACCESS_STREAMING </para><simplesectsep></simplesectsep><para>ACCESS_RANDOM </para><simplesectsep></simplesectsep><para>ACCESS_BUFFER </para><simplesectsep></simplesectsep><para>open(String) </para><simplesectsep></simplesectsep><para>list </para></para>        
				/// </summary>
				/// <java-name>
				/// open
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		...
		public partial interface IXmlResourceParser : global::Org.Xmlpull.V1.IXmlPullParser, global::Android.Util.IAttributeSet, global::Java.Lang.IAutoCloseable
 /* scope: __dot42__ */ 
		{
				/// <summary>
 ...
 /* scope: __dot42__ */ 
    ...
    "res/Configuration;)V", AccessFlags = 1)]
				...
				public virtual global::Android.Graphics.Drawable.Drawable GetDrawable(int id) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Graphics.Drawable.Drawable);
				}

				/// <summary>
				/// <para>Return a drawable object associated with a particular resource ID for the given screen density in DPI. This will set the drawable's density to be the device's density multiplied by the ratio of actual drawable density to requested density. This allows the drawable to be scaled up to the correct size if needed. Various types of objects will be returned depending on the underlying resource  for example, a solid color, PNG image, scalable image, etc. The Drawable API hides these implementation details.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>Drawable An object that can be used to draw this resource. </para>
				/// </returns>
				...
				public virtual global::Android.Graphics.Drawable.Drawable GetDrawableForDensity(int id, int density) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Graphics.Drawable.Drawable);
				}
				...
				/// <summary>
				/// <para>Get the raw value associated with a resource with associated density.</para><para><para>getValue(String, TypedValue, boolean) </para></para>        
				/// </summary>
				/// <java-name>
				/// getValueForDensity
				/// </java-name>
				[Dot42.DexImport("getValueForDensity", "(IILandroid/util/TypedValue;Z)V", AccessFlags = 1)]
				public virtual void GetValueForDensity(int id, int density, global::Android.Util.TypedValue outValue, bool resolveRefs) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
				{
						...
						/// <summary>
						/// <para>Return a TypedArray holding the values defined by <b>Theme</b> which are listed in <b>attrs</b>.</para><para>Be sure to call TypedArray.recycle() when you are done with the array.</para><para><para>Resources::obtainAttributes </para><simplesectsep></simplesectsep><para>obtainStyledAttributes(int, int[]) </para><simplesectsep></simplesectsep><para>obtainStyledAttributes(AttributeSet, int[], int, int) </para></para>        
						/// </summary>
						/// <returns>
						/// <para>Returns a TypedArray holding an array of the attribute values. Be sure to call TypedArray.recycle() when done with it.</para>
						/// </returns>
						...
						/// <summary>
						/// <para>Return a TypedArray holding the values defined by the style resource <b>resid</b> which are listed in <b>attrs</b>.</para><para>Be sure to call TypedArray.recycle() when you are done with the array.</para><para><para>Resources::obtainAttributes </para><simplesectsep></simplesectsep><para>obtainStyledAttributes(int[]) </para><simplesectsep></simplesectsep><para>obtainStyledAttributes(AttributeSet, int[], int, int) </para></para>        
						/// </summary>
						/// <returns>
						/// <para>Returns a TypedArray holding an array of the attribute values. Be sure to call TypedArray.recycle() when done with it.</para>
						/// </returns>
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para>Class to scan Opaque Binary Blob (OBB) files. Use this to get information about an OBB file for use in a program via ObbInfo. </para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Scan a file for OBB information.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>ObbInfo object information corresponding to the file path </para>
				/// </returns>
				/// <java-name>
				/// getObbInfo
				/// </java-name>
				[Dot42.DexImport("getObbInfo", "(Ljava/lang/String;)Landroid/content/res/ObbInfo;", AccessFlags = 9)]
				public static global::Android.Content.Res.ObbInfo GetObbInfo(string filePath) /* MethodBuilder.Create */ 
				{
		...
		public partial class AssetFileDescriptor : global::Android.Os.IParcelable, global::Java.Io.ICloseable
 /* scope: __dot42__ */ 
		{
				/// <summary>
				...
				/// <summary>
				/// <para>Create a new AssetFileDescriptor from the given values. </para>        
				/// </summary>
				...
				[Dot42.DexImport("<init>", "(Landroid/os/ParcelFileDescriptor;JJLandroid/os/Bundle;)V", AccessFlags = 1)]
				public AssetFileDescriptor(global::Android.Os.ParcelFileDescriptor parcelFileDescriptor, long int64, long int641, global::Android.Os.Bundle bundle) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para>Basic information about a Opaque Binary Blob (OBB) that reflects the info from the footer on the OBB file. This information may be manipulated by a developer with the <code>obbtool</code> program in the Android SDK. </para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				/// <summary>
				/// <para>Flag noting that this OBB is an overlay patch for a base OBB. </para>        
				/// </summary>
				/// <java-name>
				/// OBB_OVERLAY
				/// </java-name>
				...
				/// <summary>
				/// <para>The canonical filename of the OBB. </para>        
				/// </summary>
				/// <java-name>
				/// filename
				/// </java-name>
				...
				/// <summary>
				/// <para>The name of the package to which the OBB file belongs. </para>        
				/// </summary>
				/// <java-name>
				/// packageName
				/// </java-name>
				...
				/// <summary>
				/// <para>The version of the package to which the OBB file belongs. </para>        
				/// </summary>
				/// <java-name>
				/// version
				/// </java-name>
				...
				public int Version;
				/// <summary>
				/// <para>The flags relating to the OBB. </para>        
				/// </summary>
				/// <java-name>
				/// flags
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				public int Mcc;
				/// <summary>
				/// <para>IMSI MNC (Mobile Network Code), corresponding to  resource qualifier. 0 if undefined. </para>        
				/// </summary>
				/// <java-name>
				/// mnc
				/// </java-name>
				...
				/// MNC_ZERO
				/// </java-name>
				[Dot42.DexImport("MNC_ZERO", "I", AccessFlags = 25)]
				public const int MNC_ZERO = 65535;
				/// <summary>
				...
				/// <summary>
				/// <para>Constant for screenLayout: a SCREENLAYOUT_SIZE_MASK value indicating the screen is at least approximately 720x960 dp units, corresponds to the  resource qualifier. See  for more information. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				/// <para>Constant for screenLayout: bits that encode the layout direction. </para>        
				/// </summary>
				/// <java-name>
				/// SCREENLAYOUT_LAYOUTDIR_MASK
				/// </java-name>
				[Dot42.DexImport("SCREENLAYOUT_LAYOUTDIR_MASK", "I", AccessFlags = 25)]
				public const int SCREENLAYOUT_LAYOUTDIR_MASK = 192;
				/// <summary>
				/// <para>Constant for screenLayout: bits shift to get the layout direction. </para>        
				/// </summary>
				/// <java-name>
				/// SCREENLAYOUT_LAYOUTDIR_SHIFT
				/// </java-name>
				[Dot42.DexImport("SCREENLAYOUT_LAYOUTDIR_SHIFT", "I", AccessFlags = 25)]
				public const int SCREENLAYOUT_LAYOUTDIR_SHIFT = 6;
				/// <summary>
				/// <para>Constant for screenLayout: a SCREENLAYOUT_LAYOUTDIR_MASK value indicating that no layout dir has been set. </para>        
				/// </summary>
				/// <java-name>
				/// SCREENLAYOUT_LAYOUTDIR_UNDEFINED
				/// </java-name>
				[Dot42.DexImport("SCREENLAYOUT_LAYOUTDIR_UNDEFINED", "I", AccessFlags = 25)]
				public const int SCREENLAYOUT_LAYOUTDIR_UNDEFINED = 0;
				/// <summary>
				/// <para>Constant for screenLayout: a SCREENLAYOUT_LAYOUTDIR_MASK value indicating that a layout dir has been set to LTR. </para>        
				/// </summary>
				/// <java-name>
				/// SCREENLAYOUT_LAYOUTDIR_LTR
				/// </java-name>
				[Dot42.DexImport("SCREENLAYOUT_LAYOUTDIR_LTR", "I", AccessFlags = 25)]
				public const int SCREENLAYOUT_LAYOUTDIR_LTR = 64;
				/// <summary>
				/// <para>Constant for screenLayout: a SCREENLAYOUT_LAYOUTDIR_MASK value indicating that a layout dir has been set to RTL. </para>        
				/// </summary>
				/// <java-name>
				/// SCREENLAYOUT_LAYOUTDIR_RTL
				/// </java-name>
				[Dot42.DexImport("SCREENLAYOUT_LAYOUTDIR_RTL", "I", AccessFlags = 25)]
				public const int SCREENLAYOUT_LAYOUTDIR_RTL = 128;
				/// <summary>
				/// <para>Constant for screenLayout: a value indicating that screenLayout is undefined </para>        
				/// </summary>
				/// <java-name>
				/// SCREENLAYOUT_UNDEFINED
				/// </java-name>
				[Dot42.DexImport("SCREENLAYOUT_UNDEFINED", "I", AccessFlags = 25)]
				public const int SCREENLAYOUT_UNDEFINED = 0;
				/// <summary>
				...
				/// </java-name>
				[Dot42.DexImport("UI_MODE_TYPE_APPLIANCE", "I", AccessFlags = 25)]
				public const int UI_MODE_TYPE_APPLIANCE = 5;
				/// <summary>
				...
				public int UiMode;
				/// <summary>
				/// <para>Default value for screenWidthDp indicating that no width has been specified. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				/// <para>The current width of the available screen space, in dp units, corresponding to  resource qualifier. Set to SCREEN_WIDTH_DP_UNDEFINED if no width is specified. </para>        
				/// </summary>
				/// <java-name>
				/// screenWidthDp
				/// </java-name>
				...
				/// <summary>
				/// <para>Default value for screenHeightDp indicating that no width has been specified. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				/// <para>The current height of the available screen space, in dp units, corresponding to  resource qualifier. Set to SCREEN_HEIGHT_DP_UNDEFINED if no height is specified. </para>        
				/// </summary>
				/// <java-name>
				/// screenHeightDp
				/// </java-name>
				...
				/// <summary>
				/// <para>Default value for smallestScreenWidthDp indicating that no width has been specified. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				/// <para>The smallest screen size an application will see in normal operation, corresponding to  resource qualifier. This is the smallest value of both screenWidthDp and screenHeightDp in both portrait and landscape. Set to SMALLEST_SCREEN_WIDTH_DP_UNDEFINED if no width is specified. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				/// <para>Default value for densityDpi indicating that no width has been specified. </para>        
				/// </summary>
				/// <java-name>
				/// DENSITY_DPI_UNDEFINED
				/// </java-name>
				[Dot42.DexImport("DENSITY_DPI_UNDEFINED", "I", AccessFlags = 25)]
				public const int DENSITY_DPI_UNDEFINED = 0;
				/// <summary>
				/// <para>The target screen density being rendered to, corresponding to  resource qualifier. Set to DENSITY_DPI_UNDEFINED if no density is specified. </para>        
				/// </summary>
				/// <java-name>
				/// densityDpi
				/// </java-name>
				...
				/// <summary>
				/// <para>Check if the Configuration's current screenLayout is at least the given size.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>Returns true if the current screen layout size is at least the given size. </para>
				/// </returns>
				/// <java-name>
				/// isLayoutSizeAtLeast
				/// </java-name>
				[Dot42.DexImport("isLayoutSizeAtLeast", "(I)Z", AccessFlags = 1)]
				public bool IsLayoutSizeAtLeast(int size) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				/// <summary>
				/// <para>Set the locale. This is the preferred way for setting up the locale (instead of using the direct accessor). This will also set the userLocale and layout direction according to the locale.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setLocale
				/// </java-name>
				[Dot42.DexImport("setLocale", "(Ljava/util/Locale;)V", AccessFlags = 1)]
				public void SetLocale(global::Java.Util.Locale loc) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Return the layout direction. Will be either View#LAYOUT_DIRECTION_LTR or View#LAYOUT_DIRECTION_RTL.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>Returns View#LAYOUT_DIRECTION_RTL if the configuration is SCREENLAYOUT_LAYOUTDIR_RTL, otherwise View#LAYOUT_DIRECTION_LTR. </para>
				/// </returns>
				/// <java-name>
				/// getLayoutDirection
				/// </java-name>
				[Dot42.DexImport("getLayoutDirection", "()I", AccessFlags = 1)]
				public int GetLayoutDirection() /* MethodBuilder.Create */ 
				{
						return default(int);
				}

				/// <summary>
				/// <para>Set the layout direction from the Locale.</para><para><para>View#LAYOUT_DIRECTION_LTR and View#LAYOUT_DIRECTION_RTL </para></para>        
				/// </summary>
				/// <java-name>
				/// setLayoutDirection
				/// </java-name>
				[Dot42.DexImport("setLayoutDirection", "(Ljava/util/Locale;)V", AccessFlags = 1)]
				public void SetLayoutDirection(global::Java.Util.Locale locale) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Retrieve a dimensional unit attribute at <b>index</b>. Unit conversions are based on the current DisplayMetrics associated with the resources this TypedArray object came from.</para><para><para>getDimensionPixelOffset </para><simplesectsep></simplesectsep><para>getDimensionPixelSize </para></para>        
				/// </summary>
				/// <returns>
