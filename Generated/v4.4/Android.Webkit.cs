...
namespace Android.Webkit
{
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// getInstance
				/// </java-name>
				[Dot42.DexImport("getInstance", "(Landroid/content/Context;)Landroid/webkit/WebViewDatabase;", AccessFlags = 9)]
		...
		/// </java-name>
		[Dot42.DexImport("android/webkit/WebIconDatabase", AccessFlags = 33)]
 ...
 /* scope: __dot42__ */ 
		{
				...
				public virtual void Open(string path) /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual void RemoveAllIcons() /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual void RequestIconForPageUrl(string url, global::Android.Webkit.WebIconDatabase.IIconListener listener) /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual void RetainIconForPageUrl(string url) /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual void ReleaseIconForPageUrl(string url) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
    ...
    "ng/String;)V", AccessFlags = 1)]
				...
				/// evaluateJavascript
				/// </java-name>
				[Dot42.DexImport("evaluateJavascript", "(Ljava/lang/String;Landroid/webkit/ValueCallback;)V", AccessFlags = 1, Signature = "(Ljava/lang/String;Landroid/webkit/ValueCallback<Ljava/lang/String;>;)V")]
				public virtual void EvaluateJavascript(string @string, global::Android.Webkit.IValueCallback<string> valueCallback) /* MethodBuilder.Create */ 
				{
				}
				...
				/// </java-name>
				[Dot42.DexImport("createPrintDocumentAdapter", "()Landroid/print/PrintDocumentAdapter;", AccessFlags = 1)]
				public virtual global::Android.Print.PrintDocumentAdapter CreatePrintDocumentAdapter() /* MethodBuilder.Create */ 
				{
						return default(global::Android.Print.PrintDocumentAdapter);
				}
				...
				/// <summary>
				/// <para>Registers the listener to be notified as find-on-page operations progress. This will replace the current listener.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setFindListener
				/// </java-name>
				[Dot42.DexImport("setFindListener", "(Landroid/webkit/WebView$FindListener;)V", AccessFlags = 1)]
				public virtual void SetFindListener(global::Android.Webkit.WebView.IFindListener listener) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Finds all instances of find on the page and highlights them, asynchronously. Notifies any registered FindListener. Successive calls to this will cancel any pending searches.</para><para><para>setFindListener </para></para>        
				/// </summary>
				/// <java-name>
				/// findAllAsync
				/// </java-name>
				[Dot42.DexImport("findAllAsync", "(Ljava/lang/String;)V", AccessFlags = 1)]
				public virtual void FindAllAsync(string find) /* MethodBuilder.Create */ 
				{
				}
				...
				/// </java-name>
				[Dot42.DexImport("setWebContentsDebuggingEnabled", "(Z)V", AccessFlags = 9)]
				public static void SetWebContentsDebuggingEnabled(bool boolean) /* MethodBuilder.Create */ 
				{
				}
				...
				/// </java-name>
				[Dot42.DexImport("getAccessibilityNodeProvider", "()Landroid/view/accessibility/AccessibilityNodeProvider;", AccessFlags = 1)]
				public override global::Android.View.Accessibility.AccessibilityNodeProvider GetAccessibilityNodeProvider() /* MethodBuilder.Create */ 
				{
						return default(global::Android.View.Accessibility.AccessibilityNodeProvider);
				}
				...
				/// <summary>
				/// <para>Performs the specified accessibility action on the view. For possible accessibility actions look at AccessibilityNodeInfo. </para><para>If an AccessibilityDelegate has been specified via calling setAccessibilityDelegate(AccessibilityDelegate) its AccessibilityDelegate#performAccessibilityAction(View, int, Bundle) is responsible for handling this call. </para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>Whether the action was performed. </para>
				/// </returns>
				/// <java-name>
				/// performAccessibilityAction
				/// </java-name>
				[Dot42.DexImport("performAccessibilityAction", "(ILandroid/os/Bundle;)Z", AccessFlags = 1)]
				public override bool PerformAccessibilityAction(int action, global::Android.Os.Bundle arguments) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
    ...
    "", AccessFlags = 1)]
				...
				/// <summary>
				/// <para>Specifies the type of layer backing this view. The layer can be LAYER_TYPE_NONE, LAYER_TYPE_SOFTWARE or LAYER_TYPE_HARDWARE.</para><para>A layer is associated with an optional android.graphics.Paint instance that controls how the layer is composed on screen. The following properties of the paint are taken into account when composing the layer:</para><para><ul><li><para>Translucency (alpha) </para></li><li><para>Blending mode </para></li><li><para>Color filter </para></li></ul></para><para>If this view has an alpha value set to &lt; 1.0 by calling setAlpha(float), the alpha value of the layer's paint is superceded by this view's alpha value.</para><para>Refer to the documentation of LAYER_TYPE_NONE, LAYER_TYPE_SOFTWARE and LAYER_TYPE_HARDWARE for more information on when and how to use layers.</para><para><para>getLayerType() </para><simplesectsep></simplesectsep><para>LAYER_TYPE_NONE </para><simplesectsep></simplesectsep><para>LAYER_TYPE_SOFTWARE </para><simplesectsep></simplesectsep><para>LAYER_TYPE_HARDWARE </para><simplesectsep></simplesectsep><para>setAlpha(float)</para>ref android.R.styleable::View_layerType </para>        
				/// </summary>
				/// <java-name>
				/// setLayerType
				/// </java-name>
				[Dot42.DexImport("setLayerType", "(ILandroid/graphics/Paint;)V", AccessFlags = 1)]
				public override void SetLayerType(int layerType, global::Android.Graphics.Paint paint) /* MethodBuilder.Create */ 
				{
				}
				...
				/// getAccessibilityNodeProvider
				/// </java-name>
				public global::Android.View.Accessibility.AccessibilityNodeProvider AccessibilityNodeProvider
				{
				[Dot42.DexImport("getAccessibilityNodeProvider", "()Landroid/view/accessibility/AccessibilityNodeProvider;", AccessFlags = 1)]
						get{ return GetAccessibilityNodeProvider(); }
				}

				/// <java-name>
				/// android/webkit/WebView$HitTestResult
				/// </java-name>
				[Dot42.DexImport("android/webkit/WebView$HitTestResult", AccessFlags = 9)]
 ...
 /* scope: __dot42__ */ 
				{
						...
						[Dot42.DexImport("<init>", "()V", AccessFlags = 0)]
						internal HitTestResult() /* MethodBuilder.Create */ 
						{
						}
 ...
 /* scope: __dot42__ */ 
				...
				/// <summary>
				/// <para>Interface to listen for find results. </para>    
				/// </summary>
				/// <java-name>
				/// android/webkit/WebView$FindListener
				/// </java-name>
				[Dot42.DexImport("android/webkit/WebView$FindListener", AccessFlags = 1545)]
				public partial interface IFindListener
 /* scope: __dot42__ */ 
				{
						/// <summary>
						/// <para>Notifies the listener about progress made by a find operation.</para><para></para>        
						/// </summary>
						/// <java-name>
						/// onFindResultReceived
						/// </java-name>
						[Dot42.DexImport("onFindResultReceived", "(IIZ)V", AccessFlags = 1025)]
						void OnFindResultReceived(int activeMatchOrdinal, int numberOfMatches, bool isDoneCounting) /* MethodBuilder.Create */ ;
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para>Annotation that allows exposing methods to JavaScript. Starting from API level android.os.Build.VERSION_CODES#JELLY_BEAN_MR1 and above, only methods explicitly marked with this annotation are available to the Javascript code. See android.webkit.WebView#addJavascriptInterface for more information about it. </para>    
		/// </summary>
		/// <java-name>
		/// android/webkit/JavascriptInterface
		/// </java-name>
		[Dot42.DexImport("android/webkit/JavascriptInterface", AccessFlags = 9729)]
		public partial interface IJavascriptInterface : global::Java.Lang.Annotation.IAnnotation
 /* scope: __dot42__ */ 
		{
		}
		...
		/// </java-name>
		[Dot42.DexImport("android/webkit/WebStorage", AccessFlags = 33)]
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// </summary>
				[Dot42.DexImport("<init>", "()V", AccessFlags = 0)]
				internal WebStorage() /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual void GetOrigins(global::Android.Webkit.IValueCallback<global::Java.Util.IMap<object, object>> callback) /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual void GetUsageForOrigin(string origin, global::Android.Webkit.IValueCallback<long?> callback) /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual void GetQuotaForOrigin(string origin, global::Android.Webkit.IValueCallback<long?> callback) /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual void SetQuotaForOrigin(string origin, long quota) /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual void DeleteOrigin(string origin) /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual void DeleteAllData() /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		...
		/// </java-name>
		[Dot42.DexImport("android/webkit/WebSettings", AccessFlags = 1057)]
		public abstract partial class WebSettings
 /* scope: __dot42__ */ 
		{
				/// <summary>
				...
				/// <summary>
				/// <para>Sets whether the WebView requires a user gesture to play media. The default is true.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setMediaPlaybackRequiresUserGesture
				/// </java-name>
				[Dot42.DexImport("setMediaPlaybackRequiresUserGesture", "(Z)V", AccessFlags = 1)]
				public virtual void SetMediaPlaybackRequiresUserGesture(bool require) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Gets whether the WebView requires a user gesture to play media.</para><para><para>setMediaPlaybackRequiresUserGesture </para></para>        
				/// </summary>
				/// <returns>
				/// <para>true if the WebView requires a user gesture to play media </para>
				/// </returns>
				/// <java-name>
				/// getMediaPlaybackRequiresUserGesture
				/// </java-name>
				[Dot42.DexImport("getMediaPlaybackRequiresUserGesture", "()Z", AccessFlags = 1)]
				public virtual bool GetMediaPlaybackRequiresUserGesture() /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				/// <summary>
				/// <para>Sets whether JavaScript running in the context of a file scheme URL should be allowed to access content from any origin. This includes access to content from other file scheme URLs. See setAllowFileAccessFromFileURLs. To enable the most restrictive, and therefore secure policy, this setting should be disabled. Note that this setting affects only JavaScript access to file scheme resources. Other access to such resources, for example, from image HTML elements, is unaffected. </para><para>The default value is true for API level android.os.Build.VERSION_CODES#ICE_CREAM_SANDWICH_MR1 and below, and false for API level android.os.Build.VERSION_CODES#JELLY_BEAN and above.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setAllowUniversalAccessFromFileURLs
				/// </java-name>
				[Dot42.DexImport("setAllowUniversalAccessFromFileURLs", "(Z)V", AccessFlags = 1025)]
				public abstract void SetAllowUniversalAccessFromFileURLs(bool flag) /* MethodBuilder.Create */ ;

				/// <summary>
				/// <para>Sets whether JavaScript running in the context of a file scheme URL should be allowed to access content from other file scheme URLs. To enable the most restrictive, and therefore secure policy, this setting should be disabled. Note that the value of this setting is ignored if the value of getAllowUniversalAccessFromFileURLs is true. Note too, that this setting affects only JavaScript access to file scheme resources. Other access to such resources, for example, from image HTML elements, is unaffected. </para><para>The default value is true for API level android.os.Build.VERSION_CODES#ICE_CREAM_SANDWICH_MR1 and below, and false for API level android.os.Build.VERSION_CODES#JELLY_BEAN and above.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setAllowFileAccessFromFileURLs
				/// </java-name>
				[Dot42.DexImport("setAllowFileAccessFromFileURLs", "(Z)V", AccessFlags = 1025)]
				public abstract void SetAllowFileAccessFromFileURLs(bool flag) /* MethodBuilder.Create */ ;
				...
				/// <summary>
				/// <para>Gets whether JavaScript running in the context of a file scheme URL can access content from any origin. This includes access to content from other file scheme URLs.</para><para><para>setAllowUniversalAccessFromFileURLs </para></para>        
				/// </summary>
				/// <returns>
				/// <para>whether JavaScript running in the context of a file scheme URL can access content from any origin </para>
				/// </returns>
				/// <java-name>
				/// getAllowUniversalAccessFromFileURLs
				/// </java-name>
				[Dot42.DexImport("getAllowUniversalAccessFromFileURLs", "()Z", AccessFlags = 1025)]
				public abstract bool GetAllowUniversalAccessFromFileURLs() /* MethodBuilder.Create */ ;

				/// <summary>
				/// <para>Gets whether JavaScript running in the context of a file scheme URL can access content from other file scheme URLs.</para><para><para>setAllowFileAccessFromFileURLs </para></para>        
				/// </summary>
				/// <returns>
				/// <para>whether JavaScript running in the context of a file scheme URL can access content from other file scheme URLs </para>
				/// </returns>
				/// <java-name>
				/// getAllowFileAccessFromFileURLs
				/// </java-name>
				[Dot42.DexImport("getAllowFileAccessFromFileURLs", "()Z", AccessFlags = 1025)]
				public abstract bool GetAllowFileAccessFromFileURLs() /* MethodBuilder.Create */ ;
				...
				/// <summary>
				/// <para>Returns the default User-Agent used by a WebView. An instance of WebView could use a different User-Agent if a call is made to WebSettings#setUserAgentString(String).</para><para></para>        
				/// </summary>
				/// <java-name>
				/// getDefaultUserAgent
				/// </java-name>
				[Dot42.DexImport("getDefaultUserAgent", "(Landroid/content/Context;)Ljava/lang/String;", AccessFlags = 9)]
				public static string GetDefaultUserAgent(global::Android.Content.Context context) /* MethodBuilder.Create */ 
				{
						return default(string);
				}
				...
				/// getMediaPlaybackRequiresUserGesture
				/// </java-name>
				public bool IsMediaPlaybackRequiresUserGesture
				{
				[Dot42.DexImport("getMediaPlaybackRequiresUserGesture", "()Z", AccessFlags = 1)]
						get{ return GetMediaPlaybackRequiresUserGesture(); }
				[Dot42.DexImport("setMediaPlaybackRequiresUserGesture", "(Z)V", AccessFlags = 1)]
						set{ SetMediaPlaybackRequiresUserGesture(value); }
				}
				...
				/// getAllowUniversalAccessFromFileURLs
				/// </java-name>
				public bool IsAllowUniversalAccessFromFileURLs
				{
				[Dot42.DexImport("getAllowUniversalAccessFromFileURLs", "()Z", AccessFlags = 1025)]
						get{ return GetAllowUniversalAccessFromFileURLs(); }
				[Dot42.DexImport("setAllowUniversalAccessFromFileURLs", "(Z)V", AccessFlags = 1025)]
						set{ SetAllowUniversalAccessFromFileURLs(value); }
				}
				...
				/// getAllowFileAccessFromFileURLs
				/// </java-name>
				public bool IsAllowFileAccessFromFileURLs
				{
				[Dot42.DexImport("getAllowFileAccessFromFileURLs", "()Z", AccessFlags = 1025)]
						get{ return GetAllowFileAccessFromFileURLs(); }
				[Dot42.DexImport("setAllowFileAccessFromFileURLs", "(Z)V", AccessFlags = 1025)]
						set{ SetAllowFileAccessFromFileURLs(value); }
				}
 ...
 /* scope: __dot42__ */ 
				{
						...
						/// TEXT_AUTOSIZING
						/// </java-name>
						[Dot42.DexImport("TEXT_AUTOSIZING", "Landroid/webkit/WebSettings$LayoutAlgorithm;", AccessFlags = 16409)]
						public static readonly LayoutAlgorithm TEXT_AUTOSIZING;
 ...
 /* scope: __dot42__ */ 
		...
		/// </java-name>
		[Dot42.DexImport("android/webkit/CookieManager", AccessFlags = 33)]
 ...
 /* scope: __dot42__ */ 
		{
				...
				public virtual void SetAcceptCookie(bool accept) /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual bool AcceptCookie() /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				public virtual void SetCookie(string url, string value) /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual string GetCookie(string uri) /* MethodBuilder.Create */ 
				{
						return default(string);
				}
				...
				public virtual void RemoveSessionCookie() /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual void RemoveAllCookie() /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual bool HasCookies() /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				public virtual void RemoveExpiredCookie() /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		...
		/// </java-name>
		[Dot42.DexImport("android/webkit/GeolocationPermissions", AccessFlags = 33)]
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// </summary>
				[Dot42.DexImport("<init>", "()V", AccessFlags = 0)]
				internal GeolocationPermissions() /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual void GetOrigins(global::Android.Webkit.IValueCallback<global::Java.Util.ISet<string>> callback) /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual void GetAllowed(string origin, global::Android.Webkit.IValueCallback<bool?> callback) /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual void Clear(string origin) /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual void Allow(string origin) /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual void ClearAll() /* MethodBuilder.Create */ 
				{
				}
