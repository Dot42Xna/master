...
namespace Java.Util
{
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Constructs a new <c> ConcurrentModificationException </c> with the given detail message and cause. <para>1.7  1.7 </para></para>        
				/// </summary>
				[Dot42.DexImport("<init>", "(Ljava/lang/String;Ljava/lang/Throwable;)V", AccessFlags = 1)]
				public ConcurrentModificationException(string detailMessage, global::System.Exception cause) /* MethodBuilder.Create */ 
				{
				}

				[Dot42.DexImport("<init>", "(Ljava/lang/Throwable;)V", AccessFlags = 1)]
				public ConcurrentModificationException(global::System.Exception exception) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para><para>Returns a <c> SortedSet </c> of the specified portion of this <c> SortedSet </c> which contains elements greater or equal to the start element but less than the end element. The returned <c> SortedSet </c> is backed by this SortedMap so changes to one set are reflected by the other.</para><para></para></para><para>Equivalent to <c> subSet(fromElement, true, toElement, false) </c> .</para><para></para>        
				/// </summary>
				/// <returns>
				...
				global::Java.Util.ISortedSet<E> SubSet(E fromElement, E toElement) /* MethodBuilder.Create */ ;

				/// <summary>
				/// <para><span>   {@inheritDoc}   &lt;p&gt;Equivalent to @code headSet(toElement, false) @endcode .   @throws ClassCastException       {@inheritDoc}   @throws NullPointerException     {@inheritDoc}   @throws IllegalArgumentException {@inheritDoc}</span> na </para>        
				/// </summary>
				/// <java-name>
				/// headSet
				/// </java-name>
				[Dot42.DexImport("headSet", "(Ljava/lang/Object;)Ljava/util/SortedSet;", AccessFlags = 1025, Signature = "(TE;)Ljava/util/SortedSet<TE;>;")]
				global::Java.Util.ISortedSet<E> HeadSet(E toElement) /* MethodBuilder.Create */ ;

				/// <summary>
				/// <para><para>Returns a <c> SortedSet </c> of the specified portion of this <c> SortedSet </c> which contains elements greater or equal to the start element. The returned <c> SortedSet </c> is backed by this <c> SortedSet </c> so changes to one set are reflected by the other.</para><para></para></para><para>Equivalent to <c> tailSet(fromElement, true) </c> .</para><para></para>        
				/// </summary>
				/// <returns>
				...
				global::Java.Util.ISortedSet<E> TailSet(E fromElement) /* MethodBuilder.Create */ ;
 ...
 /* scope: __dot42__ */ 
		{
				/// <summary>
				/// <para>Inserts the specified element into this queue if it is possible to do so immediately without violating capacity restrictions, returning <code>true</code> upon success and throwing an <code>IllegalStateException</code> if no space is currently available.</para><para></para>        
				/// </summary>
				/// <returns>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Returns a set of all known currencies. <para>1.7  1.7 </para></para>        
				/// </summary>
				/// <java-name>
				/// getAvailableCurrencies
				/// </java-name>
				[Dot42.DexImport("getAvailableCurrencies", "()Ljava/util/Set;", AccessFlags = 9, Signature = "()Ljava/util/Set<Ljava/util/Currency;>;")]
				public static global::Java.Util.ISet<global::Java.Util.Currency> GetAvailableCurrencies() /* MethodBuilder.Create */ 
				{
						return default(global::Java.Util.ISet<global::Java.Util.Currency>);
				}
				...
				/// <summary>
				/// <para>Equivalent to <c> getDisplayName(Locale.getDefault()) </c> . See "&lt;a href="../util/Locale.html::default_locale"&gt;Be wary of the default locale&lt;/a&gt;". <para>1.7  1.7 </para></para>        
				/// </summary>
				/// <java-name>
				/// getDisplayName
				/// </java-name>
				...
				/// <summary>
				/// <para>Returns the localized name of this currency in the given <c> locale </c> . Returns the ISO 4217 currency code if no localized name is available. <para>1.7  1.7 </para></para>        
				/// </summary>
				/// <java-name>
				/// getDisplayName
				/// </java-name>
				...
				/// getAvailableCurrencies
				/// </java-name>
				public static global::Java.Util.ISet<global::Java.Util.Currency> AvailableCurrencies
				{
				[Dot42.DexImport("getAvailableCurrencies", "()Ljava/util/Set;", AccessFlags = 9, Signature = "()Ljava/util/Set<Ljava/util/Currency;>;")]
						get{ return GetAvailableCurrencies(); }
				}
 ...
 /* scope: __dot42__ */ 
		...
		/// java/util/Scanner
		/// </java-name>
		[Dot42.DexImport("java/util/Scanner", AccessFlags = 49, Signature = "Ljava/lang/Object;Ljava/io/Closeable;Ljava/util/Iterator<Ljava/lang/String;>;")]
		public sealed partial class Scanner : global::Java.Io.ICloseable, global::Java.Util.IIterator<string>
 /* scope: __dot42__ */ 
		{
				/// <summary>
 ...
 /* scope: __dot42__ */ 
		...
		/// java/util/Objects
		/// </java-name>
		[Dot42.DexImport("java/util/Objects", AccessFlags = 49)]
		public sealed partial class Objects
 /* scope: __dot42__ */ 
		{
				[Dot42.DexImport("<init>", "()V", AccessFlags = 0)]
				internal Objects() /* MethodBuilder.Create */ 
				{
				}
				...
				/// compare
				/// </java-name>
				[Dot42.DexImport("compare", "(Ljava/lang/Object;Ljava/lang/Object;Ljava/util/Comparator;)I", AccessFlags = 9, Signature = "<T:Ljava/lang/Object;>(TT;TT;Ljava/util/Comparator<-TT;>;)I")]
				public static int Compare<T>(T t, T t1, global::Java.Util.IComparator<T> comparator) /* MethodBuilder.Create */ 
				{
						return default(int);
				}
				...
				/// hash
				/// </java-name>
				[Dot42.DexImport("hash", "([Ljava/lang/Object;)I", AccessFlags = 137)]
				public static int Hash(params object[] @object) /* MethodBuilder.Create */ 
				{
						return default(int);
				}
				...
				/// requireNonNull
				/// </java-name>
				[Dot42.DexImport("requireNonNull", "(Ljava/lang/Object;)Ljava/lang/Object;", AccessFlags = 9, Signature = "<T:Ljava/lang/Object;>(TT;)TT;")]
				public static T RequireNonNull<T>(T t) /* MethodBuilder.Create */ 
				{
						return default(T);
				}
				...
				/// requireNonNull
				/// </java-name>
				[Dot42.DexImport("requireNonNull", "(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;", AccessFlags = 9, Signature = "<T:Ljava/lang/Object;>(TT;Ljava/lang/String;)TT;")]
				public static T RequireNonNull<T>(T t, string @string) /* MethodBuilder.Create */ 
				{
						return default(T);
				}
				...
				/// toString
				/// </java-name>
				[Dot42.DexImport("toString", "(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;", AccessFlags = 9)]
				public static string ToString(object @object, string @string) /* MethodBuilder.Create */ 
				{
						return default(string);
				}
 ...
 /* scope: __dot42__ */ 
    ...
    "til/SortedMap<TK;TV;>;")]
				...
				/// <summary>
				/// <para>Returns an enumeration containing no elements.  1.7 </para>        
				/// </summary>
				/// <java-name>
				/// emptyEnumeration
				/// </java-name>
				[Dot42.DexImport("emptyEnumeration", "()Ljava/util/Enumeration;", AccessFlags = 9, Signature = "<T:Ljava/lang/Object;>()Ljava/util/Enumeration<TT;>;")]
				public static global::Java.Util.IEnumeration<T> EmptyEnumeration<T>() /* MethodBuilder.Create */ 
				{
						return default(global::Java.Util.IEnumeration<T>);
				}

				/// <summary>
				/// <para>Returns an iterator containing no elements.  1.7 </para>        
				/// </summary>
				/// <java-name>
				/// emptyIterator
				/// </java-name>
				[Dot42.DexImport("emptyIterator", "()Ljava/util/Iterator;", AccessFlags = 9, Signature = "<T:Ljava/lang/Object;>()Ljava/util/Iterator<TT;>;")]
				public static global::Java.Util.IIterator<T> EmptyIterator<T>() /* MethodBuilder.Create */ 
				{
						return default(global::Java.Util.IIterator<T>);
				}

				/// <summary>
				/// <para>Returns a list iterator containing no elements.  1.7 </para>        
				/// </summary>
				/// <java-name>
				/// emptyListIterator
				/// </java-name>
				[Dot42.DexImport("emptyListIterator", "()Ljava/util/ListIterator;", AccessFlags = 9, Signature = "<T:Ljava/lang/Object;>()Ljava/util/ListIterator<TT;>;")]
				public static global::Java.Util.IListIterator<T> EmptyListIterator<T>() /* MethodBuilder.Create */ 
				{
						return default(global::Java.Util.IListIterator<T>);
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para><para>Returns a sorted map over a range of this sorted map with all keys greater than or equal to the specified <c> startKey </c> and less than the specified <c> endKey </c> . Changes to the returned sorted map are reflected in this sorted map and vice versa. </para><para>Note: The returned map will not allow an insertion of a key outside the specified range.</para><para></para></para><para>Equivalent to <c> subMap(fromKey, true, toKey, false) </c> .</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>a sorted map with the key from the specified range. </para>
				/// </returns>
				...
				/// </java-name>
				[Dot42.DexImport("subMap", "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/util/SortedMap;", AccessFlags = 1025, Signature = "(TK;TK;)Ljava/util/SortedMap<TK;TV;>;")]
				global::Java.Util.ISortedMap<K, V> SubMap(K fromKey, K toKey) /* MethodBuilder.Create */ ;

				/// <summary>
				/// <para><para>Returns a sorted map over a range of this sorted map with all keys that are less than the specified <c> endKey </c> . Changes to the returned sorted map are reflected in this sorted map and vice versa. </para><para>Note: The returned map will not allow an insertion of a key outside the specified range.</para><para></para></para><para>Equivalent to <c> headMap(toKey, false) </c> .</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>a sorted map where the keys are less than <c> endKey </c> . </para>
				/// </returns>
				...
				/// </java-name>
				[Dot42.DexImport("headMap", "(Ljava/lang/Object;)Ljava/util/SortedMap;", AccessFlags = 1025, Signature = "(TK;)Ljava/util/SortedMap<TK;TV;>;")]
				global::Java.Util.ISortedMap<K, V> HeadMap(K toKey) /* MethodBuilder.Create */ ;

				/// <summary>
				/// <para><para>Returns a sorted map over a range of this sorted map with all keys that are greater than or equal to the specified <c> startKey </c> . Changes to the returned sorted map are reflected in this sorted map and vice versa. </para><para>Note: The returned map will not allow an insertion of a key outside the specified range.</para><para></para></para><para>Equivalent to <c> tailMap(fromKey, true) </c> .</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>a sorted map where the keys are greater or equal to <c> startKey </c> . </para>
				/// </returns>
				...
				/// </java-name>
				[Dot42.DexImport("tailMap", "(Ljava/lang/Object;)Ljava/util/SortedMap;", AccessFlags = 1025, Signature = "(TK;)Ljava/util/SortedMap<TK;TV;>;")]
				global::Java.Util.ISortedMap<K, V> TailMap(K fromKey) /* MethodBuilder.Create */ ;
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Returns the index of the first bit that is set on or before <c> index </c> , or -1 if no lower bits are set or <c> index == -1 </c> . </para>        
				/// </summary>
				/// <java-name>
				/// previousSetBit
				/// </java-name>
				[Dot42.DexImport("previousSetBit", "(I)I", AccessFlags = 1)]
				public virtual int PreviousSetBit(int index) /* MethodBuilder.Create */ 
				{
						return default(int);
				}

				/// <summary>
				/// <para>Returns the index of the first bit that is clear on or before <c> index </c> , or -1 if no lower bits are clear or <c> index == -1 </c> . </para>        
				/// </summary>
				/// <java-name>
				/// previousClearBit
				/// </java-name>
				[Dot42.DexImport("previousClearBit", "(I)I", AccessFlags = 1)]
				public virtual int PreviousClearBit(int index) /* MethodBuilder.Create */ 
				{
						return default(int);
				}
				...
				/// <summary>
				/// <para>Returns a <c> BitSet </c> corresponding to <c> longBuffer </c> , interpreted as a little-endian sequence of bits. This method does not alter the <c> LongBuffer </c> .  1.7 </para>        
				/// </summary>
				/// <java-name>
				/// valueOf
				/// </java-name>
				[Dot42.DexImport("valueOf", "([J)Ljava/util/BitSet;", AccessFlags = 9)]
				public static global::Java.Util.BitSet ValueOf(long[] longBuffer) /* MethodBuilder.Create */ 
				{
						return default(global::Java.Util.BitSet);
				}
				...
				/// valueOf
				/// </java-name>
				[Dot42.DexImport("valueOf", "(Ljava/nio/LongBuffer;)Ljava/util/BitSet;", AccessFlags = 9)]
				public static global::Java.Util.BitSet ValueOf(global::Java.Nio.LongBuffer longBuffer) /* MethodBuilder.Create */ 
				{
						return default(global::Java.Util.BitSet);
				}
				...
				/// valueOf
				/// </java-name>
				[Dot42.DexImport("valueOf", "([B)Ljava/util/BitSet;", AccessFlags = 9)]
				public static global::Java.Util.BitSet ValueOf(sbyte[] longBuffer) /* MethodBuilder.Create */ 
				{
						return default(global::Java.Util.BitSet);
				}
				...
				/// valueOf
				/// </java-name>
				[Dot42.DexImport("valueOf", "([B)Ljava/util/BitSet;", AccessFlags = 9, IgnoreFromJava = true)]
				public static global::Java.Util.BitSet ValueOf(byte[] longBuffer) /* MethodBuilder.Create */ 
				{
						return default(global::Java.Util.BitSet);
				}
				...
				/// valueOf
				/// </java-name>
				[Dot42.DexImport("valueOf", "(Ljava/nio/ByteBuffer;)Ljava/util/BitSet;", AccessFlags = 9)]
				public static global::Java.Util.BitSet ValueOf(global::Java.Nio.ByteBuffer longBuffer) /* MethodBuilder.Create */ 
				{
						return default(global::Java.Util.BitSet);
				}

				/// <summary>
				/// <para>Returns a new <c> long[] </c> containing a little-endian representation of the bits of this <c> BitSet </c> , suitable for passing to <c> valueOf </c> to reconstruct this <c> BitSet </c> .  1.7 </para>        
				/// </summary>
				/// <java-name>
				/// toLongArray
				/// </java-name>
				[Dot42.DexImport("toLongArray", "()[J", AccessFlags = 1)]
				public virtual long[] ToLongArray() /* MethodBuilder.Create */ 
				{
						return default(long[]);
				}

				/// <summary>
				/// <para>Returns a new <c> byte[] </c> containing a little-endian representation the bits of this <c> BitSet </c> , suitable for passing to <c> valueOf </c> to reconstruct this <c> BitSet </c> .  1.7 </para>        
				/// </summary>
				/// <java-name>
				/// toByteArray
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Returns <code>true</code> if this deque contains the specified element. More formally, returns <code>true</code> if and only if this deque contains at least one element <code>e</code> such that <code>(o==null ? e==null : o.equals(e))</code>.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para><code>true</code> if this deque contains the specified element </para>
				/// </returns>
