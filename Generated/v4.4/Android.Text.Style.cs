...
namespace Android.Text.Style
{
 ...
 /* scope: __dot42__ */ 
		{
				/// <summary>
				/// <para>The extra key field in the pending intent that describes how the text changed.</para><para><para>TEXT_DELETED </para><simplesectsep></simplesectsep><para>TEXT_MODIFIED </para><simplesectsep></simplesectsep><para>getPendingIntent() </para></para>        
				/// </summary>
				/// <java-name>
				/// EXTRA_TEXT_CHANGED_TYPE
				/// </java-name>
				[Dot42.DexImport("EXTRA_TEXT_CHANGED_TYPE", "Ljava/lang/String;", AccessFlags = 25)]
				public const string EXTRA_TEXT_CHANGED_TYPE = "android.text.style.EXTRA_TEXT_CHANGED_TYPE";
				/// <summary>
				/// <para>The value of EXTRA_TEXT_CHANGED_TYPE when the text wrapped by this span is deleted. </para>        
				/// </summary>
				/// <java-name>
				/// TEXT_DELETED
				/// </java-name>
				[Dot42.DexImport("TEXT_DELETED", "I", AccessFlags = 25)]
				public const int TEXT_DELETED = 1;
				/// <summary>
				/// <para>The value of EXTRA_TEXT_CHANGED_TYPE when the text wrapped by this span is modified. </para>        
				/// </summary>
				/// <java-name>
				/// TEXT_MODIFIED
				/// </java-name>
				[Dot42.DexImport("TEXT_MODIFIED", "I", AccessFlags = 25)]
				public const int TEXT_MODIFIED = 2;
				/// <summary>
				...
				public EasyEditSpan(global::Android.App.PendingIntent pendingIntent) /* MethodBuilder.Create */ 
				{
				}
				...
				/// </summary>
				[Dot42.DexImport("<init>", "(Landroid/os/Parcel;)V", AccessFlags = 1)]
				public EasyEditSpan(global::Android.Os.Parcel pendingIntent) /* MethodBuilder.Create */ 
				{
				}
