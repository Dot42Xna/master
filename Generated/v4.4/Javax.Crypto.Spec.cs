...
namespace Javax.Crypto.Spec
{
 ...
 /* scope: __dot42__ */ 
		{
				[Dot42.DexImport("<init>", "(I[B)V", AccessFlags = 1)]
				public GCMParameterSpec(int int32, sbyte[] sByte) /* MethodBuilder.Create */ 
				{
				}

				[Dot42.DexImport("<init>", "(I[B)V", AccessFlags = 1, IgnoreFromJava = true)]
				public GCMParameterSpec(int int32, byte[] @byte) /* MethodBuilder.Create */ 
				{
				}

				[Dot42.DexImport("<init>", "(I[BII)V", AccessFlags = 1)]
				public GCMParameterSpec(int int32, sbyte[] sByte, int int321, int int322) /* MethodBuilder.Create */ 
				{
				}

				[Dot42.DexImport("<init>", "(I[BII)V", AccessFlags = 1, IgnoreFromJava = true)]
				public GCMParameterSpec(int int32, byte[] @byte, int int321, int int322) /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual int GetTLen() /* MethodBuilder.Create */ 
				{
						return default(int);
				}
