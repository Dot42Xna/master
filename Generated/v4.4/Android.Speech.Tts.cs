...
namespace Android.Speech.Tts
{
 ...
 /* scope: __dot42__ */ 
    ...
    "ang/String;)V", AccessFlags = 1)]
				...
				/// <summary>
				/// <para>Returns a Locale instance describing the language currently being used as the default Text-to-speech language.</para><para></para>        
				/// </summary>
				/// <returns>
				...
				/// getDefaultLanguage
				/// </java-name>
				[Dot42.DexImport("getDefaultLanguage", "()Ljava/util/Locale;", AccessFlags = 1)]
				public virtual global::Java.Util.Locale GetDefaultLanguage() /* MethodBuilder.Create */ 
				{
    ...
    "/lang/String;)I")]
				...
				/// <summary>
				/// <para>Limit of length of input string passed to speak and synthesizeToFile.</para><para><para>speak </para><simplesectsep></simplesectsep><para>synthesizeToFile </para></para>        
				/// </summary>
				/// <java-name>
				/// getMaxSpeechInputLength
				/// </java-name>
				[Dot42.DexImport("getMaxSpeechInputLength", "()I", AccessFlags = 9)]
				public static int GetMaxSpeechInputLength() /* MethodBuilder.Create */ 
				{
						return default(int);
				}
				...
				/// getDefaultLanguage
				/// </java-name>
				public global::Java.Util.Locale DefaultLanguage
				{
				[Dot42.DexImport("getDefaultLanguage", "()Ljava/util/Locale;", AccessFlags = 1)]
						get{ return GetDefaultLanguage(); }
				}
				...
				{
				[Dot42.DexImport("getMaxSpeechInputLength", "()I", AccessFlags = 9)]
						get{ return GetMaxSpeechInputLength(); }
				}
 ...
 /* scope: __dot42__ */ 
				{
						...
						/// <summary>
						/// <para>Activity intent for getting some sample text to use for demonstrating TTS. Specific locale have to be requested by passing following extra parameters: <ul><li><para>language </para></li><li><para>country </para></li><li><para>variant </para></li></ul></para><para>Upon completion, the activity result may contain the following fields: <ul><li><para>EXTRA_SAMPLE_TEXT which contains an String with sample text. </para></li></ul></para>        
						/// </summary>
						/// <java-name>
						/// ACTION_GET_SAMPLE_TEXT
						/// </java-name>
						[Dot42.DexImport("ACTION_GET_SAMPLE_TEXT", "Ljava/lang/String;", AccessFlags = 25)]
						public const string ACTION_GET_SAMPLE_TEXT = "android.speech.tts.engine.GET_SAMPLE_TEXT";
						/// <summary>
						/// <para>Extra information received with the ACTION_GET_SAMPLE_TEXT intent result where the TextToSpeech engine returns an String with sample text for requested voice </para>        
						/// </summary>
						/// <java-name>
						/// EXTRA_SAMPLE_TEXT
						/// </java-name>
						[Dot42.DexImport("EXTRA_SAMPLE_TEXT", "Ljava/lang/String;", AccessFlags = 25)]
						public const string EXTRA_SAMPLE_TEXT = "sampleText";
						/// <summary>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// getCallerUid
				/// </java-name>
				[Dot42.DexImport("getCallerUid", "()I", AccessFlags = 1)]
				public int GetCallerUid() /* MethodBuilder.Create */ 
				{
						return default(int);
				}
