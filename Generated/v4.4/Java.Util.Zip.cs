...
namespace Java.Util.Zip
{
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Use buffering for best compression.</para><para><para>1.7 </para></para>        
				/// </summary>
				/// <java-name>
				/// NO_FLUSH
				/// </java-name>
				[Dot42.DexImport("NO_FLUSH", "I", AccessFlags = 25)]
				public const int NO_FLUSH = 0;
				/// <summary>
				/// <para>Flush buffers so recipients can immediately decode the data sent thus far. This mode may degrade compression.</para><para><para>1.7 </para></para>        
				/// </summary>
				/// <java-name>
				/// SYNC_FLUSH
				/// </java-name>
				[Dot42.DexImport("SYNC_FLUSH", "I", AccessFlags = 25)]
				public const int SYNC_FLUSH = 2;
				/// <summary>
				/// <para>Flush buffers so recipients can immediately decode the data sent thus far. The compression state is also reset to permit random access and recovery for clients who have discarded or damaged their own copy. This mode may degrade compression.</para><para><para>1.7 </para></para>        
				/// </summary>
				/// <java-name>
				/// FULL_FLUSH
				/// </java-name>
				[Dot42.DexImport("FULL_FLUSH", "I", AccessFlags = 25)]
				...
				/// <summary>
				/// <para>Deflates data (previously passed to setInput) into a specific region within the supplied buffer, optionally flushing the input buffer.</para><para><para>1.7 </para></para>        
				/// </summary>
				/// <returns>
				/// <para>the number of compressed bytes written to <c> buf </c> . If this equals <c> byteCount </c> , the number of bytes of input to be flushed may have exceeded the output buffer's capacity. In this case, finishing a flush will require the output buffer to be drained and additional calls to deflate to be made.  </para>
				/// </returns>
				/// <java-name>
				/// deflate
				/// </java-name>
				[Dot42.DexImport("deflate", "([BIII)I", AccessFlags = 33)]
				public virtual int Deflate(sbyte[] buf, int offset, int byteCount, int flush) /* MethodBuilder.Create */ 
				{
						return default(int);
				}
				...
				/// deflate
				/// </java-name>
				[Dot42.DexImport("deflate", "([BIII)I", AccessFlags = 33, IgnoreFromJava = true)]
				public virtual int Deflate(byte[] buf, int offset, int byteCount, int flush) /* MethodBuilder.Create */ 
				{
						return default(int);
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				public DeflaterOutputStream(global::Java.Io.OutputStream os, bool def) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <para>This constructor lets you specify both the compression algorithm as well as the internal buffer size to be used.</para><para></para>        
				/// </summary>
				[Dot42.DexImport("<init>", "(Ljava/io/OutputStream;Ljava/util/zip/Deflater;Z)V", AccessFlags = 1)]
				public DeflaterOutputStream(global::Java.Io.OutputStream os, global::Java.Util.Zip.Deflater def, bool bufferSize) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para><para>1.7 </para></para>        
				/// </summary>
				[Dot42.DexImport("<init>", "(Ljava/io/OutputStream;Ljava/util/zip/Deflater;IZ)V", AccessFlags = 1)]
				public DeflaterOutputStream(global::Java.Io.OutputStream os, global::Java.Util.Zip.Deflater def, int bufferSize, bool syncFlush) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// </summary>
				[Dot42.DexImport("<init>", "(Ljava/io/OutputStream;Z)V", AccessFlags = 1)]
				public GZIPOutputStream(global::Java.Io.OutputStream os, bool size) /* MethodBuilder.Create */ 
				{
				}
				...
				[Dot42.DexImport("<init>", "(Ljava/io/OutputStream;IZ)V", AccessFlags = 1)]
				public GZIPOutputStream(global::Java.Io.OutputStream outputStream, int int32, bool boolean) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		...
		public partial class ZipFile : global::Java.Io.ICloseable
 /* scope: __dot42__ */ 
		{
				/// <summary>
