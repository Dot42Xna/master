...
//
// Original filename: Android.Content.Pm.cs
//
...
namespace Android.Content.Pm
{
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>PackageInfo flag: include disabled components which are in that state only because of COMPONENT_ENABLED_STATE_DISABLED_UNTIL_USED in the returned info. Note that if you set this flag, applications that are in this disabled state will be reported as enabled. </para>        
				/// </summary>
				/// <java-name>
				/// GET_DISABLED_UNTIL_USED_COMPONENTS
				/// </java-name>
				[Dot42.DexImport("GET_DISABLED_UNTIL_USED_COMPONENTS", "I", AccessFlags = 25)]
				public const int GET_DISABLED_UNTIL_USED_COMPONENTS = 32768;
				/// <summary>
				...
				/// <summary>
				/// <para>Flag for setApplicationEnabledSetting(String, int, int) only: The user has explicitly disabled the application, regardless of what it has specified in its manifest. Because this is due to the user's request, they may re-enable it if desired through the appropriate system UI. This option currently <b>cannot</b> be used with setComponentEnabledSetting(ComponentName, int, int). </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				/// <para>Used as the <c> verificationCode </c> argument for PackageManager#verifyPendingInstall to indicate that the calling package verifier allows the installation to proceed. </para>        
				/// </summary>
				/// <java-name>
				/// VERIFICATION_ALLOW
				/// </java-name>
				...
				/// <summary>
				/// <para>Used as the <c> verificationCode </c> argument for PackageManager#verifyPendingInstall to indicate the calling package verifier does not vote to allow the installation to proceed. </para>        
				/// </summary>
				/// <java-name>
				/// VERIFICATION_REJECT
				/// </java-name>
				...
				/// <summary>
				/// <para>Can be used as the <c> millisecondsToDelay </c> argument for PackageManager#extendVerificationTimeout. This is the maximum time <c> PackageManager </c> waits for the verification agent to return (in milliseconds). </para>        
				/// </summary>
				/// <java-name>
				/// MAXIMUM_VERIFICATION_TIMEOUT
				/// </java-name>
				[Dot42.DexImport("MAXIMUM_VERIFICATION_TIMEOUT", "J", AccessFlags = 25)]
				public const long MAXIMUM_VERIFICATION_TIMEOUT = 3600000;
				/// <summary>
				...
				/// <summary>
				/// <para>Feature for getSystemAvailableFeatures and hasSystemFeature: The device is capable of communicating with other devices via Bluetooth Low Energy radio. </para>        
				/// </summary>
				/// <java-name>
				/// FEATURE_BLUETOOTH_LE
				/// </java-name>
				[Dot42.DexImport("FEATURE_BLUETOOTH_LE", "Ljava/lang/String;", AccessFlags = 25)]
				...
				/// <summary>
				/// <para>Feature for getSystemAvailableFeatures and hasSystemFeature: The device has at least one camera pointing in some direction. </para>        
				/// </summary>
				/// <java-name>
				/// FEATURE_CAMERA_ANY
				/// </java-name>
				[Dot42.DexImport("FEATURE_CAMERA_ANY", "Ljava/lang/String;", AccessFlags = 25)]
				...
				/// FEATURE_CONSUMER_IR
				/// </java-name>
				[Dot42.DexImport("FEATURE_CONSUMER_IR", "Ljava/lang/String;", AccessFlags = 25)]
				...
				/// </java-name>
				[Dot42.DexImport("FEATURE_NFC_HOST_CARD_EMULATION", "Ljava/lang/String;", AccessFlags = 25)]
				...
				/// </java-name>
				[Dot42.DexImport("FEATURE_SENSOR_STEP_COUNTER", "Ljava/lang/String;", AccessFlags = 25)]
				public const string FEATURE_SENSOR_STEP_COUNTER = "android.hardware.sensor.stepcounter";
				/// <java-name>
				/// FEATURE_SENSOR_STEP_DETECTOR
				/// </java-name>
				[Dot42.DexImport("FEATURE_SENSOR_STEP_DETECTOR", "Ljava/lang/String;", AccessFlags = 25)]
				...
				/// <summary>
				/// <para>Feature for getSystemAvailableFeatures and hasSystemFeature: The device supports app widgets. </para>        
				/// </summary>
				/// <java-name>
				/// FEATURE_APP_WIDGETS
				/// </java-name>
				[Dot42.DexImport("FEATURE_APP_WIDGETS", "Ljava/lang/String;", AccessFlags = 25)]
				public const string FEATURE_APP_WIDGETS = "android.software.app_widgets";
				/// <summary>
				/// <para>Feature for getSystemAvailableFeatures and hasSystemFeature: The device supports a home screen that is replaceable by third party applications. </para>        
				/// </summary>
				/// <java-name>
				/// FEATURE_HOME_SCREEN
				/// </java-name>
				[Dot42.DexImport("FEATURE_HOME_SCREEN", "Ljava/lang/String;", AccessFlags = 25)]
				public const string FEATURE_HOME_SCREEN = "android.software.home_screen";
				/// <summary>
				/// <para>Feature for getSystemAvailableFeatures and hasSystemFeature: The device supports adding new input methods implemented with the android.inputmethodservice.InputMethodService API. </para>        
				/// </summary>
				/// <java-name>
				/// FEATURE_INPUT_METHODS
				/// </java-name>
				[Dot42.DexImport("FEATURE_INPUT_METHODS", "Ljava/lang/String;", AccessFlags = 25)]
				public const string FEATURE_INPUT_METHODS = "android.software.input_methods";
				/// <java-name>
				/// FEATURE_DEVICE_ADMIN
				/// </java-name>
				[Dot42.DexImport("FEATURE_DEVICE_ADMIN", "Ljava/lang/String;", AccessFlags = 25)]
				...
				/// <summary>
				/// <para>Feature for getSystemAvailableFeatures and hasSystemFeature: The device supports Wi-Fi Direct networking. </para>        
				/// </summary>
				/// <java-name>
				/// FEATURE_WIFI_DIRECT
				/// </java-name>
				...
				/// <summary>
				/// <para>Feature for getSystemAvailableFeatures and hasSystemFeature: This is a device dedicated to showing UI on a television. Television here is defined to be a typical living room television experience: displayed on a big screen, where the user is sitting far away from it, and the dominant form of input will be something like a DPAD, not through touch or mouse. </para>        
				/// </summary>
				/// <java-name>
				/// FEATURE_TELEVISION
				/// </java-name>
				[Dot42.DexImport("FEATURE_TELEVISION", "Ljava/lang/String;", AccessFlags = 25)]
				public const string FEATURE_TELEVISION = "android.hardware.type.television";
				/// <summary>
				/// <para>Extra field name for the ID of a package pending verification. Passed to a package verifier and is used to call back to PackageManager#verifyPendingInstall(int, int) </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				/// <para>Extra field name for the result of a verification, either VERIFICATION_ALLOW, or VERIFICATION_REJECT. Passed to package verifiers after a package is verified. </para>        
				/// </summary>
				/// <java-name>
				/// EXTRA_VERIFICATION_RESULT
				/// </java-name>
				[Dot42.DexImport("EXTRA_VERIFICATION_RESULT", "Ljava/lang/String;", AccessFlags = 25)]
				public const string EXTRA_VERIFICATION_RESULT = "android.content.pm.extra.VERIFICATION_RESULT";
				...
				/// <summary>
				/// <para>Return a List of all installed packages that are currently holding any of the given permissions.</para><para><para>GET_ACTIVITIES </para><simplesectsep></simplesectsep><para>GET_GIDS </para><simplesectsep></simplesectsep><para>GET_CONFIGURATIONS </para><simplesectsep></simplesectsep><para>GET_INSTRUMENTATION </para><simplesectsep></simplesectsep><para>GET_PERMISSIONS </para><simplesectsep></simplesectsep><para>GET_PROVIDERS </para><simplesectsep></simplesectsep><para>GET_RECEIVERS </para><simplesectsep></simplesectsep><para>GET_SERVICES </para><simplesectsep></simplesectsep><para>GET_SIGNATURES </para><simplesectsep></simplesectsep><para>GET_UNINSTALLED_PACKAGES </para></para>        
				/// </summary>
				/// <returns>
				/// <para>Returns a List of PackageInfo objects, one for each installed application that is holding any of the permissions that were provided.</para>
				/// </returns>
				/// <java-name>
				/// getPackagesHoldingPermissions
				/// </java-name>
				[Dot42.DexImport("getPackagesHoldingPermissions", "([Ljava/lang/String;I)Ljava/util/List;", AccessFlags = 1025, Signature = "([Ljava/lang/String;I)Ljava/util/List<Landroid/content/pm/PackageInfo;>;")]
				public abstract global::Java.Util.IList<global::Android.Content.Pm.PackageInfo> GetPackagesHoldingPermissions(string[] permissions, int flags) /* MethodBuilder.Create */ ;
    ...
    "I)Ljava/util/List<Landroid/content/pm/ResolveInfo;>;")]
				...
				/// </java-name>
				[Dot42.DexImport("queryIntentContentProviders", "(Landroid/content/Intent;I)Ljava/util/List;", AccessFlags = 1025, Signature = "(Landroid/content/Intent;I)Ljava/util/List<Landroid/content/pm/ResolveInfo;>;")]
				public abstract global::Java.Util.IList<global::Android.Content.Pm.ResolveInfo> QueryIntentContentProviders(global::Android.Content.Intent intent, int int32) /* MethodBuilder.Create */ ;
    ...
    "le/Drawable;", AccessFlags = 1025)]
				public abstract global::Android.Graphics.Drawable.Drawable GetDrawable(string packageName, int resid, global::Android.Content.Pm.ApplicationInfo appInfo) /* MethodBuilder.Create */ ;
				...
				public abstract global::Android.Graphics.Drawable.Drawable GetActivityIcon(global::Android.Content.ComponentName activityName) /* MethodBuilder.Create */ ;
				...
				public abstract global::Android.Graphics.Drawable.Drawable GetActivityIcon(global::Android.Content.Intent activityName) /* MethodBuilder.Create */ ;
				...
				public abstract global::Android.Graphics.Drawable.Drawable GetApplicationIcon(global::Android.Content.Pm.ApplicationInfo info) /* MethodBuilder.Create */ ;
				...
				public abstract global::Android.Graphics.Drawable.Drawable GetApplicationIcon(string info) /* MethodBuilder.Create */ ;
				...
				public abstract global::Android.Graphics.Drawable.Drawable GetActivityLogo(global::Android.Content.ComponentName activityName) /* MethodBuilder.Create */ ;
				...
				public abstract global::Android.Graphics.Drawable.Drawable GetActivityLogo(global::Android.Content.Intent activityName) /* MethodBuilder.Create */ ;
				...
				public abstract global::Android.Graphics.Drawable.Drawable GetApplicationLogo(global::Android.Content.Pm.ApplicationInfo info) /* MethodBuilder.Create */ ;
				...
				public abstract global::Android.Graphics.Drawable.Drawable GetApplicationLogo(string info) /* MethodBuilder.Create */ ;
    ...
    "ResourceParser;", AccessFlags = 1025)]
				...
				public abstract void VerifyPendingInstall(int id, int verificationCode) /* MethodBuilder.Create */ ;

				/// <summary>
				/// <para>Allows a package listening to the package verification broadcast to extend the default timeout for a response and declare what action to perform after the timeout occurs. The response must include the <c> verificationCodeAtTimeout </c> which is one of PackageManager#VERIFICATION_ALLOW or PackageManager#VERIFICATION_REJECT.</para><para>This method may only be called once per package id. Additional calls will have no effect.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// extendVerificationTimeout
				/// </java-name>
				[Dot42.DexImport("extendVerificationTimeout", "(IIJ)V", AccessFlags = 1025)]
				public abstract void ExtendVerificationTimeout(int id, int verificationCodeAtTimeout, long millisecondsToDelay) /* MethodBuilder.Create */ ;
 ...
 /* scope: __dot42__ */ 
		{
				...
				public virtual global::Android.Graphics.Drawable.Drawable LoadIcon(global::Android.Content.Pm.PackageManager pm) /* MethodBuilder.Create */ 
				{
				...
				public virtual global::Android.Graphics.Drawable.Drawable LoadLogo(global::Android.Content.Pm.PackageManager pm) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Graphics.Drawable.Drawable);
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Bit in flags: If set, a single instance of the provider will run for all users on the device. Set from the android.R.attr#singleUser attribute. </para>        
				/// </summary>
				/// <java-name>
				/// FLAG_SINGLE_USER
				/// </java-name>
				[Dot42.DexImport("FLAG_SINGLE_USER", "I", AccessFlags = 25)]
				public const int FLAG_SINGLE_USER = 1073741824;
				/// <summary>
				/// <para>Options that have been set in the provider declaration in the manifest. These include: FLAG_SINGLE_USER. </para>        
				/// </summary>
				/// <java-name>
				/// flags
				/// </java-name>
				...
				/// </java-name>
				[Dot42.DexImport("writeToParcel", "(Landroid/os/Parcel;I)V", AccessFlags = 1)]
				public override void WriteToParcel(global::Android.Os.Parcel @out, int parcelableFlags) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Additional flag for protectionLevel, corresponding to the <code>system</code> value of android.R.attr#protectionLevel. </para>        
				/// </summary>
				/// <java-name>
				/// PROTECTION_FLAG_SYSTEM
				/// </java-name>
				[Dot42.DexImport("PROTECTION_FLAG_SYSTEM", "I", AccessFlags = 25)]
				public const int PROTECTION_FLAG_SYSTEM = 16;
				/// <summary>
				/// <para>Additional flag for protectionLevel, corresponding to the <code>development</code> value of android.R.attr#protectionLevel. </para>        
				/// </summary>
				/// <java-name>
				/// PROTECTION_FLAG_DEVELOPMENT
				/// </java-name>
				[Dot42.DexImport("PROTECTION_FLAG_DEVELOPMENT", "I", AccessFlags = 25)]
				public const int PROTECTION_FLAG_DEVELOPMENT = 32;
				/// <summary>
				/// <para>Mask for protectionLevel: the basic protection type. </para>        
				/// </summary>
				/// <java-name>
				/// PROTECTION_MASK_BASE
				/// </java-name>
				[Dot42.DexImport("PROTECTION_MASK_BASE", "I", AccessFlags = 25)]
				public const int PROTECTION_MASK_BASE = 15;
				/// <summary>
				/// <para>Mask for protectionLevel: additional flag bits. </para>        
				/// </summary>
				/// <java-name>
				/// PROTECTION_MASK_FLAGS
				/// </java-name>
				[Dot42.DexImport("PROTECTION_MASK_FLAGS", "I", AccessFlags = 25)]
				public const int PROTECTION_MASK_FLAGS = 240;
				/// <summary>
				...
				public string Group;
				/// <summary>
				/// <para>Flag for flags, corresponding to <code>costsMoney</code> value of android.R.attr#permissionFlags. </para>        
				/// </summary>
				/// <java-name>
				/// FLAG_COSTS_MONEY
				/// </java-name>
				[Dot42.DexImport("FLAG_COSTS_MONEY", "I", AccessFlags = 25)]
				public const int FLAG_COSTS_MONEY = 1;
				/// <summary>
				/// <para>Additional flags about this permission as given by android.R.attr#permissionFlags. </para>        
				/// </summary>
				/// <java-name>
				/// flags
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Array of flags of all &lt;uses-permission&gt; tags included under &lt;manifest&gt;, or null if there were none. This is only filled in if the flag PackageManager#GET_PERMISSIONS was set. Each value matches the corresponding entry in requestedPermissions, and will have the flags REQUESTED_PERMISSION_REQUIRED and REQUESTED_PERMISSION_GRANTED set as appropriate. </para>        
				/// </summary>
				/// <java-name>
				/// requestedPermissionsFlags
				/// </java-name>
				[Dot42.DexImport("requestedPermissionsFlags", "[I", AccessFlags = 1)]
				public int[] RequestedPermissionsFlags;
				/// <summary>
				/// <para>Flag for requestedPermissionsFlags: the requested permission is required for the application to run; the user can not optionally disable it. Currently all permissions are required. </para>        
				/// </summary>
				/// <java-name>
				/// REQUESTED_PERMISSION_REQUIRED
				/// </java-name>
				[Dot42.DexImport("REQUESTED_PERMISSION_REQUIRED", "I", AccessFlags = 25)]
				public const int REQUESTED_PERMISSION_REQUIRED = 1;
				/// <summary>
				/// <para>Flag for requestedPermissionsFlags: the requested permission is currently granted to the application. </para>        
				/// </summary>
				/// <java-name>
				/// REQUESTED_PERMISSION_GRANTED
				/// </java-name>
				[Dot42.DexImport("REQUESTED_PERMISSION_GRANTED", "I", AccessFlags = 25)]
				public const int REQUESTED_PERMISSION_GRANTED = 2;
				/// <summary>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// getLogoResource
				/// </java-name>
				[Dot42.DexImport("getLogoResource", "()I", AccessFlags = 17)]
				public int GetLogoResource() /* MethodBuilder.Create */ 
				{
						return default(int);
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>The default extra UI options for activities in this application. Set from the android.R.attr#uiOptions attribute in the activity's manifest. </para>        
				/// </summary>
				/// <java-name>
				/// uiOptions
				/// </java-name>
				...
				/// <summary>
				/// <para>Value for flags: true when the application is willing to support RTL (right to left). All activities will inherit this value.</para><para>Set from the android.R.attr#supportsRtl attribute in the activity's manifest.</para><para>Default value is false (no support for RTL). </para>        
				/// </summary>
				/// <java-name>
				/// FLAG_SUPPORTS_RTL
				/// </java-name>
				[Dot42.DexImport("FLAG_SUPPORTS_RTL", "I", AccessFlags = 25)]
				public const int FLAG_SUPPORTS_RTL = 4194304;
				/// <summary>
				/// <para>Value for flags: true if the application is currently installed for the calling user. </para>        
				/// </summary>
				/// <java-name>
				/// FLAG_INSTALLED
				/// </java-name>
				[Dot42.DexImport("FLAG_INSTALLED", "I", AccessFlags = 25)]
				public const int FLAG_INSTALLED = 8388608;
				/// <summary>
				/// <para>Value for flags: true if the application only has its data installed; the application package itself does not currently exist on the device. </para>        
				/// </summary>
				/// <java-name>
				/// FLAG_IS_DATA_ONLY
				/// </java-name>
				[Dot42.DexImport("FLAG_IS_DATA_ONLY", "I", AccessFlags = 25)]
				public const int FLAG_IS_DATA_ONLY = 16777216;
				/// <summary>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Size of the secure container on external storage holding the application's code. </para>        
				/// </summary>
				/// <java-name>
				/// externalCodeSize
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Bit in flags corresponding to an immersive activity that wishes not to be interrupted by notifications. Applications that hide the system notification bar with android.view.WindowManager.LayoutParams#FLAG_FULLSCREEN may still be interrupted by high-priority notifications; for example, an incoming phone call may use fullScreenIntent to present a full-screen in-call activity to the user, pausing the current activity as a side-effect. An activity with FLAG_IMMERSIVE set, however, will not be interrupted; the notification may be shown in some other way (such as a small floating "toast" window).</para><para>Note that this flag will always reflect the Activity's <code>android:immersive</code> manifest definition, even if the Activity's immersive state is changed at runtime via android.app.Activity#setImmersive(boolean).</para><para><para>android.app.Notification::FLAG_HIGH_PRIORITY </para><simplesectsep></simplesectsep><para>android.app.Activity::setImmersive(boolean) </para></para>        
				/// </summary>
				/// <java-name>
				/// FLAG_IMMERSIVE
				/// </java-name>
				[Dot42.DexImport("FLAG_IMMERSIVE", "I", AccessFlags = 25)]
				public const int FLAG_IMMERSIVE = 2048;
				/// <summary>
				/// <para>Bit in flags: If set, a single instance of the receiver will run for all users on the device. Set from the android.R.attr#singleUser attribute. Note that this flag is only relevant for ActivityInfo structures that are describing receiver components; it is not applied to activities. </para>        
				/// </summary>
				/// <java-name>
				/// FLAG_SINGLE_USER
				/// </java-name>
				...
				/// <summary>
				/// <para>Constant corresponding to <code>userLandscape</code> in the android.R.attr#screenOrientation attribute. </para>        
				/// </summary>
				/// <java-name>
				/// SCREEN_ORIENTATION_USER_LANDSCAPE
				/// </java-name>
				[Dot42.DexImport("SCREEN_ORIENTATION_USER_LANDSCAPE", "I", AccessFlags = 25)]
				public const int SCREEN_ORIENTATION_USER_LANDSCAPE = 11;
				/// <summary>
				/// <para>Constant corresponding to <code>userPortrait</code> in the android.R.attr#screenOrientation attribute. </para>        
				/// </summary>
				/// <java-name>
				/// SCREEN_ORIENTATION_USER_PORTRAIT
				/// </java-name>
				[Dot42.DexImport("SCREEN_ORIENTATION_USER_PORTRAIT", "I", AccessFlags = 25)]
				public const int SCREEN_ORIENTATION_USER_PORTRAIT = 12;
				/// <summary>
				/// <para>Constant corresponding to <code>fullUser</code> in the android.R.attr#screenOrientation attribute. </para>        
				/// </summary>
				/// <java-name>
				/// SCREEN_ORIENTATION_FULL_USER
				/// </java-name>
				[Dot42.DexImport("SCREEN_ORIENTATION_FULL_USER", "I", AccessFlags = 25)]
				public const int SCREEN_ORIENTATION_FULL_USER = 13;
				/// <summary>
				/// <para>Constant corresponding to <code>locked</code> in the android.R.attr#screenOrientation attribute. </para>        
				/// </summary>
				/// <java-name>
				/// SCREEN_ORIENTATION_LOCKED
				/// </java-name>
				[Dot42.DexImport("SCREEN_ORIENTATION_LOCKED", "I", AccessFlags = 25)]
				public const int SCREEN_ORIENTATION_LOCKED = 14;
				/// <summary>
				...
				/// <summary>
				/// <para>Bit in configChanges that indicates that the activity can itself handle density changes. Set from the android.R.attr#configChanges attribute. </para>        
				/// </summary>
				/// <java-name>
				/// CONFIG_DENSITY
				/// </java-name>
				[Dot42.DexImport("CONFIG_DENSITY", "I", AccessFlags = 25)]
				public const int CONFIG_DENSITY = 4096;
				/// <summary>
				/// <para>Bit in configChanges that indicates that the activity can itself handle the change to layout direction. Set from the android.R.attr#configChanges attribute. </para>        
				/// </summary>
				/// <java-name>
				/// CONFIG_LAYOUT_DIRECTION
				/// </java-name>
				[Dot42.DexImport("CONFIG_LAYOUT_DIRECTION", "I", AccessFlags = 25)]
				public const int CONFIG_LAYOUT_DIRECTION = 8192;
				/// <summary>
				...
				/// <summary>
				/// <para>The desired extra UI options for this activity and its main window. Set from the android.R.attr#uiOptions attribute in the activity's manifest. </para>        
				/// </summary>
				/// <java-name>
				/// uiOptions
				/// </java-name>
				...
				public int UiOptions;
				/// <summary>
				/// <para>Flag for use with uiOptions. Indicates that the action bar should put all action items in a separate bar when the screen is narrow. </para><para>This value corresponds to "splitActionBarWhenNarrow" for the uiOptions XML attribute. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				/// <para>If defined, the activity named here is the logical parent of this activity. </para>        
				/// </summary>
				/// <java-name>
				/// parentActivityName
				/// </java-name>
				[Dot42.DexImport("parentActivityName", "Ljava/lang/String;", AccessFlags = 1)]
 ...
 /* scope: __dot42__ */ 
		{
				...
				public global::Java.Lang.ICharSequence NonLocalizedDescription;
				/// <summary>
				/// <para>Flag for flags, corresponding to <code>personalInfo</code> value of android.R.attr#permissionGroupFlags. </para>        
				/// </summary>
				/// <java-name>
				/// FLAG_PERSONAL_INFO
				/// </java-name>
				[Dot42.DexImport("FLAG_PERSONAL_INFO", "I", AccessFlags = 25)]
				public const int FLAG_PERSONAL_INFO = 1;
				/// <summary>
				/// <para>Additional flags about this group as given by android.R.attr#permissionGroupFlags. </para>        
				/// </summary>
				/// <java-name>
				/// flags
				/// </java-name>
				...
				public int Flags;
				/// <summary>
				/// <para>Prioritization of this group, for visually sorting with other groups. </para>        
				/// </summary>
				/// <java-name>
				/// priority
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				/// <summary>
				/// <para>The activity or broadcast receiver that corresponds to this resolution match, if this resolution is for an activity or broadcast receiver. One and only one of this and serviceInfo must be non-null. </para>        
				/// </summary>
				/// <java-name>
				/// activityInfo
				/// </java-name>
				...
				/// <summary>
				/// <para>The service that corresponds to this resolution match, if this resolution is for a service. One and only one of this and activityInfo must be non-null. </para>        
				/// </summary>
				/// <java-name>
				/// serviceInfo
				/// </java-name>
				...
				/// providerInfo
				/// </java-name>
				[Dot42.DexImport("providerInfo", "Landroid/content/pm/ProviderInfo;", AccessFlags = 1)]
				public global::Android.Content.Pm.ProviderInfo ProviderInfo;
				/// <summary>
				...
				[Dot42.DexImport("<init>", "(Landroid/content/pm/ResolveInfo;)V", AccessFlags = 1)]
				public ResolveInfo(global::Android.Content.Pm.ResolveInfo orig) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				public string Permission;
				/// <summary>
				/// <para>Bit in flags: If set, the service will automatically be stopped by the system if the user removes a task that is rooted in one of the application's activities. Set from the android.R.attr#stopWithTask attribute. </para>        
				/// </summary>
				/// <java-name>
				/// FLAG_STOP_WITH_TASK
				/// </java-name>
				...
				/// <summary>
				/// <para>Bit in flags: If set, the service will run in its own isolated process. Set from the android.R.attr#isolatedProcess attribute. </para>        
				/// </summary>
				/// <java-name>
				/// FLAG_ISOLATED_PROCESS
				/// </java-name>
				[Dot42.DexImport("FLAG_ISOLATED_PROCESS", "I", AccessFlags = 25)]
				public const int FLAG_ISOLATED_PROCESS = 2;
				/// <summary>
				/// <para>Bit in flags: If set, a single instance of the service will run for all users on the device. Set from the android.R.attr#singleUser attribute. </para>        
				/// </summary>
				/// <java-name>
				/// FLAG_SINGLE_USER
				/// </java-name>
				...
				public const int FLAG_SINGLE_USER = 1073741824;
				/// <summary>
				/// <para>Options that have been set in the service declaration in the manifest. These include: FLAG_STOP_WITH_TASK, FLAG_ISOLATED_PROCESS, FLAG_SINGLE_USER. </para>        
				/// </summary>
				/// <java-name>
				/// flags
				/// </java-name>
