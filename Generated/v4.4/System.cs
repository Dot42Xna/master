...
namespace System
{
 ...
 /* scope: __dot42__ */ 
		{
				...
				[Dot42.DexImport("<init>", "(Ljava/lang/String;Ljava/lang/Throwable;ZZ)V", AccessFlags = 4)]
				protected internal Exception(string @string, global::System.Exception exception, bool boolean, bool boolean1) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Adds <c> throwable </c> to the list of throwables suppressed by this. The throwable will included when this exception's stack trace is printed.</para><para><para>1.7  1.7 </para></para>        
				/// </summary>
				/// <java-name>
				/// addSuppressed
				/// </java-name>
				[Dot42.DexImport("addSuppressed", "(Ljava/lang/Throwable;)V", AccessFlags = 17)]
				public void AddSuppressed(global::System.Exception throwable) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Returns the throwables suppressed by this.</para><para><para>1.7  1.7 </para></para>        
				/// </summary>
				/// <java-name>
				/// getSuppressed
				/// </java-name>
				[Dot42.DexImport("getSuppressed", "()[Ljava/lang/Throwable;", AccessFlags = 17)]
				public global::System.Exception[] GetSuppressed() /* MethodBuilder.Create */ 
				{
						return default(global::System.Exception[]);
				}
				...
				/// getSuppressed
				/// </java-name>
				public global::System.Exception[] Suppressed
				{
				[Dot42.DexImport("getSuppressed", "()[Ljava/lang/Throwable;", AccessFlags = 17)]
						get{ return GetSuppressed(); }
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Compares two <c> int </c> values. <para>1.7  1.7 </para></para>        
				/// </summary>
				/// <returns>
				/// <para>0 if lhs = rhs, less than 0 if lhs &lt; rhs, and greater than 0 if lhs &gt; rhs. </para>
				/// </returns>
				/// <java-name>
				/// compare
				/// </java-name>
				[Dot42.DexImport("compare", "(II)I", AccessFlags = 9)]
				public static int Compare(int lhs, int rhs) /* MethodBuilder.Create */ 
				{
						return default(int);
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Compares two <c> long </c> values. <para>1.7  1.7 </para></para>        
				/// </summary>
				/// <returns>
				/// <para>0 if lhs = rhs, less than 0 if lhs &lt; rhs, and greater than 0 if lhs &gt; rhs. </para>
				/// </returns>
				...
				/// compare
				/// </java-name>
				[Dot42.DexImport("compare", "(JJ)I", AccessFlags = 9)]
				public static int Compare(long lhs, long rhs) /* MethodBuilder.Create */ 
				{
						return default(int);
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Compares two <c> short </c> values. <para>1.7  1.7 </para></para>        
				/// </summary>
				/// <returns>
				/// <para>0 if lhs = rhs, less than 0 if lhs &lt; rhs, and greater than 0 if lhs &gt; rhs. </para>
				/// </returns>
				...
				/// compare
				/// </java-name>
				[Dot42.DexImport("compare", "(SS)I", AccessFlags = 9)]
				public static int Compare(short lhs, short rhs) /* MethodBuilder.Create */ 
				{
						return default(int);
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Compares two <c> char </c> values. <para>1.7  1.7 </para></para>        
				/// </summary>
				/// <returns>
				/// <para>0 if lhs = rhs, less than 0 if lhs &lt; rhs, and greater than 0 if lhs &gt; rhs. </para>
				/// </returns>
				...
				/// compare
				/// </java-name>
				[Dot42.DexImport("compare", "(CC)I", AccessFlags = 9)]
				public static int Compare(char lhs, char rhs) /* MethodBuilder.Create */ 
				{
						return default(int);
				}
				...
				/// <summary>
				/// <para>Tests whether the given character is a high or low surrogate. <para>1.7  1.7 </para></para>        
				/// </summary>
				/// <java-name>
				/// isSurrogate
				/// </java-name>
				[Dot42.DexImport("isSurrogate", "(C)Z", AccessFlags = 9)]
				public static bool IsSurrogate(char ch) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				/// <summary>
				/// <para>Returns the name of the given code point, or null if the code point is unassigned.</para><para>As a fallback mechanism this method returns strings consisting of the Unicode block name (with underscores replaced by spaces), a single space, and the uppercase hex value of the code point, using as few digits as necessary.</para><para>Examples: <ul><li><para><c> Character.getName(0) </c> returns "NULL". </para></li><li><para><c> Character.getName('e') </c> returns "LATIN SMALL LETTER E". </para></li><li><para><c> Character.getName('\u0666') </c> returns "ARABIC-INDIC DIGIT SIX". </para></li><li><para><c> Character.getName(0xe000) </c> returns "PRIVATE USE AREA E000". </para></li></ul></para><para><para>1.7  1.7 </para></para>        
				/// </summary>
				/// <java-name>
				/// getName
				/// </java-name>
				[Dot42.DexImport("getName", "(I)Ljava/lang/String;", AccessFlags = 9)]
				public static string GetName(int codePoint) /* MethodBuilder.Create */ 
				{
						return default(string);
				}
				...
				/// <summary>
				/// <para>Returns the high surrogate for the given code point. The result is meaningless if the given code point is not a supplementary character. <para>1.7  1.7 </para></para>        
				/// </summary>
				/// <java-name>
				/// highSurrogate
				/// </java-name>
				[Dot42.DexImport("highSurrogate", "(I)C", AccessFlags = 9)]
				public static char HighSurrogate(int codePoint) /* MethodBuilder.Create */ 
				{
						return default(char);
				}

				/// <summary>
				/// <para>Returns the low surrogate for the given code point. The result is meaningless if the given code point is not a supplementary character. <para>1.7  1.7 </para></para>        
				/// </summary>
				/// <java-name>
				/// lowSurrogate
				/// </java-name>
				[Dot42.DexImport("lowSurrogate", "(I)C", AccessFlags = 9)]
				public static char LowSurrogate(int codePoint) /* MethodBuilder.Create */ 
				{
						return default(char);
				}
				...
				/// isAlphabetic
				/// </java-name>
				[Dot42.DexImport("isAlphabetic", "(I)Z", AccessFlags = 265)]
				public static bool IsAlphabetic(int int32) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}

				/// <summary>
				/// <para>Tests whether the given code point is in the Basic Multilingual Plane (BMP). Such code points can be represented by a single <c> char </c> . <para>1.7  1.7 </para></para>        
				/// </summary>
				/// <java-name>
				/// isBmpCodePoint
				/// </java-name>
				[Dot42.DexImport("isBmpCodePoint", "(I)Z", AccessFlags = 9)]
				public static bool IsBmpCodePoint(int codePoint) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				/// isIdeographic
				/// </java-name>
				[Dot42.DexImport("isIdeographic", "(I)Z", AccessFlags = 265)]
				public static bool IsIdeographic(int int32) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
 ...
 /* scope: __dot42__ */ 
				{
						...
						/// </java-name>
						[Dot42.DexImport("ANCIENT_GREEK_MUSICAL_NOTATION", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock ANCIENT_GREEK_MUSICAL_NOTATION;
						/// <java-name>
						/// ANCIENT_GREEK_NUMBERS
						/// </java-name>
						[Dot42.DexImport("ANCIENT_GREEK_NUMBERS", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock ANCIENT_GREEK_NUMBERS;
						/// <java-name>
						/// ARABIC_SUPPLEMENT
						/// </java-name>
						[Dot42.DexImport("ARABIC_SUPPLEMENT", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock ARABIC_SUPPLEMENT;
						/// <java-name>
						/// BUGINESE
						/// </java-name>
						[Dot42.DexImport("BUGINESE", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock BUGINESE;
						/// <java-name>
						/// CJK_STROKES
						/// </java-name>
						[Dot42.DexImport("CJK_STROKES", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock CJK_STROKES;
						/// <java-name>
						/// COMBINING_DIACRITICAL_MARKS_SUPPLEMENT
						/// </java-name>
						[Dot42.DexImport("COMBINING_DIACRITICAL_MARKS_SUPPLEMENT", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock COMBINING_DIACRITICAL_MARKS_SUPPLEMENT;
						/// <java-name>
						/// COPTIC
						/// </java-name>
						[Dot42.DexImport("COPTIC", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock COPTIC;
						/// <java-name>
						/// ETHIOPIC_EXTENDED
						/// </java-name>
						[Dot42.DexImport("ETHIOPIC_EXTENDED", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock ETHIOPIC_EXTENDED;
						/// <java-name>
						/// ETHIOPIC_SUPPLEMENT
						/// </java-name>
						[Dot42.DexImport("ETHIOPIC_SUPPLEMENT", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock ETHIOPIC_SUPPLEMENT;
						/// <java-name>
						/// GEORGIAN_SUPPLEMENT
						/// </java-name>
						[Dot42.DexImport("GEORGIAN_SUPPLEMENT", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock GEORGIAN_SUPPLEMENT;
						/// <java-name>
						/// GLAGOLITIC
						/// </java-name>
						[Dot42.DexImport("GLAGOLITIC", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock GLAGOLITIC;
						/// <java-name>
						/// KHAROSHTHI
						/// </java-name>
						[Dot42.DexImport("KHAROSHTHI", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock KHAROSHTHI;
						/// <java-name>
						/// MODIFIER_TONE_LETTERS
						/// </java-name>
						[Dot42.DexImport("MODIFIER_TONE_LETTERS", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock MODIFIER_TONE_LETTERS;
						/// <java-name>
						/// NEW_TAI_LUE
						/// </java-name>
						[Dot42.DexImport("NEW_TAI_LUE", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock NEW_TAI_LUE;
						/// <java-name>
						/// OLD_PERSIAN
						/// </java-name>
						[Dot42.DexImport("OLD_PERSIAN", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock OLD_PERSIAN;
						/// <java-name>
						/// PHONETIC_EXTENSIONS_SUPPLEMENT
						/// </java-name>
						[Dot42.DexImport("PHONETIC_EXTENSIONS_SUPPLEMENT", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock PHONETIC_EXTENSIONS_SUPPLEMENT;
						/// <java-name>
						/// SUPPLEMENTAL_PUNCTUATION
						/// </java-name>
						[Dot42.DexImport("SUPPLEMENTAL_PUNCTUATION", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock SUPPLEMENTAL_PUNCTUATION;
						/// <java-name>
						/// SYLOTI_NAGRI
						/// </java-name>
						[Dot42.DexImport("SYLOTI_NAGRI", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock SYLOTI_NAGRI;
						/// <java-name>
						/// TIFINAGH
						/// </java-name>
						[Dot42.DexImport("TIFINAGH", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock TIFINAGH;
						/// <java-name>
						/// VERTICAL_FORMS
						/// </java-name>
						[Dot42.DexImport("VERTICAL_FORMS", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock VERTICAL_FORMS;
						/// <java-name>
						/// NKO
						/// </java-name>
						[Dot42.DexImport("NKO", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock NKO;
						/// <java-name>
						/// BALINESE
						/// </java-name>
						[Dot42.DexImport("BALINESE", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock BALINESE;
						/// <java-name>
						/// LATIN_EXTENDED_C
						/// </java-name>
						[Dot42.DexImport("LATIN_EXTENDED_C", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock LATIN_EXTENDED_C;
						/// <java-name>
						/// LATIN_EXTENDED_D
						/// </java-name>
						[Dot42.DexImport("LATIN_EXTENDED_D", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock LATIN_EXTENDED_D;
						/// <java-name>
						/// PHAGS_PA
						/// </java-name>
						[Dot42.DexImport("PHAGS_PA", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock PHAGS_PA;
						/// <java-name>
						/// PHOENICIAN
						/// </java-name>
						[Dot42.DexImport("PHOENICIAN", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock PHOENICIAN;
						/// <java-name>
						/// CUNEIFORM
						/// </java-name>
						[Dot42.DexImport("CUNEIFORM", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock CUNEIFORM;
						/// <java-name>
						/// CUNEIFORM_NUMBERS_AND_PUNCTUATION
						/// </java-name>
						[Dot42.DexImport("CUNEIFORM_NUMBERS_AND_PUNCTUATION", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock CUNEIFORM_NUMBERS_AND_PUNCTUATION;
						/// <java-name>
						/// COUNTING_ROD_NUMERALS
						/// </java-name>
						[Dot42.DexImport("COUNTING_ROD_NUMERALS", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock COUNTING_ROD_NUMERALS;
						/// <java-name>
						/// SUNDANESE
						/// </java-name>
						[Dot42.DexImport("SUNDANESE", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock SUNDANESE;
						/// <java-name>
						/// LEPCHA
						/// </java-name>
						[Dot42.DexImport("LEPCHA", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock LEPCHA;
						/// <java-name>
						/// OL_CHIKI
						/// </java-name>
						[Dot42.DexImport("OL_CHIKI", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock OL_CHIKI;
						/// <java-name>
						/// CYRILLIC_EXTENDED_A
						/// </java-name>
						[Dot42.DexImport("CYRILLIC_EXTENDED_A", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock CYRILLIC_EXTENDED_A;
						/// <java-name>
						/// VAI
						/// </java-name>
						[Dot42.DexImport("VAI", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock VAI;
						/// <java-name>
						/// CYRILLIC_EXTENDED_B
						/// </java-name>
						[Dot42.DexImport("CYRILLIC_EXTENDED_B", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock CYRILLIC_EXTENDED_B;
						/// <java-name>
						/// SAURASHTRA
						/// </java-name>
						[Dot42.DexImport("SAURASHTRA", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock SAURASHTRA;
						/// <java-name>
						/// KAYAH_LI
						/// </java-name>
						[Dot42.DexImport("KAYAH_LI", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock KAYAH_LI;
						/// <java-name>
						/// REJANG
						/// </java-name>
						[Dot42.DexImport("REJANG", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock REJANG;
						/// <java-name>
						/// CHAM
						/// </java-name>
						[Dot42.DexImport("CHAM", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock CHAM;
						/// <java-name>
						/// ANCIENT_SYMBOLS
						/// </java-name>
						[Dot42.DexImport("ANCIENT_SYMBOLS", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock ANCIENT_SYMBOLS;
						/// <java-name>
						/// PHAISTOS_DISC
						/// </java-name>
						[Dot42.DexImport("PHAISTOS_DISC", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock PHAISTOS_DISC;
						/// <java-name>
						/// LYCIAN
						/// </java-name>
						[Dot42.DexImport("LYCIAN", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock LYCIAN;
						/// <java-name>
						/// CARIAN
						/// </java-name>
						[Dot42.DexImport("CARIAN", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock CARIAN;
						/// <java-name>
						/// LYDIAN
						/// </java-name>
						[Dot42.DexImport("LYDIAN", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock LYDIAN;
						/// <java-name>
						/// MAHJONG_TILES
						/// </java-name>
						[Dot42.DexImport("MAHJONG_TILES", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock MAHJONG_TILES;
						/// <java-name>
						/// DOMINO_TILES
						/// </java-name>
						[Dot42.DexImport("DOMINO_TILES", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock DOMINO_TILES;
						/// <java-name>
						/// SAMARITAN
						/// </java-name>
						[Dot42.DexImport("SAMARITAN", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock SAMARITAN;
						/// <java-name>
						/// UNIFIED_CANADIAN_ABORIGINAL_SYLLABICS_EXTENDED
						/// </java-name>
						[Dot42.DexImport("UNIFIED_CANADIAN_ABORIGINAL_SYLLABICS_EXTENDED", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock UNIFIED_CANADIAN_ABORIGINAL_SYLLABICS_EXTENDED;
						/// <java-name>
						/// TAI_THAM
						/// </java-name>
						[Dot42.DexImport("TAI_THAM", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock TAI_THAM;
						/// <java-name>
						/// VEDIC_EXTENSIONS
						/// </java-name>
						[Dot42.DexImport("VEDIC_EXTENSIONS", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock VEDIC_EXTENSIONS;
						/// <java-name>
						/// LISU
						/// </java-name>
						[Dot42.DexImport("LISU", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock LISU;
						/// <java-name>
						/// BAMUM
						/// </java-name>
						[Dot42.DexImport("BAMUM", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock BAMUM;
						/// <java-name>
						/// COMMON_INDIC_NUMBER_FORMS
						/// </java-name>
						[Dot42.DexImport("COMMON_INDIC_NUMBER_FORMS", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock COMMON_INDIC_NUMBER_FORMS;
						/// <java-name>
						/// DEVANAGARI_EXTENDED
						/// </java-name>
						[Dot42.DexImport("DEVANAGARI_EXTENDED", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock DEVANAGARI_EXTENDED;
						/// <java-name>
						/// HANGUL_JAMO_EXTENDED_A
						/// </java-name>
						[Dot42.DexImport("HANGUL_JAMO_EXTENDED_A", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock HANGUL_JAMO_EXTENDED_A;
						/// <java-name>
						/// JAVANESE
						/// </java-name>
						[Dot42.DexImport("JAVANESE", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock JAVANESE;
						/// <java-name>
						/// MYANMAR_EXTENDED_A
						/// </java-name>
						[Dot42.DexImport("MYANMAR_EXTENDED_A", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock MYANMAR_EXTENDED_A;
						/// <java-name>
						/// TAI_VIET
						/// </java-name>
						[Dot42.DexImport("TAI_VIET", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock TAI_VIET;
						/// <java-name>
						/// MEETEI_MAYEK
						/// </java-name>
						[Dot42.DexImport("MEETEI_MAYEK", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock MEETEI_MAYEK;
						/// <java-name>
						/// HANGUL_JAMO_EXTENDED_B
						/// </java-name>
						[Dot42.DexImport("HANGUL_JAMO_EXTENDED_B", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock HANGUL_JAMO_EXTENDED_B;
						/// <java-name>
						/// IMPERIAL_ARAMAIC
						/// </java-name>
						[Dot42.DexImport("IMPERIAL_ARAMAIC", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock IMPERIAL_ARAMAIC;
						/// <java-name>
						/// OLD_SOUTH_ARABIAN
						/// </java-name>
						[Dot42.DexImport("OLD_SOUTH_ARABIAN", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock OLD_SOUTH_ARABIAN;
						/// <java-name>
						/// AVESTAN
						/// </java-name>
						[Dot42.DexImport("AVESTAN", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock AVESTAN;
						/// <java-name>
						/// INSCRIPTIONAL_PARTHIAN
						/// </java-name>
						[Dot42.DexImport("INSCRIPTIONAL_PARTHIAN", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock INSCRIPTIONAL_PARTHIAN;
						/// <java-name>
						/// INSCRIPTIONAL_PAHLAVI
						/// </java-name>
						[Dot42.DexImport("INSCRIPTIONAL_PAHLAVI", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock INSCRIPTIONAL_PAHLAVI;
						/// <java-name>
						/// OLD_TURKIC
						/// </java-name>
						[Dot42.DexImport("OLD_TURKIC", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock OLD_TURKIC;
						/// <java-name>
						/// RUMI_NUMERAL_SYMBOLS
						/// </java-name>
						[Dot42.DexImport("RUMI_NUMERAL_SYMBOLS", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock RUMI_NUMERAL_SYMBOLS;
						/// <java-name>
						/// KAITHI
						/// </java-name>
						[Dot42.DexImport("KAITHI", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock KAITHI;
						/// <java-name>
						/// EGYPTIAN_HIEROGLYPHS
						/// </java-name>
						[Dot42.DexImport("EGYPTIAN_HIEROGLYPHS", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock EGYPTIAN_HIEROGLYPHS;
						/// <java-name>
						/// ENCLOSED_ALPHANUMERIC_SUPPLEMENT
						/// </java-name>
						[Dot42.DexImport("ENCLOSED_ALPHANUMERIC_SUPPLEMENT", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock ENCLOSED_ALPHANUMERIC_SUPPLEMENT;
						/// <java-name>
						/// ENCLOSED_IDEOGRAPHIC_SUPPLEMENT
						/// </java-name>
						[Dot42.DexImport("ENCLOSED_IDEOGRAPHIC_SUPPLEMENT", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock ENCLOSED_IDEOGRAPHIC_SUPPLEMENT;
						/// <java-name>
						/// CJK_UNIFIED_IDEOGRAPHS_EXTENSION_C
						/// </java-name>
						[Dot42.DexImport("CJK_UNIFIED_IDEOGRAPHS_EXTENSION_C", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock CJK_UNIFIED_IDEOGRAPHS_EXTENSION_C;
						/// <java-name>
						/// MANDAIC
						/// </java-name>
						[Dot42.DexImport("MANDAIC", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock MANDAIC;
						/// <java-name>
						/// BATAK
						/// </java-name>
						[Dot42.DexImport("BATAK", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock BATAK;
						/// <java-name>
						/// ETHIOPIC_EXTENDED_A
						/// </java-name>
						[Dot42.DexImport("ETHIOPIC_EXTENDED_A", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock ETHIOPIC_EXTENDED_A;
						/// <java-name>
						/// BRAHMI
						/// </java-name>
						[Dot42.DexImport("BRAHMI", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock BRAHMI;
						/// <java-name>
						/// BAMUM_SUPPLEMENT
						/// </java-name>
						[Dot42.DexImport("BAMUM_SUPPLEMENT", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock BAMUM_SUPPLEMENT;
						/// <java-name>
						/// KANA_SUPPLEMENT
						/// </java-name>
						[Dot42.DexImport("KANA_SUPPLEMENT", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock KANA_SUPPLEMENT;
						/// <java-name>
						/// PLAYING_CARDS
						/// </java-name>
						[Dot42.DexImport("PLAYING_CARDS", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock PLAYING_CARDS;
						/// <java-name>
						/// MISCELLANEOUS_SYMBOLS_AND_PICTOGRAPHS
						/// </java-name>
						[Dot42.DexImport("MISCELLANEOUS_SYMBOLS_AND_PICTOGRAPHS", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock MISCELLANEOUS_SYMBOLS_AND_PICTOGRAPHS;
						/// <java-name>
						/// EMOTICONS
						/// </java-name>
						[Dot42.DexImport("EMOTICONS", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock EMOTICONS;
						/// <java-name>
						/// TRANSPORT_AND_MAP_SYMBOLS
						/// </java-name>
						[Dot42.DexImport("TRANSPORT_AND_MAP_SYMBOLS", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock TRANSPORT_AND_MAP_SYMBOLS;
						/// <java-name>
						/// ALCHEMICAL_SYMBOLS
						/// </java-name>
						[Dot42.DexImport("ALCHEMICAL_SYMBOLS", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
						public static readonly UnicodeBlock ALCHEMICAL_SYMBOLS;
						/// <java-name>
						/// CJK_UNIFIED_IDEOGRAPHS_EXTENSION_D
						/// </java-name>
						[Dot42.DexImport("CJK_UNIFIED_IDEOGRAPHS_EXTENSION_D", "Ljava/lang/Character$UnicodeBlock;", AccessFlags = 25)]
 ...
 /* scope: __dot42__ */ 
		...
		public partial class MissingFieldException : global::Java.Lang.ReflectiveOperationException
 /* scope: __dot42__ */ 
		{
				/// <summary>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Compares two <c> byte </c> values. <para>1.7  1.7 </para></para>        
				/// </summary>
				/// <returns>
				/// <para>0 if lhs = rhs, less than 0 if lhs &lt; rhs, and greater than 0 if lhs &gt; rhs. </para>
				/// </returns>
				...
				/// compare
				/// </java-name>
				[Dot42.DexImport("compare", "(BB)I", AccessFlags = 9)]
				public static int Compare(sbyte lhs, sbyte rhs) /* MethodBuilder.Create */ 
				{
						return default(int);
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Compares two <c> boolean </c> values. <para>1.7  1.7 </para></para>        
				/// </summary>
				/// <returns>
				/// <para>0 if lhs = rhs, less than 0 if lhs &lt; rhs, and greater than 0 if lhs &gt; rhs. (Where true &gt; false.) </para>
				/// </returns>
				/// <java-name>
				/// compare
				/// </java-name>
				[Dot42.DexImport("compare", "(ZZ)I", AccessFlags = 9)]
				public static int Compare(bool lhs, bool rhs) /* MethodBuilder.Create */ 
				{
						return default(int);
				}
 ...
 /* scope: __dot42__ */ 
		...
		public partial class MissingMethodException : global::Java.Lang.ReflectiveOperationException
 /* scope: __dot42__ */ 
		{
				/// <summary>
