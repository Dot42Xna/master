...
namespace Android.Net.Http
{
 ...
 /* scope: __dot42__ */ 
    ...
    ";)TT;")]
		...
		/// <summary>
		/// <para>X509TrustManager wrapper exposing Android-added features.</para><para>The checkServerTrusted method allows callers to perform additional verification of certificate chains after they have been successfully verified by the platform.</para>    
		/// </summary>
		/// <java-name>
		/// android/net/http/X509TrustManagerExtensions
		/// </java-name>
		[Dot42.DexImport("android/net/http/X509TrustManagerExtensions", AccessFlags = 33)]
		public partial class X509TrustManagerExtensions
 /* scope: __dot42__ */ 
		{
				/// <summary>
				/// <para>Constructs a new X509TrustManagerExtensions wrapper.</para><para></para>        
				/// </summary>
				[Dot42.DexImport("<init>", "(Ljavax/net/ssl/X509TrustManager;)V", AccessFlags = 1)]
				public X509TrustManagerExtensions(global::Javax.Net.Ssl.IX509TrustManager tm) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Verifies the given certificate chain.</para><para>See X509TrustManager#checkServerTrusted(X509Certificate[], String) for a description of the chain and authType parameters. The final parameter, host, should be the hostname of the server.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>the properly ordered chain used for verification as a list of X509Certificates. </para>
				/// </returns>
				/// <java-name>
				/// checkServerTrusted
				/// </java-name>
				[Dot42.DexImport("checkServerTrusted", "([Ljava/security/cert/X509Certificate;Ljava/lang/String;Ljava/lang/String;)Ljava/" +
    "util/List;", AccessFlags = 1, Signature = "([Ljava/security/cert/X509Certificate;Ljava/lang/String;Ljava/lang/String;)Ljava/" +
    "util/List<Ljava/security/cert/X509Certificate;>;")]
				public virtual global::Java.Util.IList<global::Java.Security.Cert.X509Certificate> CheckServerTrusted(global::Java.Security.Cert.X509Certificate[] chain, string authType, string host) /* MethodBuilder.Create */ 
				{
						return default(global::Java.Util.IList<global::Java.Security.Cert.X509Certificate>);
				}

				[global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
				internal X509TrustManagerExtensions() /* TypeBuilder.AddDefaultConstructor */ 
				{
				}
