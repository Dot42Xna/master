...
//
// Original filename: Android.Net.Wifi.cs
//
...
namespace Android.Net.Wifi
{
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para>Enterprise configuration details for Wi-Fi. Stores details about the EAP method and any associated credentials. </para>    
		/// </summary>
		/// <java-name>
		/// android/net/wifi/WifiEnterpriseConfig
		/// </java-name>
		[Dot42.DexImport("android/net/wifi/WifiEnterpriseConfig", AccessFlags = 33)]
		public partial class WifiEnterpriseConfig : global::Android.Os.IParcelable
 /* scope: __dot42__ */ 
		{
				/// <java-name>
				/// CREATOR
				...
				public static readonly global::Android.Os.IParcelable_ICreator<global::Android.Net.Wifi.WifiEnterpriseConfig> CREATOR;
				[Dot42.DexImport("<init>", "()V", AccessFlags = 1)]
				public WifiEnterpriseConfig() /* MethodBuilder.Create */ 
				{
				}
				...
				/// </summary>
				[Dot42.DexImport("<init>", "(Landroid/net/wifi/WifiEnterpriseConfig;)V", AccessFlags = 1)]
				public WifiEnterpriseConfig(global::Android.Net.Wifi.WifiEnterpriseConfig source) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Set the EAP authentication method. </para>        
				/// </summary>
				/// <java-name>
				/// setEapMethod
				/// </java-name>
				[Dot42.DexImport("setEapMethod", "(I)V", AccessFlags = 1)]
				public virtual void SetEapMethod(int eapMethod) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Get the eap method. </para>        
				/// </summary>
				/// <returns>
				/// <para>eap method configured </para>
				/// </returns>
				/// <java-name>
				/// getEapMethod
				/// </java-name>
				[Dot42.DexImport("getEapMethod", "()I", AccessFlags = 1)]
				public virtual int GetEapMethod() /* MethodBuilder.Create */ 
				{
						return default(int);
				}

				/// <summary>
				/// <para>Set Phase 2 authentication method. Sets the inner authentication method to be used in phase 2 after setting up a secure channel </para>        
				/// </summary>
				/// <java-name>
				/// setPhase2Method
				/// </java-name>
				[Dot42.DexImport("setPhase2Method", "(I)V", AccessFlags = 1)]
				public virtual void SetPhase2Method(int phase2Method) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Get the phase 2 authentication method. </para>        
				/// </summary>
				/// <returns>
				/// <para>a phase 2 method defined at Phase2 </para>
				/// </returns>
				/// <java-name>
				/// getPhase2Method
				/// </java-name>
				[Dot42.DexImport("getPhase2Method", "()I", AccessFlags = 1)]
				public virtual int GetPhase2Method() /* MethodBuilder.Create */ 
				{
						return default(int);
				}

				/// <summary>
				/// <para>Set the identity </para>        
				/// </summary>
				/// <java-name>
				/// setIdentity
				/// </java-name>
				[Dot42.DexImport("setIdentity", "(Ljava/lang/String;)V", AccessFlags = 1)]
				public virtual void SetIdentity(string identity) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Get the identity </para>        
				/// </summary>
				/// <returns>
				...
				/// getIdentity
				/// </java-name>
				[Dot42.DexImport("getIdentity", "()Ljava/lang/String;", AccessFlags = 1)]
				public virtual string GetIdentity() /* MethodBuilder.Create */ 
				{
						return default(string);
				}

				/// <summary>
				/// <para>Set anonymous identity. This is used as the unencrypted identity with certain EAP types </para>        
				/// </summary>
				/// <java-name>
				/// setAnonymousIdentity
				/// </java-name>
				[Dot42.DexImport("setAnonymousIdentity", "(Ljava/lang/String;)V", AccessFlags = 1)]
				public virtual void SetAnonymousIdentity(string anonymousIdentity) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Get the anonymous identity </para>        
				/// </summary>
				/// <returns>
				/// <para>anonymous identity </para>
				/// </returns>
				/// <java-name>
				/// getAnonymousIdentity
				/// </java-name>
				[Dot42.DexImport("getAnonymousIdentity", "()Ljava/lang/String;", AccessFlags = 1)]
				public virtual string GetAnonymousIdentity() /* MethodBuilder.Create */ 
				{
						return default(string);
				}

				/// <summary>
				/// <para>Set the password. </para>        
				/// </summary>
				/// <java-name>
				/// setPassword
				/// </java-name>
				[Dot42.DexImport("setPassword", "(Ljava/lang/String;)V", AccessFlags = 1)]
				public virtual void SetPassword(string password) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Get the password.</para><para>Returns locally set password value. For networks fetched from framework, returns "*". </para>        
				/// </summary>
				/// <java-name>
				/// getPassword
				/// </java-name>
				...
				/// <summary>
				/// <para>Specify a X.509 certificate that identifies the server.</para><para>A default name is automatically assigned to the certificate and used with this configuration. The framework takes care of installing the certificate when the config is saved and removing the certificate when the config is removed.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setCaCertificate
				/// </java-name>
				[Dot42.DexImport("setCaCertificate", "(Ljava/security/cert/X509Certificate;)V", AccessFlags = 1)]
				public virtual void SetCaCertificate(global::Java.Security.Cert.X509Certificate cert) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Get CA certificate</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>X.509 CA certificate </para>
				/// </returns>
				/// <java-name>
				/// getCaCertificate
				/// </java-name>
				[Dot42.DexImport("getCaCertificate", "()Ljava/security/cert/X509Certificate;", AccessFlags = 1)]
				public virtual global::Java.Security.Cert.X509Certificate GetCaCertificate() /* MethodBuilder.Create */ 
				{
						return default(global::Java.Security.Cert.X509Certificate);
				}

				/// <summary>
				/// <para>Specify a private key and client certificate for client authorization.</para><para>A default name is automatically assigned to the key entry and used with this configuration. The framework takes care of installing the key entry when the config is saved and removing the key entry when the config is removed.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setClientKeyEntry
				/// </java-name>
				[Dot42.DexImport("setClientKeyEntry", "(Ljava/security/PrivateKey;Ljava/security/cert/X509Certificate;)V", AccessFlags = 1)]
				public virtual void SetClientKeyEntry(global::Java.Security.IPrivateKey privateKey, global::Java.Security.Cert.X509Certificate clientCertificate) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Get client certificate</para><para></para>        
				/// </summary>
				/// <returns>
				...
				/// </java-name>
				[Dot42.DexImport("getClientCertificate", "()Ljava/security/cert/X509Certificate;", AccessFlags = 1)]
				public virtual global::Java.Security.Cert.X509Certificate GetClientCertificate() /* MethodBuilder.Create */ 
				{
						return default(global::Java.Security.Cert.X509Certificate);
				}

				/// <summary>
				/// <para>Set subject match. This is the substring to be matched against the subject of the authentication server certificate. </para>        
				/// </summary>
				/// <java-name>
				/// setSubjectMatch
				/// </java-name>
				[Dot42.DexImport("setSubjectMatch", "(Ljava/lang/String;)V", AccessFlags = 1)]
				public virtual void SetSubjectMatch(string subjectMatch) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Get subject match </para>        
				/// </summary>
				/// <returns>
				/// <para>the subject match string </para>
				/// </returns>
				/// <java-name>
				/// getSubjectMatch
				/// </java-name>
				[Dot42.DexImport("getSubjectMatch", "()Ljava/lang/String;", AccessFlags = 1)]
				public virtual string GetSubjectMatch() /* MethodBuilder.Create */ 
				{
						return default(string);
				}
				...
				{
				[Dot42.DexImport("getEapMethod", "()I", AccessFlags = 1)]
						get{ return GetEapMethod(); }
				[Dot42.DexImport("setEapMethod", "(I)V", AccessFlags = 1)]
						set{ SetEapMethod(value); }
				}
				...
				{
				[Dot42.DexImport("getPhase2Method", "()I", AccessFlags = 1)]
						get{ return GetPhase2Method(); }
				[Dot42.DexImport("setPhase2Method", "(I)V", AccessFlags = 1)]
						set{ SetPhase2Method(value); }
				}
				...
				{
				[Dot42.DexImport("getAnonymousIdentity", "()Ljava/lang/String;", AccessFlags = 1)]
						get{ return GetAnonymousIdentity(); }
				[Dot42.DexImport("setAnonymousIdentity", "(Ljava/lang/String;)V", AccessFlags = 1)]
						set{ SetAnonymousIdentity(value); }
				}
				...
				/// getCaCertificate
				/// </java-name>
				public global::Java.Security.Cert.X509Certificate CaCertificate
				{
				[Dot42.DexImport("getCaCertificate", "()Ljava/security/cert/X509Certificate;", AccessFlags = 1)]
						get{ return GetCaCertificate(); }
				[Dot42.DexImport("setCaCertificate", "(Ljava/security/cert/X509Certificate;)V", AccessFlags = 1)]
						set{ SetCaCertificate(value); }
				}
				...
				/// getClientCertificate
				/// </java-name>
				public global::Java.Security.Cert.X509Certificate ClientCertificate
				{
				[Dot42.DexImport("getClientCertificate", "()Ljava/security/cert/X509Certificate;", AccessFlags = 1)]
						get{ return GetClientCertificate(); }
				}
				...
				{
				[Dot42.DexImport("getSubjectMatch", "()Ljava/lang/String;", AccessFlags = 1)]
						get{ return GetSubjectMatch(); }
				[Dot42.DexImport("setSubjectMatch", "(Ljava/lang/String;)V", AccessFlags = 1)]
						set{ SetSubjectMatch(value); }
				}

				/// <summary>
				/// <para>The inner authentication method used </para>    
				/// </summary>
				/// <java-name>
				/// android/net/wifi/WifiEnterpriseConfig$Phase2
				/// </java-name>
				[Dot42.DexImport("android/net/wifi/WifiEnterpriseConfig$Phase2", AccessFlags = 25)]
				public sealed partial class Phase2
 /* scope: __dot42__ */ 
				{
						/// <java-name>
						/// NONE
						...
						/// <summary>
						/// <para>Password Authentication Protocol </para>        
						/// </summary>
						/// <java-name>
						/// PAP
						/// </java-name>
						[Dot42.DexImport("PAP", "I", AccessFlags = 25)]
						public const int PAP = 1;
						/// <summary>
						/// <para>Microsoft Challenge Handshake Authentication Protocol </para>        
						/// </summary>
						/// <java-name>
						/// MSCHAP
						/// </java-name>
						[Dot42.DexImport("MSCHAP", "I", AccessFlags = 25)]
						public const int MSCHAP = 2;
						/// <summary>
						/// <para>Microsoft Challenge Handshake Authentication Protocol v2 </para>        
						/// </summary>
						/// <java-name>
						/// MSCHAPV2
						/// </java-name>
						[Dot42.DexImport("MSCHAPV2", "I", AccessFlags = 25)]
						public const int MSCHAPV2 = 3;
						/// <summary>
						/// <para>Generic Token Card </para>        
						/// </summary>
						/// <java-name>
						/// GTC
						/// </java-name>
						[Dot42.DexImport("GTC", "I", AccessFlags = 25)]
						public const int GTC = 4;
						[Dot42.DexImport("<init>", "()V", AccessFlags = 0)]
						internal Phase2() /* MethodBuilder.Create */ 
						{
						}
				...
				/// <summary>
				/// <para>The Extensible Authentication Protocol method used </para>    
				/// </summary>
				/// <java-name>
				/// android/net/wifi/WifiEnterpriseConfig$Eap
				/// </java-name>
				[Dot42.DexImport("android/net/wifi/WifiEnterpriseConfig$Eap", AccessFlags = 25)]
				public sealed partial class Eap
 /* scope: __dot42__ */ 
				{
						/// <summary>
						/// <para>No EAP method used. Represents an empty config </para>        
						/// </summary>
						/// <java-name>
						/// NONE
						/// </java-name>
						...
						/// PEAP
						/// </java-name>
						[Dot42.DexImport("PEAP", "I", AccessFlags = 25)]
						public const int PEAP = 0;
						/// <summary>
						/// <para>EAP-Transport Layer Security </para>        
						/// </summary>
						/// <java-name>
						/// TLS
						/// </java-name>
						[Dot42.DexImport("TLS", "I", AccessFlags = 25)]
						public const int TLS = 1;
						/// <summary>
						/// <para>EAP-Tunneled Transport Layer Security </para>        
						/// </summary>
						/// <java-name>
						/// TTLS
						/// </java-name>
						[Dot42.DexImport("TTLS", "I", AccessFlags = 25)]
						public const int TTLS = 2;
						/// <summary>
						/// <para>EAP-Password </para>        
						/// </summary>
						/// <java-name>
						/// PWD
						/// </java-name>
						[Dot42.DexImport("PWD", "I", AccessFlags = 25)]
						public const int PWD = 3;
						[Dot42.DexImport("<init>", "()V", AccessFlags = 0)]
						internal Eap() /* MethodBuilder.Create */ 
						{
						}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Time Synchronization Function (tsf) timestamp in microseconds when this result was last seen. </para>        
				/// </summary>
				/// <java-name>
				/// timestamp
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Broadcast intent action indicating that Wi-Fi has been enabled, disabled, enabling, disabling, or unknown. One extra provides this state as an int. Another extra provides the previous state, if available.</para><para><para>EXTRA_WIFI_STATE </para><simplesectsep></simplesectsep><para>EXTRA_PREVIOUS_WIFI_STATE </para></para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				/// <para>The lookup key for an int that indicates whether Wi-Fi is enabled, disabled, enabling, disabling, or unknown. Retrieve it with android.content.Intent#getIntExtra(String,int).</para><para><para>WIFI_STATE_DISABLED </para><simplesectsep></simplesectsep><para>WIFI_STATE_DISABLING </para><simplesectsep></simplesectsep><para>WIFI_STATE_ENABLED </para><simplesectsep></simplesectsep><para>WIFI_STATE_ENABLING </para><simplesectsep></simplesectsep><para>WIFI_STATE_UNKNOWN </para></para>        
				/// </summary>
				/// <java-name>
				/// EXTRA_WIFI_STATE
				/// </java-name>
				...
				/// <summary>
				/// <para>Wi-Fi is currently being disabled. The state will change to WIFI_STATE_DISABLED if it finishes successfully.</para><para><para>WIFI_STATE_CHANGED_ACTION </para><simplesectsep></simplesectsep><para>getWifiState() </para></para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				/// <para>Wi-Fi is disabled.</para><para><para>WIFI_STATE_CHANGED_ACTION </para><simplesectsep></simplesectsep><para>getWifiState() </para></para>        
				/// </summary>
				/// <java-name>
				/// WIFI_STATE_DISABLED
				/// </java-name>
				...
				/// <summary>
				/// <para>Wi-Fi is currently being enabled. The state will change to WIFI_STATE_ENABLED if it finishes successfully.</para><para><para>WIFI_STATE_CHANGED_ACTION </para><simplesectsep></simplesectsep><para>getWifiState() </para></para>        
				/// </summary>
				/// <java-name>
				/// WIFI_STATE_ENABLING
				/// </java-name>
				...
				/// <summary>
				/// <para>Wi-Fi is enabled.</para><para><para>WIFI_STATE_CHANGED_ACTION </para><simplesectsep></simplesectsep><para>getWifiState() </para></para>        
				/// </summary>
				/// <java-name>
				/// WIFI_STATE_ENABLED
				/// </java-name>
				...
				/// <summary>
				/// <para>Wi-Fi is in an unknown state. This state will occur when an error happens while enabling or disabling.</para><para><para>WIFI_STATE_CHANGED_ACTION </para><simplesectsep></simplesectsep><para>getWifiState() </para></para>        
				/// </summary>
				/// <java-name>
				/// WIFI_STATE_UNKNOWN
				/// </java-name>
				...
				/// <summary>
				/// <para>Activity Action: Show a system activity that allows the user to enable scans to be available even with Wi-Fi turned off.</para><para>Notification of the result of this activity is posted using the android.app.Activity#onActivityResult callback. The <code>resultCode</code> will be android.app.Activity#RESULT_OK if scan always mode has been turned on or android.app.Activity#RESULT_CANCELED if the user has rejected the request or an error has occurred. </para>        
				/// </summary>
				/// <java-name>
				/// ACTION_REQUEST_SCAN_ALWAYS_AVAILABLE
				/// </java-name>
				[Dot42.DexImport("ACTION_REQUEST_SCAN_ALWAYS_AVAILABLE", "Ljava/lang/String;", AccessFlags = 25)]
				...
				/// <summary>
				/// <para>Check if scanning is always available.</para><para>If this return <c> true </c> , apps can issue startScan and fetch scan results even when Wi-Fi is turned off.</para><para>To change this setting, see ACTION_REQUEST_SCAN_ALWAYS_AVAILABLE. </para>        
				/// </summary>
				/// <java-name>
				/// isScanAlwaysAvailable
				/// </java-name>
				[Dot42.DexImport("isScanAlwaysAvailable", "()Z", AccessFlags = 1)]
				public virtual bool IsScanAlwaysAvailable() /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				/// <summary>
				/// <para>Return the DHCP-assigned addresses from the last successful DHCP request, if any. <xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para><ul><li><para>use ConnectivityManager.getLinkProperties instead. TODO - remove 11/2013 </para></li></ul></para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <returns>
				...
				/// </summary>
				/// <returns>
				/// <para><c> true </c> if the operation succeeds (or if the existing state is the same as the requested state). </para>
				/// </returns>
				/// <java-name>
				/// setWifiEnabled
				/// </java-name>
				...
				/// setTdlsEnabled
				/// </java-name>
				[Dot42.DexImport("setTdlsEnabled", "(Ljava/net/InetAddress;Z)V", AccessFlags = 1)]
				public virtual void SetTdlsEnabled(global::Java.Net.InetAddress inetAddress, bool boolean) /* MethodBuilder.Create */ 
				{
				}
				...
				/// </java-name>
				[Dot42.DexImport("setTdlsEnabledWithMacAddress", "(Ljava/lang/String;Z)V", AccessFlags = 1)]
				public virtual void SetTdlsEnabledWithMacAddress(string @string, bool boolean) /* MethodBuilder.Create */ 
				{
				}
				...
				extern ~WifiManager() /* MethodBuilder.Create */ ;
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>The enterprise configuration details specifying the EAP method, certificates and other settings associated with the EAP. </para>        
				/// </summary>
				/// <java-name>
				/// enterpriseConfig
				/// </java-name>
				[Dot42.DexImport("enterpriseConfig", "Landroid/net/wifi/WifiEnterpriseConfig;", AccessFlags = 1)]
				public global::Android.Net.Wifi.WifiEnterpriseConfig EnterpriseConfig;
				[Dot42.DexImport("<init>", "()V", AccessFlags = 1)]
