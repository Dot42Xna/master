 ...
 /* scope: __dot42__ */ 
		{
				...
				public static global::Android.Text.BidiFormatter GetInstance() /* MethodBuilder.Create */ 
				{
				...
				public bool IsRtlContext() /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				public bool GetStereoReset() /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				/// getStereoReset
				/// </java-name>
				public bool IsStereoReset
				{
				[Dot42.DexImport("getStereoReset", "()Z", AccessFlags = 1)]
						get{ return GetStereoReset(); }
				}
