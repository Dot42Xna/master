...
{
		/// <summary>
		/// <para>Signals some sort of problem during either serialization or deserialization of objects. This is actually the superclass of several other, more specific exception classes.</para><para><para>InvalidObjectException </para><simplesectsep></simplesectsep><para>NotActiveException </para><simplesectsep></simplesectsep><para>NotSerializableException </para><simplesectsep></simplesectsep><para>OptionalDataException </para><simplesectsep></simplesectsep><para>StreamCorruptedException </para><simplesectsep></simplesectsep><para>WriteAbortedException </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Indicates whether this stream supports <c> mark() </c> and <c> reset() </c> . This implementation returns whether or not the filtered stream supports marking.</para><para><para>mark(int) </para><simplesectsep></simplesectsep><para>reset() </para><simplesectsep></simplesectsep><para>skip(long) </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				/// <para>Reads at most <c> count </c> bytes from this stream and stores them in the byte array <c> buffer </c> starting at <c> offset </c> . Returns the number of bytes actually read or -1 if no bytes have been read and the end of this stream has been reached. This implementation reads bytes from the filtered stream.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>the number of bytes actually read or -1 if the end of the filtered stream has been reached while reading. </para>
				/// </returns>
				/// <java-name>
				/// read
				/// </java-name>
				...
				/// <summary>
				/// <para>Resets this stream to the last marked location. This implementation resets the target stream.</para><para><para>mark(int) </para><simplesectsep></simplesectsep><para>markSupported() </para></para>        
				/// </summary>
				/// <java-name>
				/// reset
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Returns the historical name of the encoding used by this writer to convert characters to bytes, or null if this writer has been closed. Most callers should probably keep track of the String or Charset they passed in; this method may not return the same name. </para>        
				/// </summary>
				/// <java-name>
				/// getEncoding
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Sets a mark position in this reader. The parameter <c> readlimit </c> indicates how many bytes can be read before the mark is invalidated. Sending <c> reset() </c> will reposition this reader back to the marked position, provided that <c> readlimit </c> has not been surpassed. </para><para>This implementation sets a mark in the filtered reader.</para><para><para>markSupported() </para><simplesectsep></simplesectsep><para>reset() </para></para>        
				/// </summary>
				/// <java-name>
				/// mark
				/// </java-name>
				...
				/// <summary>
				/// <para>Indicates whether this reader supports <c> mark() </c> and <c> reset() </c> . This implementation returns whether the filtered reader supports marking.</para><para><para>mark(int) </para><simplesectsep></simplesectsep><para>reset() </para><simplesectsep></simplesectsep><para>skip(long) </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				/// <para>Reads at most <c> count </c> characters from the filtered reader and stores them in the byte array <c> buffer </c> starting at <c> offset </c> . Returns the number of characters actually read or -1 if no characters were read and the end of the filtered reader was encountered.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>the number of characters actually read or -1 if the end of the filtered reader has been reached while reading. </para>
				/// </returns>
				/// <java-name>
				/// read
				/// </java-name>
				...
				/// <summary>
				/// <para>Skips <c> charCount </c> characters in this reader. Subsequent calls to <c> read </c> will not return these characters unless <c> reset </c> is used. The default implementation is to skip characters in the filtered reader.</para><para><para>mark(int) </para><simplesectsep></simplesectsep><para>markSupported() </para><simplesectsep></simplesectsep><para>reset() </para></para>        
				/// </summary>
				/// <returns>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Sets a mark position in this reader. The parameter <c> markLimit </c> indicates how many characters can be read before the mark is invalidated. Calling <c> reset() </c> will reposition the reader back to the marked position if <c> markLimit </c> has not been surpassed.</para><para><para>markSupported() </para><simplesectsep></simplesectsep><para>reset() </para></para>        
				/// </summary>
				/// <java-name>
				/// mark
				/// </java-name>
				...
				/// <summary>
				/// <para>Indicates whether this reader supports the <c> mark() </c> and <c> reset() </c> methods. This implementation returns <c> true </c> .</para><para><para>mark(int) </para><simplesectsep></simplesectsep><para>reset() </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				/// <para>Indicates whether this reader is ready to be read without blocking.</para><para><para>read() </para><simplesectsep></simplesectsep><para>read(char[], int, int) </para><simplesectsep></simplesectsep><para>readLine() </para></para>        
				/// </summary>
				/// <returns>
				/// <para><c> true </c> if this reader will not block when <c> read </c> is called, <c> false </c> if unknown or blocking will occur. </para>
				/// </returns>
				...
				/// <summary>
				/// <para>Resets this reader's position to the last <c> mark() </c> location. Invocations of <c> read() </c> and <c> skip() </c> will occur from this new location.</para><para><para>mark(int) </para><simplesectsep></simplesectsep><para>markSupported() </para></para>        
				/// </summary>
				/// <java-name>
				/// reset
				/// </java-name>
				...
				/// <summary>
				/// <para>Skips <c> charCount </c> chars in this stream. Subsequent calls to <c> read </c> will not return these chars unless <c> reset </c> is used.</para><para>Skipping characters may invalidate a mark if <c> markLimit </c> is surpassed.</para><para><para>mark(int) </para><simplesectsep></simplesectsep><para>markSupported() </para><simplesectsep></simplesectsep><para>reset() </para></para>        
				/// </summary>
				/// <returns>
				/// <para>the number of characters actually skipped. </para>
				/// </returns>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Resets this reader to the last marked location. It also resets the line count to what is was when this reader was marked. This implementation resets the source reader.</para><para><para>mark(int) </para><simplesectsep></simplesectsep><para>markSupported() </para></para>        
				/// </summary>
				/// <java-name>
				/// reset
				/// </java-name>
				...
				/// <summary>
				/// <para>Sets the line number of this reader to the specified <c> lineNumber </c> . Note that this may have side effects on the line number associated with the last marked position.</para><para><para>mark(int) </para><simplesectsep></simplesectsep><para>reset() </para></para>        
				/// </summary>
				/// <java-name>
				/// setLineNumber
				/// </java-name>
				...
				/// <summary>
				/// <para>Skips <c> charCount </c> characters in this reader. Subsequent calls to <c> read </c> will not return these characters unless <c> reset </c> is used. This implementation skips <c> charCount </c> number of characters in the source reader and increments the line number count whenever line terminator sequences are skipped.</para><para><para>mark(int) </para><simplesectsep></simplesectsep><para>read() </para><simplesectsep></simplesectsep><para>reset() </para></para>        
				/// </summary>
				/// <returns>
				/// <para>the number of characters actually skipped. </para>
				/// </returns>
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para>Describes a field for the purpose of serialization. Classes can define the collection of fields that are serialized, which may be different from the set of all declared fields.</para><para><para>ObjectOutputStream::writeFields() </para><simplesectsep></simplesectsep><para>ObjectInputStream::readFields() </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Writes the specified 8-bit byte.</para><para><para>DataInput::readByte() </para><simplesectsep></simplesectsep><para>DataInput::readUnsignedByte() </para></para>        
				/// </summary>
				/// <java-name>
				/// writeByte
				/// </java-name>
				...
				/// <summary>
				/// <para>Writes the specified 16-bit short in big-endian order. Only the lower two bytes of <c>       val </c> are written.</para><para><para>DataInput::readShort() </para><simplesectsep></simplesectsep><para>DataInput::readUnsignedShort() </para></para>        
				/// </summary>
				/// <java-name>
				/// writeShort
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para>An interface for filtering File objects based on their names or the directory they reside in.</para><para><para>File </para><simplesectsep></simplesectsep><para>File::list(FilenameFilter) </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para>Signals that the ObjectInputStream class encountered a primitive type (<c> int </c> , <c> char </c> etc.) instead of an object instance in the input stream.</para><para><para>ObjectInputStream::available() </para><simplesectsep></simplesectsep><para>ObjectInputStream::readObject() </para><simplesectsep></simplesectsep><para>ObjectInputStream::skipBytes(int) </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Writes an 8-bit byte to the target stream. Only the least significant byte of the integer <c> val </c> is written.</para><para><para>DataInputStream::readByte() </para><simplesectsep></simplesectsep><para>DataInputStream::readUnsignedByte() </para></para>        
				/// </summary>
				/// <java-name>
				/// writeByte
				/// </java-name>
		...
		/// <summary>
		/// <para>Signals that an object that is not serializable has been passed into the <c> ObjectOutput.writeObject() </c> method. This can happen if the object does not implement <c> Serializable </c> or <c> Externalizable </c> , or if it is serializable but it overrides <c> writeObject(ObjectOutputStream) </c> and explicitly prevents serialization by throwing this type of exception.</para><para><para>ObjectOutput::writeObject(Object) </para><simplesectsep></simplesectsep><para>ObjectOutputStream::writeObject(Object) </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para>Signals a problem during the serialization or or deserialization of an object. Possible reasons include: <ul><li><para>The SUIDs of the class loaded by the VM and the serialized class info do not match. </para></li><li><para>A serializable or externalizable object cannot be instantiated (when deserializing) because the no-arg constructor that needs to be run is not visible or fails. </para></li></ul></para><para><para>ObjectInputStream #readObject() </para><simplesectsep></simplesectsep><para>ObjectInputValidation::validateObject() </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Indicates whether this reader supports the <c> mark(int) </c> and <c> reset() </c> methods. <c> PushbackReader </c> does not support them, so it returns <c> false </c> .</para><para><para>mark(int) </para><simplesectsep></simplesectsep><para>reset() </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				/// <para>Reads at most <c> length </c> bytes from this reader and stores them in byte array <c> buffer </c> starting at <c> offset </c> . Characters are read from the pushback buffer first, then from the source reader if more bytes are required. Blocks until <c> count </c> characters have been read, the end of the source reader is detected or an exception is thrown.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>the number of bytes read or -1 if the end of the source reader has been reached. </para>
				/// </returns>
				/// <java-name>
				/// read
				/// </java-name>
				...
				/// <summary>
				/// <para>Indicates whether this reader is ready to be read without blocking. Returns <c> true </c> if this reader will not block when <c> read </c> is called, <c> false </c> if unknown or blocking will occur.</para><para><para>read() </para><simplesectsep></simplesectsep><para>read(char[], int, int) </para></para>        
				/// </summary>
				/// <returns>
				/// <para><c> true </c> if the receiver will not block when <c> read() </c> is called, <c> false </c> if unknown or blocking will occur. </para>
				/// </returns>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Constructs a new File using the path of the specified URI. <c> uri </c> needs to be an absolute and hierarchical Unified Resource Identifier with file scheme and non-empty path component, but with undefined authority, query or fragment components.</para><para><para>toURI </para><simplesectsep></simplesectsep><para>java.net.URI </para></para>        
				/// </summary>
				[Dot42.DexImport("<init>", "(Ljava/lang/String;)V", AccessFlags = 1)]
				...
				/// <summary>
				/// <para>Returns the path of this file.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>this file's path. </para>
				/// </returns>
				/// <java-name>
				/// getPath
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para>A specialized OutputStream that is able to write (serialize) Java objects as well as primitive data types (int, byte, char etc.). The data can later be loaded using an ObjectInputStream.</para><para><para>ObjectInputStream </para><simplesectsep></simplesectsep><para>ObjectOutput </para><simplesectsep></simplesectsep><para>Serializable </para><simplesectsep></simplesectsep><para>Externalizable </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Enables object replacement for this stream. By default this is not enabled. Only trusted subclasses (loaded with system class loader) are allowed to change this status.</para><para><para>replaceObject </para><simplesectsep></simplesectsep><para>ObjectInputStream::enableResolveObject </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				/// <para>Sets the specified protocol version to be used by this stream.</para><para><para>ObjectStreamConstants::PROTOCOL_VERSION_1 </para><simplesectsep></simplesectsep><para>ObjectStreamConstants::PROTOCOL_VERSION_2 </para></para>        
				/// </summary>
				/// <java-name>
				/// useProtocolVersion
				/// </java-name>
				...
				public override void Write(sbyte[] value) /* TypeBuilder.AddAbstractInterfaceMethods */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Sets a mark position in this InputStream. The parameter <c> readlimit </c> indicates how many bytes can be read before the mark is invalidated. Sending <c> reset() </c> will reposition the stream back to the marked position provided <c> readLimit </c> has not been surpassed. </para><para>This default implementation does nothing and concrete subclasses must provide their own implementation.</para><para><para>markSupported() </para><simplesectsep></simplesectsep><para>reset() </para></para>        
				/// </summary>
				/// <java-name>
				/// mark
				/// </java-name>
				...
				/// <summary>
				/// <para>Indicates whether this stream supports the <c> mark() </c> and <c> reset() </c> methods. The default implementation returns <c> false </c> .</para><para><para>mark(int) </para><simplesectsep></simplesectsep><para>reset() </para></para>        
				/// </summary>
				/// <returns>
				/// <para>always <c> false </c> . </para>
				/// </returns>
				...
				/// </java-name>
				[Dot42.DexImport("read", "([BII)I", AccessFlags = 1)]
				public virtual int Read(sbyte[] buffer, int offset, int length) /* MethodBuilder.Create */ 
				{
						return default(int);
				}
				...
				/// </java-name>
				[Dot42.DexImport("read", "([BII)I", AccessFlags = 1, IgnoreFromJava = true)]
				public virtual int Read(byte[] buffer, int offset, int length) /* MethodBuilder.Create */ 
				{
						return default(int);
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para><para>Returns an estimated number of bytes that can be read or skipped without blocking for more input.</para><para>Note that this method provides such a weak guarantee that it is not very useful in practice.</para><para>Firstly, the guarantee is "without blocking for more input" rather than "without       blocking": a read may still block waiting for I/O to complete  the guarantee is merely that it won't have to wait indefinitely for data to be written. The result of this method should not be used as a license to do I/O on a thread that shouldn't be blocked.</para><para>Secondly, the result is a conservative estimate and may be significantly smaller than the actual number of bytes available. In particular, an implementation that always returns 0 would be correct. In general, callers should only use this method if they'd be satisfied with treating the result as a boolean yes or no answer to the question "is there definitely       data ready?".</para><para>Thirdly, the fact that a given number of bytes is "available" does not guarantee that a read or skip will actually read or skip that many bytes: they may read or skip fewer.</para><para>It is particularly important to realize that you <b>must not</b> use this method to size a container and assume that you can read the entirety of the stream without needing to resize the container. Such callers should probably write everything they read to a ByteArrayOutputStream and convert that to a byte array. Alternatively, if you're reading from a file, File#length returns the current length of the file (though assuming the file's length can't change may be incorrect, reading a file is inherently racy).</para><para>The default implementation of this method in <c> InputStream </c> always returns 0. Subclasses should override this method if they are able to indicate the number of bytes available.</para><para></para></para><para>Unlike most streams, <c> PipedInputStream </c> returns 0 rather than throwing <c> IOException </c> if the stream has been closed. Unconnected and broken pipes also return 0.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>the estimated number of bytes available </para>
				/// </returns>
				...
				/// <summary>
				/// <para>Reads at most <c> byteCount </c> bytes from this stream and stores them in the byte array <c> bytes </c> starting at <c> offset </c> . Blocks until at least one byte has been read, the end of the stream is detected or an exception is thrown. </para><para>Separate threads should be used to read from a <c> PipedInputStream </c> and to write to the connected PipedOutputStream. If the same thread is used, a deadlock may occur.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>the number of bytes actually read or -1 if the end of the stream has been reached. </para>
				/// </returns>
				...
				public override int Read(sbyte[] bytes, int offset, int byteCount) /* MethodBuilder.Create */ 
				{
						return default(int);
				}
				...
				public override int Read(byte[] bytes, int offset, int byteCount) /* MethodBuilder.Create */ 
				{
						return default(int);
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Enables object replacement for this stream. By default this is not enabled. Only trusted subclasses (loaded with system class loader) are allowed to change this status.</para><para><para>resolveObject </para><simplesectsep></simplesectsep><para>ObjectOutputStream::enableReplaceObject </para></para>        
				/// </summary>
				/// <returns>
				/// <para>the previous setting. </para>
				/// </returns>
				...
				/// <summary>
				/// <para>Reads at most <c> length </c> bytes from the source stream and stores them in byte array <c> buffer </c> starting at offset <c> count </c> . Blocks until <c> count </c> bytes have been read, the end of the source stream is detected or an exception is thrown.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>the number of bytes read or -1 if the end of the source input stream has been reached. </para>
				/// </returns>
				/// <java-name>
				/// read
				/// </java-name>
				...
				/// <summary>
				/// <para>Reads the next line from the source stream. Lines are terminated by <c> '\r' </c> , <c> '\n' </c> , <c> "\r\n" </c> or an <c> EOF </c> .</para><para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>Use BufferedReader </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				/// <para>Allows trusted subclasses to substitute the specified original <c>       object </c> with a new object. Object substitution has to be activated first with calling <c> enableResolveObject(true) </c> . This implementation just returns <c> object </c> .</para><para><para>enableResolveObject </para><simplesectsep></simplesectsep><para>ObjectOutputStream::enableReplaceObject </para><simplesectsep></simplesectsep><para>ObjectOutputStream::replaceObject </para></para>        
				/// </summary>
				/// <returns>
				/// <para>the replacement object for <c> object </c> . </para>
				/// </returns>
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para>Signals that, during deserialization, the validation of an object has failed.</para><para><para>ObjectInputStream::registerValidation(ObjectInputValidation, int) </para><simplesectsep></simplesectsep><para>ObjectInputValidation::validateObject() </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Indicates whether this reader supports the <c> mark() </c> and <c> reset() </c> methods.</para><para><para>mark(int) </para><simplesectsep></simplesectsep><para>reset() </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				/// <para>Reads at most <c> count </c> characters from this CharArrayReader and stores them at <c> offset </c> in the character array <c> buf </c> . Returns the number of characters actually read or -1 if the end of reader was encountered.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>number of characters read or -1 if the end of the reader has been reached. </para>
				/// </returns>
				/// <java-name>
				/// read
				/// </java-name>
				[Dot42.DexImport("read", "([CII)I", AccessFlags = 1)]
				public override int Read(char[] buffer, int offset, int len) /* MethodBuilder.Create */ 
				{
						return default(int);
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Indicates whether this stream supports the <c> mark(int) </c> and <c> reset() </c> methods. <c> PushbackInputStream </c> does not support them, so it returns <c> false </c> .</para><para><para>mark(int) </para><simplesectsep></simplesectsep><para>reset() </para></para>        
				/// </summary>
				/// <returns>
				/// <para>always <c> false </c> . </para>
				/// </returns>
				...
				/// <summary>
				/// <para>Reads at most <c> length </c> bytes from this stream and stores them in the byte array <c> buffer </c> starting at <c> offset </c> . Bytes are read from the pushback buffer first, then from the source stream if more bytes are required. Blocks until <c> count </c> bytes have been read, the end of the source stream is detected or an exception is thrown.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>the number of bytes read or -1 if the end of the source stream has been reached. </para>
				/// </returns>
				/// <java-name>
				/// read
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para>Defines an interface for classes that allow reading serialized objects.</para><para><para>ObjectInputStream </para><simplesectsep></simplesectsep><para>ObjectOutput </para></para>    
		/// </summary>
		/// <java-name>
		/// java/io/ObjectInput
		/// </java-name>
		[Dot42.DexImport("java/io/ObjectInput", AccessFlags = 1537)]
		public partial interface IObjectInput : global::Java.Io.IDataInput, global::Java.Lang.IAutoCloseable
 /* scope: __dot42__ */ 
		{
				/// <summary>
				...
				/// <summary>
				/// <para>Reads bytes from this stream into the byte array <c> buffer </c> . Blocks while waiting for input.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>the number of bytes read or -1 if the end of this stream has been reached. </para>
				/// </returns>
				/// <java-name>
				/// read
				/// </java-name>
				...
				/// <summary>
				/// <para>Reads at most <c> count </c> bytes from this stream and stores them in byte array <c> buffer </c> starting at offset <c> count </c> . Blocks while waiting for input.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>the number of bytes read or -1 if the end of this stream has been reached. </para>
				/// </returns>
				...
				int Read(sbyte[] buffer, int offset, int count) /* MethodBuilder.Create */ ;
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Sets a mark position in this reader. The parameter <c> readLimit </c> is ignored for this class. Calling <c> reset() </c> will reposition the reader back to the marked position.</para><para><para>markSupported() </para><simplesectsep></simplesectsep><para>reset() </para></para>        
				/// </summary>
				/// <java-name>
				/// mark
				/// </java-name>
				...
				/// <summary>
				/// <para>Reads at most <c> len </c> characters from the source string and stores them at <c> offset </c> in the character array <c> buf </c> . Returns the number of characters actually read or -1 if the end of the source string has been reached.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>the number of characters read or -1 if the end of the reader has been reached. </para>
				/// </returns>
				...
				/// </java-name>
				[Dot42.DexImport("read", "([CII)I", AccessFlags = 1)]
				public override int Read(char[] buf, int offset, int len) /* MethodBuilder.Create */ 
				{
						return default(int);
				}

				/// <summary>
				/// <para>Indicates whether this reader is ready to be read without blocking. This implementation always returns <c> true </c> .</para><para><para>read() </para><simplesectsep></simplesectsep><para>read(char[], int, int) </para></para>        
				/// </summary>
				/// <returns>
				/// <para>always <c> true </c> . </para>
				/// </returns>
				...
				/// <summary>
				/// <para>Resets this reader's position to the last <c> mark() </c> location. Invocations of <c> read() </c> and <c> skip() </c> will occur from this new location. If this reader has not been marked, it is reset to the beginning of the source string.</para><para><para>mark(int) </para><simplesectsep></simplesectsep><para>markSupported() </para></para>        
				/// </summary>
				/// <java-name>
				/// reset
				/// </java-name>
				...
				/// <summary>
				/// <para>Moves <c> charCount </c> characters in the source string. Unlike the overridden method, this method may skip negative skip distances: this rewinds the input so that characters may be read again. When the end of the source string has been reached, the input cannot be rewound.</para><para><para>mark(int) </para><simplesectsep></simplesectsep><para>markSupported() </para><simplesectsep></simplesectsep><para>reset() </para></para>        
				/// </summary>
				/// <returns>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para><para>Returns an estimated number of bytes that can be read or skipped without blocking for more input.</para><para>Note that this method provides such a weak guarantee that it is not very useful in practice.</para><para>Firstly, the guarantee is "without blocking for more input" rather than "without       blocking": a read may still block waiting for I/O to complete  the guarantee is merely that it won't have to wait indefinitely for data to be written. The result of this method should not be used as a license to do I/O on a thread that shouldn't be blocked.</para><para>Secondly, the result is a conservative estimate and may be significantly smaller than the actual number of bytes available. In particular, an implementation that always returns 0 would be correct. In general, callers should only use this method if they'd be satisfied with treating the result as a boolean yes or no answer to the question "is there definitely       data ready?".</para><para>Thirdly, the fact that a given number of bytes is "available" does not guarantee that a read or skip will actually read or skip that many bytes: they may read or skip fewer.</para><para>It is particularly important to realize that you <b>must not</b> use this method to size a container and assume that you can read the entirety of the stream without needing to resize the container. Such callers should probably write everything they read to a ByteArrayOutputStream and convert that to a byte array. Alternatively, if you're reading from a file, File#length returns the current length of the file (though assuming the file's length can't change may be incorrect, reading a file is inherently racy).</para><para>The default implementation of this method in <c> InputStream </c> always returns 0. Subclasses should override this method if they are able to indicate the number of bytes available.</para><para></para></para><para>Note that the source stream may just be a sequence of <c> "\r\n" </c> bytes which are converted into <c> '\n' </c> by this stream. Therefore, <c> available </c> returns only <c> in.available() / 2 </c> bytes as result. </para>        
				/// </summary>
				/// <returns>
				/// <para>the estimated number of bytes available </para>
				/// </returns>
				...
				/// <summary>
				/// <para>Reads at most <c> length </c> bytes from the filtered stream and stores them in the byte array <c> buffer </c> starting at <c> offset </c> . Returns the number of bytes actually read or -1 if no bytes have been read and the end of this stream has been reached. </para><para>The line number count is incremented if a line terminator is encountered. Recognized line terminator sequences are <c> '\r' </c> , <c> '\n' </c> and <c> "\r\n" </c> . Line terminator sequences are always translated into <c> '\n' </c> .</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>the number of bytes actually read or -1 if the end of the filtered stream has been reached while reading. </para>
				/// </returns>
				...
				/// <summary>
				/// <para>Resets this stream to the last marked location. It also resets the line count to what is was when this stream was marked.</para><para><para>mark(int) </para><simplesectsep></simplesectsep><para>markSupported() </para></para>        
				/// </summary>
				/// <java-name>
				/// reset
				/// </java-name>
				...
				/// <summary>
				/// <para>Sets the line number of this stream to the specified <c> lineNumber </c> . Note that this may have side effects on the line number associated with the last marked position.</para><para><para>mark(int) </para><simplesectsep></simplesectsep><para>reset() </para></para>        
				/// </summary>
				/// <java-name>
				/// setLineNumber
				/// </java-name>
				...
				/// <summary>
				/// <para>Skips <c> count </c> number of bytes in this stream. Subsequent calls to <c> read </c> will not return these bytes unless <c> reset </c> is used. This implementation skips <c> byteCount </c> bytes in the filtered stream and increments the line number count whenever line terminator sequences are skipped.</para><para><para>mark(int) </para><simplesectsep></simplesectsep><para>read() </para><simplesectsep></simplesectsep><para>reset() </para></para>        
				/// </summary>
				/// <returns>
				/// <para>the number of bytes actually skipped. </para>
				/// </returns>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Indicates whether <c> BufferedInputStream </c> supports the <c> mark() </c> and <c> reset() </c> methods.</para><para><para>mark(int) </para><simplesectsep></simplesectsep><para>reset() </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				/// <para>Reads at most <c> byteCount </c> bytes from this stream and stores them in byte array <c> buffer </c> starting at offset <c> offset </c> . Returns the number of bytes actually read or -1 if no bytes were read and the end of the stream was encountered. If all the buffered bytes have been used, a mark has not been set and the requested number of bytes is larger than the receiver's buffer size, this implementation bypasses the buffer and simply places the results directly into <c> buffer </c> .</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>the number of bytes actually read or -1 if end of stream. </para>
				/// </returns>
				/// <java-name>
				/// read
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				public int Ttype;
				/// <summary>
				/// <para>Constructs a new <c> StreamTokenizer </c> with <c> is </c> as source input stream. This constructor is deprecated; instead, the constructor that takes a <c> Reader </c> as an arugment should be used.</para><para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>Use StreamTokenizer(Reader) </para></xrefdescription></xrefsect></para>        
				/// </summary>
				[Dot42.DexImport("<init>", "(Ljava/io/InputStream;)V", AccessFlags = 1)]
 ...
 /* scope: __dot42__ */ 
		...
		///      }
		/// 
		///  </pre></para><para>This stream is <b>not buffered</b>. Most callers should wrap this stream with a BufferedOutputStream.</para><para>Use FileWriter to write characters, as opposed to bytes, to a file.</para><para><para>BufferedOutputStream </para><simplesectsep></simplesectsep><para>FileInputStream </para></para>    
		/// </summary>
		/// <java-name>
		/// java/io/FileOutputStream
		/// </java-name>
		[Dot42.DexImport("java/io/FileOutputStream", AccessFlags = 33)]
		public partial class FileOutputStream : global::Java.Io.OutputStream
 /* scope: __dot42__ */ 
		{
				/// <summary>
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para>A specialized InputStream that reads bytes from a <c> String </c> in a sequential manner.</para><para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>Use StringReader </para></xrefdescription></xrefsect></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Reads at most <c> length </c> bytes from the source string and stores them in the byte array <c> b </c> starting at <c> offset </c> .</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>the number of bytes actually read or -1 if the end of the source string has been reached. </para>
				/// </returns>
				/// <java-name>
				/// read
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Reads at most <c> count </c> bytes from this sequence of input streams and stores them in the byte array <c> buffer </c> starting at <c> offset </c> . Blocks only until at least 1 byte has been read, the end of the stream has been reached, or an exception is thrown. </para><para>This SequenceInputStream shows the same behavior as other InputStreams. To do this it will read only as many bytes as a call to read on the current substream returns. If that call does not return as many bytes as requested by <c> count </c> , it will not retry to read more on its own because subsequent reads might block. This would violate the rule that it will only block until at least one byte has been read. </para><para>If a substream has already reached the end when this call is made, it will close that substream and start with the next one. If there are no more substreams it will return -1.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>the number of bytes actually read; -1 if this sequence of streams is closed or if the end of the last stream in the sequence has been reached. </para>
				/// </returns>
				/// <java-name>
				/// read
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Sets a mark position in this ByteArrayInputStream. The parameter <c> readlimit </c> is ignored. Sending <c> reset() </c> will reposition the stream back to the marked position.</para><para><para>markSupported() </para><simplesectsep></simplesectsep><para>reset() </para></para>        
				/// </summary>
				/// <java-name>
				/// mark
				/// </java-name>
				...
				/// <summary>
				/// <para>Indicates whether this stream supports the <c> mark() </c> and <c> reset() </c> methods. Returns <c> true </c> since this class supports these methods.</para><para><para>mark(int) </para><simplesectsep></simplesectsep><para>reset() </para></para>        
				/// </summary>
				/// <returns>
				/// <para>always <c> true </c> . </para>
				/// </returns>
				...
				/// <summary>
				/// <para>Reads at most <c> len </c> bytes from this stream and stores them in byte array <c> b </c> starting at <c> offset </c> . This implementation reads bytes from the source byte array.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>the number of bytes actually read or -1 if no bytes were read and the end of the stream was encountered. </para>
				/// </returns>
				/// <java-name>
				/// read
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Reads bytes from the current position in this file and stores them in the byte array <c> buffer </c> . The maximum number of bytes read corresponds to the size of <c> buffer </c> . Blocks until at least one byte has been read, the end of the file is detected, or an exception is thrown.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>the number of bytes actually read or -1 if the end of the file has been reached. </para>
				/// </returns>
				/// <java-name>
				/// read
				/// </java-name>
				...
				/// <summary>
				/// <para>Reads at most <c> byteCount </c> bytes from the current position in this file and stores them in the byte array <c> buffer </c> starting at <c>       byteOffset </c> . Blocks until at least one byte has been read, the end of the file is detected, or an exception is thrown.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>the number of bytes actually read or -1 if the end of the stream has been reached. </para>
				/// </returns>
				...
				/// <summary>
				/// <para>Writes an 8-bit byte to this file, starting at the current file pointer. Only the least significant byte of the integer <c> val </c> is written.</para><para><para>readByte() </para><simplesectsep></simplesectsep><para>readUnsignedByte() </para></para>        
				/// </summary>
				/// <java-name>
				/// writeByte
				/// </java-name>
				...
				/// <summary>
				/// <para>Writes a big-endian 16-bit short to this file, starting at the current file pointer. Only the two least significant bytes of the integer <c> val </c> are written.</para><para><para>readShort() </para><simplesectsep></simplesectsep><para>DataInput::readUnsignedShort() </para></para>        
				/// </summary>
				/// <java-name>
				/// writeShort
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		...
		///      }
		/// 
		///  </pre></para><para>This stream is <b>not buffered</b>. Most callers should wrap this stream with a BufferedInputStream.</para><para>Use FileReader to read characters, as opposed to bytes, from a file.</para><para><para>BufferedInputStream </para><simplesectsep></simplesectsep><para>FileOutputStream </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para>A specialized Reader that reads from a file in the file system. All read requests made by calling methods in this class are directly forwarded to the equivalent function of the underlying operating system. Since this may induce some performance penalty, in particular if many small read requests are made, a FileReader is often wrapped by a BufferedReader.</para><para><para>BufferedReader </para><simplesectsep></simplesectsep><para>FileWriter </para></para>    
		/// </summary>
		/// <java-name>
		/// java/io/FileReader
		/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				/// <summary>
				/// <para>Constructs a new DataInputStream on the InputStream <c> in </c> . All reads are then filtered through this stream. Note that data read by this stream is not in a human readable format and was most likely created by a DataOutputStream.</para><para><b>Warning:</b> passing a null source creates an invalid <c> DataInputStream </c> . All operations on such a stream will fail.</para><para><para>DataOutputStream </para><simplesectsep></simplesectsep><para>RandomAccessFile </para></para>        
				/// </summary>
				[Dot42.DexImport("<init>", "(Ljava/io/InputStream;)V", AccessFlags = 1)]
				...
				/// <summary>
				/// <para>Reads at most <c> length </c> bytes from this stream and stores them in the byte array <c> buffer </c> starting at <c> offset </c> . Returns the number of bytes that have been read or -1 if no bytes have been read and the end of the stream has been reached.</para><para><para>DataOutput::write(byte[]) </para><simplesectsep></simplesectsep><para>DataOutput::write(byte[], int, int) </para></para>        
				/// </summary>
				/// <returns>
				/// <para>the number of bytes that have been read or -1 if the end of the stream has been reached. </para>
				/// </returns>
				/// <java-name>
				/// read
				/// </java-name>
				...
				/// <summary>
				/// <para>Skips <c> count </c> number of bytes in this stream. Subsequent <c>       read() </c> s will not return these bytes unless <c> reset() </c> is used.</para><para>This method will not throw an EOFException if the end of the input is reached before <c> count </c> bytes where skipped.</para><para><para>mark(int) </para><simplesectsep></simplesectsep><para>reset() </para></para>        
				/// </summary>
				/// <returns>
				/// <para>the number of bytes actually skipped. </para>
				/// </returns>
		...
		/// <summary>
		/// <para>Defines an interface for classes that allow reading serialized objects.</para><para><para>ObjectOutputStream </para><simplesectsep></simplesectsep><para>ObjectInput </para></para>    
		/// </summary>
		/// <java-name>
		/// java/io/ObjectOutput
		/// </java-name>
		[Dot42.DexImport("java/io/ObjectOutput", AccessFlags = 1537)]
		public partial interface IObjectOutput : global::Java.Io.IDataOutput, global::Java.Lang.IAutoCloseable
 /* scope: __dot42__ */ 
		{
				/// <summary>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Sets a mark position in this reader. The parameter <c> readLimit </c> indicates how many characters can be read before the mark is invalidated. Calling <c> reset() </c> will reposition the reader back to the marked position if <c> readLimit </c> has not been surpassed. </para><para>This default implementation simply throws an <c> IOException </c> ; subclasses must provide their own implementation.</para><para><para>markSupported() </para><simplesectsep></simplesectsep><para>reset() </para></para>        
				/// </summary>
				/// <java-name>
				/// mark
				/// </java-name>
				...
				/// <summary>
				/// <para>Reads at most <c> count </c> characters from this reader and stores them at <c> offset </c> in the character array <c> buf </c> . Returns the number of characters actually read or -1 if the end of the reader has been reached.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>the number of characters read or -1 if the end of the reader has been reached. </para>
				/// </returns>
				...
				public abstract int Read(char[] buf, int offset, int count) /* MethodBuilder.Create */ ;

				/// <summary>
				/// <para>Indicates whether this reader is ready to be read without blocking. Returns <c> true </c> if this reader will not block when <c> read </c> is called, <c> false </c> if unknown or blocking will occur. This default implementation always returns <c> false </c> .</para><para><para>read() </para><simplesectsep></simplesectsep><para>read(char[]) </para><simplesectsep></simplesectsep><para>read(char[], int, int) </para></para>        
				/// </summary>
				/// <returns>
				/// <para>always <c> false </c> . </para>
				/// </returns>
				...
				/// <summary>
				/// <para>Skips <c> charCount </c> characters in this reader. Subsequent calls of <c> read </c> methods will not return these characters unless <c>       reset </c> is used. This method may perform multiple reads to read <c>       charCount </c> characters.</para><para><para>mark(int) </para><simplesectsep></simplesectsep><para>markSupported() </para><simplesectsep></simplesectsep><para>reset() </para></para>        
				/// </summary>
				/// <returns>
				/// <para>the number of characters actually skipped. </para>
				/// </returns>
