...
//
// Original filename: Android.Database.cs
//
...
namespace Android.Database
{
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Special function for writing an exception result at the header of a parcel, to be used when returning an exception from a transaction. exception will be re-thrown by the function in another process <para>Parcel::writeNoException </para><simplesectsep></simplesectsep><para>Parcel::writeException </para></para>        
				/// </summary>
				/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				public SQLException(string error, global::System.Exception cause) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>This method is called when a content change occurs. Includes the changed content Uri when available. </para><para>Subclasses should override this method to handle content changes. To ensure correct operation on older versions of the framework that did not provide a Uri argument, applications should also implement the onChange(boolean) overload of this method whenever they implement the onChange(boolean, Uri) overload. </para><para>Example implementation: <pre><code>
				...
				///        }</code>
				/// 
				/// <code>       // Implement the onChange(boolean, Uri) method to take advantage of the new Uri argument.
				///        { }
				///        public void onChange(boolean selfChange, Uri uri) {
				///            // Handle change.
				///        }
				///        </code></pre> </para><para></para>        
				/// </summary>
				/// <java-name>
				/// onChange
				/// </java-name>
				[Dot42.DexImport("onChange", "(ZLandroid/net/Uri;)V", AccessFlags = 1)]
				public virtual void OnChange(bool selfChange, global::Android.Net.Uri uri) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Dispatches a change notification to the observer. Includes the changed content Uri when available. </para><para>If a Handler was supplied to the ContentObserver constructor, then a call to the onChange method is posted to the handler's message queue. Otherwise, the onChange method is invoked immediately on this thread. </para><para></para>        
				/// </summary>
				/// <java-name>
				/// dispatchChange
				/// </java-name>
				[Dot42.DexImport("dispatchChange", "(ZLandroid/net/Uri;)V", AccessFlags = 17)]
				public void DispatchChange(bool selfChange, global::Android.Net.Uri uri) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Invokes ContentObserver#dispatchChange(boolean, Uri) on each observer. Includes the changed content Uri when available. </para><para>If <code>selfChange</code> is true, only delivers the notification to the observer if it has indicated that it wants to receive self-change notifications by implementing ContentObserver#deliverSelfNotifications to return true. </para><para></para>        
				/// </summary>
				/// <java-name>
				/// dispatchChange
				/// </java-name>
				[Dot42.DexImport("dispatchChange", "(ZLandroid/net/Uri;)V", AccessFlags = 1)]
				public virtual void DispatchChange(bool selfChange, global::Android.Net.Uri uri) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Sets the start position of this cursor window. </para><para>The start position is the zero-based index of the first row that this window contains relative to the entire result set of the Cursor. </para><para></para>        
				/// </summary>
				/// <java-name>
				/// setStartPosition
				/// </java-name>
				[Dot42.DexImport("setStartPosition", "(I)V", AccessFlags = 1)]
				public virtual void SetStartPosition(int pos) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Builds a row, starting from the left-most column and adding one column value at a time. Follows the same ordering as the column names specified at cursor construction time. </para>    
				/// </summary>
				/// <java-name>
 ...
 /* scope: __dot42__ */ 
				{
						...
						/// add
						/// </java-name>
						[Dot42.DexImport("add", "(Ljava/lang/String;Ljava/lang/Object;)Landroid/database/MatrixCursor$RowBuilder;", AccessFlags = 1)]
						public virtual RowBuilder Add(string @string, object @object) /* MethodBuilder.Create */ 
						{
								return default(RowBuilder);
						}
 ...
 /* scope: __dot42__ */ 
		{
				...
				[Dot42.DexImport("android/database/Cursor", "getNotificationUri", "()Landroid/net/Uri;", AccessFlags = 1025)]
				public override global::Android.Net.Uri GetNotificationUri() /* TypeBuilder.AddAbstractInterfaceMethods */ 
				{
						return default(global::Android.Net.Uri);
				}
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para>This interface provides random read-write access to the result set returned by a database query.</para><para>Cursor implementations are not required to be synchronized so code using a Cursor from multiple threads should perform its own synchronization when using the Cursor. </para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		...
		public partial interface ICursor : global::Java.Io.ICloseable
 /* scope: __dot42__ */ 
		{
				/// <summary>
				/// <para>Returns the numbers of rows in the cursor.</para><para></para>        
				...
				/// getNotificationUri
				/// </java-name>
				[Dot42.DexImport("getNotificationUri", "()Landroid/net/Uri;", AccessFlags = 1025)]
				global::Android.Net.Uri GetNotificationUri() /* MethodBuilder.Create */ ;
