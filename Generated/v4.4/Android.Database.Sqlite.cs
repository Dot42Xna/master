...
namespace Android.Database.Sqlite
{
 ...
 /* scope: __dot42__ */ 
		...
		/// </java-name>
		[Dot42.DexImport("android/database/sqlite/SQLiteStatement", AccessFlags = 49)]
		public sealed partial class SQLiteStatement : global::Android.Database.Sqlite.SQLiteProgram
 /* scope: __dot42__ */ 
		{
				...
				public int ExecuteUpdateDelete() /* MethodBuilder.Create */ 
				{
						return default(int);
				}
				...
				public long ExecuteInsert() /* MethodBuilder.Create */ 
				{
						return default(long);
				}
				...
				public long SimpleQueryForLong() /* MethodBuilder.Create */ 
				{
						return default(long);
				}
				...
				public string SimpleQueryForString() /* MethodBuilder.Create */ 
				{
				...
				public global::Android.Os.ParcelFileDescriptor SimpleQueryForBlobFileDescriptor() /* MethodBuilder.Create */ 
				{
 ...
 /* scope: __dot42__ */ 
		...
		/// </java-name>
		[Dot42.DexImport("android/database/sqlite/SQLiteQuery", AccessFlags = 49)]
		public sealed partial class SQLiteQuery : global::Android.Database.Sqlite.SQLiteProgram
 /* scope: __dot42__ */ 
		{
				[Dot42.DexImport("<init>", "()V", AccessFlags = 0)]
 ...
 /* scope: __dot42__ */ 
    ...
    "id/database/Cursor;", AccessFlags = 1025)]
		...
		public abstract partial class SQLiteClosable : global::Java.Io.ICloseable
 /* scope: __dot42__ */ 
		{
				[Dot42.DexImport("<init>", "()V", AccessFlags = 1)]
				...
				/// <summary>
				/// <para>Releases a reference to the object, closing the object if the last reference was released.</para><para>Calling this method is equivalent to calling releaseReference.</para><para><para>releaseReference() </para><simplesectsep></simplesectsep><para>onAllReferencesReleased() </para></para>        
				/// </summary>
				/// <java-name>
				/// close
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
    ...
    "se$CursorFactory;ILandroid/database/DatabaseErrorHandler;)V", AccessFlags = 1)]
				...
				/// <summary>
				/// <para>Return the name of the SQLite database being opened, as given to the constructor. </para>        
				/// </summary>
				/// <java-name>
				/// getDatabaseName
				/// </java-name>
				...
				/// <summary>
				/// <para>Enables or disables the use of write-ahead logging for the database.</para><para>Write-ahead logging cannot be used with read-only databases so the value of this flag is ignored if the database is opened read-only.</para><para><para>SQLiteDatabase::enableWriteAheadLogging() </para></para>        
				/// </summary>
				/// <java-name>
				/// setWriteAheadLoggingEnabled
				/// </java-name>
				[Dot42.DexImport("setWriteAheadLoggingEnabled", "(Z)V", AccessFlags = 1)]
				public virtual void SetWriteAheadLoggingEnabled(bool enabled) /* MethodBuilder.Create */ 
				{
				}
				...
				/// getWritableDatabase
				/// </java-name>
				[Dot42.DexImport("getWritableDatabase", "()Landroid/database/sqlite/SQLiteDatabase;", AccessFlags = 1)]
				...
				/// getReadableDatabase
				/// </java-name>
				[Dot42.DexImport("getReadableDatabase", "()Landroid/database/sqlite/SQLiteDatabase;", AccessFlags = 1)]
				...
				/// <summary>
				/// <para>Called when the database connection is being configured, to enable features such as write-ahead logging or foreign key support. </para><para>This method is called before onCreate, onUpgrade, onDowngrade, or onOpen are called. It should not modify the database except to configure the database connection as required. </para><para>This method should only call methods that configure the parameters of the database connection, such as SQLiteDatabase#enableWriteAheadLogging SQLiteDatabase#setForeignKeyConstraintsEnabled, SQLiteDatabase#setLocale, SQLiteDatabase#setMaximumSize, or executing PRAGMA statements. </para><para></para>        
				/// </summary>
				/// <java-name>
				/// onConfigure
				/// </java-name>
				[Dot42.DexImport("onConfigure", "(Landroid/database/sqlite/SQLiteDatabase;)V", AccessFlags = 1)]
				public virtual void OnConfigure(global::Android.Database.Sqlite.SQLiteDatabase db) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		...
		/// </java-name>
		[Dot42.DexImport("android/database/sqlite/SQLiteDatabase", AccessFlags = 49)]
		public sealed partial class SQLiteDatabase : global::Android.Database.Sqlite.SQLiteClosable
 /* scope: __dot42__ */ 
		{
				/// <summary>
				...
				/// <summary>
				/// <para>Open flag: Flag for openDatabase to open the database file with write-ahead logging enabled by default. Using this flag is more efficient than calling enableWriteAheadLogging.</para><para>Write-ahead logging cannot be used with read-only databases so the value of this flag is ignored if the database is opened read-only.</para><para><para>enableWriteAheadLogging </para></para>        
				/// </summary>
				/// <java-name>
				/// ENABLE_WRITE_AHEAD_LOGGING
				/// </java-name>
				[Dot42.DexImport("ENABLE_WRITE_AHEAD_LOGGING", "I", AccessFlags = 25)]
				public const int ENABLE_WRITE_AHEAD_LOGGING = 536870912;
				/// <summary>
				...
				/// releaseMemory
				/// </java-name>
				[Dot42.DexImport("releaseMemory", "()I", AccessFlags = 9)]
				...
				public void SetLockingEnabled(bool lockingEnabled) /* MethodBuilder.Create */ 
				{
				}
				...
				public void BeginTransaction() /* MethodBuilder.Create */ 
				{
				}
				...
				public void BeginTransactionNonExclusive() /* MethodBuilder.Create */ 
				{
				}
				...
				public void BeginTransactionWithListener(global::Android.Database.Sqlite.ISQLiteTransactionListener transactionListener) /* MethodBuilder.Create */ 
				{
				}
				...
				public void BeginTransactionWithListenerNonExclusive(global::Android.Database.Sqlite.ISQLiteTransactionListener transactionListener) /* MethodBuilder.Create */ 
				{
				}
				...
				public void EndTransaction() /* MethodBuilder.Create */ 
				{
				}
				...
				public void SetTransactionSuccessful() /* MethodBuilder.Create */ 
				{
				}
				...
				public bool InTransaction() /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				public bool IsDbLockedByCurrentThread() /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				public bool IsDbLockedByOtherThreads() /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				public bool YieldIfContended() /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				public bool YieldIfContendedSafely() /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				public bool YieldIfContendedSafely(long sleepAfterYieldDelay) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				public global::Java.Util.IMap<string, string> GetSyncedTables() /* MethodBuilder.Create */ 
				{
    ...
    "/database/DatabaseErrorHandler;)Landroid/database/sqlite/SQLiteDatabase;", AccessFlags = 9)]
				...
				/// <summary>
				/// <para>Deletes a database including its journal file and other auxiliary files that may have been created by the database engine.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>True if the database was successfully deleted. </para>
				/// </returns>
				/// <java-name>
				/// deleteDatabase
				/// </java-name>
				[Dot42.DexImport("deleteDatabase", "(Ljava/io/File;)Z", AccessFlags = 9)]
				public static bool DeleteDatabase(global::Java.Io.File file) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
    ...
    "SQLiteDatabase;", AccessFlags = 9)]
				...
				public void SetVersion(int version) /* MethodBuilder.Create */ 
				{
				}
				...
				public long GetMaximumSize() /* MethodBuilder.Create */ 
				{
						return default(long);
				}
				...
				public long SetMaximumSize(long numBytes) /* MethodBuilder.Create */ 
				{
						return default(long);
				}
				...
				public long GetPageSize() /* MethodBuilder.Create */ 
				{
						return default(long);
				}
				...
				public void SetPageSize(long numBytes) /* MethodBuilder.Create */ 
				{
				}
				...
				public void MarkTableSyncable(string table, string deletedTable) /* MethodBuilder.Create */ 
				{
				}
				...
				public void MarkTableSyncable(string table, string foreignKey, string updateTable) /* MethodBuilder.Create */ 
				{
				}
				...
				public global::Android.Database.Sqlite.SQLiteStatement CompileStatement(string sql) /* MethodBuilder.Create */ 
				{
    ...
    "abase/Cursor;", AccessFlags = 1)]
				public global::Android.Database.ICursor Query(bool distinct, string table, string[] columns, string selection, string[] selectionArgs, string groupBy, string having, string orderBy, string limit) /* MethodBuilder.Create */ 
				{
				...
				/// </java-name>
				[Dot42.DexImport("query", "(ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava" +
    "/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/C" +
    "ancellationSignal;)Landroid/database/Cursor;", AccessFlags = 1)]
				public global::Android.Database.ICursor Query(bool distinct, string table, string[] columns, string selection, string[] selectionArgs, string groupBy, string having, string orderBy, string limit, global::Android.Os.CancellationSignal cancellationSignal) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Database.ICursor);
				}
    ...
    "ring;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;", AccessFlags = 1)]
				public global::Android.Database.ICursor QueryWithFactory(global::Android.Database.Sqlite.SQLiteDatabase.ICursorFactory cursorFactory, bool distinct, string table, string[] columns, string selection, string[] selectionArgs, string groupBy, string having, string orderBy, string limit) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Database.ICursor);
				}
				...
				/// queryWithFactory
				/// </java-name>
				[Dot42.DexImport("queryWithFactory", @"(Landroid/database/sqlite/SQLiteDatabase$CursorFactory;ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/CancellationSignal;)Landroid/database/Cursor;", AccessFlags = 1)]
				public global::Android.Database.ICursor QueryWithFactory(global::Android.Database.Sqlite.SQLiteDatabase.ICursorFactory cursorFactory, bool distinct, string table, string[] columns, string selection, string[] selectionArgs, string groupBy, string having, string orderBy, string limit, global::Android.Os.CancellationSignal cancellationSignal) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Database.ICursor);
				}
    ...
    "lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;", AccessFlags = 1)]
				public global::Android.Database.ICursor Query(string table, string[] columns, string selection, string[] selectionArgs, string groupBy, string having, string orderBy) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Database.ICursor);
				}
    ...
    "base/Cursor;", AccessFlags = 1)]
				public global::Android.Database.ICursor Query(string table, string[] columns, string selection, string[] selectionArgs, string groupBy, string having, string orderBy, string limit) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Database.ICursor);
				}
				...
				public global::Android.Database.ICursor RawQuery(string sql, string[] selectionArgs) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Database.ICursor);
				}
				...
				/// rawQuery
				/// </java-name>
				[Dot42.DexImport("rawQuery", "(Ljava/lang/String;[Ljava/lang/String;Landroid/os/CancellationSignal;)Landroid/da" +
    "tabase/Cursor;", AccessFlags = 1)]
				public global::Android.Database.ICursor RawQuery(string sql, string[] selectionArgs, global::Android.Os.CancellationSignal cancellationSignal) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Database.ICursor);
				}
    ...
    "ang/String;Ljava/lang/String;)Landroid/database/Cursor;", AccessFlags = 1)]
				public global::Android.Database.ICursor RawQueryWithFactory(global::Android.Database.Sqlite.SQLiteDatabase.ICursorFactory cursorFactory, string sql, string[] selectionArgs, string editTable) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Database.ICursor);
				}
				...
				/// </java-name>
				[Dot42.DexImport("rawQueryWithFactory", "(Landroid/database/sqlite/SQLiteDatabase$CursorFactory;Ljava/lang/String;[Ljava/l" +
    "ang/String;Ljava/lang/String;Landroid/os/CancellationSignal;)Landroid/database/C" +
    "ursor;", AccessFlags = 1)]
				public global::Android.Database.ICursor RawQueryWithFactory(global::Android.Database.Sqlite.SQLiteDatabase.ICursorFactory cursorFactory, string sql, string[] selectionArgs, string editTable, global::Android.Os.CancellationSignal cancellationSignal) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Database.ICursor);
				}
				...
				public long Insert(string table, string nullColumnHack, global::Android.Content.ContentValues values) /* MethodBuilder.Create */ 
				{
						return default(long);
				}
				...
				public long InsertOrThrow(string table, string nullColumnHack, global::Android.Content.ContentValues values) /* MethodBuilder.Create */ 
				{
						return default(long);
				}
				...
				public long Replace(string table, string nullColumnHack, global::Android.Content.ContentValues initialValues) /* MethodBuilder.Create */ 
				{
						return default(long);
				}
				...
				public long ReplaceOrThrow(string table, string nullColumnHack, global::Android.Content.ContentValues initialValues) /* MethodBuilder.Create */ 
				{
						return default(long);
				}
				...
				public long InsertWithOnConflict(string table, string nullColumnHack, global::Android.Content.ContentValues initialValues, int conflictAlgorithm) /* MethodBuilder.Create */ 
				{
						return default(long);
				}
				...
				public int Delete(string table, string whereClause, string[] whereArgs) /* MethodBuilder.Create */ 
				{
						return default(int);
				}
    ...
    "tring;)I", AccessFlags = 1)]
				public int Update(string table, global::Android.Content.ContentValues values, string whereClause, string[] whereArgs) /* MethodBuilder.Create */ 
				{
						return default(int);
				}
    ...
    "tring;I)I", AccessFlags = 1)]
				public int UpdateWithOnConflict(string table, global::Android.Content.ContentValues values, string whereClause, string[] whereArgs, int conflictAlgorithm) /* MethodBuilder.Create */ 
				{
						return default(int);
				}
				...
				public void ExecSQL(string sql) /* MethodBuilder.Create */ 
				{
				}
				...
				public void ExecSQL(string sql, object[] bindArgs) /* MethodBuilder.Create */ 
				{
				}
				...
				public bool NeedUpgrade(int newVersion) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				public void SetLocale(global::Java.Util.Locale locale) /* MethodBuilder.Create */ 
				{
				}
				...
				public void SetMaxSqlCacheSize(int cacheSize) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Sets whether foreign key constraints are enabled for the database. </para><para>By default, foreign key constraints are not enforced by the database. This method allows an application to enable foreign key constraints. It must be called each time the database is opened to ensure that foreign key constraints are enabled for the session. </para><para>A good time to call this method is right after calling openOrCreateDatabase or in the SQLiteOpenHelper#onConfigure callback. </para><para>When foreign key constraints are disabled, the database does not check whether changes to the database will violate foreign key constraints. Likewise, when foreign key constraints are disabled, the database will not execute cascade delete or update triggers. As a result, it is possible for the database state to become inconsistent. To perform a database integrity check, call isDatabaseIntegrityOk. </para><para>This method must not be called while a transaction is in progress. </para><para>See also  for more details about foreign key constraint support. </para><para></para>        
				/// </summary>
				/// <java-name>
				/// setForeignKeyConstraintsEnabled
				/// </java-name>
				[Dot42.DexImport("setForeignKeyConstraintsEnabled", "(Z)V", AccessFlags = 1)]
				public void SetForeignKeyConstraintsEnabled(bool enable) /* MethodBuilder.Create */ 
				{
				}
				...
				public bool EnableWriteAheadLogging() /* MethodBuilder.Create */ 
				{
						return default(bool);
				}

				/// <summary>
				/// <para>This method disables the features enabled by enableWriteAheadLogging().</para><para><para>enableWriteAheadLogging </para></para>        
				/// </summary>
				/// <java-name>
				/// disableWriteAheadLogging
				/// </java-name>
				[Dot42.DexImport("disableWriteAheadLogging", "()V", AccessFlags = 1)]
				public void DisableWriteAheadLogging() /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Returns true if write-ahead logging has been enabled for this database.</para><para><para>enableWriteAheadLogging </para><simplesectsep></simplesectsep><para>ENABLE_WRITE_AHEAD_LOGGING </para></para>        
				/// </summary>
				/// <returns>
				/// <para>True if write-ahead logging has been enabled for this database.</para>
				/// </returns>
				/// <java-name>
				/// isWriteAheadLoggingEnabled
				/// </java-name>
				[Dot42.DexImport("isWriteAheadLoggingEnabled", "()Z", AccessFlags = 1)]
				public bool IsWriteAheadLoggingEnabled() /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				public global::Java.Util.IList<global::Android.Util.Pair<string, string>> GetAttachedDbs() /* MethodBuilder.Create */ 
				{
				...
				public bool IsDatabaseIntegrityOk() /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>When set, the selection is verified against malicious arguments. When using this class to create a statement using buildQueryString(boolean, String, String[], String, String, String, String, String), non-numeric limits will raise an exception. If a projection map is specified, fields not in that map will be ignored. If this class is used to execute the statement directly using query(SQLiteDatabase, String[], String, String[], String, String, String) or query(SQLiteDatabase, String[], String, String[], String, String, String, String), additionally also parenthesis escaping selection are caught.</para><para>To summarize: To get maximum protection against malicious third party apps (for example content provider consumers), make sure to do the following: <ul><li><para>Set this value to true </para></li><li><para>Use a projection map </para></li><li><para>Use one of the query overloads instead of getting the statement as a sql string </para></li></ul>By default, this value is false. </para>        
				/// </summary>
				/// <java-name>
				/// setStrict
				/// </java-name>
				[Dot42.DexImport("setStrict", "(Z)V", AccessFlags = 1)]
				public virtual void SetStrict(bool flag) /* MethodBuilder.Create */ 
				{
				}
    ...
    "/String;)Landroid/database/Cursor;", AccessFlags = 1)]
				...
				[Dot42.DexImport("query", "(Landroid/database/sqlite/SQLiteDatabase;[Ljava/lang/String;Ljava/lang/String;[Lj" +
    "ava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang" +
    "/String;Landroid/os/CancellationSignal;)Landroid/database/Cursor;", AccessFlags = 1)]
				public virtual global::Android.Database.ICursor Query(global::Android.Database.Sqlite.SQLiteDatabase db, string[] projectionIn, string selection, string[] selectionArgs, string groupBy, string having, string sortOrder, string limit, global::Android.Os.CancellationSignal cancellationSignal) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Database.ICursor);
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				public SQLiteException(string error, global::System.Exception cause) /* MethodBuilder.Create */ 
				{
				}
