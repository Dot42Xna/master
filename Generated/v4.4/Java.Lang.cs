...
//
// Original filename: Java.Lang.cs
//
...
namespace Java.Lang
{
 ...
 /* scope: __dot42__ */ 
		{
				/// <summary>
				/// <para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>Use checkPermission </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <java-name>
				/// inCheck
				/// </java-name>
				...
				/// <summary>
				/// <para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>use checkMulticast(java.net.InetAddress) </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <java-name>
				/// checkMulticast
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		...
		public partial class IllegalAccessException : global::Java.Lang.ReflectiveOperationException
 /* scope: __dot42__ */ 
		{
				/// <summary>
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para>Thrown when the VM notices that a program tries to reference, on a class or object, a field that does not exist. </para><para>Note that this can only occur when inconsistent class files are being loaded. </para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				/// <summary>
				/// <para>Constructs a new <c> NoSuchFieldError </c> that includes the current stack trace. </para>        
				/// </summary>
				[Dot42.DexImport("<init>", "()V", AccessFlags = 1)]
				...
				/// <summary>
				/// <para>Constructs a new <c> NoSuchFieldError </c> with the current stack trace and the specified detail message.</para><para></para>        
				/// </summary>
				[Dot42.DexImport("<init>", "(Ljava/lang/String;)V", AccessFlags = 1)]
				public NoSuchFieldError(string detailMessage) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				public virtual A GetAnnotation<A>(global::System.Type annotationType) /* MethodBuilder.Create */ 
				{
						return default(A);
				}
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para>A modifiable sequence of characters for use in creating and modifying Strings. This class is intended as a base class for StringBuffer and StringBuilder.</para><para><para>StringBuffer </para><simplesectsep></simplesectsep><para>StringBuilder </para><para>1.5 </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Returns the number of characters that can be held without growing.</para><para><para>#ensureCapacity </para><simplesectsep></simplesectsep><para>#length </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				/// <para>Retrieves the Unicode code point value at the <c> index </c> .</para><para><para>Character </para><simplesectsep></simplesectsep><para>Character::codePointAt(char[], int, int) </para><para>1.5 </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				/// <para>Retrieves the Unicode code point value that precedes the <c> index </c> .</para><para><para>Character </para><simplesectsep></simplesectsep><para>Character::codePointBefore(char[], int, int) </para><para>1.5 </para></para>        
				/// </summary>
				/// <returns>
				/// <para>the Unicode code point value. </para>
				/// </returns>
				...
				/// <summary>
				/// <para>Calculates the number of Unicode code points between <c> start </c> and <c> end </c> .</para><para><para>Character </para><simplesectsep></simplesectsep><para>Character::codePointCount(char[], int, int) </para><para>1.5 </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				/// <para>Returns the index that is offset <c> codePointOffset </c> code points from <c> index </c> .</para><para><para>Character </para><simplesectsep></simplesectsep><para>Character::offsetByCodePoints(char[], int, int, int, int) </para><para>1.5 </para></para>        
				/// </summary>
				/// <returns>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Constructs a new <c> LinkageError </c> with the given detail message and cause. <para>1.7  1.7 </para></para>        
				/// </summary>
				[Dot42.DexImport("<init>", "(Ljava/lang/String;Ljava/lang/Throwable;)V", AccessFlags = 1)]
				public LinkageError(string detailMessage, global::System.Exception cause) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Constructs a new <c> AssertionError </c> with the given detail message and cause. <para>1.7  1.7 </para></para>        
				/// </summary>
				[Dot42.DexImport("<init>", "(Ljava/lang/String;Ljava/lang/Throwable;)V", AccessFlags = 1)]
				public AssertionError(string detailMessage, global::System.Exception cause) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		...
		/// </java-name>
		[Dot42.DexImport("java/lang/ReflectiveOperationException", AccessFlags = 33)]
		public partial class ReflectiveOperationException : global::System.Exception
 /* scope: __dot42__ */ 
		{
				[Dot42.DexImport("<init>", "()V", AccessFlags = 1)]
				public ReflectiveOperationException() /* MethodBuilder.Create */ 
				{
				}

				[Dot42.DexImport("<init>", "(Ljava/lang/String;)V", AccessFlags = 1)]
				public ReflectiveOperationException(string @string) /* MethodBuilder.Create */ 
				{
				}

				[Dot42.DexImport("<init>", "(Ljava/lang/Throwable;)V", AccessFlags = 1)]
				public ReflectiveOperationException(global::System.Exception exception) /* MethodBuilder.Create */ 
				{
				}

				[Dot42.DexImport("<init>", "(Ljava/lang/String;Ljava/lang/Throwable;)V", AccessFlags = 1)]
				public ReflectiveOperationException(string @string, global::System.Exception exception) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para>This (empty) interface must be implemented by all classes that wish to support cloning. The implementation of <c> clone() </c> in <c> Object </c> checks if the object being cloned implements this interface and throws <c> CloneNotSupportedException </c> if it does not.</para><para><para>Object::clone </para><simplesectsep></simplesectsep><para>CloneNotSupportedException </para></para>    
		/// </summary>
		/// <java-name>
		/// java/lang/Cloneable
		/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Returns the current timestamp of the most precise timer available on the local system.</para><para>This timestamp should only be used to measure a duration by comparing it against another timestamp from the same process on the same device. Values returned by this method do not have a defined correspondence to wall clock times; the zero value is typically whenever the device last booted. Use currentTimeMillis if you want to know what time it is. </para>        
				/// </summary>
				/// <java-name>
				/// nanoTime
				/// </java-name>
				...
				/// <summary>
				/// <para>Causes the VM to stop running and the program to exit. If runFinalizersOnExit(boolean) has been previously invoked with a <c> true </c> argument, then all objects will be properly garbage-collected and finalized first.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// exit
				/// </java-name>
				...
				/// <summary>
				/// <para>Returns the value of the environment variable with the given name <c>       var </c> .</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>the value of the specified environment variable or <c> null </c> if no variable exists with the given name. </para>
				/// </returns>
				/// <java-name>
				/// getenv
				/// </java-name>
				...
				/// <summary>
				/// <para>Returns an unmodifiable map of all available environment variables.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>the map representing all environment variables. </para>
				/// </returns>
				/// <java-name>
				/// getenv
				/// </java-name>
				...
				/// <summary>
				/// <para>Returns the inherited channel from the creator of the current virtual machine.</para><para><para>SelectorProvider </para><simplesectsep></simplesectsep><para>SelectorProvider::inheritedChannel() </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				/// <para>Returns the java.io.Console associated with this VM, or null. Not all VMs will have an associated console. A console is typically only available for programs run from the command line. <para>1.6 </para></para>        
				/// </summary>
				/// <java-name>
				/// console
				/// </java-name>
				...
				/// <summary>
				/// <para>Returns the system's line separator. On Android, this is <c> "\n" </c> . The value comes from the value of the <c> line.separator </c> system property when the VM starts. Later changes to the property will not affect the value returned by this method. <para>1.7  1.7 - fix documentation references to "line.separator" in Formatter. </para></para>        
				/// </summary>
				/// <java-name>
				/// lineSeparator
				/// </java-name>
				[Dot42.DexImport("lineSeparator", "()Ljava/lang/String;", AccessFlags = 9)]
				public static string LineSeparator() /* MethodBuilder.Create */ 
				{
						return default(string);
				}
				...
				/// <summary>
				/// <para>Sets all system properties. This does not take a copy; the passed-in object is used directly. Passing null causes the VM to reinitialize the properties to how they were when the VM was started. </para>        
				/// </summary>
				/// <java-name>
				/// setProperties
				/// </java-name>
				[Dot42.DexImport("setProperties", "(Ljava/util/Properties;)V", AccessFlags = 9)]
				public static void SetProperties(global::Java.Util.Properties p) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Throws <c> SecurityException </c> .</para><para>Security managers do <b>not</b> provide a secure environment for executing untrusted code and are unsupported on Android. Untrusted code cannot be safely isolated within a single VM on Android, so this method <b>always</b> throws a <c> SecurityException </c> .</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setSecurityManager
				/// </java-name>
				[Dot42.DexImport("setSecurityManager", "(Ljava/lang/SecurityManager;)V", AccessFlags = 9)]
				public static void SetSecurityManager(global::Java.Lang.SecurityManager sm) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				/// <summary>
				/// <para>Constructs a new <c> NoSuchMethodError </c> that includes the current stack trace. </para>        
				/// </summary>
				[Dot42.DexImport("<init>", "()V", AccessFlags = 1)]
				...
				/// <summary>
				/// <para>Constructs a new <c> NoSuchMethodError </c> with the current stack trace and the specified detail message.</para><para></para>        
				/// </summary>
				[Dot42.DexImport("<init>", "(Ljava/lang/String;)V", AccessFlags = 1)]
				public NoSuchMethodError(string detailMessage) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para>Class StrictMath provides basic math constants and operations such as trigonometric functions, hyperbolic functions, exponential, logarithms, etc. </para><para>In contrast to class Math, the methods in this class return exactly the same results on all platforms. Algorithms based on these methods thus behave the same (e.g. regarding numerical convergence) on all platforms, complying with the slogan "write once, run everywhere". On the other side, the implementation of class StrictMath may be less efficient than that of class Math, as class StrictMath cannot utilize platform specific features such as an extended precision math co-processors. </para><para>The methods in this class are specified using the "Freely Distributable Math   Library" (fdlibm), version 5.3. </para><para> </para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Returns a double with the given magnitude and the sign of <c> sign </c> . If <c> sign </c> is NaN, the sign of the result is positive. <para>1.6 </para></para>        
				/// </summary>
				/// <java-name>
				/// copySign
				/// </java-name>
				...
				/// <summary>
				/// <para>Returns the exponent of float <c> f </c> . <para>1.6 </para></para>        
				/// </summary>
				/// <java-name>
				/// getExponent
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		...
		/// </java-name>
		[Dot42.DexImport("java/lang/SafeVarargs", AccessFlags = 9729)]
		public partial interface ISafeVarargs : global::Java.Lang.Annotation.IAnnotation
 /* scope: __dot42__ */ 
		{
		}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Enum types may not have finalizers.</para><para><para>1.6 </para></para>        
				/// </summary>
				/// <java-name>
				/// finalize
				/// </java-name>
		...
		/// <summary>
		/// <para><c> Error </c> is the superclass of all classes that represent unrecoverable errors. When errors are thrown, they should not be caught by application code.</para><para><para>Throwable </para><simplesectsep></simplesectsep><para>Exception </para><simplesectsep></simplesectsep><para>RuntimeException </para></para>    
		/// </summary>
		/// <java-name>
		/// java/lang/Error
		/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Constructs a new class from an array of bytes containing a class definition in class file format.</para><para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>Use defineClass(String, byte[], int, int) </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <returns>
 ...
 /* scope: __dot42__ */ 
		...
		public partial class InstantiationException : global::Java.Lang.ReflectiveOperationException
 /* scope: __dot42__ */ 
		{
				/// <summary>
 ...
 /* scope: __dot42__ */ 
		...
		public partial class ClassNotFoundException : global::Java.Lang.ReflectiveOperationException
 /* scope: __dot42__ */ 
		{
				/// <summary>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Checks whether this thread group is a daemon <c> ThreadGroup </c> .</para><para><para>setDaemon </para><simplesectsep></simplesectsep><para>destroy </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				/// <para>Resumes every thread in this group and recursively in all its subgroups.</para><para><para>Thread::resume </para><simplesectsep></simplesectsep><para>suspend</para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>Requires deprecated method Thread.resume(). </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <java-name>
				/// resume
				/// </java-name>
				...
				/// <summary>
				/// <para>Sets whether this is a daemon <c> ThreadGroup </c> or not. Daemon thread groups are automatically destroyed when they become empty.</para><para><para>#isDaemon </para><simplesectsep></simplesectsep><para>destroy </para></para>        
				/// </summary>
				/// <java-name>
				/// setDaemon
				/// </java-name>
				...
				/// <summary>
				/// <para>Configures the maximum allowed priority for a <c> Thread </c> in this group and recursively in all its subgroups.</para><para>A caller can never increase the maximum priority of a thread group. Such an attempt will not result in an exception, it will simply leave the thread group with its current maximum priority.</para><para><para>getMaxPriority </para></para>        
				/// </summary>
				/// <java-name>
				/// setMaxPriority
				/// </java-name>
				[Dot42.DexImport("setMaxPriority", "(I)V", AccessFlags = 17)]
				public void SetMaxPriority(int newMax) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Stops every thread in this group and recursively in all its subgroups.</para><para><para>Thread::stop() </para><simplesectsep></simplesectsep><para>Thread::stop(Throwable) </para><simplesectsep></simplesectsep><para>ThreadDeath</para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>Requires deprecated method Thread.stop(). </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <java-name>
				/// stop
				/// </java-name>
				...
				/// <summary>
				/// <para>Suspends every thread in this group and recursively in all its subgroups.</para><para><para>Thread::suspend </para><simplesectsep></simplesectsep><para>resume</para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>Requires deprecated method Thread.suspend(). </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <java-name>
				/// suspend
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para><c> Exception </c> is the superclass of all classes that represent recoverable exceptions. When exceptions are thrown, they may be caught by application code.</para><para><para>Throwable </para><simplesectsep></simplesectsep><para>Error </para><simplesectsep></simplesectsep><para>RuntimeException </para></para>    
		/// </summary>
		/// <java-name>
		/// java/lang/Exception
		/// </java-name>
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para>Defines an interface for classes that can (or need to) be closed once they are not used any longer. Calling the <c> close </c> method releases resources that the object holds.</para><para>A common pattern for using an <c> AutoCloseable </c> resource: <pre>        Closable foo = new Foo();
		/// 
		///      try {
		/// 
		///         ...;
		...
		///      }
		/// 
		///  </pre></para><para><para>1.7  1.7 </para></para>    
		/// </summary>
		/// <java-name>
		/// java/lang/AutoCloseable
		/// </java-name>
		[Dot42.DexImport("java/lang/AutoCloseable", AccessFlags = 1537)]
		public partial interface IAutoCloseable
 /* scope: __dot42__ */ 
		{
				/// <summary>
				/// <para>Closes the object and release any system resources it holds.</para><para>Unless the implementing class specifies otherwise, it is an error to call close more than once. </para>        
				/// </summary>
				/// <java-name>
				/// close
				/// </java-name>
