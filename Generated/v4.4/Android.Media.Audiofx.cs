...
//
// Original filename: Android.Media.Audiofx.cs
//
...
namespace Android.Media.Audiofx
{
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Sets the equalizer properties. This method is useful when equalizer settings have to be applied from a previous backup. </para>        
				/// </summary>
				/// <java-name>
				/// setProperties
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Sets the virtualizer properties. This method is useful when virtualizer settings have to be applied from a previous backup. </para>        
				/// </summary>
				/// <java-name>
				/// setProperties
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				public static bool IsAvailable() /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Sets the master volume level of the environmental reverb effect. </para>        
				/// </summary>
				/// <java-name>
				/// setRoomLevel
				/// </java-name>
				[Dot42.DexImport("setRoomLevel", "(S)V", AccessFlags = 1)]
				public virtual void SetRoomLevel(short room) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Sets the volume level at 5 kHz relative to the volume level at low frequencies of the overall reverb effect. </para><para>This controls a low-pass filter that will reduce the level of the high-frequency. </para>        
				/// </summary>
				/// <java-name>
				/// setRoomHFLevel
				/// </java-name>
				[Dot42.DexImport("setRoomHFLevel", "(S)V", AccessFlags = 1)]
				public virtual void SetRoomHFLevel(short roomHF) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Sets the time taken for the level of reverberation to decay by 60 dB. </para>        
				/// </summary>
				/// <java-name>
				/// setDecayTime
				/// </java-name>
				[Dot42.DexImport("setDecayTime", "(I)V", AccessFlags = 1)]
				public virtual void SetDecayTime(int decayTime) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Sets the ratio of high frequency decay time (at 5 kHz) relative to the decay time at low frequencies. </para>        
				/// </summary>
				/// <java-name>
				/// setDecayHFRatio
				/// </java-name>
				[Dot42.DexImport("setDecayHFRatio", "(S)V", AccessFlags = 1)]
				public virtual void SetDecayHFRatio(short decayHFRatio) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Sets the volume level of the early reflections. </para><para>This level is combined with the overall room level (set using setRoomLevel(short)). </para>        
				/// </summary>
				/// <java-name>
				/// setReflectionsLevel
				/// </java-name>
				[Dot42.DexImport("setReflectionsLevel", "(S)V", AccessFlags = 1)]
				public virtual void SetReflectionsLevel(short reflectionsLevel) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Sets the delay time for the early reflections. </para><para>This method sets the time between when the direct path is heard and when the first reflection is heard. </para>        
				/// </summary>
				/// <java-name>
				/// setReflectionsDelay
				/// </java-name>
				[Dot42.DexImport("setReflectionsDelay", "(I)V", AccessFlags = 1)]
				public virtual void SetReflectionsDelay(int reflectionsDelay) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Sets the volume level of the late reverberation. </para><para>This level is combined with the overall room level (set using setRoomLevel(short)). </para>        
				/// </summary>
				/// <java-name>
				/// setReverbLevel
				/// </java-name>
				[Dot42.DexImport("setReverbLevel", "(S)V", AccessFlags = 1)]
				public virtual void SetReverbLevel(short reverbLevel) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Sets the time between the first reflection and the reverberation. </para>        
				/// </summary>
				/// <java-name>
				/// setReverbDelay
				/// </java-name>
				[Dot42.DexImport("setReverbDelay", "(I)V", AccessFlags = 1)]
				public virtual void SetReverbDelay(int reverbDelay) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Sets the echo density in the late reverberation decay. </para><para>The scale should approximately map linearly to the perceived change in reverberation. </para>        
				/// </summary>
				/// <java-name>
				/// setDiffusion
				/// </java-name>
				[Dot42.DexImport("setDiffusion", "(S)V", AccessFlags = 1)]
				public virtual void SetDiffusion(short diffusion) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Controls the modal density of the late reverberation decay. </para><para>The scale should approximately map linearly to the perceived change in reverberation. A lower density creates a hollow sound that is useful for simulating small reverberation spaces such as bathrooms. </para>        
				/// </summary>
				/// <java-name>
				/// setDensity
				/// </java-name>
				[Dot42.DexImport("setDensity", "(S)V", AccessFlags = 1)]
				public virtual void SetDensity(short density) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Sets the environmental reverb properties. This method is useful when reverb settings have to be applied from a previous backup. </para>        
				/// </summary>
				/// <java-name>
				/// setProperties
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		...
		/// </java-name>
		[Dot42.DexImport("android/media/audiofx/LoudnessEnhancer", AccessFlags = 33)]
		public partial class LoudnessEnhancer : global::Android.Media.Audiofx.AudioEffect
 /* scope: __dot42__ */ 
		{
				/// <java-name>
				/// PARAM_TARGET_GAIN_MB
				/// </java-name>
				[Dot42.DexImport("PARAM_TARGET_GAIN_MB", "I", AccessFlags = 25)]
				public const int PARAM_TARGET_GAIN_MB = 0;
				[Dot42.DexImport("<init>", "(I)V", AccessFlags = 1)]
				public LoudnessEnhancer(int int32) /* MethodBuilder.Create */ 
				{
				}
				...
				/// setTargetGain
				/// </java-name>
				[Dot42.DexImport("setTargetGain", "(I)V", AccessFlags = 1)]
				public virtual void SetTargetGain(int int32) /* MethodBuilder.Create */ 
				{
				}
				...
				/// getTargetGain
				/// </java-name>
				[Dot42.DexImport("getTargetGain", "()F", AccessFlags = 1)]
				public virtual float GetTargetGain() /* MethodBuilder.Create */ 
				{
						return default(float);
				}

				[global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
				internal LoudnessEnhancer() /* TypeBuilder.AddDefaultConstructor */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Enables a preset on the reverb. </para><para>The reverb PRESET_NONE disables any reverb from the current output but does not free the resources associated with the reverb. For an application to signal to the implementation to free the resources, it must call the release() method. </para>        
				/// </summary>
				/// <java-name>
				/// setPreset
				/// </java-name>
				[Dot42.DexImport("setPreset", "(S)V", AccessFlags = 1)]
				public virtual void SetPreset(short preset) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Sets the preset reverb properties. This method is useful when preset reverb settings have to be applied from a previous backup. </para>        
				/// </summary>
				/// <java-name>
				/// setProperties
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// </java-name>
				[Dot42.DexImport("MEASUREMENT_MODE_NONE", "I", AccessFlags = 25)]
				public const int MEASUREMENT_MODE_NONE = 0;
				/// <java-name>
				/// MEASUREMENT_MODE_PEAK_RMS
				/// </java-name>
				[Dot42.DexImport("MEASUREMENT_MODE_PEAK_RMS", "I", AccessFlags = 25)]
				public const int MEASUREMENT_MODE_PEAK_RMS = 1;
				/// <summary>
				...
				public virtual int GetScalingMode() /* MethodBuilder.Create */ 
				{
						return default(int);
				}
				...
				/// setMeasurementMode
				/// </java-name>
				[Dot42.DexImport("setMeasurementMode", "(I)I", AccessFlags = 1)]
				public virtual int SetMeasurementMode(int int32) /* MethodBuilder.Create */ 
				{
						return default(int);
				}
				...
				/// getMeasurementMode
				/// </java-name>
				[Dot42.DexImport("getMeasurementMode", "()I", AccessFlags = 1)]
				public virtual int GetMeasurementMode() /* MethodBuilder.Create */ 
				{
						return default(int);
				}
				...
				/// </java-name>
				[Dot42.DexImport("getMeasurementPeakRms", "(Landroid/media/audiofx/Visualizer$MeasurementPeakRms;)I", AccessFlags = 1)]
				public virtual int GetMeasurementPeakRms(global::Android.Media.Audiofx.Visualizer.MeasurementPeakRms measurementPeakRms) /* MethodBuilder.Create */ 
				{
						return default(int);
				}
 ...
 /* scope: __dot42__ */ 
				...
				/// </java-name>
				[Dot42.DexImport("android/media/audiofx/Visualizer$MeasurementPeakRms", AccessFlags = 25)]
				public sealed partial class MeasurementPeakRms
 /* scope: __dot42__ */ 
				{
						/// <java-name>
						/// mPeak
						/// </java-name>
						[Dot42.DexImport("mPeak", "I", AccessFlags = 1)]
						public int MPeak;
						/// <java-name>
						/// mRms
						/// </java-name>
						[Dot42.DexImport("mRms", "I", AccessFlags = 1)]
						public int MRms;
						[Dot42.DexImport("<init>", "()V", AccessFlags = 1)]
						public MeasurementPeakRms() /* MethodBuilder.Create */ 
						{
						}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Sets the bass boost properties. This method is useful when bass boost settings have to be applied from a previous backup. </para>        
				/// </summary>
				/// <java-name>
				/// setProperties
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				/// <summary>
				/// <para>The following UUIDs define effect types corresponding to standard audio effects whose implementation and interface conform to the OpenSL ES specification. The definitions match the corresponding interface IDs in OpenSLES_IID.h UUID for environmental reverberation effect </para>        
				/// </summary>
				/// <java-name>
				/// EFFECT_TYPE_ENV_REVERB
				/// </java-name>
				[Dot42.DexImport("EFFECT_TYPE_ENV_REVERB", "Ljava/util/UUID;", AccessFlags = 25)]
				public static readonly global::Java.Util.UUID EFFECT_TYPE_ENV_REVERB;
				/// <summary>
				/// <para>UUID for preset reverberation effect </para>        
				/// </summary>
				/// <java-name>
				/// EFFECT_TYPE_PRESET_REVERB
				/// </java-name>
				[Dot42.DexImport("EFFECT_TYPE_PRESET_REVERB", "Ljava/util/UUID;", AccessFlags = 25)]
				public static readonly global::Java.Util.UUID EFFECT_TYPE_PRESET_REVERB;
				/// <summary>
				/// <para>UUID for equalizer effect </para>        
				/// </summary>
				/// <java-name>
				/// EFFECT_TYPE_EQUALIZER
				/// </java-name>
				[Dot42.DexImport("EFFECT_TYPE_EQUALIZER", "Ljava/util/UUID;", AccessFlags = 25)]
				public static readonly global::Java.Util.UUID EFFECT_TYPE_EQUALIZER;
				/// <summary>
				/// <para>UUID for bass boost effect </para>        
				/// </summary>
				/// <java-name>
				/// EFFECT_TYPE_BASS_BOOST
				/// </java-name>
				[Dot42.DexImport("EFFECT_TYPE_BASS_BOOST", "Ljava/util/UUID;", AccessFlags = 25)]
				public static readonly global::Java.Util.UUID EFFECT_TYPE_BASS_BOOST;
				/// <summary>
				/// <para>UUID for virtualizer effect </para>        
				/// </summary>
				/// <java-name>
				/// EFFECT_TYPE_VIRTUALIZER
				/// </java-name>
				[Dot42.DexImport("EFFECT_TYPE_VIRTUALIZER", "Ljava/util/UUID;", AccessFlags = 25)]
				public static readonly global::Java.Util.UUID EFFECT_TYPE_VIRTUALIZER;
				/// <summary>
				/// <para>UUIDs for effect types not covered by OpenSL ES. UUID for Automatic Gain Control (AGC) </para>        
				/// </summary>
				/// <java-name>
				/// EFFECT_TYPE_AGC
				/// </java-name>
				[Dot42.DexImport("EFFECT_TYPE_AGC", "Ljava/util/UUID;", AccessFlags = 25)]
				public static readonly global::Java.Util.UUID EFFECT_TYPE_AGC;
				/// <summary>
				/// <para>UUID for Acoustic Echo Canceler (AEC) </para>        
				/// </summary>
				/// <java-name>
				/// EFFECT_TYPE_AEC
				/// </java-name>
				[Dot42.DexImport("EFFECT_TYPE_AEC", "Ljava/util/UUID;", AccessFlags = 25)]
				public static readonly global::Java.Util.UUID EFFECT_TYPE_AEC;
				/// <summary>
				/// <para>UUID for Noise Suppressor (NS) </para>        
				/// </summary>
				/// <java-name>
				/// EFFECT_TYPE_NS
				/// </java-name>
				[Dot42.DexImport("EFFECT_TYPE_NS", "Ljava/util/UUID;", AccessFlags = 25)]
				public static readonly global::Java.Util.UUID EFFECT_TYPE_NS;
				/// <java-name>
				/// EFFECT_TYPE_LOUDNESS_ENHANCER
				/// </java-name>
				[Dot42.DexImport("EFFECT_TYPE_LOUDNESS_ENHANCER", "Ljava/util/UUID;", AccessFlags = 25)]
				public static readonly global::Java.Util.UUID EFFECT_TYPE_LOUDNESS_ENHANCER;
				/// <summary>
				/// <para>Successful operation. </para>        
				/// </summary>
				/// <java-name>
