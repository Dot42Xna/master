...
namespace Android.Accounts
{
 ...
 /* scope: __dot42__ */ 
    ...
    "id/os/Bundle;", AccessFlags = 1)]
				...
				/// <summary>
				/// <para>Returns a Bundle that contains whatever is required to clone the account on a different user. The Bundle is passed to the authenticator instance in the target user via addAccountFromCredentials(AccountAuthenticatorResponse, Account, Bundle). The default implementation returns null, indicating that cloning is not supported. <para>addAccountFromCredentials(AccountAuthenticatorResponse, Account, Bundle) </para></para>        
				/// </summary>
				/// <returns>
				/// <para>a Bundle result or null if the result is to be returned via the response. </para>
				/// </returns>
				/// <java-name>
				/// getAccountCredentialsForCloning
				/// </java-name>
				[Dot42.DexImport("getAccountCredentialsForCloning", "(Landroid/accounts/AccountAuthenticatorResponse;Landroid/accounts/Account;)Landro" +
    "id/os/Bundle;", AccessFlags = 1)]
				public virtual global::Android.Os.Bundle GetAccountCredentialsForCloning(global::Android.Accounts.AccountAuthenticatorResponse response, global::Android.Accounts.Account account) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Os.Bundle);
				}

				/// <summary>
				/// <para>Creates an account based on credentials provided by the authenticator instance of another user on the device, who has chosen to share the account with this user. <para>getAccountCredentialsForCloning(AccountAuthenticatorResponse, Account) </para></para>        
				/// </summary>
				/// <returns>
				/// <para>a Bundle result or null if the result is to be returned via the response. </para>
				/// </returns>
				...
				/// </java-name>
				[Dot42.DexImport("addAccountFromCredentials", "(Landroid/accounts/AccountAuthenticatorResponse;Landroid/accounts/Account;Landroi" +
    "d/os/Bundle;)Landroid/os/Bundle;", AccessFlags = 1)]
				public virtual global::Android.Os.Bundle AddAccountFromCredentials(global::Android.Accounts.AccountAuthenticatorResponse response, global::Android.Accounts.Account account, global::Android.Os.Bundle accountCredentials) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Os.Bundle);
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// </java-name>
				[Dot42.DexImport("ERROR_CODE_BAD_AUTHENTICATION", "I", AccessFlags = 25)]
				public const int ERROR_CODE_BAD_AUTHENTICATION = 9;
				/// <summary>
				...
				/// <summary>
				/// <para>Returns the accounts visible to the specified package, in an environment where some apps are not authorized to view all accounts. This method can only be called by system apps. </para>        
				/// </summary>
				/// <returns>
				...
				/// </java-name>
				[Dot42.DexImport("getAccountsByTypeForPackage", "(Ljava/lang/String;Ljava/lang/String;)[Landroid/accounts/Account;", AccessFlags = 1)]
				public virtual global::Android.Accounts.Account[] GetAccountsByTypeForPackage(string type, string packageName) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Accounts.Account[]);
				}
