 ...
 /* scope: __dot42__ */ 
		{
				...
				/// </java-name>
				[Dot42.DexImport("KEYGUARD_DISABLE_FEATURES_NONE", "I", AccessFlags = 25)]
				public const int KEYGUARD_DISABLE_FEATURES_NONE = 0;
				/// <summary>
				/// <para>Disable all keyguard widgets </para>        
				/// </summary>
				/// <java-name>
				/// KEYGUARD_DISABLE_WIDGETS_ALL
				/// </java-name>
				[Dot42.DexImport("KEYGUARD_DISABLE_WIDGETS_ALL", "I", AccessFlags = 25)]
				public const int KEYGUARD_DISABLE_WIDGETS_ALL = 1;
				/// <summary>
				...
				/// </java-name>
				[Dot42.DexImport("KEYGUARD_DISABLE_SECURE_CAMERA", "I", AccessFlags = 25)]
				public const int KEYGUARD_DISABLE_SECURE_CAMERA = 2;
				/// <summary>
				...
				/// </java-name>
				[Dot42.DexImport("KEYGUARD_DISABLE_FEATURES_ALL", "I", AccessFlags = 25)]
				public const int KEYGUARD_DISABLE_FEATURES_ALL = 2147483647;
				...
				/// <summary>
				/// <para>Called by an application that is administering the device to disable keyguard customizations, such as widgets. After setting this, keyguard features will be disabled according to the provided feature list.</para><para>The calling device admin must have requested DeviceAdminInfo#USES_POLICY_DISABLE_KEYGUARD_FEATURES to be able to call this method; if it has not, a security exception will be thrown.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setKeyguardDisabledFeatures
				/// </java-name>
				[Dot42.DexImport("setKeyguardDisabledFeatures", "(Landroid/content/ComponentName;I)V", AccessFlags = 1)]
				public virtual void SetKeyguardDisabledFeatures(global::Android.Content.ComponentName admin, int which) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Determine whether or not features have been disabled in keyguard either by the current admin, if specified, or all admins. </para>        
				/// </summary>
				/// <returns>
				/// <para>bitfield of flags. See setKeyguardDisabledFeatures(ComponentName, int) for a list. </para>
				/// </returns>
				/// <java-name>
				/// getKeyguardDisabledFeatures
				/// </java-name>
				[Dot42.DexImport("getKeyguardDisabledFeatures", "(Landroid/content/ComponentName;)I", AccessFlags = 1)]
				public virtual int GetKeyguardDisabledFeatures(global::Android.Content.ComponentName admin) /* MethodBuilder.Create */ 
				{
						return default(int);
				}

				/// <summary>
				/// <para>Used to determine if a particular package has been registered as a Device Owner app. A device owner app is a special device admin that cannot be deactivated by the user, once activated as a device admin. It also cannot be uninstalled. To check if a particular package is currently registered as the device owner app, pass in the package name from Context#getPackageName() to this method.</para><para>This is useful for device admin apps that want to check if they are also registered as the device owner app. The exact mechanism by which a device admin app is registered as a device owner app is defined by the setup process. </para>        
				/// </summary>
				/// <returns>
				/// <para>whether or not the package is registered as the device owner app. </para>
				/// </returns>
				/// <java-name>
				/// isDeviceOwnerApp
				/// </java-name>
				[Dot42.DexImport("isDeviceOwnerApp", "(Ljava/lang/String;)Z", AccessFlags = 1)]
				public virtual bool IsDeviceOwnerApp(string packageName) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>A type of policy that this device admin can use: disables use of keyguard features.</para><para>To control this policy, the device admin must have a "disable-keyguard-features" tag in the "uses-policies" section of its meta-data. </para>        
				/// </summary>
				/// <java-name>
				/// USES_POLICY_DISABLE_KEYGUARD_FEATURES
				/// </java-name>
				[Dot42.DexImport("USES_POLICY_DISABLE_KEYGUARD_FEATURES", "I", AccessFlags = 25)]
				public const int USES_POLICY_DISABLE_KEYGUARD_FEATURES = 9;
				/// <summary>
