...
namespace Android.Accessibilityservice
{
 ...
 /* scope: __dot42__ */ 
		{
				/// <summary>
				/// <para>Capability: This accessibility service can retrieve the active window content. <para>android.R.styleable::AccessibilityService_canRetrieveWindowContent </para></para>        
				/// </summary>
				/// <java-name>
				/// CAPABILITY_CAN_RETRIEVE_WINDOW_CONTENT
				/// </java-name>
				[Dot42.DexImport("CAPABILITY_CAN_RETRIEVE_WINDOW_CONTENT", "I", AccessFlags = 25)]
				public const int CAPABILITY_CAN_RETRIEVE_WINDOW_CONTENT = 1;
				/// <summary>
				/// <para>Capability: This accessibility service can request touch exploration mode in which touched items are spoken aloud and the UI can be explored via gestures. <para>android.R.styleable::AccessibilityService_canRequestTouchExplorationMode </para></para>        
				/// </summary>
				/// <java-name>
				/// CAPABILITY_CAN_REQUEST_TOUCH_EXPLORATION
				/// </java-name>
				[Dot42.DexImport("CAPABILITY_CAN_REQUEST_TOUCH_EXPLORATION", "I", AccessFlags = 25)]
				public const int CAPABILITY_CAN_REQUEST_TOUCH_EXPLORATION = 2;
				/// <summary>
				/// <para>Capability: This accessibility service can request enhanced web accessibility enhancements. For example, installing scripts to make app content more accessible. <para>android.R.styleable::AccessibilityService_canRequestEnhancedWebAccessibility </para></para>        
				/// </summary>
				/// <java-name>
				/// CAPABILITY_CAN_REQUEST_ENHANCED_WEB_ACCESSIBILITY
				/// </java-name>
				[Dot42.DexImport("CAPABILITY_CAN_REQUEST_ENHANCED_WEB_ACCESSIBILITY", "I", AccessFlags = 25)]
				public const int CAPABILITY_CAN_REQUEST_ENHANCED_WEB_ACCESSIBILITY = 4;
				/// <summary>
				/// <para>Capability: This accessibility service can request to filter the key event stream. <para>android.R.styleable::AccessibilityService_canRequestFilterKeyEvents </para></para>        
				/// </summary>
				/// <java-name>
				/// CAPABILITY_CAN_REQUEST_FILTER_KEY_EVENTS
				/// </java-name>
				[Dot42.DexImport("CAPABILITY_CAN_REQUEST_FILTER_KEY_EVENTS", "I", AccessFlags = 25)]
				public const int CAPABILITY_CAN_REQUEST_FILTER_KEY_EVENTS = 8;
				/// <summary>
				...
				/// <summary>
				/// <para>Denotes braille feedback. </para>        
				/// </summary>
				/// <java-name>
				/// FEEDBACK_BRAILLE
				/// </java-name>
				[Dot42.DexImport("FEEDBACK_BRAILLE", "I", AccessFlags = 25)]
				public const int FEEDBACK_BRAILLE = 32;
				/// <summary>
				...
				/// <summary>
				/// <para>This flag requests from the system to enable web accessibility enhancing extensions. Such extensions aim to provide improved accessibility support for content presented in a android.webkit.WebView. An example of such an extension is injecting JavaScript from a secure source. The system will enable enhanced web accessibility if there is at least one accessibility service that has this flag set. Hence, clearing this flag does not guarantee that the device will not have enhanced web accessibility enabled since there may be another enabled service that requested it. </para><para>Services that want to set this flag have to declare this capability in their meta-data by setting the attribute #canRequestEnhancedWebAccessibility canRequestEnhancedWebAccessibility to true, otherwise this flag will be ignored. For how to declare the meta-data of a service refer to { AccessibilityService::SERVICE_META_DATA}. </para><para><para>android.R.styleable::AccessibilityService_canRequestEnhancedWebAccessibility </para></para>        
				/// </summary>
				/// <java-name>
				/// FLAG_REQUEST_ENHANCED_WEB_ACCESSIBILITY
				/// </java-name>
				[Dot42.DexImport("FLAG_REQUEST_ENHANCED_WEB_ACCESSIBILITY", "I", AccessFlags = 25)]
				public const int FLAG_REQUEST_ENHANCED_WEB_ACCESSIBILITY = 8;
				/// <summary>
				/// <para>This flag requests that the AccessibilityNodeInfos obtained by an AccessibilityService contain the id of the source view. The source view id will be a fully qualified resource name of the form "package:id/name", for example "foo.bar:id/my_list", and it is useful for UI test automation. This flag is not set by default. </para>        
				/// </summary>
				/// <java-name>
				/// FLAG_REPORT_VIEW_IDS
				/// </java-name>
				[Dot42.DexImport("FLAG_REPORT_VIEW_IDS", "I", AccessFlags = 25)]
				public const int FLAG_REPORT_VIEW_IDS = 16;
				/// <summary>
				/// <para>This flag requests from the system to filter key events. If this flag is set the accessibility service will receive the key events before applications allowing it implement global shortcuts. Setting this flag does not guarantee that this service will filter key events since only one service can do so at any given time. This avoids user confusion due to behavior change in case different key filtering services are enabled. If there is already another key filtering service enabled, this one will not receive key events. </para><para>Services that want to set this flag have to declare this capability in their meta-data by setting the attribute #canRequestFilterKeyEvents canRequestFilterKeyEvents to true, otherwise this flag will be ignored. For how to declare the meta-data of a service refer to { AccessibilityService::SERVICE_META_DATA}. </para><para><para>android.R.styleable::AccessibilityService_canRequestFilterKeyEvents </para></para>        
				/// </summary>
				/// <java-name>
				/// FLAG_REQUEST_FILTER_KEY_EVENTS
				/// </java-name>
				[Dot42.DexImport("FLAG_REQUEST_FILTER_KEY_EVENTS", "I", AccessFlags = 25)]
				public const int FLAG_REQUEST_FILTER_KEY_EVENTS = 32;
				/// <summary>
				...
				/// <summary>
				/// <para>Returns the bit mask of capabilities this accessibility service has such as being able to retrieve the active window content, etc.</para><para><para>CAPABILITY_CAN_RETRIEVE_WINDOW_CONTENT </para><simplesectsep></simplesectsep><para>CAPABILITY_CAN_REQUEST_TOUCH_EXPLORATION </para><simplesectsep></simplesectsep><para>CAPABILITY_CAN_REQUEST_ENHANCED_WEB_ACCESSIBILITY </para><simplesectsep></simplesectsep><para>#CAPABILITY_FILTER_KEY_EVENTS </para></para>        
				/// </summary>
				/// <returns>
				/// <para>The capability bit mask.</para>
				/// </returns>
				/// <java-name>
				/// getCapabilities
				/// </java-name>
				[Dot42.DexImport("getCapabilities", "()I", AccessFlags = 1)]
				public virtual int GetCapabilities() /* MethodBuilder.Create */ 
				{
						return default(int);
				}
				...
				/// <summary>
				/// <para>Returns the string representation of a capability. For example, CAPABILITY_CAN_RETRIEVE_WINDOW_CONTENT is represented by the string CAPABILITY_CAN_RETRIEVE_WINDOW_CONTENT.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>The string representation. </para>
				/// </returns>
				...
				/// capabilityToString
				/// </java-name>
				[Dot42.DexImport("capabilityToString", "(I)Ljava/lang/String;", AccessFlags = 9)]
				public static string CapabilityToString(int capability) /* MethodBuilder.Create */ 
				{
						return default(string);
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Action to open the quick settings. </para>        
				/// </summary>
				/// <java-name>
				/// GLOBAL_ACTION_QUICK_SETTINGS
				/// </java-name>
				[Dot42.DexImport("GLOBAL_ACTION_QUICK_SETTINGS", "I", AccessFlags = 25)]
				public const int GLOBAL_ACTION_QUICK_SETTINGS = 5;
				[Dot42.DexImport("<init>", "()V", AccessFlags = 1)]
				...
				/// <summary>
				/// <para>Called by the system when the user performs a specific gesture on the touch screen.</para><para><b>Note:</b> To receive gestures an accessibility service must request that the device is in touch exploration mode by setting the android.accessibilityservice.AccessibilityServiceInfo#FLAG_REQUEST_TOUCH_EXPLORATION_MODE flag.</para><para><para>GESTURE_SWIPE_UP </para><simplesectsep></simplesectsep><para>GESTURE_SWIPE_UP_AND_LEFT </para><simplesectsep></simplesectsep><para>GESTURE_SWIPE_UP_AND_DOWN </para><simplesectsep></simplesectsep><para>GESTURE_SWIPE_UP_AND_RIGHT </para><simplesectsep></simplesectsep><para>GESTURE_SWIPE_DOWN </para><simplesectsep></simplesectsep><para>GESTURE_SWIPE_DOWN_AND_LEFT </para><simplesectsep></simplesectsep><para>GESTURE_SWIPE_DOWN_AND_UP </para><simplesectsep></simplesectsep><para>GESTURE_SWIPE_DOWN_AND_RIGHT </para><simplesectsep></simplesectsep><para>GESTURE_SWIPE_LEFT </para><simplesectsep></simplesectsep><para>GESTURE_SWIPE_LEFT_AND_UP </para><simplesectsep></simplesectsep><para>GESTURE_SWIPE_LEFT_AND_RIGHT </para><simplesectsep></simplesectsep><para>GESTURE_SWIPE_LEFT_AND_DOWN </para><simplesectsep></simplesectsep><para>GESTURE_SWIPE_RIGHT </para><simplesectsep></simplesectsep><para>GESTURE_SWIPE_RIGHT_AND_UP </para><simplesectsep></simplesectsep><para>GESTURE_SWIPE_RIGHT_AND_LEFT </para><simplesectsep></simplesectsep><para>GESTURE_SWIPE_RIGHT_AND_DOWN </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				/// <para>Callback that allows an accessibility service to observe the key events before they are passed to the rest of the system. This means that the events are first delivered here before they are passed to the device policy, the input method, or applications. </para><para><b>Note:</b> It is important that key events are handled in such a way that the event stream that would be passed to the rest of the system is well-formed. For example, handling the down event but not the up event and vice versa would generate an inconsistent event stream. </para><para><b>Note:</b> The key events delivered in this method are copies and modifying them will have no effect on the events that will be passed to the system. This method is intended to perform purely filtering functionality. </para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>If true then the event will be consumed and not delivered to applications, otherwise it will be delivered as usual. </para>
				/// </returns>
				/// <java-name>
				/// onKeyEvent
				/// </java-name>
				[Dot42.DexImport("onKeyEvent", "(Landroid/view/KeyEvent;)Z", AccessFlags = 4)]
				protected internal virtual bool OnKeyEvent(global::Android.View.KeyEvent @event) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				public virtual global::Android.View.Accessibility.AccessibilityNodeInfo GetRootInActiveWindow() /* MethodBuilder.Create */ 
				{
						return default(global::Android.View.Accessibility.AccessibilityNodeInfo);
				}

				/// <summary>
				/// <para>Performs a global action. Such an action can be performed at any moment regardless of the current application or user location in that application. For example going back, going home, opening recents, etc.</para><para><para>GLOBAL_ACTION_BACK </para><simplesectsep></simplesectsep><para>GLOBAL_ACTION_HOME </para><simplesectsep></simplesectsep><para>GLOBAL_ACTION_NOTIFICATIONS </para><simplesectsep></simplesectsep><para>GLOBAL_ACTION_RECENTS </para></para>        
				/// </summary>
				/// <returns>
				...
				public global::Android.Accessibilityservice.AccessibilityServiceInfo GetServiceInfo() /* MethodBuilder.Create */ 
				{
						return default(global::Android.Accessibilityservice.AccessibilityServiceInfo);
				}
				...
				/// getRootInActiveWindow
				/// </java-name>
				public global::Android.View.Accessibility.AccessibilityNodeInfo RootInActiveWindow
				{
				[Dot42.DexImport("getRootInActiveWindow", "()Landroid/view/accessibility/AccessibilityNodeInfo;", AccessFlags = 1)]
						get{ return GetRootInActiveWindow(); }
				}
				...
				/// getServiceInfo
				/// </java-name>
				public global::Android.Accessibilityservice.AccessibilityServiceInfo ServiceInfo
				{
				[Dot42.DexImport("getServiceInfo", "()Landroid/accessibilityservice/AccessibilityServiceInfo;", AccessFlags = 17)]
						get{ return GetServiceInfo(); }
				[Dot42.DexImport("setServiceInfo", "(Landroid/accessibilityservice/AccessibilityServiceInfo;)V", AccessFlags = 17)]
						set{ SetServiceInfo(value); }
				}
