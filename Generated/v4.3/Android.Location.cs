 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Returns true if the Location came from a mock provider.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>true if this Location came from a mock provider, false otherwise </para>
				/// </returns>
				/// <java-name>
				/// isFromMockProvider
				/// </java-name>
				[Dot42.DexImport("isFromMockProvider", "()Z", AccessFlags = 1)]
				public virtual bool IsFromMockProvider() /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
