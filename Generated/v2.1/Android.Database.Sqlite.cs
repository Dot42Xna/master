 ...
 /* scope: __dot42__ */ 
		{
				...
				public override void BindNull(int int32) /* MethodBuilder.Create */ 
				{
				}
				...
				public override void BindLong(int int32, long int64) /* MethodBuilder.Create */ 
				{
				}
				...
				public override void BindDouble(int int32, double @double) /* MethodBuilder.Create */ 
				{
				}
				...
				public override void BindString(int int32, string @string) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// </java-name>
				[Dot42.DexImport("finalize", "()V", AccessFlags = 4)]
				extern ~SQLiteProgram() /* MethodBuilder.Create */ ;
