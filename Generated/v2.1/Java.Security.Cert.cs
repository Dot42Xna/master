...
//
// Original filename: Java.Security.Cert.cs
//
...
namespace Java.Security.Cert
{
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Sets the criterion for the issuer distinguished names. </para><para>The CRL issuer must match at least one of the specified distinguished names.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setIssuers
				/// </java-name>
				...
				public virtual void SetIssuers(global::Java.Util.ICollection<global::Javax.Security.Auth.X500.X500Principal> issuers) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para><b>Do not use:</b> use setIssuers(Collection) or one of addIssuerName instead. Sets the criterion for the issuer distinguished names. </para><para>The CRL issuer must match at least one of the specified distinguished names. </para><para>The specified parameter <c> names </c> is a collection with an entry for each name to be included in the criterion. The name is specified as a <c> String </c> or a byte array specifying the name (in RFC 2253 or ASN.1 DER encoded form)</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setIssuerNames
				/// </java-name>
				[Dot42.DexImport("setIssuerNames", "(Ljava/util/Collection;)V", AccessFlags = 1, Signature = "(Ljava/util/Collection<*>;)V")]
				public virtual void SetIssuerNames(global::Java.Util.ICollection<object> names) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Sets the criterion for the CRL update period. </para><para>The CRL's <c> thisUpdate </c> value must be equal or before the specified date and the <c> nextUpdate </c> value must be after the specified date.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setDateAndTime
				/// </java-name>
				[Dot42.DexImport("setDateAndTime", "(Ljava/util/Date;)V", AccessFlags = 1)]
				public virtual void SetDateAndTime(global::Java.Util.Date dateAndTime) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Sets a certificate hint to find CRLs. It's not a criterion but may help finding relevant CRLs.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setCertificateChecking
				/// </java-name>
				[Dot42.DexImport("setCertificateChecking", "(Ljava/security/cert/X509Certificate;)V", AccessFlags = 1)]
				public virtual void SetCertificateChecking(global::Java.Security.Cert.X509Certificate cert) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Generates a <c> CertPath </c> (a certificate chain) from the given <c> inputStream </c> , assuming the given <c> charsetName </c> .</para><para></para>        
				/// </summary>
				/// <java-name>
				/// engineGenerateCertPath
				/// </java-name>
				[Dot42.DexImport("engineGenerateCertPath", "(Ljava/io/InputStream;Ljava/lang/String;)Ljava/security/cert/CertPath;", AccessFlags = 1)]
				public virtual global::Java.Security.Cert.CertPath EngineGenerateCertPath(global::Java.Io.InputStream inStream, string charsetName) /* MethodBuilder.Create */ 
				{
						return default(global::Java.Security.Cert.CertPath);
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Sets the certificate that a matching certificate must be equal to.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setCertificate
				/// </java-name>
				[Dot42.DexImport("setCertificate", "(Ljava/security/cert/X509Certificate;)V", AccessFlags = 1)]
				public virtual void SetCertificate(global::Java.Security.Cert.X509Certificate certificate) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Sets the serial number that a certificate must match.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setSerialNumber
				/// </java-name>
				[Dot42.DexImport("setSerialNumber", "(Ljava/math/BigInteger;)V", AccessFlags = 1)]
				public virtual void SetSerialNumber(global::Java.Math.BigInteger serialNumber) /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual void SetIssuer(global::Javax.Security.Auth.X500.X500Principal issuer) /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual void SetSubject(global::Javax.Security.Auth.X500.X500Principal subject) /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual void SetSubjectKeyIdentifier(byte[] subjectKeyIdentifier) /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual void SetAuthorityKeyIdentifier(byte[] authorityKeyIdentifier) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Sets the criterion for the validity date of the certificate. </para><para>The certificate must be valid at the specified date. </para>        
				/// </summary>
				/// <java-name>
				/// setCertificateValid
				/// </java-name>
				[Dot42.DexImport("setCertificateValid", "(Ljava/util/Date;)V", AccessFlags = 1)]
				public virtual void SetCertificateValid(global::Java.Util.Date certificateValid) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Sets the criterion for the validity date of the private key. </para><para>The private key must be valid at the specified date.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setPrivateKeyValid
				/// </java-name>
				[Dot42.DexImport("setPrivateKeyValid", "(Ljava/util/Date;)V", AccessFlags = 1)]
				public virtual void SetPrivateKeyValid(global::Java.Util.Date privateKeyValid) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Sets the criterion for the subject public key signature algorithm. </para><para>The certificate must contain a subject public key with the algorithm specified.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setSubjectPublicKeyAlgID
				/// </java-name>
				[Dot42.DexImport("setSubjectPublicKeyAlgID", "(Ljava/lang/String;)V", AccessFlags = 1)]
				public virtual void SetSubjectPublicKeyAlgID(string oid) /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual void SetSubjectPublicKey(global::Java.Security.IPublicKey key) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Sets the criterion for the { KeyUsage} extension.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setKeyUsage
				/// </java-name>
				[Dot42.DexImport("setKeyUsage", "([Z)V", AccessFlags = 1)]
				public virtual void SetKeyUsage(bool[] keyUsage) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Sets the criterion for the { ExtendedKeyUsage} extension.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setExtendedKeyUsage
				/// </java-name>
				[Dot42.DexImport("setExtendedKeyUsage", "(Ljava/util/Set;)V", AccessFlags = 1, Signature = "(Ljava/util/Set<Ljava/lang/String;>;)V")]
				public virtual void SetExtendedKeyUsage(global::Java.Util.ISet<string> keyUsage) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Sets the flag for the matching behavior for subject alternative names. </para><para>The flag indicates whether a certificate must contain all or at least one of the subject alternative names specified by setSubjectAlternativeNames or addSubjectAlternativeName.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setMatchAllSubjectAltNames
				/// </java-name>
				[Dot42.DexImport("setMatchAllSubjectAltNames", "(Z)V", AccessFlags = 1)]
				public virtual void SetMatchAllSubjectAltNames(bool matchAllNames) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Sets the criterion for subject alternative names. </para><para>the certificate must contain all or at least one of the specified subject alternative names. The behavior is specified by getMatchAllSubjectAltNames. </para><para>The specified parameter <c> names </c> is a collection with an entry for each name to be included in the criterion. The name is specified as a <c> List </c> , the first entry must be an <c> Integer </c> specifying the name type (0-8), the second entry must be a <c> String </c> or a byte array specifying the name (in string or ASN.1 DER encoded form)</para><para></para>        
				/// </summary>
				/// <java-name>
				...
				public virtual void SetSubjectAlternativeNames(global::Java.Util.ICollection<global::Java.Util.IList<object>> names) /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual void SetNameConstraints(byte[] bytes) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Sets the criterion for the policy constraint. </para><para>The certificate must have at least one of the specified certificate policy extensions. For an empty set the certificate must have at least some policies in its policy extension.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setPolicy
				/// </java-name>
				[Dot42.DexImport("setPolicy", "(Ljava/util/Set;)V", AccessFlags = 1, Signature = "(Ljava/util/Set<Ljava/lang/String;>;)V")]
				public virtual void SetPolicy(global::Java.Util.ISet<string> policies) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Sets the criterion for the pathToNames constraint. </para><para>This allows to specify the complete set of names, a certificate's name constraints must permit. </para><para>The specified parameter <c> names </c> is a collection with an entry for each name to be included in the criterion. The name is specified as a <c> List </c> , the first entry must be an <c> Integer </c> specifying the name type (0-8), the second entry must be a <c> String </c> or a byte array specifying the name (in string or ASN.1 DER encoded form)</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setPathToNames
				/// </java-name>
				[Dot42.DexImport("setPathToNames", "(Ljava/util/Collection;)V", AccessFlags = 1, Signature = "(Ljava/util/Collection<Ljava/util/List<*>;>;)V")]
				public virtual void SetPathToNames(global::Java.Util.ICollection<global::Java.Util.IList<object>> names) /* MethodBuilder.Create */ 
				{
				}
		...
		/// <summary>
		/// <para>The interface specification to determine whether a <c>   Certificate </c> meets some criteria. </para><para>The implementations of this interface are typically used to define the criteria for selecting <c> Certificate </c> s from a <c> CertStore </c> .</para><para><para>CertStore </para><simplesectsep></simplesectsep><para>Certificate </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para>The implementation of the result of the PKIX certification path validation.</para><para><para>CertPathValidator </para><simplesectsep></simplesectsep><para>CertPathValidator::validate(CertPath, CertPathParameters) </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
    ...
    "r;)V")]
				...
				/// <summary>
				/// <para>Set the maximum length of a certification path. </para><para>This is the maximum number of non-self-signed certificates in a certification path.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setMaxPathLength
				/// </java-name>
				[Dot42.DexImport("setMaxPathLength", "(I)V", AccessFlags = 1)]
				public virtual void SetMaxPathLength(int maxPathLength) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para>This class implements the parameters for the <c> PKIX CertPathValidator </c> . </para><para>The parameters must be created with <b>trusted</b> certificate authorities (trust anchors).</para><para><para>CertPathValidator </para><simplesectsep></simplesectsep><para>CertPathParameters </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Sets the set of <b>trusted</b> certificate authorities.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setTrustAnchors
				/// </java-name>
				...
				public virtual void SetTrustAnchors(global::Java.Util.ISet<global::Java.Security.Cert.TrustAnchor> trustAnchors) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Sets whether the <b>any policy OID</b> should be inhibited if it's included in a certificate.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setAnyPolicyInhibited
				/// </java-name>
				[Dot42.DexImport("setAnyPolicyInhibited", "(Z)V", AccessFlags = 1)]
				public virtual void SetAnyPolicyInhibited(bool anyPolicyInhibited) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Sets the list of checkers for the certification path. </para><para>The list is copied and the entries are cloned.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setCertPathCheckers
				/// </java-name>
				...
				public virtual void SetCertPathCheckers(global::Java.Util.IList<global::Java.Security.Cert.PKIXCertPathChecker> certPathCheckers) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Set the list of certificate stores that are used to find certificates and CRLs.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setCertStores
				/// </java-name>
				[Dot42.DexImport("setCertStores", "(Ljava/util/List;)V", AccessFlags = 1, Signature = "(Ljava/util/List<Ljava/security/cert/CertStore;>;)V")]
				public virtual void SetCertStores(global::Java.Util.IList<global::Java.Security.Cert.CertStore> certStores) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Sets the time for which the validation of the certification path should be evaluated.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setDate
				/// </java-name>
				...
				/// <summary>
				/// <para>Sets whether an an acceptable policy needs to be explicit identified in every certificate.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setExplicitPolicyRequired
				/// </java-name>
				[Dot42.DexImport("setExplicitPolicyRequired", "(Z)V", AccessFlags = 1)]
				public virtual void SetExplicitPolicyRequired(bool explicitPolicyRequired) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Sets the list of policies (as OID strings) that would be acceptable for the purpose of certification path processing.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setInitialPolicies
				/// </java-name>
				[Dot42.DexImport("setInitialPolicies", "(Ljava/util/Set;)V", AccessFlags = 1, Signature = "(Ljava/util/Set<Ljava/lang/String;>;)V")]
				public virtual void SetInitialPolicies(global::Java.Util.ISet<string> initialPolicies) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Sets whether policy mapping is to be inhibited.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setPolicyMappingInhibited
				/// </java-name>
				[Dot42.DexImport("setPolicyMappingInhibited", "(Z)V", AccessFlags = 1)]
				public virtual void SetPolicyMappingInhibited(bool policyMappingInhibited) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Sets whether certificates should be rejected that include policy qualifiers in a certificate policy extension that is marked as critical.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setPolicyQualifiersRejected
				/// </java-name>
				[Dot42.DexImport("setPolicyQualifiersRejected", "(Z)V", AccessFlags = 1)]
				public virtual void SetPolicyQualifiersRejected(bool policyQualifiersRejected) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Sets whether the default revocation checking mechanism of the underlying service provider should be used.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setRevocationEnabled
				/// </java-name>
				[Dot42.DexImport("setRevocationEnabled", "(Z)V", AccessFlags = 1)]
				public virtual void SetRevocationEnabled(bool revocationEnabled) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Sets the name of the preferred signature provider. </para><para>If set, the specified provider will be preferred for creating signatures. If not set, the first provider found supporting creation of signatures will be used.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setSigProvider
				/// </java-name>
				[Dot42.DexImport("setSigProvider", "(Ljava/lang/String;)V", AccessFlags = 1)]
				public virtual void SetSigProvider(string sigProvider) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Sets the constraints that are required for the target certificate.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setTargetCertConstraints
				/// </java-name>
				[Dot42.DexImport("setTargetCertConstraints", "(Ljava/security/cert/CertSelector;)V", AccessFlags = 1)]
				public virtual void SetTargetCertConstraints(global::Java.Security.Cert.ICertSelector targetCertConstraints) /* MethodBuilder.Create */ 
				{
				}
