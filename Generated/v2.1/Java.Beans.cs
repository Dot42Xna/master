 ...
 /* scope: __dot42__ */ 
		{
				...
				/// </java-name>
				[Dot42.DexImport("removePropertyChangeListener", "(Ljava/lang/String;Ljava/beans/PropertyChangeListener;)V", AccessFlags = 33)]
				...
				/// </java-name>
				[Dot42.DexImport("addPropertyChangeListener", "(Ljava/lang/String;Ljava/beans/PropertyChangeListener;)V", AccessFlags = 33)]
				...
				/// </java-name>
				[Dot42.DexImport("getPropertyChangeListeners", "(Ljava/lang/String;)[Ljava/beans/PropertyChangeListener;", AccessFlags = 33)]
				...
				/// hasListeners
				/// </java-name>
				[Dot42.DexImport("hasListeners", "(Ljava/lang/String;)Z", AccessFlags = 33)]
				...
				/// removePropertyChangeListener
				/// </java-name>
				[Dot42.DexImport("removePropertyChangeListener", "(Ljava/beans/PropertyChangeListener;)V", AccessFlags = 33)]
				...
				/// addPropertyChangeListener
				/// </java-name>
				[Dot42.DexImport("addPropertyChangeListener", "(Ljava/beans/PropertyChangeListener;)V", AccessFlags = 33)]
				...
				/// getPropertyChangeListeners
				/// </java-name>
				[Dot42.DexImport("getPropertyChangeListeners", "()[Ljava/beans/PropertyChangeListener;", AccessFlags = 33)]
