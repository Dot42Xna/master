 ...
 /* scope: __dot42__ */ 
				{
						...
						/// MOVE_TO_ACTIVE_HEAP
						/// </java-name>
						[Dot42.DexImport("MOVE_TO_ACTIVE_HEAP", "Landroid/view/ViewDebug$RecyclerTraceType;", AccessFlags = 16409)]
						public static readonly RecyclerTraceType MOVE_TO_ACTIVE_HEAP;
						/// <java-name>
						/// MOVE_TO_SCRAP_HEAP
						/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// </java-name>
				[Dot42.DexImport("finalize", "()V", AccessFlags = 4)]
				extern ~View() /* MethodBuilder.Create */ ;
