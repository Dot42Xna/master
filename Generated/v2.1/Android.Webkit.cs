...
namespace Android.Webkit
{
 ...
 /* scope: __dot42__ */ 
    ...
    "ng/String;)V", AccessFlags = 1)]
				...
				/// <summary>
				/// <para>Gets the list of currently loaded plugins.</para><para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>This was used for Gears, which has been deprecated.  </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <returns>
				/// <para>the list of currently loaded plugins </para>
				/// </returns>
				/// <java-name>
				/// getPluginList
				/// </java-name>
				[Dot42.DexImport("getPluginList", "()Landroid/webkit/PluginList;", AccessFlags = 41)]
				public static global::Android.Webkit.PluginList GetPluginList() /* MethodBuilder.Create */ 
				{
						return default(global::Android.Webkit.PluginList);
				}

				/// <summary>
				/// <para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>This was used for Gears, which has been deprecated.  </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <java-name>
				/// refreshPlugins
				/// </java-name>
				[Dot42.DexImport("refreshPlugins", "(Z)V", AccessFlags = 1)]
				public virtual void RefreshPlugins(bool reloadOpenPages) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para>A simple list of initialized plugins. This list gets populated when the plugins are initialized (at browser startup, at the moment).</para><para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>This interface was intended to be used by Gears. Since Gears was deprecated, so is this class. </para></xrefdescription></xrefsect></para>    
		/// </summary>
		/// <java-name>
		/// android/webkit/PluginList
		/// </java-name>
		[Dot42.DexImport("android/webkit/PluginList", AccessFlags = 33)]
		public partial class PluginList
 /* scope: __dot42__ */ 
		{
				/// <summary>
				/// <para>Public constructor. Initializes the list of plugins.</para><para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>This interface was intended to be used by Gears. Since Gears was deprecated, so is this class. </para></xrefdescription></xrefsect></para>        
				/// </summary>
				[Dot42.DexImport("<init>", "()V", AccessFlags = 1)]
				public PluginList() /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Returns the list of plugins as a java.util.List.</para><para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>This interface was intended to be used by Gears. Since Gears was deprecated, so is this class. </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <java-name>
				/// getList
				/// </java-name>
				[Dot42.DexImport("getList", "()Ljava/util/List;", AccessFlags = 33)]
				public virtual global::Java.Util.IList<object> GetList() /* MethodBuilder.Create */ 
				{
						return default(global::Java.Util.IList<object>);
				}

				/// <summary>
				/// <para>Adds a plugin to the list.</para><para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>This interface was intended to be used by Gears. Since Gears was deprecated, so is this class. </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <java-name>
				/// addPlugin
				/// </java-name>
				[Dot42.DexImport("addPlugin", "(Landroid/webkit/Plugin;)V", AccessFlags = 33)]
				public virtual void AddPlugin(global::Android.Webkit.Plugin plugin) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Removes a plugin from the list.</para><para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>This interface was intended to be used by Gears. Since Gears was deprecated, so is this class. </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <java-name>
				/// removePlugin
				/// </java-name>
				[Dot42.DexImport("removePlugin", "(Landroid/webkit/Plugin;)V", AccessFlags = 33)]
				public virtual void RemovePlugin(global::Android.Webkit.Plugin plugin) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Clears the plugin list.</para><para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>This interface was intended to be used by Gears. Since Gears was deprecated, so is this class. </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <java-name>
				/// clear
				/// </java-name>
				...
				/// <summary>
				/// <para>Dispatches the click event to the appropriate plugin.</para><para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>This interface was intended to be used by Gears. Since Gears was deprecated, so is this class. </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <java-name>
				/// pluginClicked
				/// </java-name>
				[Dot42.DexImport("pluginClicked", "(Landroid/content/Context;I)V", AccessFlags = 33)]
				public virtual void PluginClicked(global::Android.Content.Context context, int position) /* MethodBuilder.Create */ 
				{
				}
				...
				/// getList
				/// </java-name>
				public global::Java.Util.IList<object> List
				{
				[Dot42.DexImport("getList", "()Ljava/util/List;", AccessFlags = 33)]
						get{ return GetList(); }
				}
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para>This class encapsulates the content generated by a plugin. The data itself is meant to be loaded into webkit via the PluginContentLoader class, which needs to be able to construct an HTTP response. For this, it needs a stream with the response body, the length of the body, the response headers, and the response status code. The PluginData class is the container for all these parts.</para><para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>This class was intended to be used by Gears. Since Gears was deprecated, so is this class. </para></xrefdescription></xrefsect></para>    
		/// </summary>
		/// <java-name>
		/// android/webkit/PluginData
		/// </java-name>
		[Dot42.DexImport("android/webkit/PluginData", AccessFlags = 49)]
		public sealed partial class PluginData
 /* scope: __dot42__ */ 
		{
				/// <summary>
				/// <para>Creates a PluginData instance.</para><para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>This class was intended to be used by Gears. Since Gears was deprecated, so is this class. </para></xrefdescription></xrefsect></para>        
				/// </summary>
				[Dot42.DexImport("<init>", "(Ljava/io/InputStream;JLjava/util/Map;I)V", AccessFlags = 1, Signature = "(Ljava/io/InputStream;JLjava/util/Map<Ljava/lang/String;[Ljava/lang/String;>;I)V")]
				public PluginData(global::Java.Io.InputStream stream, long length, global::Java.Util.IMap<string, string[]> headers, int code) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Returns the input stream that contains the plugin content.</para><para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>This class was intended to be used by Gears. Since Gears was deprecated, so is this class. </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <returns>
				/// <para>An InputStream instance with the plugin content.</para>
				/// </returns>
				/// <java-name>
				/// getInputStream
				/// </java-name>
				...
				/// <summary>
				/// <para>Returns the length of the plugin content.</para><para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>This class was intended to be used by Gears. Since Gears was deprecated, so is this class. </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <returns>
				/// <para>the length of the plugin content.</para>
				/// </returns>
				/// <java-name>
				/// getContentLength
				/// </java-name>
				[Dot42.DexImport("getContentLength", "()J", AccessFlags = 1)]
				public long GetContentLength() /* MethodBuilder.Create */ 
				{
						return default(long);
				}

				/// <summary>
				/// <para>Returns the HTTP response headers associated with the plugin content.</para><para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>This class was intended to be used by Gears. Since Gears was deprecated, so is this class. </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <returns>
				/// <para>A Map&lt;String, String[]&gt; containing all headers. The mapping is 'lowercase header name' to ['unmodified header name', header value].</para>
				/// </returns>
				/// <java-name>
				/// getHeaders
				/// </java-name>
				[Dot42.DexImport("getHeaders", "()Ljava/util/Map;", AccessFlags = 1, Signature = "()Ljava/util/Map<Ljava/lang/String;[Ljava/lang/String;>;")]
				public global::Java.Util.IMap<string, string[]> GetHeaders() /* MethodBuilder.Create */ 
				{
						return default(global::Java.Util.IMap<string, string[]>);
				}

				/// <summary>
				/// <para>Returns the HTTP status code for the response.</para><para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>This class was intended to be used by Gears. Since Gears was deprecated, so is this class. </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <returns>
				/// <para>The HTTP statue code, e.g 200.</para>
				/// </returns>
				/// <java-name>
				/// getStatusCode
				/// </java-name>
				[Dot42.DexImport("getStatusCode", "()I", AccessFlags = 1)]
				public int GetStatusCode() /* MethodBuilder.Create */ 
				{
						return default(int);
				}
		...
		/// <summary>
		/// <para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>This class was intended to be used by Gears. Since Gears was deprecated, so is this class. </para></xrefdescription></xrefsect></para>    
		/// </summary>
		/// <java-name>
		/// android/webkit/UrlInterceptRegistry
		/// </java-name>
		[Dot42.DexImport("android/webkit/UrlInterceptRegistry", AccessFlags = 49)]
		public sealed partial class UrlInterceptRegistry
 /* scope: __dot42__ */ 
		{
				[Dot42.DexImport("<init>", "()V", AccessFlags = 1)]
				public UrlInterceptRegistry() /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>set the flag to control whether url intercept is enabled or disabled</para><para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>This class was intended to be used by Gears. Since Gears was deprecated, so is this class. </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <java-name>
				/// setUrlInterceptDisabled
				/// </java-name>
				[Dot42.DexImport("setUrlInterceptDisabled", "(Z)V", AccessFlags = 41)]
				public static void SetUrlInterceptDisabled(bool disabled) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>get the state of the url intercept, enabled or disabled</para><para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>This class was intended to be used by Gears. Since Gears was deprecated, so is this class. </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <returns>
				/// <para>return if it is disabled</para>
				/// </returns>
				/// <java-name>
				/// urlInterceptDisabled
				/// </java-name>
				[Dot42.DexImport("urlInterceptDisabled", "()Z", AccessFlags = 41)]
				public static bool UrlInterceptDisabled() /* MethodBuilder.Create */ 
				{
						return default(bool);
				}

				/// <summary>
				/// <para>Register a new UrlInterceptHandler. This handler will be called before any that were previously registered.</para><para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>This class was intended to be used by Gears. Since Gears was deprecated, so is this class. </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <returns>
				/// <para>true if the handler was not previously registered.</para>
				/// </returns>
				/// <java-name>
				/// registerHandler
				/// </java-name>
				[Dot42.DexImport("registerHandler", "(Landroid/webkit/UrlInterceptHandler;)Z", AccessFlags = 41)]
				public static bool RegisterHandler(global::Android.Webkit.IUrlInterceptHandler handler) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}

				/// <summary>
				/// <para>Unregister a previously registered UrlInterceptHandler.</para><para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>This class was intended to be used by Gears. Since Gears was deprecated, so is this class. </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <returns>
				/// <para>true if the handler was found and removed from the list.</para>
				/// </returns>
				/// <java-name>
				/// unregisterHandler
				/// </java-name>
				[Dot42.DexImport("unregisterHandler", "(Landroid/webkit/UrlInterceptHandler;)Z", AccessFlags = 41)]
				public static bool UnregisterHandler(global::Android.Webkit.IUrlInterceptHandler handler) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}

				/// <summary>
				/// <para>Given an url, returns the CacheResult of the first UrlInterceptHandler interested, or null if none are.</para><para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>This class was intended to be used by Gears. Since Gears was deprecated, so is this class. </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <returns>
				/// <para>A CacheResult containing surrogate content.</para>
				/// </returns>
				/// <java-name>
				/// getSurrogate
				/// </java-name>
				[Dot42.DexImport("getSurrogate", "(Ljava/lang/String;Ljava/util/Map;)Landroid/webkit/CacheManager$CacheResult;", AccessFlags = 41, Signature = "(Ljava/lang/String;Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;)Landroid" +
    "/webkit/CacheManager$CacheResult;")]
				public static global::Android.Webkit.CacheManager.CacheResult GetSurrogate(string url, global::Java.Util.IMap<string, string> headers) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Webkit.CacheManager.CacheResult);
				}

				/// <summary>
				/// <para>Given an url, returns the PluginData of the first UrlInterceptHandler interested, or null if none are or if intercepts are disabled.</para><para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>This class was intended to be used by Gears. Since Gears was deprecated, so is this class. </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <returns>
				/// <para>A PluginData instance containing surrogate content.</para>
				/// </returns>
				/// <java-name>
				/// getPluginData
				/// </java-name>
				[Dot42.DexImport("getPluginData", "(Ljava/lang/String;Ljava/util/Map;)Landroid/webkit/PluginData;", AccessFlags = 41, Signature = "(Ljava/lang/String;Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;)Landroid" +
    "/webkit/PluginData;")]
				public static global::Android.Webkit.PluginData GetPluginData(string url, global::Java.Util.IMap<string, string> headers) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Webkit.PluginData);
				}
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para>Represents a plugin (Java equivalent of the PluginPackageAndroid C++ class in libs/WebKitLib/WebKit/WebCore/plugins/android/)</para><para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>This interface was intended to be used by Gears. Since Gears was deprecated, so is this class. </para></xrefdescription></xrefsect></para>    
		/// </summary>
		/// <java-name>
		/// android/webkit/Plugin
		/// </java-name>
		[Dot42.DexImport("android/webkit/Plugin", AccessFlags = 33)]
		public partial class Plugin
 /* scope: __dot42__ */ 
		{
				/// <summary>
				/// <para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>This interface was intended to be used by Gears. Since Gears was deprecated, so is this class. </para></xrefdescription></xrefsect></para>        
				/// </summary>
				[Dot42.DexImport("<init>", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", AccessFlags = 1)]
				public Plugin(string name, string path, string fileName, string description) /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual string GetFileName() /* MethodBuilder.Create */ 
				{
						return default(string);
				}
				...
				/// setFileName
				/// </java-name>
				[Dot42.DexImport("setFileName", "(Ljava/lang/String;)V", AccessFlags = 1)]
				public virtual void SetFileName(string fileName) /* MethodBuilder.Create */ 
				{
				}
				...
				/// setClickHandler
				/// </java-name>
				[Dot42.DexImport("setClickHandler", "(Landroid/webkit/Plugin$PreferencesClickHandler;)V", AccessFlags = 1)]
				public virtual void SetClickHandler(global::Android.Webkit.Plugin.IPreferencesClickHandler handler) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Invokes the click handler for this plugin.</para><para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>This interface was intended to be used by Gears. Since Gears was deprecated, so is this class. </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <java-name>
				/// dispatchClickEvent
				/// </java-name>
				[Dot42.DexImport("dispatchClickEvent", "(Landroid/content/Context;)V", AccessFlags = 1)]
				public virtual void DispatchClickEvent(global::Android.Content.Context context) /* MethodBuilder.Create */ 
				{
				}
				...
				/// </java-name>
				[Dot42.DexImport("android/webkit/Plugin$PreferencesClickHandler", AccessFlags = 1545)]
				public partial interface IPreferencesClickHandler
 /* scope: __dot42__ */ 
				{
						/// <java-name>
						/// handleClickEvent
						/// </java-name>
						[Dot42.DexImport("handleClickEvent", "(Landroid/content/Context;)V", AccessFlags = 1025)]
						void HandleClickEvent(global::Android.Content.Context context) /* MethodBuilder.Create */ ;
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>This interface was inteded to be used by Gears. Since Gears was deprecated, so is this class. </para></xrefdescription></xrefsect></para>    
		/// </summary>
		/// <java-name>
		/// android/webkit/UrlInterceptHandler
		/// </java-name>
		[Dot42.DexImport("android/webkit/UrlInterceptHandler", AccessFlags = 1537)]
		public partial interface IUrlInterceptHandler
 /* scope: __dot42__ */ 
		{
				/// <summary>
				/// <para>Given an URL, returns the CacheResult which contains the surrogate response for the request, or null if the handler is not interested.</para><para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>Do not use, this interface is deprecated. </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <returns>
				/// <para>The CacheResult containing the surrogate response.</para>
				/// </returns>
				/// <java-name>
				/// service
				/// </java-name>
				[Dot42.DexImport("service", "(Ljava/lang/String;Ljava/util/Map;)Landroid/webkit/CacheManager$CacheResult;", AccessFlags = 1025, Signature = "(Ljava/lang/String;Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;)Landroid" +
    "/webkit/CacheManager$CacheResult;")]
				global::Android.Webkit.CacheManager.CacheResult Service(string url, global::Java.Util.IMap<string, string> headers) /* MethodBuilder.Create */ ;

				/// <summary>
				/// <para>Given an URL, returns the PluginData which contains the surrogate response for the request, or null if the handler is not interested.</para><para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>Do not use, this interface is deprecated. </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <returns>
				/// <para>The PluginData containing the surrogate response.</para>
				/// </returns>
				/// <java-name>
				/// getPluginData
				/// </java-name>
				[Dot42.DexImport("getPluginData", "(Ljava/lang/String;Ljava/util/Map;)Landroid/webkit/PluginData;", AccessFlags = 1025, Signature = "(Ljava/lang/String;Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;)Landroid" +
    "/webkit/PluginData;")]
				global::Android.Webkit.PluginData GetPluginData(string url, global::Java.Util.IMap<string, string> headers) /* MethodBuilder.Create */ ;
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para>This class is a proxy class for handling WebCore -&gt; UI thread messaging. All the callback functions are called from the WebCore thread and messages are posted to the UI thread for the actual client callback. </para>    
		/// </summary>
		/// <java-name>
		/// android/webkit/CallbackProxy
		/// </java-name>
		[Dot42.DexImport("android/webkit/CallbackProxy", AccessFlags = 32)]
		public partial class CallbackProxy : global::Android.Os.Handler
 /* scope: __dot42__ */ 
		{
				/// <summary>
				/// <para>Construct a new CallbackProxy. </para>        
				/// </summary>
				[Dot42.DexImport("<init>", "(Landroid/content/Context;Landroid/webkit/WebView;)V", AccessFlags = 1)]
				public CallbackProxy(global::Android.Content.Context context, global::Android.Webkit.WebView w) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Set the WebViewClient. </para>        
				/// </summary>
				/// <java-name>
				/// setWebViewClient
				/// </java-name>
				...
				/// <summary>
				/// <para>Set the WebChromeClient. </para>        
				/// </summary>
				/// <java-name>
				/// setWebChromeClient
				/// </java-name>
				...
				/// <summary>
				/// <para>Get the WebChromeClient. </para>        
				/// </summary>
				/// <returns>
				/// <para>the current WebChromeClient instance. </para>
				/// </returns>
				/// <java-name>
				/// getWebChromeClient
				/// </java-name>
				[Dot42.DexImport("getWebChromeClient", "()Landroid/webkit/WebChromeClient;", AccessFlags = 1)]
				public virtual global::Android.Webkit.WebChromeClient GetWebChromeClient() /* MethodBuilder.Create */ 
				{
						return default(global::Android.Webkit.WebChromeClient);
				}

				/// <summary>
				/// <para>Set the client DownloadListener. </para>        
				/// </summary>
				/// <java-name>
				/// setDownloadListener
				/// </java-name>
				[Dot42.DexImport("setDownloadListener", "(Landroid/webkit/DownloadListener;)V", AccessFlags = 1)]
				public virtual void SetDownloadListener(global::Android.Webkit.IDownloadListener client) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Get the Back/Forward list to return to the user or to update the cached history list. </para>        
				/// </summary>
				/// <java-name>
				/// getBackForwardList
				/// </java-name>
				[Dot42.DexImport("getBackForwardList", "()Landroid/webkit/WebBackForwardList;", AccessFlags = 1)]
				public virtual global::Android.Webkit.WebBackForwardList GetBackForwardList() /* MethodBuilder.Create */ 
				{
						return default(global::Android.Webkit.WebBackForwardList);
				}

				/// <summary>
				/// <para>Called by the UI side. Calling overrideUrlLoading from the WebCore side will post a message to call this method. </para>        
				/// </summary>
				/// <java-name>
				/// uiOverrideUrlLoading
				/// </java-name>
				[Dot42.DexImport("uiOverrideUrlLoading", "(Ljava/lang/String;)Z", AccessFlags = 1)]
				public virtual bool UiOverrideUrlLoading(string overrideUrl) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}

				/// <summary>
				/// <para>Called by UI side. </para>        
				/// </summary>
				/// <java-name>
				/// uiOverrideKeyEvent
				/// </java-name>
				[Dot42.DexImport("uiOverrideKeyEvent", "(Landroid/view/KeyEvent;)Z", AccessFlags = 1)]
				public virtual bool UiOverrideKeyEvent(global::Android.View.KeyEvent @event) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				/// <summary>
				/// <para>Return the latest progress. </para>        
				/// </summary>
				/// <java-name>
				/// getProgress
				/// </java-name>
				...
				/// onPageStarted
				/// </java-name>
				[Dot42.DexImport("onPageStarted", "(Ljava/lang/String;Landroid/graphics/Bitmap;)V", AccessFlags = 1)]
				public virtual void OnPageStarted(string url, global::Android.Graphics.Bitmap favicon) /* MethodBuilder.Create */ 
				{
				}
				...
				/// onPageFinished
				/// </java-name>
				[Dot42.DexImport("onPageFinished", "(Ljava/lang/String;)V", AccessFlags = 1)]
				public virtual void OnPageFinished(string url) /* MethodBuilder.Create */ 
				{
				}
				...
				/// onTooManyRedirects
				/// </java-name>
				[Dot42.DexImport("onTooManyRedirects", "(Landroid/os/Message;Landroid/os/Message;)V", AccessFlags = 1)]
				public virtual void OnTooManyRedirects(global::Android.Os.Message cancelMsg, global::Android.Os.Message continueMsg) /* MethodBuilder.Create */ 
				{
				}
				...
				/// onReceivedError
				/// </java-name>
				[Dot42.DexImport("onReceivedError", "(ILjava/lang/String;Ljava/lang/String;)V", AccessFlags = 1)]
				public virtual void OnReceivedError(int errorCode, string description, string failingUrl) /* MethodBuilder.Create */ 
				{
				}
				...
				/// onFormResubmission
				/// </java-name>
				[Dot42.DexImport("onFormResubmission", "(Landroid/os/Message;Landroid/os/Message;)V", AccessFlags = 1)]
				public virtual void OnFormResubmission(global::Android.Os.Message dontResend, global::Android.Os.Message resend) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Called by the WebCore side </para>        
				/// </summary>
				/// <java-name>
				/// shouldOverrideUrlLoading
				/// </java-name>
				[Dot42.DexImport("shouldOverrideUrlLoading", "(Ljava/lang/String;)Z", AccessFlags = 1)]
				public virtual bool ShouldOverrideUrlLoading(string url) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				/// onReceivedHttpAuthRequest
				/// </java-name>
				[Dot42.DexImport("onReceivedHttpAuthRequest", "(Landroid/webkit/HttpAuthHandler;Ljava/lang/String;Ljava/lang/String;)V", AccessFlags = 1)]
				public virtual void OnReceivedHttpAuthRequest(global::Android.Webkit.HttpAuthHandler handler, string hostName, string realmName) /* MethodBuilder.Create */ 
				{
				}
				...
				/// doUpdateVisitedHistory
				/// </java-name>
				[Dot42.DexImport("doUpdateVisitedHistory", "(Ljava/lang/String;Z)V", AccessFlags = 1)]
				public virtual void DoUpdateVisitedHistory(string url, bool isReload) /* MethodBuilder.Create */ 
				{
				}
				...
				/// onLoadResource
				/// </java-name>
				[Dot42.DexImport("onLoadResource", "(Ljava/lang/String;)V", AccessFlags = 1)]
				public virtual void OnLoadResource(string @string) /* MethodBuilder.Create */ 
				{
				}
				...
				/// onUnhandledKeyEvent
				/// </java-name>
				[Dot42.DexImport("onUnhandledKeyEvent", "(Landroid/view/KeyEvent;)V", AccessFlags = 1)]
				public virtual void OnUnhandledKeyEvent(global::Android.View.KeyEvent @event) /* MethodBuilder.Create */ 
				{
				}
				...
				/// onScaleChanged
				/// </java-name>
				[Dot42.DexImport("onScaleChanged", "(FF)V", AccessFlags = 1)]
				public virtual void OnScaleChanged(float oldScale, float newScale) /* MethodBuilder.Create */ 
				{
				}
				...
				/// onDownloadStart
				/// </java-name>
				[Dot42.DexImport("onDownloadStart", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;J)Z", AccessFlags = 1)]
				public virtual bool OnDownloadStart(string @string, string string1, string string2, string string3, long int64) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				/// onSavePassword
				/// </java-name>
				[Dot42.DexImport("onSavePassword", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/Message;)Z", AccessFlags = 1)]
				public virtual bool OnSavePassword(string schemePlusHost, string username, string password, global::Android.Os.Message resumeMsg) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				/// onProgressChanged
				/// </java-name>
				[Dot42.DexImport("onProgressChanged", "(I)V", AccessFlags = 1)]
				public virtual void OnProgressChanged(int newProgress) /* MethodBuilder.Create */ 
				{
				}
				...
				/// createWindow
				/// </java-name>
				[Dot42.DexImport("createWindow", "(ZZ)Landroid/webkit/WebView;", AccessFlags = 1)]
				public virtual global::Android.Webkit.WebView CreateWindow(bool dialog, bool userGesture) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Webkit.WebView);
				}
				...
				/// onRequestFocus
				/// </java-name>
				[Dot42.DexImport("onRequestFocus", "()V", AccessFlags = 1)]
				public virtual void OnRequestFocus() /* MethodBuilder.Create */ 
				{
				}
				...
				/// onReceivedIcon
				/// </java-name>
				[Dot42.DexImport("onReceivedIcon", "(Landroid/graphics/Bitmap;)V", AccessFlags = 1)]
				public virtual void OnReceivedIcon(global::Android.Graphics.Bitmap icon) /* MethodBuilder.Create */ 
				{
				}
				...
				/// onReceivedTitle
				/// </java-name>
				[Dot42.DexImport("onReceivedTitle", "(Ljava/lang/String;)V", AccessFlags = 1)]
				public virtual void OnReceivedTitle(string title) /* MethodBuilder.Create */ 
				{
				}
				...
				/// onJsAlert
				/// </java-name>
				[Dot42.DexImport("onJsAlert", "(Ljava/lang/String;Ljava/lang/String;)V", AccessFlags = 1)]
				public virtual void OnJsAlert(string url, string message) /* MethodBuilder.Create */ 
				{
				}
				...
				/// onJsConfirm
				/// </java-name>
				[Dot42.DexImport("onJsConfirm", "(Ljava/lang/String;Ljava/lang/String;)Z", AccessFlags = 1)]
				public virtual bool OnJsConfirm(string url, string message) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				/// onJsPrompt
				/// </java-name>
				[Dot42.DexImport("onJsPrompt", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;", AccessFlags = 1)]
				public virtual string OnJsPrompt(string url, string message, string defaultValue) /* MethodBuilder.Create */ 
				{
						return default(string);
				}
				...
				/// onJsBeforeUnload
				/// </java-name>
				[Dot42.DexImport("onJsBeforeUnload", "(Ljava/lang/String;Ljava/lang/String;)Z", AccessFlags = 1)]
				public virtual bool OnJsBeforeUnload(string url, string message) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}

				/// <summary>
				/// <para>Called by WebViewCore to inform the Java side that the current origin has overflowed it's database quota. Called in the WebCore thread so posts a message to the UI thread that will prompt the WebChromeClient for what to do. On return back to C++ side, the WebCore thread will sleep pending a new quota value. </para>        
				/// </summary>
				/// <java-name>
				/// onExceededDatabaseQuota
				/// </java-name>
    ...
    "V", AccessFlags = 1)]
				...
				/// <summary>
				/// <para>Called by WebViewCore to inform the Java side that the appcache has exceeded its max size. </para>        
				/// </summary>
				/// <java-name>
				/// onReachedMaxAppCacheSize
				/// </java-name>
				...
				/// <summary>
				/// <para>Called by WebViewCore to instruct the browser to display a prompt to ask the user to set the Geolocation permission state for the given origin. </para>        
				/// </summary>
				/// <java-name>
				/// onGeolocationPermissionsShowPrompt
				/// </java-name>
				...
				/// <summary>
				/// <para>Called by WebViewCore to instruct the browser to hide the Geolocation permissions prompt. </para>        
				/// </summary>
				/// <java-name>
				/// onGeolocationPermissionsHidePrompt
				/// </java-name>
				...
				/// addMessageToConsole
				/// </java-name>
				[Dot42.DexImport("addMessageToConsole", "(Ljava/lang/String;ILjava/lang/String;)V", AccessFlags = 1)]
				public virtual void AddMessageToConsole(string @string, int int32, string string1) /* MethodBuilder.Create */ 
				{
				}
				...
				/// getWebChromeClient
				/// </java-name>
				public global::Android.Webkit.WebChromeClient WebChromeClient
				{
				[Dot42.DexImport("getWebChromeClient", "()Landroid/webkit/WebChromeClient;", AccessFlags = 1)]
						get{ return GetWebChromeClient(); }
				[Dot42.DexImport("setWebChromeClient", "(Landroid/webkit/WebChromeClient;)V", AccessFlags = 1)]
						set{ SetWebChromeClient(value); }
				}
				...
				/// getBackForwardList
				/// </java-name>
				public global::Android.Webkit.WebBackForwardList BackForwardList
				{
				[Dot42.DexImport("getBackForwardList", "()Landroid/webkit/WebBackForwardList;", AccessFlags = 1)]
						get{ return GetBackForwardList(); }
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// mProxy
				/// </java-name>
				[Dot42.DexImport("mProxy", "Landroid/webkit/CallbackProxy;", AccessFlags = 20)]
				protected internal readonly global::Android.Webkit.CallbackProxy MProxy;
				[Dot42.DexImport("<init>", "()V", AccessFlags = 0)]
