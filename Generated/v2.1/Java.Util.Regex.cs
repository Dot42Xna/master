...
//
// Original filename: Java.Util.Regex.cs
//
...
{
		/// <summary>
		/// <para>Encapsulates a syntax error that occurred during the compilation of a Pattern. Might include a detailed description, the original regular expression, and the index at which the error occurred.</para><para><para>Pattern::compile(String) </para><simplesectsep></simplesectsep><para>Pattern::compile(java.lang.String,int) </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Returns a compiled form of the given <c> regularExpression </c> , as modified by the given <c> flags </c> . See the  for more on flags.</para><para><para>CANON_EQ </para><simplesectsep></simplesectsep><para>CASE_INSENSITIVE </para><simplesectsep></simplesectsep><para>COMMENTS </para><simplesectsep></simplesectsep><para>DOTALL </para><simplesectsep></simplesectsep><para>LITERAL </para><simplesectsep></simplesectsep><para>MULTILINE </para><simplesectsep></simplesectsep><para>UNICODE_CASE </para><simplesectsep></simplesectsep><para>UNIX_LINES </para></para>        
				/// </summary>
				/// <java-name>
				/// compile
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Indicates whether this matcher has anchoring bounds enabled. When anchoring bounds are enabled, the start and end of the input match the '^' and '$' meta-characters, otherwise not. Anchoring bounds are enabled by default.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>true if (and only if) the <c> Matcher </c> uses anchoring bounds. </para>
				/// </returns>
				/// <java-name>
				/// hasAnchoringBounds
				/// </java-name>
				...
				/// <summary>
				/// <para>Indicates whether this matcher has transparent bounds enabled. When transparent bounds are enabled, the parts of the input outside the region are subject to lookahead and lookbehind, otherwise they are not. Transparent bounds are disabled by default.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>true if (and only if) the <c> Matcher </c> uses anchoring bounds. </para>
				/// </returns>
				...
				/// <summary>
				/// <para>Returns true if and only if the last match hit the end of the input. </para>        
				/// </summary>
				/// <java-name>
				/// hitEnd
				/// </java-name>
				...
				/// <summary>
				/// <para>Returns true if and only if more input might change a successful match into an unsuccessful one. </para>        
				/// </summary>
				/// <java-name>
				/// requireEnd
				/// </java-name>
