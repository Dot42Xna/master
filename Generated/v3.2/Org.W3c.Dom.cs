...
//
// Original filename: Org.W3c.Dom.cs
//
 ...
 /* scope: __dot42__ */ 
		{
				...
				void SetData(string data) /* MethodBuilder.Create */ ;
 ...
 /* scope: __dot42__ */ 
		{
				...
				void SetXmlStandalone(bool xmlStandalone) /* MethodBuilder.Create */ ;
				...
				void SetXmlVersion(string xmlVersion) /* MethodBuilder.Create */ ;
				...
				void SetStrictErrorChecking(bool strictErrorChecking) /* MethodBuilder.Create */ ;
				...
				void SetDocumentURI(string documentURI) /* MethodBuilder.Create */ ;
 ...
 /* scope: __dot42__ */ 
		{
				...
				void SetNodeValue(string nodeValue) /* MethodBuilder.Create */ ;
				...
				void SetPrefix(string prefix) /* MethodBuilder.Create */ ;
				...
				void SetTextContent(string textContent) /* MethodBuilder.Create */ ;
