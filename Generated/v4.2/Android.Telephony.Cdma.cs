 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Converts latitude or longitude from 0.25 seconds (as defined in the 3GPP2 C.S0005-A v6.0 standard) to decimal degrees</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>latitude or longitude in decimal degrees units </para>
				/// </returns>
				/// <java-name>
				/// convertQuartSecToDecDegrees
				/// </java-name>
				[Dot42.DexImport("convertQuartSecToDecDegrees", "(I)D", AccessFlags = 9)]
				public static double ConvertQuartSecToDecDegrees(int quartSec) /* MethodBuilder.Create */ 
				{
