...
//
// Original filename: Android.Nfc.Tech.cs
//
...
namespace Android.Nfc.Tech
{
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Return the maximum number of bytes that can be sent with transceive. </para>        
				/// </summary>
				/// <returns>
				/// <para>the maximum number of bytes that can be sent with transceive. </para>
				/// </returns>
				/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Get the current transceive timeout in milliseconds.</para><para>Requires the android.Manifest.permission#NFC permission.</para><para></para>        
				/// </summary>
				/// <returns>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Get the current timeout for transceive in milliseconds.</para><para>Requires the android.Manifest.permission#NFC permission.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>timeout value in milliseconds </para>
				/// </returns>
				...
				/// <summary>
				/// <para>Standard APDUs have a 1-byte length field, allowing a maximum of 255 payload bytes, which results in a maximum APDU length of 261 bytes.</para><para>Extended length APDUs have a 3-byte length field, allowing 65535 payload bytes.</para><para>Some NFC adapters, like the one used in the Nexus S and the Galaxy Nexus do not support extended length APDUs. They are expected to be well-supported in the future though. Use this method to check for extended length APDU support.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>whether the NFC adapter on this device supports extended length APDUs. </para>
				/// </returns>
				/// <java-name>
				/// isExtendedLengthApduSupported
				/// </java-name>
				[Dot42.DexImport("isExtendedLengthApduSupported", "()Z", AccessFlags = 1)]
				public bool IsExtendedLengthApduSupported() /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para>Provides access to tags containing just a barcode.</para><para>Acquire an NfcBarcode object using get. </para>    
		/// </summary>
		/// <java-name>
		/// android/nfc/tech/NfcBarcode
		/// </java-name>
		[Dot42.DexImport("android/nfc/tech/NfcBarcode", AccessFlags = 49)]
		public sealed partial class NfcBarcode : global::Android.Nfc.Tech.ITagTechnology
 /* scope: __dot42__ */ 
		{
				/// <summary>
				/// <para>Kovio Tags </para>        
				/// </summary>
				/// <java-name>
				/// TYPE_KOVIO
				/// </java-name>
				[Dot42.DexImport("TYPE_KOVIO", "I", AccessFlags = 25)]
				public const int TYPE_KOVIO = 1;
				/// <java-name>
				/// TYPE_UNKNOWN
				/// </java-name>
				[Dot42.DexImport("TYPE_UNKNOWN", "I", AccessFlags = 25)]
				public const int TYPE_UNKNOWN = -1;
				[Dot42.DexImport("<init>", "()V", AccessFlags = 0)]
				internal NfcBarcode() /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Get an instance of NfcBarcode for the given tag.</para><para>Returns null if NfcBarcode was not enumerated in Tag#getTechList.</para><para>Does not cause any RF activity and does not block.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>NfcBarcode object </para>
				/// </returns>
				/// <java-name>
				/// get
				/// </java-name>
				[Dot42.DexImport("get", "(Landroid/nfc/Tag;)Landroid/nfc/tech/NfcBarcode;", AccessFlags = 9)]
				public static global::Android.Nfc.Tech.NfcBarcode Get(global::Android.Nfc.Tag tag) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Nfc.Tech.NfcBarcode);
				}

				/// <summary>
				/// <para>Returns the NFC Barcode tag type.</para><para>Currently only one of TYPE_KOVIO or TYPE_UNKNOWN.</para><para>Does not cause any RF activity and does not block.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>the NFC Barcode tag type </para>
				/// </returns>
				/// <java-name>
				/// getType
				/// </java-name>
				...
				/// <summary>
				/// <para>Returns the barcode of an NfcBarcode tag.</para><para>Tags of TYPE_KOVIO return 16 bytes: <ul><li></li></ul></para><para>The first byte is 0x80 ORd with a manufacturer ID, corresponding to ISO/IEC 7816-6. </para><para>The second byte describes the payload data format. Defined data format types include the following:<ul><li><para>0x00: Reserved for manufacturer assignment </para></li><li><para>0x01: 96-bit URL with "http://www." prefix </para></li><li><para>0x02: 96-bit URL with "https://www." prefix </para></li><li><para>0x03: 96-bit URL with "http://" prefix </para></li><li><para>0x04: 96-bit URL with "https://" prefix </para></li><li><para>0x05: 96-bit GS1 EPC </para></li><li><para>0x06-0xFF: reserved </para></li></ul></para><para>The following 12 bytes are payload:<ul><li><para>In case of a URL payload, the payload is encoded in US-ASCII, following the limitations defined in RF3987, {<para>} </para></para></li><li><para>In case of GS1 EPC daya, {<para>} for more details.</para></para></li></ul></para><para>The last 2 bytes comprise the CRC.  </para><para>Does not cause any RF activity and does not block.</para><para></para>        
				/// </summary>
				/// <returns>
				/// <para>a byte array containing the barcode </para>
				/// </returns>
				/// <java-name>
				/// getBarcode
				/// </java-name>
				[Dot42.DexImport("getBarcode", "()[B", AccessFlags = 1)]
				public sbyte[] JavaGetBarcode() /* MethodBuilder.Create */ 
				{
						return default(sbyte[]);
				}
				...
				/// getBarcode
				/// </java-name>
				[Dot42.DexImport("getBarcode", "()[B", AccessFlags = 1, IgnoreFromJava = true)]
				public byte[] GetBarcode() /* MethodBuilder.Create */ 
				{
						return default(byte[]);
				}
