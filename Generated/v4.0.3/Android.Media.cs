 ...
 /* scope: __dot42__ */ 
				{
						...
						public virtual MetadataEditor PutString(int key, string value) /* MethodBuilder.Create */ 
						{
						...
						public virtual MetadataEditor PutLong(int key, long value) /* MethodBuilder.Create */ 
						{
								return default(MetadataEditor);
						}
						...
						public virtual MetadataEditor PutBitmap(int key, global::Android.Graphics.Bitmap bitmap) /* MethodBuilder.Create */ 
						{
								return default(MetadataEditor);
						}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Currently not implemented. It does nothing. <xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>Time lapse mode video recording using camera still image capture is not desirable, and will not be supported.  </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <java-name>
				/// setAuxiliaryOutputFile
				/// </java-name>
				[Dot42.DexImport("setAuxiliaryOutputFile", "(Ljava/io/FileDescriptor;)V", AccessFlags = 1)]
				public virtual void SetAuxiliaryOutputFile(global::Java.Io.FileDescriptor fd) /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual void SetAuxiliaryOutputFile(string fd) /* MethodBuilder.Create */ 
				{
				}
