...
//
// Original filename: Java.Security.cs
//
...
namespace Java.Security
{
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para><c> IdentityScope </c> represents a scope for Identity objects.</para><para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>The functionality of this class has been replace by Principal, KeyStore and the</para></xrefdescription></xrefsect><c>               java.security.cert </c> package. </para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Returns the hash code value for this <c> CodeSigner </c> . Returns the same hash code for <c> CodeSigner </c> s that are equal to each other as required by the general contract of Object#hashCode.</para><para><para>Object::equals(Object) </para><simplesectsep></simplesectsep><para>CodeSigner::equals(Object) </para></para>        
				/// </summary>
				/// <returns>
		...
		/// <summary>
		/// <para><c> Identity </c> represents an identity like a person or a company.</para><para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>The functionality of this class has been replace by Principal, KeyStore and the</para></xrefdescription></xrefsect><c>               java.security.cert </c> package. </para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Sets the specified <c> PublicKey </c> to this <c> Identity </c> .</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setPublicKey
				/// </java-name>
				[Dot42.DexImport("setPublicKey", "(Ljava/security/PublicKey;)V", AccessFlags = 1)]
				public virtual void SetPublicKey(global::Java.Security.IPublicKey key) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Sets an information string for this <c> Identity </c> . </para>        
				/// </summary>
				/// <java-name>
				/// setInfo
				/// </java-name>
				[Dot42.DexImport("setInfo", "(Ljava/lang/String;)V", AccessFlags = 1)]
				public virtual void SetInfo(string info) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Returns the hash code value for this <c> Identity </c> . Returns the same hash code for <c> Identity </c> s that are equal to each other as required by the general contract of Object#hashCode.</para><para><para>Object::equals(Object) </para><simplesectsep></simplesectsep><para>Identity::equals(Object) </para></para>        
				/// </summary>
				/// <returns>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// getPermissions
				/// </java-name>
				[Dot42.DexImport("getPermissions", "(Ljava/security/CodeSource;)Ljava/security/PermissionCollection;", AccessFlags = 1025)]
				public abstract global::Java.Security.PermissionCollection GetPermissions(global::Java.Security.CodeSource cs) /* MethodBuilder.Create */ ;

				/// <java-name>
				/// refresh
				/// </java-name>
				[Dot42.DexImport("refresh", "()V", AccessFlags = 1025)]
				public abstract void Refresh() /* MethodBuilder.Create */ ;
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Sets the message digest which this stream will use.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setMessageDigest
				/// </java-name>
				[Dot42.DexImport("setMessageDigest", "(Ljava/security/MessageDigest;)V", AccessFlags = 1)]
				public virtual void SetMessageDigest(global::Java.Security.MessageDigest digest) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Reads <c> len </c> bytes into the specified <c> byte[] </c> , starting from the specified offset. Updates the digest if this function is on(boolean). </para><para>This operation is blocking.</para><para></para>        
				/// </summary>
				/// <returns>
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para><c> Certificate </c> represents an identity certificate, such as X.509 or PGP. Note: A <c> Certificate </c> instances does not make any statement about the validity of itself. It's in the responsibility of the application to verify the validity of its certificates.</para><para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>Replaced by behavior in java.security.cert </para></xrefdescription></xrefsect><para>java.security.cert.Certificate </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				/// <summary>
				/// <para>Decodes a certificate from the given <c> InputStream </c> . The format of the data to encode must be that identified by getFormat() and encoded by encode(OutputStream).</para><para><para>#encode(OutputStream) </para><simplesectsep></simplesectsep><para>#getFormat() </para></para>        
				/// </summary>
				/// <java-name>
				/// decode
				/// </java-name>
				...
				/// <summary>
				/// <para>Returns the public key of this certificate. The public key is guaranteed by the guarantor to belong to the principal.</para><para><para>#getGuarantor() </para><simplesectsep></simplesectsep><para>Certificate::getPrincipal() </para></para>        
				/// </summary>
				/// <returns>
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para>Signer represents an identity (individual or corporation) that owns a private key and the corresponding public key.</para><para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>Replaced by behavior in java.security.cert package and Principal </para></xrefdescription></xrefsect></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Sets the specified parameter to the given value.</para><para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>Use setParameter(AlgorithmParameterSpec) </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <java-name>
				/// setParameter
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para><c> KeyPair </c> is a container for a public key and a private key. Since the private key can be accessed, instances must be treated like a private key.</para><para><para>PrivateKey </para><simplesectsep></simplesectsep><para>PublicKey </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para><c> Key </c> is the common interface for all keys.</para><para><para>PublicKey </para><simplesectsep></simplesectsep><para>PrivateKey </para></para>    
		/// </summary>
		/// <java-name>
		/// java/security/Key
		/// </java-name>
 ...
 /* scope: __dot42__ */ 
		...
		public partial class UnrecoverableKeyException : global::Java.Security.GeneralSecurityException
 /* scope: __dot42__ */ 
		{
				/// <summary>
 ...
 /* scope: __dot42__ */ 
				...
				/// <summary>
				/// <para><c> LoadStoreParameter </c> represents a parameter that specifies how a <c> KeyStore </c> can be loaded and stored.</para><para><para>KeyStore::load(LoadStoreParameter) </para><simplesectsep></simplesectsep><para>KeyStore::store(LoadStoreParameter) </para></para>    
				/// </summary>
				/// <java-name>
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		/// <para><c> UnrecoverableEntryException </c> indicates, that a <c> KeyStore.Entry </c> cannot be recovered from a <c> KeyStore </c> .</para><para><para>KeyStore </para><simplesectsep></simplesectsep><para>KeyStore.Entry </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				public override void Load(global::Java.Io.InputStream @in) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Returns the hash code value for this <c> Timestamp </c> . Returns the same hash code for <c> Timestamp </c> s that are equal to each other as required by the general contract of Object#hashCode.</para><para><para>Object::equals(Object) </para><simplesectsep></simplesectsep><para>Timestamp::equals(Object) </para></para>        
				/// </summary>
				/// <returns>
