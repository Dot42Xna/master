...
namespace Android.App.Backup
{
 ...
 /* scope: __dot42__ */ 
		{
				/// <summary>
				/// <para>During a full restore, indicates that the file system object being restored is an ordinary file. </para>        
				/// </summary>
				/// <java-name>
				/// TYPE_FILE
				/// </java-name>
				...
				/// <summary>
				/// <para>During a full restore, indicates that the file system object being restored is a directory. </para>        
				/// </summary>
				/// <java-name>
				/// TYPE_DIRECTORY
				/// </java-name>
    ...
    "s/ParcelFileDescriptor;)V", AccessFlags = 1025)]
				...
				/// <summary>
				/// <para>The default implementation backs up the entirety of the application's "owned" file system trees to the output. </para>        
				/// </summary>
				/// <java-name>
				/// onFullBackup
				/// </java-name>
				[Dot42.DexImport("onFullBackup", "(Landroid/app/backup/FullBackupDataOutput;)V", AccessFlags = 1)]
				public virtual void OnFullBackup(global::Android.App.Backup.FullBackupDataOutput data) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Write an entire file as part of a full-backup operation. The file's contents will be delivered to the backup destination along with the metadata necessary to place it with the proper location and permissions on the device where the data is restored.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// fullBackupFile
				/// </java-name>
				[Dot42.DexImport("fullBackupFile", "(Ljava/io/File;Landroid/app/backup/FullBackupDataOutput;)V", AccessFlags = 17)]
				public void FullBackupFile(global::Java.Io.File file, global::Android.App.Backup.FullBackupDataOutput output) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Handle the data delivered via the given file descriptor during a full restore operation. The agent is given the path to the file's original location as well as its size and metadata. </para><para>The file descriptor can only be read for <c> size </c> bytes; attempting to read more data has undefined behavior. </para><para>The default implementation creates the destination file/directory and populates it with the data from the file descriptor, then sets the file's access mode and modification time to match the restore arguments.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// onRestoreFile
				/// </java-name>
				[Dot42.DexImport("onRestoreFile", "(Landroid/os/ParcelFileDescriptor;JLjava/io/File;IJJ)V", AccessFlags = 1)]
				public virtual void OnRestoreFile(global::Android.Os.ParcelFileDescriptor data, long size, global::Java.Io.File destination, int type, long mode, long mtime) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
    ...
    "s/ParcelFileDescriptor;)V", AccessFlags = 1)]
		...
		/// <summary>
		/// <para>Provides the interface through which a BackupAgent writes entire files to a full backup data set, via its BackupAgent#onFullBackup(FullBackupDataOutput) method. </para>    
		/// </summary>
		/// <java-name>
