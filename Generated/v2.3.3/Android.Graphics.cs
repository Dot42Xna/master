...
namespace Android.Graphics
{
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// setShadowLayer
				/// </java-name>
				[Dot42.DexImport("setShadowLayer", "(FFFI)V", AccessFlags = 257)]
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <para>Construct a canvas with the specified bitmap to draw into. The bitmap must be mutable.</para><para>The initial target density of the canvas is the same as the given bitmap's density.</para><para></para>        
				/// </summary>
				[Dot42.DexImport("<init>", "(Ljavax/microedition/khronos/opengles/GL;)V", AccessFlags = 1)]
				public Canvas(global::Javax.Microedition.Khronos.Opengles.IGL bitmap) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				/// <para>Returns null.</para><para><xrefsect><xreftitle>Deprecated</xreftitle><xrefdescription><para>This method is not supported and should not be invoked.</para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <java-name>
				/// getGL
				/// </java-name>
				[Dot42.DexImport("getGL", "()Ljavax/microedition/khronos/opengles/GL;", AccessFlags = 1)]
				public virtual global::Javax.Microedition.Khronos.Opengles.IGL GetGL() /* MethodBuilder.Create */ 
				{
				...
				/// freeGlCaches
				/// </java-name>
				[Dot42.DexImport("freeGlCaches", "()V", AccessFlags = 9)]
				public static void FreeGlCaches() /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				/// <para>Set the viewport dimensions if this canvas is GL based. If it is not, this method is ignored and no exception is thrown.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setViewport
				/// </java-name>
				[Dot42.DexImport("setViewport", "(II)V", AccessFlags = 1)]
				public virtual void SetViewport(int width, int height) /* MethodBuilder.Create */ 
				{
				}
    ...
    "graphics/Paint;)V", AccessFlags = 1)]
				...
				/// drawText
				/// </java-name>
				[Dot42.DexImport("drawText", "(Ljava/lang/String;FFLandroid/graphics/Paint;)V", AccessFlags = 257)]
				...
				/// </java-name>
				[Dot42.DexImport("finalize", "()V", AccessFlags = 4)]
				extern ~Canvas() /* MethodBuilder.Create */ ;
 ...
 /* scope: __dot42__ */ 
    ...
    ";", AccessFlags = 9)]
				...
				/// </java-name>
				[Dot42.DexImport("finalize", "()V", AccessFlags = 4)]
				extern ~Bitmap() /* MethodBuilder.Create */ ;
