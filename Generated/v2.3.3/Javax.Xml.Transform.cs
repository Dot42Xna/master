...
//
// Original filename: Javax.Xml.Transform.cs
//
...
namespace Javax.Xml.Transform
{
 ...
 /* scope: __dot42__ */ 
    ...
    "g;)Ljavax/xml/transform/Source;", AccessFlags = 1025)]
				...
				/// <summary>
				/// <para>Set an object that is used by default during the transformation to resolve URIs used in document(), xsl:import, or xsl:include.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setURIResolver
				/// </java-name>
				[Dot42.DexImport("setURIResolver", "(Ljavax/xml/transform/URIResolver;)V", AccessFlags = 1025)]
				public abstract void SetURIResolver(global::Javax.Xml.Transform.IURIResolver resolver) /* MethodBuilder.Create */ ;
				...
				/// <summary>
				/// <para>Set the error event listener for the TransformerFactory, which is used for the processing of transformation instructions, and not for the transformation itself. An <code>IllegalArgumentException</code> is thrown if the <code>ErrorListener</code> listener is <code>null</code>.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setErrorListener
				/// </java-name>
				[Dot42.DexImport("setErrorListener", "(Ljavax/xml/transform/ErrorListener;)V", AccessFlags = 1025)]
				public abstract void SetErrorListener(global::Javax.Xml.Transform.IErrorListener listener) /* MethodBuilder.Create */ ;
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Set an object that will be used to resolve URIs used in document().</para><para>If the resolver argument is null, the URIResolver value will be cleared and the transformer will no longer have a resolver.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setURIResolver
				/// </java-name>
				...
				/// <summary>
				/// <para>Set the output properties for the transformation. These properties will override properties set in the Templates with xsl:output.</para><para>If argument to this function is null, any properties previously set are removed, and the value will revert to the value defined in the templates object.</para><para>Pass a qualified property key name as a two-part string, the namespace URI enclosed in curly braces ({}), followed by the local name. If the name has a null URL, the String only contain the local name. An application can safely check for a non-null URI by testing to see if the first character of the name is a '{' character.</para><para>For example, if a URI and local name were obtained from an element defined with &lt;xyz:foo xmlns:xyz="http://xyz.foo.com/yada/baz.html"/&gt;, then the qualified name would be "{http://xyz.foo.com/yada/baz.html}foo". Note that no prefix is used.</para><para>An <code>IllegalArgumentException</code> is thrown if any of the argument keys are not recognized and are not namespace qualified.</para><para><para>javax.xml.transform.OutputKeys </para><simplesectsep></simplesectsep><para>java.util.Properties </para></para>        
				/// </summary>
				/// <java-name>
				/// setOutputProperties
				/// </java-name>
				[Dot42.DexImport("setOutputProperties", "(Ljava/util/Properties;)V", AccessFlags = 1025)]
				public abstract void SetOutputProperties(global::Java.Util.Properties oformat) /* MethodBuilder.Create */ ;

				/// <summary>
				/// <para>Get a copy of the output properties for the transformation.</para><para>The properties returned should contain properties set by the user, and properties set by the stylesheet, and these properties are "defaulted" by default properties specified by . The properties that were specifically set by the user or the stylesheet should be in the base Properties list, while the XSLT default properties that were not specifically set should be the default Properties list. Thus, getOutputProperties().getProperty(String key) will obtain any property in that was set by setOutputProperty, setOutputProperties, in the stylesheet, <b>or</b> the default properties, while getOutputProperties().get(String key) will only retrieve properties that were explicitly set by setOutputProperty, setOutputProperties, or in the stylesheet.</para><para>Note that mutation of the Properties object returned will not effect the properties that the transformer contains.</para><para>If any of the argument keys are not recognized and are not namespace qualified, the property will be ignored and not returned. In other words the behavior is not orthogonal with setOutputProperties.</para><para><para>javax.xml.transform.OutputKeys </para><simplesectsep></simplesectsep><para>java.util.Properties </para><simplesectsep></simplesectsep><para> </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				/// <para>Set the error event listener in effect for the transformation.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setErrorListener
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				/// <summary>
				/// <para>Set the system identifier for this Source.</para><para>The system identifier is optional if the source does not get its data from a URL, but it may still be useful to provide one. The application can use a system identifier, for example, to resolve relative URIs and to include in error messages and warnings.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setSystemId
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				/// <para>Method setLocator sets an instance of a SourceLocator object that specifies where an error occurred.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setLocator
				/// </java-name>
				[Dot42.DexImport("setLocator", "(Ljavax/xml/transform/SourceLocator;)V", AccessFlags = 1)]
				public virtual void SetLocator(global::Javax.Xml.Transform.ISourceLocator location) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				/// <summary>
				/// <para>Set the system identifier for this Result.</para><para>If the Result is not to be written to a file, the system identifier is optional. The application may still want to provide one, however, for use in error messages and warnings, or to resolve relative output identifiers.</para><para></para>        
				/// </summary>
				/// <java-name>
				/// setSystemId
				/// </java-name>
